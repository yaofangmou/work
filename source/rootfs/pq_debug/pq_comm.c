...
HI_S32 PQ_DRV_Tool_WriteLCACM430(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_LCACM_OFFSET, (HI_PQ_LCACM_OFFSET_S *)pu8Buffer);

    return s32Ret;
}

HI_S32 PQ_DRV_Tool_ReadLCACM430(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    memset(&stAcmOffset, 0 , sizeof(HI_PQ_LCACM_OFFSET_S));

    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_LCACM_OFFSET, &stAcmOffset);
    CHECK_RETURN(s32Ret);

    memcpy(pu8Buffer, &stAcmOffset, sizeof(HI_PQ_LCACM_OFFSET_S));
    return s32Ret;
}
HI_S32 PQ_DRV_Tool_WriteSnrMotionEdge430Lut(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_SNRMOTION_430_LUT, (HI_PQ_SNR_MOTIONEDGE_LUT_S *)pu8Buffer);

    return s32Ret;
}

HI_S32 PQ_DRV_Tool_ReadSnrMotionEdge430Lut(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    HI_PQ_SNR_MOTIONEDGE_LUT_S stSnrLut;
    ...
    memset(&stSnrLut, 0 , sizeof(HI_PQ_SNR_MOTIONEDGE_LUT_S));

    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_SNRMOTION_430_LUT, &stSnrLut);
    CHECK_RETURN(s32Ret);

    memcpy(pu8Buffer, &stSnrLut, sizeof(HI_PQ_SNR_MOTIONEDGE_LUT_S));
    return s32Ret;
}
HI_S32 PQ_DRV_Tool_Write_ZME_VID_SEL(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_ZME_VID_430_SEL, (HI_PQ_ZME_VID_COEF_SEL_S *)pu8Buffer);

    return s32Ret;
}


HI_S32 PQ_DRV_Tool_Read_ZME_VID_SEL(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    HI_PQ_ZME_VID_COEF_SEL_S stLut;
    ...
    memset(&stLut, 0 , sizeof(HI_PQ_ZME_VID_COEF_SEL_S));

    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_ZME_VID_430_SEL, &stLut);
    CHECK_RETURN(s32Ret);

    memcpy(pu8Buffer, &stLut, sizeof(HI_PQ_ZME_VID_COEF_SEL_S));
    return s32Ret;
}

HI_S32 PQ_DRV_Tool_Write_ZME_WBC_SEL(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_S_ZME_WBC_430_SEL, (HI_PQ_ZME_WBC_COEF_SEL_S *)pu8Buffer);

    return s32Ret;
}


HI_S32 PQ_DRV_Tool_Read_ZME_WBC_SEL(HI_U32 u32RegAddr, HI_U8 *pu8Buffer, HI_U32 u32BufferLen)
{
    HI_S32 s32Ret = HI_FAILURE;
    HI_PQ_ZME_WBC_COEF_SEL_S stLut;
    ...
    memset(&stLut, 0 , sizeof(HI_PQ_ZME_WBC_COEF_SEL_S));

    s32Ret = ioctl(g_s32PqFd, HIIOC_PQ_G_ZME_WBC_430_SEL, &stLut);
    CHECK_RETURN(s32Ret);

    memcpy(pu8Buffer, &stLut, sizeof(HI_PQ_ZME_WBC_COEF_SEL_S));
    return s32Ret;
}
...
PQ_DBG_REG_TYPE_S stPQSetRegTypeFun[] =
{
    ...
    /* 430 ACM */
    {PQ_CMD_VIRTUAL_LCACM_430_LUT,           PQ_DRV_Tool_WriteLCACM430},
    {PQ_CMD_VIRTUAL_SNR_MOTION_430_LUT,      PQ_DRV_Tool_WriteSnrMotionEdge430Lut},
    {PQ_CMD_VIRTUAL_ZME_VID_SEL,      PQ_DRV_Tool_Write_ZME_VID_SEL},
    {PQ_CMD_VIRTUAL_ZME_WBC_SEL,      PQ_DRV_Tool_Write_ZME_WBC_SEL},
    //{PQ_CMD_BUTT, NULL},
};
...
PQ_DBG_REG_TYPE_S stPQGetRegTypeFun[] =
{
    ...
    {PQ_CMD_VIRTUAL_LCACM_430_LUT,           PQ_DRV_Tool_ReadLCACM430},
    {PQ_CMD_VIRTUAL_SNR_MOTION_430_LUT,      PQ_DRV_Tool_ReadSnrMotionEdge430Lut},
    {PQ_CMD_VIRTUAL_ZME_VID_SEL,      PQ_DRV_Tool_Read_ZME_VID_SEL},
    {PQ_CMD_VIRTUAL_ZME_WBC_SEL,      PQ_DRV_Tool_Read_ZME_WBC_SEL},
    //{PQ_CMD_BUTT, NULL},
};
...
PQ_DRV_Tool_CHECKCMDLEN_S stPQDrvCheckCmdLen[] =
{
    ...
    /* 430 add acm */
    {PQ_CMD_VIRTUAL_LCACM_430_LUT,      sizeof(HI_PQ_LCACM_OFFSET_S)    },
    {PQ_CMD_VIRTUAL_ACC_430_LUT,        sizeof(PQ_ACC_LUT_S)            },
    {PQ_CMD_VIRTUAL_SNR_MOTION_430_LUT, sizeof(HI_PQ_SNR_MOTIONEDGE_LUT_S)},
    {PQ_CMD_VIRTUAL_ZME_VID_SEL,        sizeof(HI_PQ_ZME_VID_COEF_SEL_S)},
    {PQ_CMD_VIRTUAL_ZME_WBC_SEL,        sizeof(HI_PQ_ZME_WBC_COEF_SEL_S)},
};
...
HI_S32 PQ_DRV_Tool_WriteToPqDriver(HI_U32 u32RegAddr, const HI_U32 *pu32Data, HI_U32 u32Len)
{
    ...
    if (u32RegAddr == PQ_CMD_VIRTUAL_BIN_FIXED)
    {
        ...
        pVirAddr = HI_MPI_SMMU_Map(u32BinPhyAddr, 0);
#else
        pVirAddr = HI_MPI_MMZ_Map(u32BinPhyAddr, 0);
#endif
...
#else
        HI_MPI_MMZ_Unmap(u32BinPhyAddr);
#endif
