                                      ...
                                      WIN_HAL_PARA_S *pstLayerPara)
{
    ...
    if (bInterfaceInterleave)
    {
        ...
        {
            if ((HI_NULL != stFunction.PF_TestChnSupportDhd0P2i)
                && (stFunction.PF_TestChnSupportDhd0P2i(pstWin->enDisp)))
            {
...

    {
        ...
        if (HI_NULL != stFunction.PF_GetFmtZoomInScale)
        {
                               ...
                               WIN_HAL_PARA_S *pstLayerPara)
{
    ...
    HI_RECT_S stCanvas = {0}, stFmtResolution;
