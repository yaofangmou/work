...
typedef struct
{
    ...
    HI_U32              u32HorActive;
    HI_U32              u32VerActive;
    HI_U32              u32HorFront;  /*no compare u32HorFront when the value is 0*/
...
{
    /********************VIC,PixFfeq  , HACT ,VACT, HFB ,FldRate,    EncFmt************************/
    {                        1, 25175 ,  640 ,480 , 16  ,6000 ,  HI_UNF_ENC_FMT_861D_640X480_60  },      // 1. 640 x 480p @ 60 VGA
    {                        2, 27000 ,  720 ,480 , 16  ,6000 ,  HI_UNF_ENC_FMT_480P_60          },      // 2,3 720 x 480p
    {                        3, 27000 ,  720 ,480 , 16  ,6000 ,  HI_UNF_ENC_FMT_480P_60          },      // 2,3 720 x 480p
    {                        4, 74170 ,  1280,720 , 110 ,6000 ,  HI_UNF_ENC_FMT_720P_60          },      // 4   1280 x 720p
    {                        5, 74170 ,  1920,1080, 88  ,6000 ,  HI_UNF_ENC_FMT_1080i_60         },      // 5 1920 x 1080i
    {                        6, 27000 ,  720 ,480 , 38  ,6000 ,  HI_UNF_ENC_FMT_NTSC             },      // 6,7 720 x 480i, pix repl
    {                        7, 27000 ,  720 ,480 , 38  ,6000 ,  HI_UNF_ENC_FMT_NTSC             },      // 6,7 720 x 480i, pix repl
    {                        8, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 8,9(1) 1440 x 240p
    {                        8, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 8,9(2) 1440 x 240p
    {                        9, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 8,9(1) 1440 x 240p
    {                        9, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 8,9(2) 1440 x 240p
    {                       10, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 10,11 2880 x 480p
    {                       11, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 10,11 2880 x 480p
    {                       12, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 12,13(1) 2280 x 240p
    {                       12, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 12,13(2) 2280 x 240p
    {                       14, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 14, 15 1140 x 480p
    {                       16, 148500,  1920,1080, 88  ,6000 ,  HI_UNF_ENC_FMT_1080P_60         },      // 16 1920 x 1080p
    {                       17, 27000 ,  720 ,576 , 12  ,5000 ,  HI_UNF_ENC_FMT_576P_50          },      // 17,18 720 x 576p
    {                       18, 27000 ,  720 ,576 , 12  ,5000 ,  HI_UNF_ENC_FMT_576P_50          },      // 17,18 720 x 576p
    {                       19, 74250 ,  1280,720 , 440 ,5000 ,  HI_UNF_ENC_FMT_720P_50          },      // 19 1280 x 720p
    {                       20, 74250 ,  1920,1080, 528 ,5000 ,  HI_UNF_ENC_FMT_1080i_50         },      // 20 1920 x 1080i
    {                       21, 27000 ,  1440,576 , 24  ,5000 ,  HI_UNF_ENC_FMT_PAL              },      // 21,22 1440 x 576i
    {                       22, 27000 ,  1440,576 , 24  ,5000 ,  HI_UNF_ENC_FMT_PAL              },      // 21,22 1440 x 576i
    {                       23, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 23,24(1) 1440 x 288p
    {                       23, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 23,24(2) 1440 x 288p
    {                       23, 27000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 23,24(3) 1440 x 288p
    {                       25, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 25, 26 2880 x 576p
    {                       27, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 27,28(1) 2880 x 288p
    {                       27, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 27,28(2) 2880 x 288p
    {                       27, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 27,28(3) 2880 x 288p
    {                       29, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 29,30 1440 x 576p

    /********************VIC,PixFfeq  , HACT ,VACT, HFB ,FldRate,    EncFmt************************/
    {                       31, 148500,  1440,576 , 528 ,5000 ,  HI_UNF_ENC_FMT_1080P_50         },      // 31(1) 1920 x 1080p
    {                       32, 74170 ,  1920,1080, 638 ,2400 ,  HI_UNF_ENC_FMT_1080P_24         },      // 32(2) 1920 x 1080p
    {                       33, 74250 ,  1920,1080, 528 ,2500 ,  HI_UNF_ENC_FMT_1080P_25         },      // 33(3) 1920 x 1080p
    {                       34, 74170 ,  1920,1080, 88  ,3000 ,  HI_UNF_ENC_FMT_1080P_30         },      // 34(4) 1920 x 1080p
    {                       35, 108000,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 35, 36 2880 x 480p@59.94/60Hz
    {                       37, 108000,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 37, 38 2880 x 576p@50Hz
    {                       39, 72000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 39 1920 x 1080i@50Hz
    {                       40, 148500,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 40 1920 x 1080i@100Hz
    {                       41, 148500,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 41 1280 x 720p@100Hz
    {                       42, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 42, 43, 720p x 576p@100Hz
    {                       44, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 44, 45, 720p x 576i@100Hz, pix repl
    {                       46, 148500,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 46, 1920 x 1080i@119.88/120Hz
    {                       47, 148500,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 47, 1280 x 720p@119.88/120Hz
    {                       48, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 48, 49 720 x 480p@119.88/120Hz
    {                       50, 54000 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 50, 51 720 x 480i@119.88/120Hz
    {                       52, 10800 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 52, 53, 720 x 576p@200Hz
    {                       54, 10800 ,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 54, 55, 1440 x 720i @200Hz, pix repl
    {                       56, 108000,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 56, 57, 720 x 480p @239.76/240Hz
    {                       58, 108000,  0   ,0   , 0   ,0    ,  HI_UNF_ENC_FMT_BUTT             },      // 58, 59, 1440 x 480i @239.76/240Hz, pix repl

#if defined (DVI_SUPPORT)
    /********************no compare u32HorFront when the value is 0     ************************/
    /********************VIC,PixFfeq  ,HACT ,VACT,HFB,FldRate,    EncFmt************************/
    { HDMI_VIC_PC_BASE+      0, 40000 , 800 ,600 ,0  ,60 ,      HI_UNF_ENC_FMT_VESA_800X600_60    },  // 800x600@60
    { HDMI_VIC_PC_BASE+      1, 65000 , 1024,768 ,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1024X768_60   },  // 1024x768@60
    { HDMI_VIC_PC_BASE+      2, 74250 , 1280,720 ,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1280X720_60   },  // 720x400@70.08
    { HDMI_VIC_PC_BASE+      3, 83500 , 1280,800 ,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1280X800_60   },  // 720x400@85.04
    { HDMI_VIC_PC_BASE+      4, 108000, 1280,1024,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1280X1024_60  },  // 1280x1024@60
    { HDMI_VIC_PC_BASE+      5, 85500 , 1360,768 ,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1360X768_60   },  // 1360x768@60
    { HDMI_VIC_PC_BASE+      6, 85500 , 1366,768 ,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1366X768_60   },  // 1360x768@60
    { HDMI_VIC_PC_BASE+      7, 121750, 1400,1050,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1400X1050_60  },  // 1360x768@60
    { HDMI_VIC_PC_BASE+      8, 106500, 1440,900, 0  ,60 ,      HI_UNF_ENC_FMT_VESA_1440X900_60   },  // 800x600@56.25
    { HDMI_VIC_PC_BASE+      9, 162000, 1600,1200,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1600X1200_60  },  // 1600x1200@60
    { HDMI_VIC_PC_BASE+      10,146250, 1680,1050,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1680X1050_60  },  // 800x600@72.19
    { HDMI_VIC_PC_BASE+      11,148500, 1920,1080,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1920X1080_60  },  // 800x600@72.19
    { HDMI_VIC_PC_BASE+      12,154000, 1920,1200,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1920X1200_60  },  // 1920x1200@59.95
    { HDMI_VIC_PC_BASE+      13,234000, 1920,1440,0  ,60 ,      HI_UNF_ENC_FMT_VESA_1920X1440_60  },  // 1024x768@60
    { HDMI_VIC_PC_BASE+      14,156750, 2048,1152,0  ,60 ,      HI_UNF_ENC_FMT_VESA_2048X1152_60  },  // 1024x768@70.07
    //{ HDMI_VIC_PC_BASE+    15, 88750, 1440,900, 0  ,60 ,      HI_UNF_ENC_FMT_VESA_1440X900_60_RB    },  // 800x600@56.25
    { HDMI_VIC_PC_BASE+      15, 97750, 1600,900, 0  ,60 ,      HI_UNF_ENC_FMT_VESA_1600X900_60_RB    },  // 800x600@56.25
    { HDMI_VIC_PC_BASE+     16, 241500, 2560,1440,0  ,60 ,      HI_UNF_ENC_FMT_VESA_2560X1440_60_RB}, // 2560x1440@60
    { HDMI_VIC_PC_BASE+     17, 108000, 0   ,0   ,0  ,0  ,      HI_UNF_ENC_FMT_BUTT               },  // 1152x864@75
    { HDMI_VIC_PC_BASE+     18, 108000, 0   ,0   ,0  ,0  ,      HI_UNF_ENC_FMT_BUTT               },  // 1152x864@75
    { HDMI_VIC_PC_BASE+     19, 68250 , 0   ,0   ,0  ,0  ,      HI_UNF_ENC_FMT_BUTT               },  // 1280x768@59.95
    { HDMI_VIC_PC_BASE+     20, 79500 , 0   ,0   ,0  ,0  ,      HI_UNF_ENC_FMT_BUTT               },  // 1280x768@59.87


#endif

    /********************VIC,PixFfeq  , HACT ,VACT, HFB   ,FldRate,    EncFmt************************/
    {                       93, 297000,  3840,2160, 1276  ,2400 ,    HI_UNF_ENC_FMT_3840X2160_24  },
    {                       94, 297000,  3840,2160, 1056  ,2500 ,    HI_UNF_ENC_FMT_3840X2160_25  },
    {                       95, 297000,  3840,2160, 176   ,3000 ,    HI_UNF_ENC_FMT_3840X2160_30  },
    {                       96, 594000,  3840,2160, 1056  ,5000 ,    HI_UNF_ENC_FMT_3840X2160_50  },
    {                       97, 594000,  3840,2160, 176   ,6000 ,    HI_UNF_ENC_FMT_3840X2160_60  },

    {                       98, 297000,  4096,2160, 1020  ,2400 ,    HI_UNF_ENC_FMT_4096X2160_24  },
    {                       99, 297000,  4096,2160, 968   ,2500 ,    HI_UNF_ENC_FMT_4096X2160_25  },
    {                       100,297000,  4096,2160, 88    ,3000 ,    HI_UNF_ENC_FMT_4096X2160_30  },
    {                       101,594000,  4096,2160, 968   ,5000 ,    HI_UNF_ENC_FMT_4096X2160_50  },
    {                       102,594000,  4096,2160, 88    ,6000 ,    HI_UNF_ENC_FMT_4096X2160_60  },
...
static HI_U32 Hdmi_PreTiming2Format(HDMI_EDID_PRE_TIMING_S *pstPreTiming)
{
    ...
    for (i=0;i<HDMI_ARRAY_SIZE(s_g_stFmtParamTable);i++)
    {
        ...
        if (  (pstFmtParam != HI_NULL)
            ...
            &&((pstFmtParam->u32HorFront == pstPreTiming->u32HFB)||(pstFmtParam->u32HorFront == 0 )))
        {
            return pstFmtParam->u32Format;
        }
    }
...
static HI_S32 Hdmi_AttrCheck(HI_UNF_HDMI_ATTR_S *pstAttr)
{
    ...
    if (  HI_UNF_HDMI_VIDEO_MODE_YCBCR422 == pstAttr->enVidOutMode
       || HI_UNF_HDMI_VIDEO_MODE_YCBCR420 == pstAttr->enVidOutMode)
       {
            HI_WARN_HDMI("not support enVidOutMode(%d)\n", pstAttr->enVidOutMode);
            return HI_ERR_HDMI_FEATURE_NO_SUPPORT;
       }

    if (   HI_UNF_HDMI_DEEP_COLOR_24BIT != pstAttr->enDeepColorMode
        && HI_UNF_HDMI_DEEP_COLOR_OFF   != pstAttr->enDeepColorMode)
    {
        HI_WARN_HDMI("not support enDeepColorMode(%d)\n", pstAttr->enDeepColorMode);
        return HI_ERR_HDMI_FEATURE_NO_SUPPORT;
    }

    if (HI_UNF_HDMI_HDCP_MODE_2_2 == pstAttr->enHDCPMode)
    {
        HI_WARN_HDMI("not support enHDCPMode(%d)\n", pstAttr->enHDCPMode);
        return HI_ERR_HDMI_FEATURE_NO_SUPPORT;
    }
#endif
...
HI_S32 HI_UNF_HDMI_SetDeepColor(HI_UNF_HDMI_ID_E enHdmi, HI_UNF_HDMI_DEEP_COLOR_E enDeepColor)
{
    ...
    if (HI_UNF_HDMI_DEEP_COLOR_OFF != enDeepColor)
    {
        HDMI_UNF_CHECK_MAX(enDeepColor, HI_UNF_HDMI_DEEP_COLOR_36BIT + 1);
    }

#if defined(CHIP_TYPE_hi3716mv430)
    if (   HI_UNF_HDMI_DEEP_COLOR_24BIT != enDeepColor
        && HI_UNF_HDMI_DEEP_COLOR_OFF   != enDeepColor)
    {
        HI_WARN_HDMI("not support enDeepColor(%d)\n", enDeepColor);
        return HI_ERR_HDMI_FEATURE_NO_SUPPORT;
    }
#endif
