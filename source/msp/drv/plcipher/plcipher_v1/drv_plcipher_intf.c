...
{
    HI_S32 ret = HI_SUCCESS;
    strncpy(g_PLCipherDevice.devfs_name, UMAP_DEVNAME_PLCIPHER, sizeof(g_PLCipherDevice.devfs_name) - 1);
    g_PLCipherDevice.devfs_name[strlen(UMAP_DEVNAME_PLCIPHER)] = '\0';
