...
/* Define the union U_HDMITX_DPHY_RST,ATTR:RW,ADDR:C,INIT:00000000,MASK:ffffffff,CMMNT:hdmi tx dphy rst ctrl*/
typedef union
{
    /* Define the struct bits */
    struct
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reg_test_dc         : 15  ; /* [30:16] */
        unsigned int    reg_test_dc_rxsense : 1   ; /* [31] */
    } bits;
