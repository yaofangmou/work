...
case 0: tuner->demod->tso0->CAM->tsi0->demux_port_tsi1->demux,
        parallel, internal demod, hi3751v100/hi3796cv100/hi3716mv430
...
static HI_U32 UpdatePMT(HI_U32 ProgNum)
{
    ...
    return HI_CI_UpdatePMT(CISLOT, g_pProgTbl->proginfo[ProgNum].u8PmtData, CA_PMT_LIST_MANAGEMENT_ONLY);
}
...
HI_S32 main(HI_S32 argc,HI_CHAR *argv[])
{
    ...
    if (TSOPORT != HI_UNF_PORT_INVALID)
    {
        ...
        stTSOAttr.enPortType = HI_UNF_DMX_PORT_TYPE_PARALLEL_BURST;
