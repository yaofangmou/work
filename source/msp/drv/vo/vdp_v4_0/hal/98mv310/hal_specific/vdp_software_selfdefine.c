...
#ifndef __DISP_PLATFORM_BOOT__
HI_VOID VDP_WIN_DebugLogicInfo(HI_U32 u32Data, HI_U32 u32Num, HI_VOID *pstWinDebug)
{
    U_V0_VFPOS   V0_VFPOS;
    U_V0_VLPOS   V0_VLPOS;
    U_V0_DFPOS   V0_DFPOS;
    U_V0_DLPOS   V0_DLPOS;
    U_V1_MRG_R0_DISP_POS   V1_MRG_R0_DISP_POS;
    U_V1_MRG_R0_DISP_RESO  V1_MRG_R0_DISP_RESO;
    ...
    WIN_DEBUG_LOGIC_INFO_S *pstWinDebugLogicInfo = (WIN_DEBUG_LOGIC_INFO_S *)pstWinDebug;

    if (u32Data >= VID_MAX)
    {
        VDP_PRINT("Error,VDP_WIN_DebugLogicInfo() Select Wrong Video Layer ID\n");
        return ;
    }
    ...
    if (0 == u32Data)
    {
        ...
        pstWinDebugLogicInfo->stVideo.s32X = V0_VFPOS.bits.video_xfpos;
        pstWinDebugLogicInfo->stVideo.s32Y = V0_VFPOS.bits.video_yfpos;
        pstWinDebugLogicInfo->stVideo.s32Width = V0_VLPOS.bits.video_xlpos - V0_VFPOS.bits.video_xfpos + 1;
        pstWinDebugLogicInfo->stVideo.s32Height = V0_VLPOS.bits.video_ylpos - V0_VFPOS.bits.video_yfpos + 1;
        ...
        pstWinDebugLogicInfo->stDisp.s32X = V0_DFPOS.bits.disp_xfpos;
        pstWinDebugLogicInfo->stDisp.s32Y = V0_DFPOS.bits.disp_yfpos;
        pstWinDebugLogicInfo->stDisp.s32Width = V0_DLPOS.bits.disp_xlpos - V0_DFPOS.bits.disp_xfpos + 1;
        pstWinDebugLogicInfo->stDisp.s32Height = V0_DLPOS.bits.disp_ylpos - V0_DFPOS.bits.disp_yfpos + 1;

        VID_IN_RESO.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->VID_IN_RESO.u32) + u32Data * VID_FDR_OFFSET));
        pstWinDebugLogicInfo->stInRect.s32Width = VID_IN_RESO.bits.ireso_w;
        pstWinDebugLogicInfo->stInRect.s32Height = VID_IN_RESO.bits.ireso_h;

        V0_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET));
        pstWinDebugLogicInfo->surface_en = V0_CTRL.bits.surface_en;
        V0_MUTE_BK.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_MUTE_BK.u32) + u32Data * VID_OFFSET));
        pstWinDebugLogicInfo->mute_en = V0_MUTE_BK.bits.mute_en;
    }
    else
    {
        V1_MRG_R0_DISP_POS.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->V1_MRG_R0_DISP_POS.u32) + u32Data * VID_OFFSET + u32Num * REGION_OFFSET));
        V1_MRG_R0_DISP_RESO.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->V1_MRG_R0_DISP_RESO.u32) + u32Data * VID_OFFSET + u32Num * REGION_OFFSET));
        pstWinDebugLogicInfo->stDisp.s32X = V1_MRG_R0_DISP_POS.bits.mrg_r0_xpos;
        pstWinDebugLogicInfo->stDisp.s32Y = V1_MRG_R0_DISP_POS.bits.mrg_r0_ypos;
        pstWinDebugLogicInfo->stVideo.s32Width = V1_MRG_R0_DISP_RESO.bits.mrg_r0_width + 1;
        pstWinDebugLogicInfo->stVideo.s32Height = V1_MRG_R0_DISP_RESO.bits.mrg_r0_height + 1;

        pstWinDebugLogicInfo->stVideo.s32X = pstWinDebugLogicInfo->stDisp.s32X;
        pstWinDebugLogicInfo->stVideo.s32Y = pstWinDebugLogicInfo->stDisp.s32Y;
        pstWinDebugLogicInfo->stDisp.s32Width = pstWinDebugLogicInfo->stVideo.s32Width;
        pstWinDebugLogicInfo->stDisp.s32Height = pstWinDebugLogicInfo->stVideo.s32Height;

        pstWinDebugLogicInfo->stInRect.s32Width = pstWinDebugLogicInfo->stVideo.s32Width;
        pstWinDebugLogicInfo->stInRect.s32Height = pstWinDebugLogicInfo->stVideo.s32Height;


        V1_MRG_CTRL.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V1_MRG_CTRL.u32) + u32Num * REGION_FDR_OFFSET));
        pstWinDebugLogicInfo->mute_en = V1_MRG_CTRL.bits.mrg_mute_en;
        pstWinDebugLogicInfo->surface_en = V1_MRG_CTRL.bits.mrg_en;

    }

    V0_CTRL.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET));
    pstWinDebugLogicInfo->nosec_flag = V0_CTRL.bits.nosec_flag;
    VID_SRC_INFO.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->VID_SRC_INFO.u32) + u32Data * VID_FDR_OFFSET));
    pstWinDebugLogicInfo->data_width = VID_SRC_INFO.bits.data_width;
}

HI_VOID VDP_GetVMX_WaterMarkStatus(HI_BOOL *pbEnable)
{
    U_V0_UPD V0_UPD;
    V0_UPD.u32 = VDP_RegRead((HI_ULONG) & (pVdpReg->V0_UPD.u32) );
    *pbEnable = V0_UPD.bits.regup;
    return;
}
