...
#define FRONTEND_CONFIG_PATH  "./res/"
#define FRONTEND_CONFIG_FILE  FRONTEND_CONFIG_PATH "frontend_config.ini"

//#define TUNERNUM_SECTION      "tunernum"
#define TUNERINFO_SECTION     "tuner0info"  /* OTA only need 1 tuner, always use tuner0. */
#define OTA_TUNER_ID          (0)
