...
typedef struct tagWBC_INPUT_S
{
    ...
    HI_RECT_S stSdVideoRect;
    HI_RECT_S stSdOutRect;
...
typedef struct tagVIDEO_LAYER_FUNCTIONG_S
{
    ...
    HI_S32 (*PF_GetEnable)(HI_U32 u32Layer, HI_BOOL *pbEnable);
    HI_VOID (*PF_SetLayerMute)(HI_U32 u32Layer, HI_BOOL bEnable);

    HI_S32 (*PF_InitialLayer)(HI_U32 u32Layer);
    HI_S32 (*PF_DeInitialLayer)(HI_U32 u32Layer);
    ...
    HI_VOID (*PF_GetTotalBufStatus)(HI_U32 u32LayerId, VDP_DRV_LAYER_INFO_S *pstLowdelayState);
    HI_S32 (*PF_DeuqueBufNode) (HI_U32 u32Layer, VDP_DRV_RELEASE_FRAME_NODE_S *pstReleaseNode);
    HI_S32 (*PF_ResetHwBuf) (HI_U32 u32LayerId, HI_BOOL bResetEn, HI_DRV_WIN_SWITCH_E enResetMode);
    HI_VOID (*PF_PauseHwBuf) (HI_U32 u32LayerId, VDP_CYCBUF_DTV_MODE_E enDtvMode);
    HI_VOID (*PF_HW_BUF_SetStepMode)(HI_U32 u32LayerId, HI_BOOL bhold_en);

    HI_VOID (*PF_HW_BUF_GetFramePrivateInfor)(HI_U32 u32LayerId, HW_DYNAMIC_FrameInfor_S *pstCurrentFrameInfo);
    HI_VOID (*PF_HW_BUF_GetCurrentPlayFrameInfor)(HI_U32 u32LayerId, HW_BUFNODE_Infor_S *pstCurrentFrameInfor);
    HI_VOID (*PF_SetHwBufQuickoutMode) (HI_U32 u32LayerId, VDP_CYCBUF_DTV_MODE_E enDtvMode);
    HI_BOOL (*PF_CheckResetFinish) (HI_VOID);
    HI_VOID (*PF_HW_ChangeApbConfig)(HI_BOOL bOnline,VDP_CHANGEINFO_S *pstChangeInfor);
    HI_VOID (*PF_HW_ALG_POLICY_GetVpssBufferSize)(XDP_VPSSIP_POLICY_S *pstVpssIpPolicy,
                                                  XDP_VPSSIP_CHN_CFG_S *pstVpssIpChnCfg,
                                                  HI_U32 *pu32TotalBufSize,
                                                  HI_U32 *pu32OtherBufSize);
    XDP_LAYER_VID_INFO_S* (*PF_HW_BUF_GetLastHardwareConfig)(HI_VOID);
    HI_S32 (*PF_Alg_GetMemcfg) (HI_VOID);
    HI_S32 (*PF_Alg_GetAlgEnablePolicy) (HI_VOID);
    HI_VOID (*PF_Alg_GetWbcConfig)(HW_ALG_WBC_STATUS_INFOR_S *pstWbcStatus);
    HI_VOID (*PF_Alg_SetWbcConfig)(HW_ALG_WBC_CONFIG_INFOR_S *pstWbcStatus);

    HI_VOID (*PF_OfflineReset)(HI_VOID);
