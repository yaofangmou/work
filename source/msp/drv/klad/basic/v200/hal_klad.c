...
HI_VOID HAL_KLAD_IntEn(HI_VOID)
{
    ...
    HAL_KLAD_WriteReg(KL_CA_HKL_ACPU_INT_EN, 0x01);
#else
...
{
#ifdef HI_TEE_SUPPORT
    HAL_KLAD_WriteReg(KL_CA_HKL_ACPU_INT_EN, 0x00);
#else
...
{
#ifdef HI_TEE_SUPPORT
    HAL_KLAD_WriteReg(KL_CA_HKL_ACPU_INT_RAW, 0x01);
#else
...
{
#ifdef HI_TEE_SUPPORT
    return HAL_KLAD_ReadReg(KL_CA_HKL_ACPU_INT);
#else
