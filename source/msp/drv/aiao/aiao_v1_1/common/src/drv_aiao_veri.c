...
static HI_S32 AIAO_IOCTL_HdmiSetAudioAttr(struct file* file, HI_VOID* arg)
{
    ...
    if (pstHdmiFunc && pstHdmiFunc->pfnHdmiSetAudioMute)
    {
        (pstHdmiFunc->pfnHdmiSetAudioMute)(HI_UNF_HDMI_ID_0);
    }
    ...
    if (pstHdmiFunc && pstHdmiFunc->pfnHdmiGetAoAttr)
    {
        ...
        stHDMIAtr.enAudioCode  = Param->enAudioFormat;
    ...
    if (pstHdmiFunc && pstHdmiFunc->pfnHdmiSetAudioUnMute)
    {
        (pstHdmiFunc->pfnHdmiSetAudioUnMute)(HI_UNF_HDMI_ID_0);
    }
