...
struct file* HI_DRV_FILE_Open(const HI_S8* ps8FileName, HI_U32 u32Flags)
{
    ...
    {
        u32Flags = O_WRONLY | O_CREAT | O_APPEND;
    }

    pFile = filp_open(ps8FileName, u32Flags | O_LARGEFILE, S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);
