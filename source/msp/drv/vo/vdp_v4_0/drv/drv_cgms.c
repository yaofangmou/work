...
S_VDP_MONITOR_REGS_TYPE *pVdpMonitorReg= HI_NULL;
...
HI_VOID DRV_GetTeeVideoMonitorCtrl(HI_U16 *pu16DownScale_w,HI_U16 *pu16DownScale_h)
{
    U_MONITOR_CTRL  MONITOR_CTRL;

    MONITOR_CTRL.u32 = VDP_RegRead((HI_ULONG) & (pVdpMonitorReg->MONITOR_CTRL.u32));
    *pu16DownScale_w = MONITOR_CTRL.bits.downscale_w ;
    *pu16DownScale_h = MONITOR_CTRL.bits.downscale_h ;
