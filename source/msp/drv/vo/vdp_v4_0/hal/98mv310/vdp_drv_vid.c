...
HI_S32 VDP_DRV_HdrRegClean(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoIn)
{
    HI_U32 ii=0;
...
HI_S32 XDP_DRV_RegisterClen(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfo)
{
    ...
    VDP_DRV_HdrRegClean(u32LayerId, pstInfo);
