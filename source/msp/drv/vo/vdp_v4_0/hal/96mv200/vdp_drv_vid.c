...
HI_S32 VDP_DRV_GetHiHdrCfg(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut, HI_PQ_HDR_CFG  *pstPqHdrCfg, HIHDR_SCENE_MODE_E enSceneMode, DmCfg_t  *pstDmCfg)
{
    ...
    else if ((enSceneMode == HIHDR_HDR10_IN_SDR_OUT)
     ||  (enSceneMode == HIHDR_TECHNI_IN_SDR_OUT)) //98mv200t test ok!
    {
        //typ mode
        VDP_PRINT("VdmSceneMode == VDM_HDR10_IN_SDR_OUT\n");
    ...
    else if ((enSceneMode == HIHDR_HDR10_IN_HDR10_OUT)
      || (enSceneMode == HIHDR_TECHNI_IN_HDR10_OUT)) //98mv200t test ok!
    {
        //typ mode
...
HI_S32 XDP_DRV_SetTechniCfg(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut, HIHDR_SCENE_MODE_E enSceneMode)
{
    /* Only V0 support technicolor */
    if (VDP_LAYER_VID0 != u32LayerId)
    {
        return HI_SUCCESS;
    }

    if (HIHDR_TECHNI_IN_HDR10_OUT == enSceneMode || HIHDR_TECHNI_IN_SDR_OUT == enSceneMode)
    {
        VDP_TCHDR_SetTchdrCkGtEn(HI_TRUE);
        VDP_TCHDR_SetTchdrEn(pstInfoOut->pstSlHdrPsParam->stPsParam.tchdr_en);

        if (pstInfoOut->pstSlHdrPsParam->stPsParam.tchdr_en)
        {

            /* Config PS IP */
            VDP_FUNC_SetTchdrMode(pstInfoOut->pstSlHdrPsParam);

            /* Load technicolor COEF */
            VDP_FUNC_FormatTchdrCoefToDDR(VDP_RM_COEF_MODE_TYP, &pstInfoOut->pstSlHdrPsParam->stPsParam);
            VDP_FUNC_LoadTchdrCoefFromDdr2Reg();
        }
    }
    else
    {
        VDP_TCHDR_SetTchdrEn(HI_FALSE);
    }
...
HI_S32 XDP_DRV_SetVidMute(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut)
{
    ...
    {
        if ((HI_TRUE == pstInfoOut->stXdpSysCfg.bMuteEn) || (HI_TRUE == pstInfoOut->stXdpSysCfg.bMask))
        {
            bMuteEn = HI_TRUE;
        }
        else
        ...
        VDP_VID_SetMuteEnable          (u32LayerId, bMuteEn);
...
HI_S32  XDP_DRV_GetOptimizePerformance(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut)
{
    ...
    if ((u32LayerId == VDP_LAYER_VID0)
        && ((VDP_VID_IFMT_SP_TILE == pstInfoOut->stXdpSrcCfg.enInFmt) || (VDP_VID_IFMT_SP_TILE_64 == pstInfoOut->stXdpSrcCfg.enInFmt))
        && ((2 * pstInfoOut->stXdpPositionCfg.stVideoRect.u32Hgt) < pstInfoOut->stXdpDispCfg.stFmtReso.u32Hgt))
    {
        pstInfoOut->stXdpLayerExtern.bReduceDataWth = HI_TRUE;
    }
...
HI_S32 VDP_DRV_SetVidZme2(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut)
{
    ...
    if (VDP_LAYER_VID0 == u32LayerId)
    {
        ...
        if (pstInfoOut->stXdpZmeCfg.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32PixInFmt !=
            pstInfoOut->stXdpZmeCfg.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].u32PixOutFmt)
        {
            HI_ERR_PRINT(HI_ID_DISP,"ZME1 OUT->%d, ZME2 IN->%d !!!!\n",
                        pstInfoOut->stXdpZmeCfg.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].u32PixOutFmt,
                        pstInfoOut->stXdpZmeCfg.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32PixInFmt);
            return HI_FAILURE;
        }
        VDP_VID_SetZme2InFmt(u32LayerId, pstInfoOut->stXdpZmeCfg.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32PixInFmt);
        VDP_VID_SetZme2OutFmt(u32LayerId,pstInfoOut->stXdpZmeCfg.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32PixOutFmt);
...
HI_S32 VDP_DRV_SetV0V1CscReg(HI_U32 u32LayerId, XDP_CSC_CFG_S* pstXdpCscCfg)
{
#ifndef  __DISP_PLATFORM_BOOT__
    ...
    if (u32LayerId == VDP_LAYER_VID0)
    {
        ...
        VDP_HIHDR_SetVdm00Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef00);
        VDP_HIHDR_SetVdm01Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef01);
        VDP_HIHDR_SetVdm02Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef02);
        VDP_HIHDR_SetVdm03Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef10);
        VDP_HIHDR_SetVdm04Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef11);
        VDP_HIHDR_SetVdm05Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef12);
        VDP_HIHDR_SetVdm06Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef20);
        VDP_HIHDR_SetVdm07Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef21);
        VDP_HIHDR_SetVdm08Yuv2rgb( pstXdpCscCfg->stPqCscCoef.csc_coef22);
        VDP_HIHDR_SetVdmYuv2rgb00InDc( pstXdpCscCfg->stPqCscDc.csc_in_dc0);
        VDP_HIHDR_SetVdmYuv2rgb01InDc( pstXdpCscCfg->stPqCscDc.csc_in_dc1);
        VDP_HIHDR_SetVdmYuv2rgb02InDc( pstXdpCscCfg->stPqCscDc.csc_in_dc2);
        VDP_HIHDR_SetVdmYuv2rgb00OutDc( pstXdpCscCfg->stPqCscDc.csc_out_dc0);
        VDP_HIHDR_SetVdmYuv2rgb01OutDc( pstXdpCscCfg->stPqCscDc.csc_out_dc1);
        VDP_HIHDR_SetVdmYuv2rgb02OutDc( pstXdpCscCfg->stPqCscDc.csc_out_dc2);
    ...
    else if (u32LayerId == VDP_LAYER_VID1)
    {
        ...
        VDP_HIHDR_SetVdm10Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef00));
        VDP_HIHDR_SetVdm11Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef01));
        VDP_HIHDR_SetVdm12Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef02));
        VDP_HIHDR_SetVdm13Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef10));
        VDP_HIHDR_SetVdm14Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef11));
        VDP_HIHDR_SetVdm15Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef12));
        VDP_HIHDR_SetVdm16Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef20));
        VDP_HIHDR_SetVdm17Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef21));
        VDP_HIHDR_SetVdm18Yuv2rgb( ( pstXdpCscCfg->stPqCscCoef.csc_coef22));

        VDP_HIHDR_SetVdmYuv2rgb10InDc( pstXdpCscCfg->stPqCscDc.csc_in_dc0);
        VDP_HIHDR_SetVdmYuv2rgb11InDc( pstXdpCscCfg->stPqCscDc.csc_in_dc1);
        VDP_HIHDR_SetVdmYuv2rgb12InDc( pstXdpCscCfg->stPqCscDc.csc_in_dc2);
        VDP_HIHDR_SetVdmYuv2rgb10OutDc(pstXdpCscCfg->stPqCscDc.csc_out_dc0);
        VDP_HIHDR_SetVdmYuv2rgb11OutDc(pstXdpCscCfg->stPqCscDc.csc_out_dc1);
        VDP_HIHDR_SetVdmYuv2rgb12OutDc(pstXdpCscCfg->stPqCscDc.csc_out_dc2);
...
HI_S32 XDP_DRV_AdjustVidCscInfo(HI_U32 u32LayerId, XDP_CSC_CFG_S* pstXdpCscCfg)
{
    if (u32LayerId == VDP_LAYER_VID0)
    {
        pstXdpCscCfg->stPqCscDc.csc_out_dc0 *= 4;
        pstXdpCscCfg->stPqCscDc.csc_out_dc1 *= 4;
        pstXdpCscCfg->stPqCscDc.csc_out_dc2 *= 4;

        pstXdpCscCfg->stPqCscCoef.csc_coef00 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef01 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef02 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef10 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef11 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef12 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef20 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef21 *= 8;
        pstXdpCscCfg->stPqCscCoef.csc_coef22 *= 8;
    }
    else if (u32LayerId == VDP_LAYER_VID1)
    {
...
HI_S32 XDP_DRV_GetVidCscInfo(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut, XDP_CSC_CFG_S* pstXdpCscCfg)
{
    ...
    if (u32LayerId == VDP_LAYER_VID0)
    {
        ...
        pstXdpCscCfg->enCbbCscMode = enCscMode;
        pstXdpCscCfg->enPqCscMode  = enPqCscMode;
    }
    else  if (u32LayerId == VDP_LAYER_VID1)
    {
        stCscCtrl.bCSCEn    = HI_TRUE;
    ...
    memcpy(&pstXdpCscCfg->stPqCscCoef, &stPqCscCoef, sizeof(HI_PQ_CSC_COEF_S));
    memcpy(&pstXdpCscCfg->stPqCscDc,   &stPqCscDc,   sizeof(HI_PQ_CSC_DCCOEF_S));

    XDP_DRV_AdjustVidCscInfo(u32LayerId, pstXdpCscCfg);

    return HI_SUCCESS;

}

HI_S32 XDP_DRV_SetVidCsc(HI_U32 u32LayerId, XDP_CSC_CFG_S* pstXdpCscCfg)
{
    ...
    if (u32LayerId == VDP_LAYER_VID3)
    {
        memcpy(&stVdpCscCoef, &pstXdpCscCfg->stPqCscCoef, sizeof(VDP_CSC_COEF_S));
        memcpy(&stVdpDcCscCoef, &pstXdpCscCfg->stPqCscDc,   sizeof(VDP_CSC_DC_COEF_S));
    ...
    {
        VDP_DRV_SetV0V1CscReg(u32LayerId, pstXdpCscCfg);
    }
...
HI_S32 VDP_DRV_SetVidLayer(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstLayerInfoIn, HI_PQ_HDR_CFG  *pstPqHdrCfg)
{
    ...
    XDP_DRV_SetTechniCfg(u32LayerId, pstOutInfo, enSceneMode);
