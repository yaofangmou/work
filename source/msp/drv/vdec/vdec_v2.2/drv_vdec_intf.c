...
#define DEFAULT_COMPRESS_STRATEGY VDEC_FORCE_NO_COMPRESS
                                ...
                                VDEC_CHANNEL_S *pstChan)
{
    ...
    PROC_PRINT(p,
               ...
               "Receive Frame - Decoder Over        : %d ms\n",
               ...
               pstStatInfo->u32ReceiveFrameTime - pstStatInfo->u32DecoderReportTime);
    return;
}
...
{
#if !defined(HI_MCE_SUPPORT) || defined(HI_PROC_SUPPORT)
    int ret = 0;
#endif
