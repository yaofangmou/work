...
#if defined(DEMOD_DEV_TYPE_HI3136) || (DEMOD_DEV_TYPE_HISDTV100)
...
HI_S32 av2011_init_tuner(HI_U32 u32TunerPort)
{
    ...
    {
        HI_ERR_TUNER( "av2011_write error\n");
        return s32Ret;
    }
    tuner_mdelay(1);
...
HI_S32 av2011_set_tuner(HI_U32 u32TunerPort, HI_U8 enI2cChannel, HI_U32 u32PuRF/*kHz*/)  //freq :unit MHZ, symbol:unit  Khz
{
    ...
    av2011_get_lpf(u32TunerPort, &BW);
...
#endif
    {
        ...
        //mdelay(2);
        reg_start = 0;
        s32Ret = av2011_write(u32TunerPort, enI2cChannel, tuner_address, reg_start, reg, 4);
        if (HI_SUCCESS != s32Ret)
        {
            HI_ERR_TUNER( "av2011_write error\n");
            return s32Ret;
        ...
        // Send Reg5
        reg_start = 5;
        s32Ret = av2011_write(u32TunerPort, enI2cChannel, tuner_address, reg_start, reg + 5, 1);
        if (HI_SUCCESS != s32Ret)
        {
            HI_ERR_TUNER( "av2011_write error\n");
            return s32Ret;
        ...
        reg_start = 3;
        s32Ret = av2011_write(u32TunerPort, enI2cChannel, tuner_address, reg_start, reg+3, 1);
        if (HI_SUCCESS != s32Ret)
        {
            HI_ERR_TUNER( "av2011_write error\n");
            return s32Ret;
...
HI_S32 av2011_set_loopthrough(HI_U32 u32TunerPort)
{
    HI_S32 s32Ret;
    HI_U8 reg_start;
    HI_U8 reg;
    ...
    enI2cChannel = g_stTunerOps[u32TunerPort].enI2cChannel;
    tuner_address = g_stTunerOps[u32TunerPort].u32TunerAddress;
    s32Ret = av2011_write(u32TunerPort, enI2cChannel, tuner_address, reg_start, &reg, 1);
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER( "av2011_write error\n");
        return s32Ret;
...
HI_S32 av2011_cancel_loopthrough(HI_U32 u32TunerPort)
{
    HI_S32 s32Ret;
    HI_U8 reg_start;
    HI_U8 reg;
...
HI_VOID av2011_set_lpf(HI_U32 u32TunerPort, HI_U32 u32LPFKHz)
{
    u32LPF_KHz[u32TunerPort] = u32LPFKHz;
    return;
}

HI_S32  av2011_get_lpf(HI_U32 u32TunerPort, HI_U32 *pu32LPFKHz)
{
