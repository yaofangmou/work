...
#define YXSB_WATERMARK_CODE     0x1B1
...
typedef struct
{
    ...
    UINT8  ref_flag;
    UINT32 err_level;
    SINT32 vo_fs_id_plus1;
    SINT32 tf_fs_id_plus1;
    IMAGE  imginf;
} MP2VOBUFINF;
...
typedef struct
{
    ...
    UINT32  FirstMbInSliceFlag;
    UINT32  slice_vertical_position;
    UINT32  slice_vertical_position_extension;
    UINT32  previous_macroblock_address;
    UINT32  intra_slice;
    UINT32  ByteLen;
...
typedef struct
{
    ...
    MP2VOBUFINF   VOBufInf[MAX_QUEUE_IMAGE_NUM];
...
VOID   MPEG2DEC_FlushRemainImg(MP2_CTX_S *pCtx);
