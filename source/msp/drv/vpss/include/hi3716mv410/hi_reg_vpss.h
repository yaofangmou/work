...
#ifndef __VPSS_MV410_H__
#define __VPSS_MV410_H__
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    market_coordinate     : 11  ; /* [31..21]  */
    } bits;
...
/* Define the union U_VPSS_DBM_ADDR */
typedef union
{
    /* Define the struct bits  */
    struct
    {
        unsigned int dbm_cfg_addr           : 32  ; /* [31..0]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    die_demo_en           : 1   ; /* [30]  */
        unsigned int    die_demo_mode         : 1   ; /* [31]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    db_lum_ver_en         : 1   ; /* [0]  */
        unsigned int    db_lum_hor_en         : 1   ; /* [1]  */
        unsigned int    db_chr_ver_en         : 1   ; /* [2]  */
        unsigned int    db_chr_hor_en         : 1   ; /* [3]  */
        unsigned int    db_chr_hor_mid_grey_en : 1   ; /* [4]  */
        unsigned int    dm_en                 : 1   ; /* [5]  */
        unsigned int    reserved_0            : 4   ; /* [9..6]  */
        unsigned int    dbm_demo_en           : 1   ; /* [10]  */
        unsigned int    dbm_demo_mode         : 1   ; /* [11]  */
        unsigned int    det_size_en           : 1   ; /* [12]  */
        unsigned int    det_hy_en             : 1   ; /* [13]  */
        unsigned int    det_hc_en             : 1   ; /* [14]  */
        unsigned int    det_vy_en             : 1   ; /* [15]  */
        unsigned int    dbm_out_mode          : 2   ; /* [17..16]  */
        unsigned int    dbm_out_sel_gain      : 6   ; /* [23..18]  */
        unsigned int    reserved_1            : 8   ; /* [31..24]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    global_db_strenth_lum : 4   ; /* [15..12]  */
        unsigned int    global_db_strenth_chr : 4   ; /* [19..16]  */
...
typedef union
{
    ...
    struct
    {
        unsigned int    lum_ver_adj_gain      : 5   ; /* [4..0]  */
        ...
        unsigned int    lum_ver_hf_var_core   : 7   ; /* [30..24]  */
        unsigned int    reserved_0            : 1   ; /* [31]  */
    } bits;
...
/* Define the union U_VPSS_DB_LUT11 */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    dir_str_lut_p0        : 4   ; /* [3..0]  */
        unsigned int    dir_str_lut_p1        : 4   ; /* [7..4]  */
        unsigned int    dir_str_lut_p2        : 4   ; /* [11..8]  */
        unsigned int    dir_str_lut_p3        : 4   ; /* [15..12]  */
        unsigned int    dir_str_lut_p4        : 4   ; /* [19..16]  */
        unsigned int    dir_str_lut_p5        : 4   ; /* [23..20]  */
        unsigned int    dir_str_lut_p6        : 4   ; /* [27..24]  */
        unsigned int    dir_str_lut_p7        : 4   ; /* [31..28]  */
    } bits;
...
/* Define the union U_VPSS_DB_LUT12 */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    dir_str_lut_p8        : 4   ; /* [3..0]  */
        unsigned int    dir_str_lut_p9        : 4   ; /* [7..4]  */
        unsigned int    dir_str_lut_p10       : 4   ; /* [11..8]  */
        unsigned int    dir_str_lut_p11       : 4   ; /* [15..12]  */
        unsigned int    dir_str_lut_p12       : 4   ; /* [19..16]  */
        unsigned int    dir_str_lut_p13       : 4   ; /* [23..20]  */
        unsigned int    dir_str_lut_p14       : 4   ; /* [27..24]  */
        unsigned int    dir_str_lut_p15       : 4   ; /* [31..28]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    hy_tst_blk_num        : 10  ; /* [9..0]  */
        unsigned int    hc_tst_blk_num        : 10  ; /* [19..10]  */
        unsigned int    vy_tst_blk_num        : 10  ; /* [29..20]  */
        unsigned int    reserved_0            : 2   ; /* [31..30]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_0            : 2   ; /* [7..6]  */
        unsigned int    hy_max_blk_size       : 7   ; /* [14..8]  */
        unsigned int    reserved_1            : 1   ; /* [15]  */
        unsigned int    hc_max_blk_size       : 7   ; /* [22..16]  */
        unsigned int    reserved_2            : 1   ; /* [23]  */
        unsigned int    vy_max_blk_size       : 7   ; /* [30..24]  */
        unsigned int    reserved_3            : 1   ; /* [31]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    dm_str_idx_t          : 4   ; /* [11..8]  */
        unsigned int    dm_limit_t            : 8   ; /* [19..12]  */
        unsigned int    reserved_1            : 12  ; /* [31..20]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    dm_str_idx            : 4   ; /* [29..26]  */
        unsigned int    reserved_3            : 2   ; /* [31..30]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    dbm_demo_xpos         : 16  ; /* [15..0]  */
        unsigned int    reserved_0            : 16  ; /* [31..16]  */
    } bits;
...
/* Define the union U_VPSS_DB_BORD_FLAG */
typedef union
{
    /* Define the struct bits  */
    struct
    {
        unsigned int vpss_db_bord_flag      : 32  ; /* [31..0]  */
    } bits;
...
typedef struct
{
    ...
    U_VPSS_TESTPATTERN     VPSS_TESTPATTERN                  ; /* 0xc8 */
    unsigned int           reserved_1[18]                     ; /* 0xcc~0x110 */
    ...
    unsigned int           reserved_6[2]                     ; /* 0x228~0x22c */
    U_VPSS_DBM_ADDR        VPSS_DBM_ADDR                     ; /* 0x230 */
    unsigned int           reserved_7[3]                     ; /* 0x234~0x23c */
    U_VPSS_DEI_ADDR        VPSS_DEI_ADDR                     ; /* 0x240 */
    U_VPSS_VHD0_LCMP_ADDR   VPSS_VHD0_LCMP_ADDR              ; /* 0x244 */
    unsigned int           reserved_8[2]                     ; /* 0x248~0x24c */
    ...
    unsigned int           reserved_9[8]                     ; /* 0x260~0x27c */
    ...
    unsigned int           reserved_10[13]                     ; /* 0x28c~0x2bc */
    ...
    unsigned int           reserved_11[11]                     ; /* 0x2d0~0x2f8 */
    ...
    unsigned int           reserved_12[3]                     ; /* 0x324~0x32c */
    U_VPSS_VERSION         VPSS_VERSION                      ; /* 0x330 */
    unsigned int           reserved_13[51]                     ; /* 0x334~0x3fc */
    ...
    unsigned int           reserved_14[7]                     ; /* 0x424~0x43c */
    ...
    unsigned int           reserved_15[743]                     ; /* 0x464~0xffc */
    ...
    unsigned int           reserved_16[42]                     ; /* 0x109c~0x1140 */
    ...
    unsigned int           reserved_17[1248]                     ; /* 0x1180~0x24fc */
    U_VPSS_DB_CTRL         VPSS_DB_CTRL                      ; /* 0x2500 */
    U_VPSS_DB_DIR          VPSS_DB_DIR                       ; /* 0x2504 */
    U_VPSS_DB_BLK          VPSS_DB_BLK                       ; /* 0x2508 */
    U_VPSS_DB_RATIO        VPSS_DB_RATIO                     ; /* 0x250c */
    U_VPSS_DB_LHHF         VPSS_DB_LHHF                      ; /* 0x2510 */
    U_VPSS_DB_LVHF         VPSS_DB_LVHF                      ; /* 0x2514 */
    U_VPSS_DB_CTRS         VPSS_DB_CTRS                      ; /* 0x2518 */
    U_VPSS_DB_LUT0         VPSS_DB_LUT0                      ; /* 0x251c */
    U_VPSS_DB_LUT1         VPSS_DB_LUT1                      ; /* 0x2520 */
    U_VPSS_DB_LUT2         VPSS_DB_LUT2                      ; /* 0x2524 */
    U_VPSS_DB_LUT3         VPSS_DB_LUT3                      ; /* 0x2528 */
    U_VPSS_DB_LUT4         VPSS_DB_LUT4                      ; /* 0x252c */
    U_VPSS_DB_LUT5         VPSS_DB_LUT5                      ; /* 0x2530 */
    U_VPSS_DB_LUT6         VPSS_DB_LUT6                      ; /* 0x2534 */
    U_VPSS_DB_LUT7         VPSS_DB_LUT7                      ; /* 0x2538 */
    U_VPSS_DB_LUT8         VPSS_DB_LUT8                      ; /* 0x253c */
    U_VPSS_DB_LUT9         VPSS_DB_LUT9                      ; /* 0x2540 */
    U_VPSS_DB_LUT10        VPSS_DB_LUT10                     ; /* 0x2544 */
    U_VPSS_DB_LUT11        VPSS_DB_LUT11                     ; /* 0x2548 */
    U_VPSS_DB_LUT12        VPSS_DB_LUT12                     ; /* 0x254c */
    U_VPSS_DBD_THDEDGE     VPSS_DBD_THDEDGE                  ; /* 0x2550 */
    U_VPSS_DBD_THDTXT      VPSS_DBD_THDTXT                   ; /* 0x2554 */
    U_VPSS_DBD_LUTWGT0     VPSS_DBD_LUTWGT0                  ; /* 0x2558 */
    U_VPSS_DBD_LUTWGT1     VPSS_DBD_LUTWGT1                  ; /* 0x255c */
    U_VPSS_DBD_RTNBDTXT    VPSS_DBD_RTNBDTXT                 ; /* 0x2560 */
    U_VPSS_DBD_TSTBLKNUM   VPSS_DBD_TSTBLKNUM                ; /* 0x2564 */
    U_VPSS_DBD_HYRDX8BINLUT0   VPSS_DBD_HYRDX8BINLUT0        ; /* 0x2568 */
    U_VPSS_DBD_HYRDX8BINLUT1   VPSS_DBD_HYRDX8BINLUT1        ; /* 0x256c */
    U_VPSS_DBD_HYRDX8BINLUT2   VPSS_DBD_HYRDX8BINLUT2        ; /* 0x2570 */
    U_VPSS_DBD_HYRDX8BINLUT3   VPSS_DBD_HYRDX8BINLUT3        ; /* 0x2574 */
    U_VPSS_DBD_HCRDX8BINLUT0   VPSS_DBD_HCRDX8BINLUT0        ; /* 0x2578 */
    U_VPSS_DBD_HCRDX8BINLUT1   VPSS_DBD_HCRDX8BINLUT1        ; /* 0x257c */
    U_VPSS_DBD_HCRDX8BINLUT2   VPSS_DBD_HCRDX8BINLUT2        ; /* 0x2580 */
    U_VPSS_DBD_HCRDX8BINLUT3   VPSS_DBD_HCRDX8BINLUT3        ; /* 0x2584 */
    U_VPSS_DBD_VYRDX8BINLUT0   VPSS_DBD_VYRDX8BINLUT0        ; /* 0x2588 */
    U_VPSS_DBD_VYRDX8BINLUT1   VPSS_DBD_VYRDX8BINLUT1        ; /* 0x258c */
    U_VPSS_DBD_VYRDX8BINLUT2   VPSS_DBD_VYRDX8BINLUT2        ; /* 0x2590 */
    U_VPSS_DBD_VYRDX8BINLUT3   VPSS_DBD_VYRDX8BINLUT3        ; /* 0x2594 */
    U_VPSS_DBD_BLKSIZE     VPSS_DBD_BLKSIZE                  ; /* 0x2598 */
    unsigned int           reserved_18                       ; /* 0x259c */
    U_VPSS_DM_DIR          VPSS_DM_DIR                       ; /* 0x25a0 */
    U_VPSS_DM_EDGE         VPSS_DM_EDGE                      ; /* 0x25a4 */
    U_VPSS_DM_LUT0         VPSS_DM_LUT0                      ; /* 0x25a8 */
    U_VPSS_DM_LUT1         VPSS_DM_LUT1                      ; /* 0x25ac */
    U_VPSS_DM_LUT2         VPSS_DM_LUT2                      ; /* 0x25b0 */
    U_VPSS_DM_LUT3         VPSS_DM_LUT3                      ; /* 0x25b4 */
    U_VPSS_DM_LUT4         VPSS_DM_LUT4                      ; /* 0x25b8 */
    U_VPSS_DBM_DEMO        VPSS_DBM_DEMO                     ; /* 0x25bc */
    unsigned int           reserved_19[16]                     ; /* 0x25c0~0x25fc */
    U_VPSS_DB_BORD_FLAG    VPSS_DB_BORD_FLAG[128]            ; /* 0x2600~0x27fc */
    unsigned int           reserved_20[1024]                     ; /* 0x2800~0x37fc */
    ...
    unsigned int           reserved_21[7]                     ; /* 0x38f8~0x3910 */
    ...
    unsigned int           reserved_22[66]                     ; /* 0x39f8~0x3afc */
    ...
    unsigned int           reserved_23[96]                     ; /* 0x3e80~0x3ffc */
    ...
    unsigned int           reserved_24[996]                     ; /* 0x40b0~0x503c */
    U_VPSS_DEI_WST_CHKSUM   VPSS_DEI_WST_CHKSUM              ; /* 0x5040 */
    unsigned int           reserved_25[2]                     ; /* 0x5044~0x5048 */
...
} VPSS_REG_S, S_CAS_REGS_TYPE,S_VPSS_REGS_TYPE;
