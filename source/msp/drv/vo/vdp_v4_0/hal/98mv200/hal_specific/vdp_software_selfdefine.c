...
HI_VOID VDP_WIN_DebugLogicInfo(HI_U32 u32Data, HI_U32 u32Num, HI_VOID *pstWinDebug)
{
    ...
    if (0 == u32Data)
    {
        ...
        pstWinDebugLogicInfo->stInRect.s32Width = V0_IRESO.bits.iw + 1;
        pstWinDebugLogicInfo->stInRect.s32Height = V0_IRESO.bits.ih + 1;
        ...
        pstWinDebugLogicInfo->mute_en = V0_CTRL.bits.mute_en;
    }
    else
    {
        ...
        pstWinDebugLogicInfo->stVideo.s32X = V0_P0VFPOS.bits.video_xfpos;
        pstWinDebugLogicInfo->stVideo.s32Y = V0_P0VFPOS.bits.video_yfpos;
        pstWinDebugLogicInfo->stVideo.s32Width = V0_P0VLPOS.bits.video_xlpos - V0_P0VFPOS.bits.video_xfpos + 1;
        pstWinDebugLogicInfo->stVideo.s32Height = V0_P0VLPOS.bits.video_ylpos - V0_P0VFPOS.bits.video_yfpos + 1;

        pstWinDebugLogicInfo->stDisp.s32X = pstWinDebugLogicInfo->stVideo.s32X;
        pstWinDebugLogicInfo->stDisp.s32Y = pstWinDebugLogicInfo->stVideo.s32Y;
        ...
        pstWinDebugLogicInfo->surface_en = V0_P0CTRL.bits.region_en;
        pstWinDebugLogicInfo->mute_en = V0_P0CTRL.bits.mute_en;
    }

    pstWinDebugLogicInfo->data_width = V0_CTRL.bits.data_width;
