...
static COMPAT_HDR_S s_stSinkHdrDebugMode[] =
{
    ...
    //{   {"GSM" ,        1,16843009,   1, 2017},  HDMI_HDR_DEBUG_MODE_OE},   // LG:60SJ8500-CA
    {   {"GSM" ,        1,16843009,   1, 2016},   0x01,   0x9f,   0xf8, HDMI_HDR_DEBUG_MODE_OE},   //  OLED65B6P-C
    {   {"SAM" ,     3386,16778752,   1, 2016},   0x01,   0x07,   0xc5,HDMI_HDR_DEBUG_MODE_OE},   // samsung UA50KUF30E JXXZ
};
#endif
...
static COMPAT_HPD_FILLTER_S s_astSinkHpdFillter[] =
{
    ...
    {   {"\x1f\x1f\x1f" ,0,      0,  20, 2009}, { HI_TRUE,        100,           60} },        //botong
};
    ...
    else
    {
            ...
            pstHdr++, i++)
        {
            ...
            if ( CompatEdidMatchChk(pstTmpManuInfo, pstSinkManuInfo) )
            {
                ...
                if(    pstHdr->u8Data7E
                    && (pstHdr->u8Data7F == pstHdmiDev->stEdidInfo.au8EdidRaw[0x7f])
                    && (pstHdr->u8DataFF == pstHdmiDev->stEdidInfo.au8EdidRaw[0xff]))
                {
