...
HI_BOOL AUTIL_IsChipMV310(HI_VOID)
{
    ...
    return ((HI_CHIP_TYPE_HI3798M   == enChipType && HI_CHIP_VERSION_V310 == enChipVersion) ||
            (HI_CHIP_TYPE_HI3798M_H == enChipType && HI_CHIP_VERSION_V200 == enChipVersion) ||
            (HI_CHIP_TYPE_HI3798M_H == enChipType && HI_CHIP_VERSION_V300 == enChipVersion) ||
            (HI_CHIP_TYPE_HI3716D   == enChipType && HI_CHIP_VERSION_V110 == enChipVersion) ||
            (HI_CHIP_TYPE_HI3716M   == enChipType && HI_CHIP_VERSION_V430 == enChipVersion));
}
