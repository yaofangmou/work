...
#define HI_WARN_PrintReg8(reg, val)      LOG_PrintWarning("%s : %02x\n",     #reg, val)
#define HI_INFO_PrintReg8(reg, val)      LOG_PrintInfo("%s : %02x\n",        #reg, val)
#define HI_DBG_PrintReg8(reg, val)       LOG_PrintDebug("%s : %02x\n",       #reg, val)
...
#define HI_TUNER_CHECKPOINTER(ptr)                          \
    ...
    {                                                       \
        if (!(ptr))                                         \
        {                                                   \
            LOG_PrintWarning("%s is null\n", #ptr);         \
            HI_ERR_PrintErrCode(HI_ERR_TUNER_INVALID_POINT);\
...
#define HI_TUNER_CHECKPORT(port)                                \
    do {                                                        \
        if (port >= TUNER_NUM)                                  \
        {                                                       \
            HI_WARN_PrintU32(port);                             \
            HI_ERR_PrintErrCode(HI_ERR_TUNER_INVALID_PORT);     \
            return HI_ERR_TUNER_INVALID_PORT;                   \
        }                                                       \
    } while(0)

#define HI_TUNER_CHECKFUNCTION(ptr)                            \
    do                                                         \
    {                                                          \
        if (!(ptr))                                            \
        {                                                      \
            LOG_PrintWarning("%s is null\n", #ptr);            \
            HI_ERR_PrintErrCode(HI_ERR_TUNER_INVALID_FUNCTION);\
            return HI_ERR_TUNER_INVALID_FUNCTION;              \
        }                                                      \
    } while(0)

#define HI_TUNER_CHECK_FUNC_RET(s32Ret, pfn)                   \
    do {                                                       \
        s32Ret = pfn;                                          \
        if (HI_SUCCESS != s32Ret)                              \
        {                                                      \
            LOG_PrintWarning(#pfn" Run Failure!\n");           \
...
extern HI_BOOL check_internal_demod(HI_U32 u32TunerPort,HI_CHIP_TYPE_E enChipType,HI_CHIP_VERSION_E enChipVersion);
...
extern HI_S32 MN88472_get_plp_info(HI_U32 u32TunerPort, HI_U32 u32Index, HI_UNF_TUNER_TER_PLP_INFO_S *pstPLPPara);
extern HI_S32 MN88472_set_plp_para(HI_U32 u32TunerPort, HI_UNF_TUNER_TER_PLP_PARA_S *pstPLPPara);
...
extern HI_S32 MN8847x_get_plp_info(HI_U32 u32TunerPort, HI_U32 u32Index, HI_UNF_TUNER_TER_PLP_INFO_S *pstPLPPara);
extern HI_S32 MN8847x_set_plp_para(HI_U32 u32TunerPort, HI_UNF_TUNER_TER_PLP_PARA_S *pstPLPPara);
...
extern HI_S32 mxl68x_deinit(HI_U32 u32TunerPort);
...
extern HI_S32 mxl582_deinit(HI_U32 u32TunerPort);
extern HI_S32 mxl582_config_ts_port_output(HI_U32 u32TunerPort,  HI_U32 u32Enable);
#endif

extern HI_S32 HiSDTV100_ADP_Init(HI_U32 u32TunerPort, HI_U8 u8I2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerType);
extern HI_S32 HiSDTV100_ADP_Connect(HI_U32 u32TunerPort, TUNER_ACC_QAM_PARAMS_S *pstChannel);
extern HI_S32 HiSDTV100_ADP_DeInit(HI_U32 u32TunerPort);
extern HI_S32 HiSDTV100_ADP_GetStatus(HI_U32 u32TunerPort, HI_UNF_TUNER_LOCK_STATUS_E  *penTunerStatus);
extern HI_S32 HiSDTV100_ADP_GetBer(HI_U32 u32TunerPort, HI_U32 *pu32BER);
extern HI_S32 HiSDTV100_ADP_GetSnr(HI_U32 u32TunerPort, HI_U32 * pu32SNR);
extern HI_S32 HiSDTV100_ADP_GetSignalStrength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength);
extern HI_S32 HiSDTV100_ADP_GetSignalInfo(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo);
extern HI_S32 HiSDTV100_ADP_GetFreqSymbOffset(HI_U32 u32TunerPort, HI_U32 * pu32Freq, HI_U32 * pu32Symb );
extern HI_S32 HiSDTV100_ADP_SetSigType(HI_U32 u32TunerPort, HI_UNF_TUNER_SIG_TYPE_E enSigType);
#if defined(HISDTV100_TER_SUPPORT)
extern HI_S32 HiSDTV100_ADP_GetPlpNum(HI_U32 u32TunerPort, HI_U8 *pu8PLPNum);
extern HI_S32 HiSDTV100_ADP_GetPLPInfo(HI_U32 u32TunerPort, HI_U32 u32Index, HI_UNF_TUNER_TER_PLP_INFO_S *pstPLPPara);
extern HI_S32 HiSDTV100_ADP_SetPLPPara(HI_U32 u32TunerPort, HI_UNF_TUNER_TER_PLP_PARA_S *pstPLPPara);
extern HI_S32 HiSDTV100_ADP_MonitorLayersConfig(HI_U32 u32TunerPort, HI_UNF_TUNER_MONITOR_LAYERS_CONFIG_S *pstMonitorLayersConfig);
#endif
#if defined(HISDTV100_SAT_SUPPORT)
extern HI_S32 HiSDTV100_ADP_SetSatAttr(HI_U32 u32TunerPort, HI_UNF_TUNER_SAT_ATTR_S *pstSatTunerAttr);
extern HI_S32 HiSDTV100_ADP_SetLnbOut(HI_U32 u32TunerPort, TUNER_LNB_OUT_E enOut);
extern HI_S32 HiSDTV100_ADP_SendContinuous22K(HI_U32 u32TunerPort, HI_U32 u32Continuous22K);
extern HI_S32 HiSDTV100_ADP_SendTone(HI_U32 u32TunerPort, HI_U32 u32Tone);
extern HI_S32 HiSDTV100_ADP_DiSEqCSendMsg(HI_U32 u32TunerPort, HI_UNF_TUNER_DISEQC_SENDMSG_S *pstSendMsg);
extern HI_S32 HiSDTV100_ADP_DiSEqCRecvMsg(HI_U32 u32TunerPort, HI_UNF_TUNER_DISEQC_RECVMSG_S *pstRecvMsg);
extern HI_S32 HiSDTV100_ADP_SetFuncMode(HI_U32 u32TunerPort, TUNER_FUNC_MODE_E enFuncMode);
extern HI_S32 HiSDTV100_ADP_BlindscanInit(HI_U32 u32TunerPort, TUNER_BLINDSCAN_INITPARA_S *pstPara);
extern HI_S32 HiSDTV100_ADP_BlindscanAction(HI_U32 u32TunerPort, TUNER_BLINDSCAN_PARA_S *pstPara);
extern HI_S32 HiSDTV100_ADP_TpVerify(HI_U32 u32TunerPort, TUNER_TP_VERIFY_PARAMS_S * pstChannel);
extern HI_S32 HiSDTV100_ADP_GetAgc(HI_U32 u32TunerPort, HI_U32 u32FreqCenter,HI_U32 *pu32Agc);
extern HI_S32 HiSDTV100_ADP_SetIsiID(HI_U32 u32TunerPort, HI_U8 u8IsiId);
extern HI_S32 HiSDTV100_ADP_GetTotalStream(HI_U32 u32TunerPort, HI_U32 *pu32TotalStream);
extern HI_S32 HiSDTV100_ADP_GetIsiID(HI_U32 u32TunerPort, HI_U8 u8Stream, HI_U8 *pu8IsiId);
extern HI_S32 HiSDTV100_ADP_SetScramble(HI_U32 u32TunerPort, HI_U32 u32ScrambleValue);
extern HI_S32 HiSDTV100_ADP_UNIC_GetSigStat(HI_U32 u32TunerPort, HI_U32 *pu32SigStat);
extern HI_S32 HiSDTV100_ADP_UNIC_ClearChangeFlag(HI_U32 u32TunerPort);
extern HI_S32 HiSDTV100_ADP_UNIC_CheckTPChange( HI_U32 u32TunerPort, HI_U32 u32SymbRateKHz, HI_U32 au32Chanchange[3]);
#endif
extern HI_S32 HiSDTV100_ADP_Standby(HI_U32 u32TunerPort, HI_U32 u32Standby);
extern HI_VOID HiSDTV100_ADP_GetRegisters(HI_U32 u32TunerPort, HI_VOID *p);
extern HI_S32 HiSDTV100_ADP_QTC_GetDataContinues(HI_U32 u32TunerPort, HI_U32 u32QtcBuffSizeMB, HI_U32 u32RecordFileSizeMB);
extern HI_S32 HiSDTV100_ADP_GetCIR(HI_U32 u32TunerPort, HI_U32 u32DataLen);
extern HI_S32 HiSDTV100_ADP_GetSampleData(HI_U32 u32TunerPort, TUNER_DATA_SRC_E enDataSrc, HI_U32 u32DataLen, HI_UNF_TUNER_SAMPLE_DATA_S *pstData);
extern HI_S32 HiSDTV100_ADP_MCU_Operate(HI_U32 u32TunerPort, const HI_CHAR *pMcuCmd);
#endif
