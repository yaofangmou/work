...
typedef struct
{
    ...
    HI_U32 subsampleNum;
    HI_UNF_CIPHER_SUBSAMPLE_S subsample[MAX_SUBSAMPLE_CNT];
}cenc_gold_s;
...
static cenc_gold_s cenc_sample_data[] =
{
    {//sample 0
        ...
        {//subsample,
            ...
            {0x00, 0x190, 0x00 * 16, 0x00 * 16, 0x00 * 16},
         }
    },
    {//sample 1
        {//enc
        ...
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0x190, 0x03 * 16, 0x07 * 16, 0x02 * 16},
         }
    },
    {//sample 2
        {//enc
        ...
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0xb0, 0x07 * 16, 0x03 * 16, 0x02 * 16},
         }
    },
    {//sample 3
        {//enc
        ...
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0xb0, 0x00 * 16, 0x00 * 16, 0x00 * 16},
         }
    },
    {//sample 4
        {//enc
        ...
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x19, 0xa0,  0x00 * 16, 0x00 * 16, 0x00 * 16},
            {0x32, 0x100, 0x00 * 16, 0x00 * 16, 0x00 * 16},
            {0x19, 0xa0,  0x00 * 16, 0x00 * 16, 0x00 * 16},
         }
    },
    {//sample 5
        ...
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x19, 0xa0,  0x03 * 16, 0x07 * 16, 0x00 * 16},
            {0x32, 0x100, 0x03 * 16, 0x07 * 16, 0x00 * 16},
            {0x19, 0xa0,  0x03 * 16, 0x07 * 16, 0x00 * 16},
         }
    },
    {//sample 6, line 3904
        ...
        {//subsample,
            /* clear size, encrypt size, encrypt,   skip,      offset */
            {0x19,         0xa0,         0x07 * 16, 0x03 * 16, 0x02 * 16},
            {0x32,         0x100,        0x07 * 16, 0x03 * 16, 0x02 * 16},
            {0x19,         0xa0,         0x09 * 16, 0x03 * 16, 0x02 * 16},
         }
    },
};

static cenc_ex_gold_s cenc_ex_sample_data[] =
{
    {//sample 0
        {//enc
            0xa,0x95,0x9,0xb6,0x45,0x6b,0xf6,0x42,0xf9,0xca,0x9e,0x53,0xca,0x5e,0xe4,0x55,
