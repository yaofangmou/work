...
static CSC_COLOR_TEMP     sg_stColorTemp[HI_PQ_DISPLAY_BUTT] =
{
    {50, 50, 50},
    {50, 50, 50},
    {50, 50, 50}
        ...
        HI_U32 Kr, HI_U32 Kg, HI_U32 Kb, HI_PQ_CSC_COEF_S *pCSCTable, HI_PQ_CSC_COEF_S *pDstCSCTable)
{
    ...
    */
    ...
    pDstCSCTable->csc_coef00 = CLIP3( DstCSCTable2.csc_coef00, -4095, 4095);
    pDstCSCTable->csc_coef01 = CLIP3( DstCSCTable2.csc_coef01, -4095, 4095);
    pDstCSCTable->csc_coef02 = CLIP3( DstCSCTable2.csc_coef02, -4095, 4095);
    pDstCSCTable->csc_coef10 = CLIP3( DstCSCTable2.csc_coef10, -4095, 4095);
    pDstCSCTable->csc_coef11 = CLIP3( DstCSCTable2.csc_coef11, -4095, 4095);
    pDstCSCTable->csc_coef12 = CLIP3( DstCSCTable2.csc_coef12, -4095, 4095);
    pDstCSCTable->csc_coef20 = CLIP3( DstCSCTable2.csc_coef20, -4095, 4095);
    pDstCSCTable->csc_coef21 = CLIP3( DstCSCTable2.csc_coef21, -4095, 4095);
    pDstCSCTable->csc_coef22 = CLIP3( DstCSCTable2.csc_coef22, -4095, 4095);
...
static HI_S32 PQ_MNG_SetCSCPictureParam(HI_PQ_CSC_TYPE_E enCscTpyeId, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    if ((HI_PQ_CSC_TUNING_V0 == enCscTpyeId) || (HI_PQ_CSC_TUNING_V1 == enCscTpyeId))
    {
        ...
        stV0CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_1].u32Red);
        stV0CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_1].u32Green);
        stV0CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_1].u32Blue);
        ...
        stV1CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_1].u32Red);
        stV1CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_1].u32Green);
        stV1CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_1].u32Blue);
    ...
    else if ((HI_PQ_CSC_TUNING_V3 == enCscTpyeId) || (HI_PQ_CSC_TUNING_V4 == enCscTpyeId))
    {
        ...
        stV3CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_0].u32Red);
        stV3CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_0].u32Green);
        stV3CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_0].u32Blue);
        ...
        stV4CSCParameter.as16ColorTempGain[COLORTEMP_R]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_0].u32Red);
        stV4CSCParameter.as16ColorTempGain[COLORTEMP_G]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_0].u32Green);
        stV4CSCParameter.as16ColorTempGain[COLORTEMP_B]   = LEVEL2NUM(sg_stColorTemp[HI_PQ_DISPLAY_0].u32Blue);
...
HI_S32 PQ_MNG_GetColorTemp(HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    pstTemperature->u32Red   = sg_stColorTemp[enDisp].u32Red;
    pstTemperature->u32Green = sg_stColorTemp[enDisp].u32Green;
    pstTemperature->u32Blue  = sg_stColorTemp[enDisp].u32Blue;

    return HI_SUCCESS;
}

HI_S32  PQ_MNG_SetColorTemp(HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    sg_stColorTemp[enDisp].u32Red   = pstTemperature->u32Red;
    sg_stColorTemp[enDisp].u32Green = pstTemperature->u32Green;
    sg_stColorTemp[enDisp].u32Blue  = pstTemperature->u32Blue;
