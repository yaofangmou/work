...
HI_S32  IPC_Client_SetTrackCmd(HI_HANDLE hTrack, HI_VOID* pstRenderCmd)
{
    ...
    switch (pstParam->enCmd)
    {
        ...
        case HA_CODEC_MS12_GET_AD_STREAM_INFO_CMD:
            ...
            break;
        case HA_CODEC_MS12_SET_SUBSTREAMID_CMD:
            u32StructSize += sizeof(HA_MS12_SET_SUBSTREAMID_S);
            break;
        default:
...
HI_S32  IPC_Client_SetTrackChannelMode(HI_HANDLE hTrack, HI_UNF_TRACK_MODE_E enMode)
{
    HI_S32 s32Ret;
    IPC_CMM stCMM;
    ...
    stCMM.u32AckData = IPC_ACK_CLIENT_WRITE;
    stCMM.u32Command = CMD_SOURCE_SETCHANNELMODE;
    stCMM.bNeedReply = HI_TRUE;
    stCMM.hTrack = hTrack;

    stCMM.aPayload[0] = (HI_U32)enMode;
...
HI_S32  IPC_Client_GetTrackChannelMode(HI_HANDLE hTrack, HI_UNF_TRACK_MODE_E* penMode)
{
    HI_S32 s32Ret;
    IPC_CMM stCMM;
    ...
    stCMM.u32AckData = IPC_ACK_CLIENT_WRITE;
    stCMM.u32Command = CMD_SOURCE_GETCHANNELMODE;
    stCMM.bNeedReply = HI_TRUE;
    stCMM.hTrack = hTrack;
...
HI_S32 IPC_Client_SetAtmosLockEnable(HI_BOOL bAtmosLockEnable)
{
    HI_S32 s32Ret;
    IPC_CMM stCMM;
    ...
    stCMM.u32AckData = IPC_ACK_CLIENT_WRITE;
    stCMM.u32Command = CMD_SOURCE_SETATMOSLOCKEnable;
    stCMM.bNeedReply = HI_TRUE;
    stCMM.aPayload[0] = bAtmosLockEnable;
...
HI_S32 IPC_Client_GetAtmosLockEnable(HI_BOOL*pbAtmosLockEnable)
{
    HI_S32 s32Ret;
    IPC_CMM stCMM;
    ...
    stCMM.u32AckData = IPC_ACK_CLIENT_WRITE;
    stCMM.u32Command = CMD_SOURCE_GETATMOSLOCKEnable;
    stCMM.bNeedReply = HI_TRUE;
    ...
    *pbAtmosLockEnable = (HI_BOOL)stCMM.aPayload[0];
