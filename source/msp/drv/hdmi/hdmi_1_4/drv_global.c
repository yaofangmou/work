...
static HDMI_HDCPKEY_ATTR_S g_stHdmiHhdcpKeyInfo[HI_UNF_HDMI_ID_BUTT] ;
...
HI_U32 DRV_HDMI_SetDefaultAttr(HI_VOID)
{
    ...
    memset(g_stHdmiHhdcpKeyInfo,0,sizeof(HDMI_HDCPKEY_ATTR_S));
...
HDMI_HDCPKEY_ATTR_S  *DRV_Get_HdcpKeyInfo(HI_UNF_HDMI_ID_E enHdmi)
{
    return g_stHdmiHhdcpKeyInfo;
}
