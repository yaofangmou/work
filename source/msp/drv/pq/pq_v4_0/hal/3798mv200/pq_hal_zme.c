...
static HI_S32 PQ_HAL_VPSS_SetZmeEnable(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, REG_ZME_MODE_E eMode, HI_BOOL bEnable)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeInSize(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, HI_U32 u32Height, HI_U32 u32Width)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeOutSize(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, HI_U32 u32Height, HI_U32 u32Width)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeFirEnable(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, REG_ZME_MODE_E eMode, HI_BOOL bEnable)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeMidEnable(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, REG_ZME_MODE_E eMode, HI_BOOL bEnable)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmePhase(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, REG_ZME_MODE_E eMode, HI_S32 s32Phase)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeRatio(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, REG_ZME_MODE_E eMode, HI_U32 u32Ratio)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeHfirOrder(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, HI_BOOL bVfirst)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
static HI_S32 PQ_HAL_VPSS_SetZmeInFmt(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, HI_DRV_PIX_FORMAT_E eFormat)
{
    HI_U32 u32Format;
...
static HI_S32 PQ_HAL_VPSS_SetZmeOutFmt(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, HI_DRV_PIX_FORMAT_E eFormat)
{
    HI_U32 u32Format;
...
static HI_S32 PQ_HAL_VPSS_SetZmeCoefAddr(HI_U32 u32HandleNo, VPSS_REG_PORT_E ePort, S_VPSS_REGS_TYPE *pstReg, REG_ZME_MODE_E eMode, HI_U32 u32Addr)
{
    switch (ePort)
    {
        case VPSS_REG_HD:
...
/* Vpss Cfg Set to reg */
HI_VOID PQ_HAL_VpssZmeRegCfg(HI_U32 u32LayerId, S_VPSS_REGS_TYPE *pstReg, ALG_VZME_RTL_PARA_S *pstZmeRtlPara, HI_BOOL bFirEnable)
{
    HI_U32 ih;
    HI_U32 iw;
    HI_U32 oh;
...
static HI_VOID PQ_HAL_V0HdcpHPreZmeConfig(HI_PQ_LAYER_STRATEGY_IN_S *pstZmeIn,
        HI_PQ_LAYER_STRATEGY_OUT_S *pstZmeOut)
{
    pstZmeOut->bOpenP2I = PQ_HAL_GetDHD0P2IEnableFlag(HI_FALSE);
        ...
        HI_PQ_LAYER_STRATEGY_OUT_S *pstZmeOut)
{
...

    {
        ...
        /* when 4K preview use more v draw*/
    {
        if (pstZmeIn->u32FrmHIn <= 3 * pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight)
            /*(<= 3); Close DrawPixel */
        {
            pstZmeOut->eVScalerMode = HI_PQ_PREZME_VER_DISABLE;
        }
        else if (2 * pstZmeIn->u32FrmHIn <= 7 * pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight)
            /* <= 3.5; Draw 2 */
        {
            pstZmeOut->eVScalerMode = HI_PQ_PREZME_VER_2X;
        }
        else if (pstZmeIn->u32FrmHIn < 10 * pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight)
            /* <= 10; Draw 4 */
        {
            pstZmeOut->eVScalerMode = HI_PQ_PREZME_VER_4X;
        }
    ...
    {
        if (pstZmeIn->u32FrmHIn <= 5 * pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight)
            /*(<= 5); Close DrawPixel */
        {
            pstZmeOut->eVScalerMode = HI_PQ_PREZME_VER_DISABLE;
        }
        else if (pstZmeIn->u32FrmHIn <= 7 * pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight)
            /* <= 7; Draw 2 */
        {
            pstZmeOut->eVScalerMode = HI_PQ_PREZME_VER_2X;
        }
        else if (pstZmeIn->u32FrmHIn < 20 * pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight)
            /* <= 20; Draw 4 */
        {
            pstZmeOut->eVScalerMode = HI_PQ_PREZME_VER_4X;
        }
...

    {
        ...
        HI_U32 u32InWidth   = pstZmeIn->u32FrmWIn;
        HI_U32 u32InHeight  = pstZmeIn->u32FrmHIn;
        HI_U32 u32Zme1OutWidth  = pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInWidth;
        HI_U32 u32Zme1OutHeight = pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight;
        if (5 * u32InHeight * u32Zme1OutWidth > 8 * u32InWidth * u32Zme1OutHeight)
        {
            if (pstZmeOut->eVScalerMode != HI_PQ_PREZME_VER_8X)
            {
                pstZmeOut->eVScalerMode += 1;
...
static HI_VOID PQ_HAL_V0HdcpZme2ResoCalc(HI_PQ_LAYER_STRATEGY_IN_S *pstZmeIn, HI_PQ_LAYER_STRATEGY_OUT_S *pstZmeOut)
{
    ...
    pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmOutWidth  = pstZmeIn->u32FrmWOut;
    /* new hdcp reso judge */
    pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight  = ZME_MIN(pstZmeIn->stHDCPAttestFactor.u32IntermedHeight, pstZmeIn->u32FrmHOut);
    pstZmeOut->stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInWidth   = ZME_MIN(pstZmeIn->stHDCPAttestFactor.u32IntermedWidth, pstZmeIn->u32FrmWOut);
