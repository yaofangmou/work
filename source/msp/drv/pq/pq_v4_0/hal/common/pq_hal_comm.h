...
#define PQ_VPSS_WBCREG_SIZE           ((sizeof(S_VPSS_STT_REGS_TYPE) + 15) & 0xFFFFFFF0)
...
#if defined(PQ_TVOS_SUPPORT)
#define VPSS_HANDLE_NUM    12
#else
...
#define VPSS_PQ_REG_SIZE(start, end)\
    (offsetof(S_VPSS_REGS_TYPE, end) + sizeof(HI_U32) -\
