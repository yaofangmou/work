...
typedef struct hiWIN_XDR_FRAME_S
{
    ...
    HI_DRV_DISP_OUT_TYPE_E     enDispOutType;
    HI_DRV_DISP_XDR_ENGINE_E   enXdrEngine;
    HI_U64                     u64StSlHdrPsParamAddr;
}WIN_XDR_FRAME_S;

typedef struct hiWIN_SYNCFRAME_S
{
    WIN_XDR_FRAME_S stXdrFrame;
    HI_U32 u32FenceFd;
}WIN_SYNCFRAME_S;
...
typedef struct hiWIN_TECHNI_DISP_BRIGHT
{
    HI_U32 u32TechniDispBright;
...
typedef struct hiWIN_FORCEFRAME_FLAG_S
{
    HI_HANDLE hWindow;
    HI_DRV_WIN_FORCEFRAMEPROG_FLAG_E eForceFrameProgFlag;
}WIN_FORCEFRAME_FLAG_S;
...
#define CMD_WIN_SET_TECHNI_LIB_STATUS  _IOWR(HI_ID_VO,IOC_WIN_SET_TECHNI_LIB_STATUS, WIN_TECHNICOLOR_LIB_INFO_S)
...
#define CMD_WIN_SET_FRAME_PROGINTER _IOWR(HI_ID_VO,IOC_WIN_SET_FRAME_PROGINTERLEAVE, WIN_FORCEFRAME_FLAG_S)
#define CMD_WIN_GET_FRAME_PROGINTER _IOWR(HI_ID_VO,IOC_WIN_GET_FRAME_PROGINTERLEAVE, WIN_FORCEFRAME_FLAG_S)


#define CMD_WIN_RESET_FIRST_FRAME_STATUS _IOWR(HI_ID_VO,IOC_WIN_RESET_FIRST_FRAME_STATUS, WIN_ALPHA_S)

#define CMD_WIN_GET_TECHNI_OUT_BRIGHT _IOWR(HI_ID_VO,IOC_WIN_GET_TECHNI_OUT_BRIGHT, WIN_ALPHA_S)
