...
/***************************** Macro Definition *************************************************/
#define CONFIG_HIFB_PRECISION_ZMERATIONH_8BITOFFSET          8
...
{
    HI_U32 i = 0;
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(ps16Coef, 0);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pBitCoef, 0);
...
{
    HI_U32 i = 0, u32Tmp = 0;
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(ps16LtiCoef, 0x0);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(ps16CtiCoef, 0x0);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pBitCoef, 0x0);
...
{
    HI_U32 i = 0,u32Tmp = 0;
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(ps16LtiCoef, 0);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(ps16CtiCoef, 0);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pBitCoef, 0);
...
static HI_U32 OPTM_GZmeLoadCoefH(OPTM_GZME_COEF_RATIO_E enCoefRatio, HI_U8 *pu8Addr)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pu8Addr, HI_FAILURE);
    HI_GFX_CHECK_ARRAY_OVER_RETURN_VALUE(enCoefRatio, GZME_COEF_RATIO_BUTT, HI_FAILURE);
...
static HI_VOID OPTM_GZmeLoadCoefHV(OPTM_ALG_GZME_MEM_S *pstGZmeCoefMem)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstGZmeCoefMem);
    pu8CurAddr = (HI_U8 *)(pstGZmeCoefMem->stMBuf.pu8StartVirAddr);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pu8CurAddr);

    u32PhyAddr = pstGZmeCoefMem->stMBuf.u32StartPhyAddr;
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(u32PhyAddr,0);

    pstAddrTmp = &(pstGZmeCoefMem->stZmeCoefAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(pstAddrTmp,0);
...
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstGZmeCoefMem, HI_FAILURE);

    if (HI_SUCCESS != DRV_HIFB_ADP_MEM_AllocAndMap(HIFB_ZME_COEF_BUFFER,NULL,(256*5 + 48*2 + 96*2) * 7,0,&pstGZmeCoefMem->stMBuf))
    {
        return HI_FAILURE;
    }
...
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstGZmeCoefMem);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstGZmeCoefMem->stMBuf.pu8StartVirAddr);

    DRV_HIFB_ADP_MEM_UnMapAndRelease(&(pstGZmeCoefMem->stMBuf));
...
{
    HI_U32 u32CoefAddr = 0, u32TmpRatio = 0;

    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_VALUE(0, u32Ratio, 0x0);
    u32TmpRatio = 4096 * 4096 / u32Ratio;

    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstZmeCoefAddr, 0x0);
...
{
    HI_U32 u32CoefAddr = 0, u32TmpRatio = 0x0;
...
static HI_VOID OPTM_ALG_GZmeComnSet(OPTM_ALG_GZME_MEM_S *pstMem, OPTM_ALG_GZME_DRV_PARA_S *pstZmeDrvPara, OPTM_ALG_GZME_RTL_PARA_S *pstZmeRtlPara)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstMem);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstZmeDrvPara);
    ...
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, pstZmeDrvPara->u32ZmeFrmWOut);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, pstZmeDrvPara->u32ZmeFrmHOut);
...
static inline HI_VOID DRV_GZME_GetVorTap(OPTM_GZME_VER_TAP_E *penVorTap,OPTM_ALG_GZME_DRV_PARA_S *pstZmeDrvPara)
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(penVorTap);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstZmeDrvPara);
...
static inline HI_VOID DRV_GZME_GetOrder(OPTM_GZME_ORDER_E *penZmeOrder, OPTM_ALG_GZME_DRV_PARA_S *pstZmeDrvPara)
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(penZmeOrder);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstZmeDrvPara);
...
static inline HI_VOID DRV_GZME_GetOffsetVbTm(HI_S32 *pOffsetVbTm, HI_U32 VorZmeRealRatio, OPTM_ALG_GZME_DRV_PARA_S *pstZmeDrvPara)
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pOffsetVbTm);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstZmeDrvPara);
...
HI_VOID OPTM_ALG_GZmeHDSet(OPTM_ALG_GZME_MEM_S *pstMem, OPTM_ALG_GZME_DRV_PARA_S *pstZmeDrvPara, OPTM_ALG_GZME_RTL_PARA_S *pstZmeRtlPara)
{
    ...
    if (0 == pstZmeRtlPara->bZmeTapV)
    {
        ...
        {
            pstZmeRtlPara->u32ZmeCoefAddrHL = OPTM_GetGfxHLfirSDCoef( &(pstMem->stZmeCoefAddr), (pstZmeRtlPara->u32ZmeRatioHL) >> CONFIG_HIFB_PRECISION_ZMERATIONH_8BITOFFSET);
            pstZmeRtlPara->u32ZmeCoefAddrHC = OPTM_GetGfxHCfirSDCoef( &(pstMem->stZmeCoefAddr), (pstZmeRtlPara->u32ZmeRatioHC) >> CONFIG_HIFB_PRECISION_ZMERATIONH_8BITOFFSET);
        ...
        {
            pstZmeRtlPara->u32ZmeCoefAddrHL = OPTM_GetGfxHLfirCoef( &(pstMem->stZmeCoefAddr), (pstZmeRtlPara->u32ZmeRatioHL) >> CONFIG_HIFB_PRECISION_ZMERATIONH_8BITOFFSET);
            pstZmeRtlPara->u32ZmeCoefAddrHC = OPTM_GetGfxHCfirCoef( &(pstMem->stZmeCoefAddr), (pstZmeRtlPara->u32ZmeRatioHC) >> CONFIG_HIFB_PRECISION_ZMERATIONH_8BITOFFSET);
