        ...
        HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    if (HI_DRV_PQ_VIDEOPHONE_MODE_USER == enDrvPqVPImageMode)
    {
        ...
        stVpssCscPara.as16ColorTempGain[VPSSCOLORTEMP_R]   = 50;
        stVpssCscPara.as16ColorTempGain[VPSSCOLORTEMP_G]   = 50;
        stVpssCscPara.as16ColorTempGain[VPSSCOLORTEMP_B]   = 50;
