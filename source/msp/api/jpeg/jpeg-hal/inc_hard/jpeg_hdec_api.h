...
/***********************************************************************************************/
   ...
   extern "C" {
    ...
    /***************************** Macro Definition ********************************************/
     ...
     #define CONFIG_JPEG_CALL_FUNC_NUM                              20
     #define CONFIG_JPEG_CALL_FUNC_LEN                              256
     /*************************** Enum Definition **********************************************/
    ...
    /*************************** Structure Definition ******************************************/
     ...
     typedef struct tagJPEG_PROC_INFO_S
     {
         ...
         HI_BOOL SupportSeekToSoft;
         HI_U32  HardDecTimes;
         HI_U32  SoftDectTimes;
         HI_U32  DecCostTimes;
     }JPEG_PROC_INFO_S;
     ...
     typedef struct tagJPEG_HDEC_HANDLE_S
     {
          ...
          /**<------------dfx ------**/
          HI_CHAR CallFunc[CONFIG_JPEG_CALL_FUNC_NUM][CONFIG_JPEG_CALL_FUNC_LEN];
          HI_U32  CallFuncLine[CONFIG_JPEG_CALL_FUNC_NUM];
          HI_U32  CallFuncNum;
          HI_U32  LogLevel;
          /**<------------dfx ------**/
