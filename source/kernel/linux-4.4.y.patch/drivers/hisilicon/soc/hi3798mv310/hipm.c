...
#define CA_DDR_WAKEUPCHECK_START	0xffff9000
#define CA_DDR_WAKEUPCHECK_LENTH	0x3000

/* LPDS ADDR */
#define ADDR_LPDS_ADDR_BASE     (0xF840EC00)
#define ADDR_CEP                (ADDR_LPDS_ADDR_BASE + 0x20)

void __iomem *hi_lpds_cep_addr = NULL;
...
static int hi_pm_suspend(void)
{
	...
	//Hi3798MV310:ca_pm_suspend is not just for CA chips.Non-secure startup will run here.
...
static int __init hi_pm_init(void)
{
	...
	hi_lpds_cep_addr = (void __iomem *)IO_ADDRESS(ADDR_CEP);
