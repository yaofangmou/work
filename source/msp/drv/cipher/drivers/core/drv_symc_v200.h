...
#define SPACC_EVEN_KEY_TABLE_ADDR_SEC_CFG       (0x03A4)
#define SPACC_ODD_KEY_TABLE_ADDR_SEC_CFG        (0x03A8)
...
#define CHANN_CIPHER_IN_LEFT_WORD0(id)          (0x0414 + (id)*0x80)
...
#define CHANN_SYM_CALC_KEY_FLEX_ADDR_REG(id)    (0x0478 + (id)*0x80)
#define HASH_INT_STATUS                         (0x0804)
#define CHN_WHO_USED_REE                        (0x0390)
#define CHN_WHO_USED_TEE                        (0x0394)
#define NON_SEC_CHN_WHO_USED                    (0x0398)
...
/* Define the union U_NON_SEC_CHN_WHO_USED */
typedef union
{
    /* Define the struct bits */
    struct
    {
        u32    non_sec_chnn_who_used : 16  ; /* [15..0]  */
        u32    sec_chn1_who_used     : 2   ; /* [17..16]  */
        u32    reserved              : 14  ; /* [31..18]  */
    } bits;

    /* Define an unsigned member */
    u32    u32;

} U_NON_SEC_CHN_WHO_USED;

/* Define the union U_SPACC_EVEN_KEY_TABLE_ADDR_SEC_CFG */
typedef union
{
    /* Define the struct bits */
    struct
    {
        u32    spacc_even_key_table_addr_sec : 8  ; /* [7..0]  */
        u32    reserved                      : 24  ; /* [31..8]  */
    } bits;

    /* Define an unsigned member */
    u32    u32;

} U_SPACC_EVEN_KEY_TABLE_ADDR_SEC_CFG;

/* Define the union U_SPACC_ODD_KEY_TABLE_ADDR_SEC_CFG */
typedef union
{
    /* Define the struct bits */
    struct
    {
        u32    spacc_odd_key_table_addr_sec : 8  ; /* [7..0]  */
        u32    reserved                      : 24  ; /* [31..8]  */
    } bits;
...
} U_SPACC_ODD_KEY_TABLE_ADDR_SEC_CFG;

/* Define the union U_CHANN_SYM_CALC_KEY_FLEX_ADDR_REG */
typedef union
{
    /* Define the struct bits */
    struct
    {
        u32    chn_sym_calc_key_flex_addr    : 3   ; /* [2..0]  */
...
} U_CHANN_SYM_CALC_KEY_FLEX_ADDR_REG;
...
typedef union
{
    ...
    struct
    {
        u32 spacc_sha2_core_srst_req       : 1 ; /* [0] */
        u32 spacc_sha2_core_clk_en         : 1 ; /* [1] */
        u32 spacc_sha1_core_srst_req       : 1 ; /* [2] */
        u32 spacc_sha1_core_clk_en         : 1 ; /* [3] */
        u32 spacc_sm4_core_srst_req        : 1 ; /* [4] */
        u32 spacc_sm4_core_clk_en          : 1 ; /* [5] */
        u32 spacc_sm3_core_srst_req        : 1 ; /* [6] */
        u32 spacc_sm3_core_clk_en          : 1 ; /* [7] */
        u32 spacc_sm1_core_srst_req        : 1 ; /* [8] */
        u32 spacc_sm1_core_clk_en          : 1 ; /* [9] */
        u32 spacc_des_core_srst_req        : 1 ; /* [10] */
        u32 spacc_des_core_clk_en          : 1 ; /* [11] */
        u32 spacc_aes_core_srst_req        : 1 ; /* [12] */
        u32 spacc_aes_core_clk_en          : 1  ; /* [13] */
        u32 reserved                       : 13 ; /* [14:26] */
        u32 spacc_core_auto_cken_bypass_lock    : 1  ; /* [27] */
        u32 spacc_rfs_mem_clk_gt_en             : 1  ; /* [28] */
        u32 spacc_rft_mem_rd_clk_gt_en          : 1  ; /* [29] */
        u32 spacc_rft_mem_wr_clk_gt_en          : 1  ; /* [30] */
        u32 spacc_core_auto_cken_bypass         : 1  ; /* [31] */
    } bits;

    /* Define an unsigned member */
    u32    u32;

} U_SPACC_CALC_CRG_CFG;
