                            ...
                            HI_U32 u32HandleNo)
{
    ...
    for (i = 0; i < sg_u32PhyListNum; i++)
    {
        ...
        if (REG_TYPE_VDP == PQ_COMM_GetAlgTypeID(u32Module))
        {
                                 ...
                                 PQ_OUTPUT_MODE_E enOutputMode)
{
    ...
    for (i = u32StartPos; i <= u32EndPos; i++)
    {
        ...
        if (REG_TYPE_VDP == PQ_COMM_GetAlgTypeID(enModule))
        {
            u32Addr |= VDP_REGS_ADDR;
            s32Ret = PQ_TABLE_SetVdpReg(u32Addr, u8Lsb, u8Msb, u32Value);
        }
...
/* init get table para of each alg module */
                            ...
                            PQ_OUTPUT_MODE_E enOutputMode)
{
    ...
    for (i = u32StartPos; i <= u32EndPos; i++)
    {
        ...
        if (REG_TYPE_VDP == PQ_COMM_GetAlgTypeID(enModule))
        {
            ...
            pVdpVirReg = PQ_HAL_GetVdpLocalReg();
