                         ...
                         CBB_CFG_EXT_S *pVDPCfgExtPara)
{
    ...
    else
    {
        ...
        TransvertPixelFmt2CBB(&pstPara->eSrcPixelFmt, &pCbbLayerBasePara->eSrcPixelFmt);
        ...
        pCbbLayerBasePara->enDispMode   = XDR_DISPMODE_TRANSFER(pstPara->eDispMode);
    }
...
HI_VOID  HAL_Video_GetVMX_WaterMarkStatus(HI_BOOL *pbEnable)
{
    VDP_GetVMX_WaterMarkStatus(pbEnable);
    return;
}
...
HI_VOID VdpWinDebugLogicInfo(HI_U32 u32Data, HI_U32 u32Num, HI_VOID *pstWinDebugLogicInfo)
{
    VDP_WIN_DebugLogicInfo(u32Data, u32Num, pstWinDebugLogicInfo);
}
