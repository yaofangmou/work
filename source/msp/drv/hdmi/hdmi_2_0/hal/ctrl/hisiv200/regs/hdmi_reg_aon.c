...
int HDMI_HOTPLUG_FillterSet(HI_BOOL bEnable, HI_U32 u32High, HI_U32 u32Low)
{
    HI_U32 *pu32RegAddr = NULL;
    U_HOTPLUG_ST_CFG o_hotplug_st_cfg;
    ...
    o_hotplug_fillter_cfg.bits.hpd_low_reshold = u32Low;
    o_hotplug_fillter_cfg.bits.hpd_high_reshold = u32High;
    HDMI_RegWrite(pu32RegAddr, o_hotplug_fillter_cfg.u32);

    pu32RegAddr = (HI_U32*)&(goptx_aon_regAllReg->HOTPLUG_ST_CFG.u32);
    o_hotplug_st_cfg.u32 = HDMI_RegRead(pu32RegAddr);
    o_hotplug_st_cfg.bits.hpd_fillter_en = bEnable;
    HDMI_RegWrite(pu32RegAddr, o_hotplug_st_cfg.u32);

    return HI_SUCCESS;
}

int HDMI_HOTPLUG_ST_CFG_SimulateSet(HI_BOOL bSoftHpdEnalbe, HI_BOOL bSoftHpdState)
{
    HI_U32 *pu32RegAddr = NULL;
    ...
    pu32RegAddr = (HI_U32*)&(goptx_aon_regAllReg->HOTPLUG_ST_CFG.u32);
    o_hotplug_st_cfg.u32 = HDMI_RegRead(pu32RegAddr);
    o_hotplug_st_cfg.bits.hpd_override_en = bSoftHpdEnalbe;
    o_hotplug_st_cfg.bits.hpd_soft_value  = bSoftHpdState;
    HDMI_RegWrite(pu32RegAddr, o_hotplug_st_cfg.u32);
...
int HDMI_CEC_IntrSet(HI_BOOL bEnable)
{
    HI_U32 *pu32RegAddr = NULL;
    ...
    o_tx_aon_intr_mask.bits.aon_intr_mask4  = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask5  = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask6  = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask7  = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask8  = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask9  = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask10 = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask11 = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask12 = bEnable;
    o_tx_aon_intr_mask.bits.aon_intr_mask13 = bEnable;
    ...
    o_tx_aon_intr_state.bits.aon_intr_stat4  = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat5  = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat6  = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat7  = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat8  = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat9  = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat10 = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat11 = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat12 = bEnable;
    o_tx_aon_intr_state.bits.aon_intr_stat13 = bEnable;
