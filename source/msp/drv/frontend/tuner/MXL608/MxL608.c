...
static MXL_STATUS mxl608_cfg_xtal(HI_U32 u32TunerPort, UINT8 devId)
{
    ...
    else if (check_internal_demod(u32TunerPort, HI_CHIP_TYPE_HI3716M, HI_CHIP_VERSION_V430))
    {
        xtalCfg.clkOutEnable = MXL_DISABLE;
        xtalCfg.clkOutDiv = MXL_DISABLE;
        xtalCfg.clkOutExt = MXL_DISABLE;
        ...
        xtalCfg.XtalSharingMode = MXL_ENABLE;
#else
        xtalCfg.XtalSharingMode = MXL_DISABLE;
#endif
    }
    ...
    /* save parameters */
    if (MXL608_XTAL_24MHz == xtalCfg.xtalFreqSel)
    {
        g_stTunerOps[u32TunerPort].stTunerCfg.u32XtalFreqKHz = 24000;
    }
    else
    {
        g_stTunerOps[u32TunerPort].stTunerCfg.u32XtalFreqKHz = 16000;
    }
    g_stTunerOps[u32TunerPort].stTunerCfg.u32XtalCapPF = xtalCfg.xtalCap;
...
HI_S32 mxl608_init_tuner(HI_U32 u32TunerPort)
{
    ...
    g_stTunerOps[u32TunerPort].stTunerCfg.bSingle3_3V = (MXL_ENABLE == singleSupply_3_3V) ? HI_TRUE : HI_FALSE;
    ...
    g_stTunerOps[u32TunerPort].stTunerCfg.u32IFFreqKHz= 5000;
