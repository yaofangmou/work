...
static s32 cryp_rsa_enc_get_alg(u32 scheme, int *padding, int *hash_id, int *hashlen)
{
...
static s32 cryp_rsa_sign_get_alg(u32 scheme, int *padding, int *hash_id, int *hashlen)
{
                     ...
                     u8 *in, u32 inlen, u8 *out, u32 *outlen)
{
    ...
    {
        HI_LOG_ERROR("error, cryp_rsa_enc_get_alg failed");
        HI_LOG_PrintFuncErr(cryp_rsa_enc_get_alg, ret);
        return ret;
    }
                        ...
                        u8 *in, u32 inlen, u8 *out, u32 *outlen, u32 saltlen)
{
    ...
    if (HI_SUCCESS != ret)
    {
        ...
        HI_LOG_PrintFuncErr(cryp_rsa_sign_get_alg, ret);
        return ret;
    }
