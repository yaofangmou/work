...
typedef struct
{
    ...
    wait_queue_head_t klad_wait_queue;
    HI_BOOL wake_up;
#endif
...
typedef struct
{
    ...
    DRV_KLAD_CONTENT_KEY_S content_key;
        ...
        #define  HKL_IRQ_NUMBER            (103 + 32)
    #elif (defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3796mv200))
        #define  HKL_IRQ_NUMBER            (77 + 32)
    #endif
    #define  HKL_IRQ_NAME              "hkl_tzcpu"
#else
    #if defined(CHIP_TYPE_hi3716mv430)
        #define  HKL_IRQ_NUMBER            (102 + 32)
    #elif (defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3796mv200))
        #define  HKL_IRQ_NUMBER            (76 + 32)
    #endif
    #define  HKL_IRQ_NAME              "hkl_acpu"
#endif
#endif
