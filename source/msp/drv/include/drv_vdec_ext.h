...
typedef HI_S32  (*FN_VDEC_AllocDeiMem)(HI_HANDLE hVdec, HI_DRV_DEI_MEM_INFO_S *pDeiMemInfo);
typedef HI_S32  (*FN_VDEC_ReleaseDeiMem)(HI_HANDLE hVdec, HI_DRV_DEI_MEM_INFO_S *pDeiMemInfo);
...
typedef struct tagVDEC_EXPORT_FUNC_S
{
    ...
    FN_VDEC_AllocDeiMem          pfnVDEC_GetDeiMem;
    FN_VDEC_ReleaseDeiMem        pfnVDEC_ReleaseDeiMem;
} VDEC_EXPORT_FUNC_S;
