...
#define MAX_HDR_METADATA_SIZE          4 * 1024 /**< HDR metadata size*/
...
#define BASE_PROFILE_MAX_BITSTREAM_SIZE          4 * 1024 /**< HDR metadata size*/
...
typedef struct hiCHAN_CFG_S
{
    ...
    VID_STD_E        eVidStd;            /* video compressing standard */
...
#ifdef AVS2_SL_HDR_EN
typedef struct
{
    UINT32  tmInputSignalBlackLevelOffset;
    UINT32  tmInputSignalWhiteLevelOffset;
    UINT32  shadowGain;
    UINT32  highlightGain;
    UINT32  midToneWidthAdjFactor;
    UINT32  tmOutputFineTuningNumVal;
    UINT32  tmOutputFineTuningX[10];
    UINT32  tmOutputFineTuningY[10];
    UINT32  saturationGainNumVal;
    UINT32  saturationGainX[6];
    UINT32  saturationGainY[6];
} SL_HDR_Metadata_Var_S;

typedef struct
{
    UINT32  luminanceMappingNumVal;
    UINT32  luminanceMappingX[65];
    UINT32  luminanceMappingY[65];
    UINT32  colourCorrectionNumVal;
    UINT32  colourCorrectionX[65];
    UINT32  colourCorrectionY[65];
} SL_HDR_Metadata_Tab_S;

typedef struct
{
    UINT32  partID;
    UINT32  majorSpecVersionID;
    UINT32  minorSpecVersionID;
    UINT32  payloadMode;
    UINT32  hdrPicColourSpace;
    UINT32  hdrDisplayColourSpace;
    UINT32  hdrDisplayMaxLuminance;
    UINT32  hdrDisplayMinLuminance;
    UINT32  sdrPicColourSpace;
    UINT32  sdrDisplayColourSpace;
    UINT32  sdrDisplayMaxLuminance;
    UINT32  sdrDisplayMinLuminance;
    UINT32  matrixCoefficient[4];
    UINT32  chromaToLumaInjection[2];
    UINT32  kCoefficient[3];
    union
    {
        SL_HDR_Metadata_Var_S variables;
        //SL_HDR_Metadata_Tab_S tables;
    } u;
} SL_HDR_Metadata_S;
#endif
...
typedef struct
{
    UINT32 active_format_flag : 1;
    UINT32 active_format      : 4;
    UINT32 reserved           : 3;
} AFD_INFO;
...
typedef struct hiIMAGE_INTF_S
{
    ...
    SINT32  (*read_image)(SINT32 InstID, VOID *pImage);
    SINT32  (*release_image)(SINT32 InstID, VOID *pImage);
} IMAGE_INTF_S;
...
typedef struct hiSTREAM_INTF_S
{
    ...
    SINT32  (*read_stream)(SINT32 InstID, VOID *pPacket);
    SINT32  (*release_stream)(SINT32 InstID, VOID *pPacket);
} STREAM_INTF_S;
