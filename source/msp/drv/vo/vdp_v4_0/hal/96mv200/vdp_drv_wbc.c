...
HI_S32 VDP_DRV_SetWbcLayer(HI_U32 u32LayerId, VDP_LAYER_WBC_INFO_S *pstInfo)
{
    ...
    HI_U32 u323DMode = VDP_WBC_3D_MODE_TWOEYE;
    ...
    */
    if (pstInfo->enDispMode == VDP_DISP_MODE_FP)
    {
        u323DMode = VDP_WBC_3D_MODE_LEFTEYE;
    }
    ...
    VDP_WBC_SetThreeMd                 ((VDP_LAYER_WBC_E)u32LayerId, u323DMode);
