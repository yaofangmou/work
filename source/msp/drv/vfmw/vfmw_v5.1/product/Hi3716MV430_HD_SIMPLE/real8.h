...
#define REAL8_PMV_ONECOLMB_ADDR_LEN              (20*4)
#define REAL8_MSG_SLOT_BURST_LEN                 (64*4)
...
typedef struct
{
    ...
    RV8_VOBUFINF VOBufInf[MAX_QUEUE_IMAGE_NUM];
...
VOID   REAL8DEC_FlushRemainImg(RV8_CTX_S *pCtx);
