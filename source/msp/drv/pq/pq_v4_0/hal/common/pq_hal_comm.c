...
#if defined(SHARPEN_CFG_STYLE_COEF)
    {
        HI_U32 addr = VDP_REGS_ADDR + (HI_U32)(unsigned long)a - (HI_U32)(unsigned long)(&(sg_pstVDPRegMem->VOCTRL.u32));
...
HI_U32 PQ_HAL_RegRead(volatile HI_U32 *a)
{
    ...
    if ((addr >= 0xf8cc7004) && (addr <= 0xf8cc704c))
    {
        addr = (addr - 0xf8cc7004 + (HI_U32)(unsigned long)g_stSharpCfgBuff.pu8StartVirAddr);
        a = (HI_U32 *)(unsigned long)addr;
    }
#endif
