...
// History       :  xxx 2016-07-13 Create file
//******************************************************************************
...
/* Define the union U_TNR_NOISEPOINTCNT */
typedef union
{
    /* Define the struct bits  */
    struct
...
typedef struct
{
    ...
    unsigned int           reserved_0[2]                     ; /* 0x2204~0x2208 */
    ...
    unsigned int           reserved_1[52]                     ; /* 0x2230~0x22fc */
    ...
    unsigned int           reserved_2[20]                     ; /* 0x23b0~0x23fc */
    ...
    unsigned int           reserved_3[14]                     ; /* 0x24c8~0x24fc */
    ...
    U_TNR_NOISEPOINTCNT    TNR_NOISEPOINTCNT                 ; /* 0x250c */
...
//extern S_MODULE_NAME_REGS_TYPE *gopMODULE_NAMEAllReg;
