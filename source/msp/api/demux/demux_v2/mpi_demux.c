...
#define DEFAULT_CHAN_BUF_CB_RCV_MSG_NUM (8)     /* keep sync with DMX_DEFAULT_BUF_NUM from drv_demux_define.h. */
...
HI_S32 HI_MPI_DMX_Init(HI_VOID)
{
    ...
    if (g_s32DmxFd == -1)
    {
        ...
        if (0 != pthread_mutex_init(&g_stChanBuf.CbLock, HI_NULL))
        {
            HI_WARN_DEMUX("mutex init failed.\n");
        }
...
HI_S32 HI_MPI_DMX_AcquireEs(HI_HANDLE hChannel, HI_UNF_ES_BUF_S *pEsBuf, HI_MPI_ES_EXT_DATA_S *pEsExtData)
{
    ...
    if (HI_SUCCESS == ret)
    {
            ...
            && ((u32PhyAddr + Param.BufSize - g_stChanBuf.BufDesc[u32DmxId * g_stChanBuf.ChnCnt + u32ChId].PhyAddr) <= g_stChanBuf.BufDesc[u32DmxId * g_stChanBuf.ChnCnt + u32ChId].Size))
        {
            ...
            pEsBuf->stPriEsBufAddr.u64BufPhyAddr = Param.u64BufPhyAddr;
            pEsBuf->stPriEsBufAddr.u64BufKerVirAddr = Param.u64BufKerVirAddr;
            if (HI_NULL != pEsExtData)
            {
...
#else
HI_S32 HI_MPI_RMX_GetDefaultAttr(HI_MPI_RMX_ATTR_S * pstAttr){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_Create(HI_MPI_RMX_ATTR_S * pstAttr, HI_HANDLE *phRmx){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_Destroy(HI_HANDLE hRmx){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_GetAttr(HI_HANDLE hRmx, HI_MPI_RMX_ATTR_S * pstAttr){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_SetAttr(HI_HANDLE hRmx, HI_MPI_RMX_ATTR_S * pstAttr){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_Start(HI_HANDLE hRmx){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_Stop(HI_HANDLE hRmx){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_GetPumpDefaultAttr(HI_MPI_RMX_PUMP_ATTR_S * pstAttr){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_AddPump(HI_HANDLE hRmx, HI_MPI_RMX_PUMP_ATTR_S *pstAttr, HI_HANDLE *phRmxPump){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_DelPump(HI_HANDLE hRmxPump){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_GetPumpAttr(HI_HANDLE hRmxPump, HI_MPI_RMX_PUMP_ATTR_S *pstAttr){return HI_ERR_DMX_NOT_SUPPORT;};
HI_S32 HI_MPI_RMX_SetPumpAttr(HI_HANDLE hRmxPump, HI_MPI_RMX_PUMP_ATTR_S *pstAttr){return HI_ERR_DMX_NOT_SUPPORT;};
#endif
