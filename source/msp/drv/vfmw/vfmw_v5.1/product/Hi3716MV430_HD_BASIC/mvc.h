...
#define   MVC_MAX_BYTES_START                     (512*1024)
#define   MVC_GET_ONE_NALU_SIZE                   (4*1024)
...
typedef struct
{
    ...
    MVC_NALU_S               NalArray[H264_MAX_SLICE_NUM + 1];
    ...
    MVC_SLCINFO_S            SlcInfo[H264_MAX_SLICE_NUM];
...
VOID   MVC_DEC_FlushRemainImg(MVC_CTX_S *pMvcCtx);
