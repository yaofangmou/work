...
/*only used in DVB-T2*/
HI_S32 MN88472_get_plp_info(HI_U32 u32TunerPort, HI_U32 u32Index, HI_UNF_TUNER_TER_PLP_INFO_S *pstPLPPara)
{
    DMD_PARAMETER_t* pstParaMeter;
    ...
    {
        /*get the number of PLPs*/
        DMD_set_info( pstParaMeter , DMD_E_INFO_DVBT2_SELECTED_PLP , u32Index & 0xFF );
        DMD_device_reset(pstParaMeter);
        DMD_device_scan(pstParaMeter);
        DMD_get_info( pstParaMeter , DMD_E_INFO_DVBT2_SELECTED_PLP);
...
/*only used in DVB-T2*/
HI_S32 MN88472_set_plp_para(HI_U32 u32TunerPort, HI_UNF_TUNER_TER_PLP_PARA_S *pstPLPPara)
{
    DMD_PARAMETER_t* pstParaMeter;
    ...
    DMD_set_info( pstParaMeter , DMD_E_INFO_DVBT2_SELECTED_PLP , pstPLPPara->u8PlpId & 0xFF );
    DMD_device_reset(  pstParaMeter);
	DMD_device_scan(  pstParaMeter);
    return HI_SUCCESS;
}
