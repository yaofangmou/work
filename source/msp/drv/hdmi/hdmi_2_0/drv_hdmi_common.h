...
typedef struct
{
    ...
    HI_U32                      u32BaseTmdsClk;             /* HDMI Base tmds colck*/
...
typedef enum
{
    HDMI_CEC_CAP_UNKNOWN,
    HDMI_CEC_CAP_SUPPORT,
    HDMI_CEC_CAP_UNSUPPORT,
}HDMI_CEC_CAP_E;
typedef struct
{
    HI_U8                              u8Length;
