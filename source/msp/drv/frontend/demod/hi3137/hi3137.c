...
HI_S32 hi3137_connect(HI_U32 u32TunerPort, TUNER_ACC_QAM_PARAMS_S *pstChannel)
{
    ...
    if(i >= u32SyncChk)
    {
        HI_WARN_TUNER("hi3137 sync fail.\n");
    ...
    if (i >= u32ChkTim)
    {
        HI_WARN_TUNER("hi3137 fec fail.u32ChkTim:%d,i:%d\n",u32ChkTim,i);
...
HI_S32 hi3137_set_plp_para(HI_U32 u32TunerPort, HI_UNF_TUNER_TER_PLP_PARA_S *pstPLPPara)
{
    ...
    qam_write_bit(u32TunerPort, Hi3137_PLP_CTRL, 0, 1);
    ...
    for (i = 0, u8Finded = 0; i < u8PLPNum && u8Finded < 2; i++)
    {
        ...
        qam_read_byte(u32TunerPort, Hi3137_PLP_ID, &u8RegVal);
    ...
    qam_write_bit(u32TunerPort, Hi3137_PLP_CTRL, 0, 1);
    qam_write_byte(u32TunerPort, Hi3137_PLP_ID0, u8PLPIndex);
    qam_write_byte(u32TunerPort, Hi3137_PLP_ID1, u8CommPLPIndex);
    qam_write_bit(u32TunerPort, Hi3137_PLP_CTRL, 1, (pstPLPPara->u8Combination?HI_TRUE:HI_FALSE));

    qam_write_bit(u32TunerPort, Hi3137_PLP_CTRL, 0, 0);
    hi3137_hot_reset(u32TunerPort);
    HI3137_MCU_RESUME;
...
HI_S32 hi3137_get_plp_info(HI_U32 u32TunerPort, HI_U32 u32Index, HI_UNF_TUNER_TER_PLP_INFO_S *pstPLPInfo)
{
    HI_U8 u8RegVal = 0;
    HI_U8 u8PlpType = 0;
    HI_U8 u8PlpId = 0;
    ...
    qam_write_byte(u32TunerPort, Hi3137_PLP_ID0, u32Index);

    qam_read_byte(u32TunerPort, Hi3137_PLP_TYPE, &u8RegVal);
...
HI_S32 hi3137_get_cir_plot_data(HI_U32 u32TunerPort,HI_U32 u32DataLen)
{
    HI_S32 s32Ret = HI_SUCCESS;
