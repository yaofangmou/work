...
#define VDP_FRAME_2_NODE(pstFrame) (container_of((HI_U32 *)(pstFrame), DISP_BUF_NODE_S, u32Data[0]))
...
typedef struct tagDISP_NodeListINFOR_S
{
    DISP_MMZ_BUF_S  stNodeAddr;
    DISP_MMZ_BUF_S  stXdpPqBaseAddr;
    HI_VOID         *pstXdpNodePrivateInfor;
    HI_BOOL          bMask;
} DISP_NodeListINFOR_S;
...
typedef struct tagDISP_BUF_NODE_S
{
    ...
    DISP_NodeListINFOR_S stPlayInfor;
...
typedef struct tagCOMMONList_S
{
    struct list_head       stBufNodeHead;
    spinlock_t             stBufLock;
    COMMON_LISTTYPE_E      eListType;
} COMMON_LIST_S;
...
{
    HI_U32            u32Number;
    DISP_BUF_NODE_S   *pstBasicNodeContainer;
    COMMON_LIST_S     stEmptyArray;
    COMMON_LIST_S     stFullArray;
    COMMON_LIST_S     stUsingArray;

    spinlock_t        stBufTopLock;
...
// put node into empry array and DO NOT set empty state
