...
#define ST_KLAD_BASIC_MCIPHER_DECLARE_FUNC \
    ...
    ST_KLAD_ASSERT(KLAD_VerifyWithMCipher(b_ca, klad_type, mcipher, alg, cipher_alg)); \
...
static HI_U8 RESULT_BASIC_SWPK_TDES[16]      = {0xcb,0x8f,0x8a,0x9c,0x60,0x49,0x3c,0xa1,0x6c,0x35,0xc1,0xc5,0xbc,0x1d,0x99,0x61};
#else
...
static HI_S32 KLAD_VerifyWithMCipher(HI_BOOL bCA, HI_U32 klad_type, HI_HANDLE mcipher, HI_UNF_KLAD_ALG_TYPE_E alg, HI_UNF_CIPHER_ALG_E cipher_alg)
{
    HI_U8 output[16] = {0};

    ST_KLAD_ASSERT(KLAD_MCipherConfig(bCA, mcipher, cipher_alg, HI_UNF_CIPHER_WORK_MODE_ECB, NULL, NULL));
