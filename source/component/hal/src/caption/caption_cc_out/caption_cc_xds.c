...
#define MAX_PACKET_PROGTYPE_LEN 5
#define MAX_PACKET_TITLE_LEN 22
#define MAX_PACKET_NETWORKNAME_LEN 18
#define MAX_CALLLETTER_NATV_LEN 4
#define MAX_CHAN_NATV_LEN 2
#define MAX_CAPTSERVICE_LEN 2
...
{
    HI_U8 au8ProgramType[MAX_PACKET_PROGTYPE_LEN];
    HI_U8 u8ContAdv;
    HI_U8 u8LengthMin;
    HI_U8 u8LengthHour;
    HI_U8 u8ElapsedMin;
    HI_U8 u8ElapsedHour;
    HI_U8 au8Title[MAX_PACKET_TITLE_LEN];
    HI_U8 u8TitleLen;
} XDSCompPacket1_S;
...
typedef struct _tagXDSCompPacket2_S
{
    ...
    HI_U8 au8CaptServices[MAX_CAPTSERVICE_LEN];
    HI_U8 au8CallLetter[MAX_CALLLETTER_NATV_LEN];
    HI_U8 au8NativeChan[MAX_CHAN_NATV_LEN];
    HI_U8 au8NetworkName[MAX_PACKET_NETWORKNAME_LEN];
...
static HI_S32 _CC608_XDS_DecodeProgName(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stProgName.au8ProgName[MAX_CC608_PROGNAME_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeProgType(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stProgType.au8ProgType[MAX_CC608_PROGTYPE_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeCaptionService(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stCaptService.au8CaptServices[MAX_CC608_CAPTSERV_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeCompPacket1(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stCompPacket1.au8ProgramType[MAX_PACKET_PROGTYPE_LEN - 1] = '\0';
    ...
    stCompPacket1.au8Title[MAX_PACKET_TITLE_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeCompPacket2(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stCompPacket2.au8NetworkName[MAX_PACKET_NETWORKNAME_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeProgDescription(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stXDSProgDesc.au8ProgDesc[MAX_CC608_PROGDESC_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeNetworkName(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stNetworkName.au8NetName[MAX_CC608_NETNAME_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeCallLetter(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stCallLetNatvCh.au8CallLetter[MAX_CALLLETTER_NATV_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeSuplDataLoc(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stSupplDataLoc.au8SupplDataLoc[MAX_CC608_SUPPDATA_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeChMapPacket(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    if (len > 2)
    {
        ...
        if (len > 4)
        {
            ...
            stChMapPacket.au8ChID[MAX_CC608_CHID_LEN - 1] = '\0';
        }
    }
...
static HI_S32 _CC608_XDS_DecodeNWSCode(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stNatWeaServcCode.au8NatWeaServcCode[MAX_CC608_NWSCODE_LEN - 1] = '\0';
...
static HI_S32 _CC608_XDS_DecodeNWSData(HI_U8* pu8PacketData, HI_U8 u8PacketLen)
{
    ...
    stNatWeaServcMsg.u8NatWeaServcMsg[MAX_CC608_NWSMSG_LEN - 1] = '\0';
