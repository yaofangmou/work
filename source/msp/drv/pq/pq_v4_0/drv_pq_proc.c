...
#define  PQ_MODIFY_TIME     "(20180919)"
...
static HI_S32 drv_pq_ProcSetBrightness(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    DRV_PQ_SetBrightness(HI_PQ_DISPLAY_0, u32Data);
    DRV_PQ_SetBrightness(HI_PQ_DISPLAY_1, u32Data);
...
static HI_S32 drv_pq_ProcSetContrast(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    DRV_PQ_SetContrast(HI_PQ_DISPLAY_0, u32Data);
    DRV_PQ_SetContrast(HI_PQ_DISPLAY_1, u32Data);
...
static HI_S32 drv_pq_ProcSetHue(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    DRV_PQ_SetHue(HI_PQ_DISPLAY_0, u32Data);
    DRV_PQ_SetHue(HI_PQ_DISPLAY_1, u32Data);
...
static HI_S32 drv_pq_ProcSetSaturation(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    DRV_PQ_SetSaturation(HI_PQ_DISPLAY_0, u32Data);
    DRV_PQ_SetSaturation(HI_PQ_DISPLAY_1, u32Data);
...
static HI_S32 drv_pq_ProcSetColorTemp(HI_CHAR *pArg1, HI_CHAR *pArg2)
{
    ...
    {
        GET_ALG_FUN(HI_PQ_MODULE_CSC)->SetColorTemp(HI_PQ_DISPLAY_1, &stTemperature);
        GET_ALG_FUN(HI_PQ_MODULE_CSC)->SetColorTemp(HI_PQ_DISPLAY_0, &stTemperature);
    }

    if (PQ_FUNC_CALL(HI_PQ_MODULE_GFXCSC, SetColorTemp))
    {
        GET_ALG_FUN(HI_PQ_MODULE_GFXCSC)->SetColorTemp(HI_PQ_DISPLAY_1, &stTemperature);
        GET_ALG_FUN(HI_PQ_MODULE_GFXCSC)->SetColorTemp(HI_PQ_DISPLAY_0, &stTemperature);
    }
