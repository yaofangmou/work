...
enum SVC_KEYMASTER_CMD_ID {
	...
	KM_CMD_ID_STORE_KB,
	KM_CMD_ID_VERIFY_KB,
        KM_CMD_ID_STORE_IDENTIFIERS,         /**new add 20180402 */
        KM_CMD_ID_VERIFY_IDENTIFIERS,        /**new add 20180402 */
        KM_CMD_ID_DESTROY_IDENTIFIERS,       /**new add 20180402 */
        KM_CMD_ID_VERIFY_ATTESTATIONIDS,     /**new add 20180402 */
        KM_CMD_ID_KB_EIMA_POLICY_SET = 0x1E, /**new add 20180402 */
        KM_CMD_ID_DELETE_KEY=0x1F,           /**new add 20180310 */
	KM_CMD_ID_PROVISION_RSA = 100,
	KM_CMD_ID_PROVISION_EC
};
