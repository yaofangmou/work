...
static HI_S32 PQ_MNG_SetTNRBlendingAlphaLut(HI_U32 u32FrameIndex, HI_U32 u32HandleNo)
{
...
HI_S32 PQ_MNG_InitTnr(PQ_PARAM_S *pstPqParam, HI_BOOL bParaUseTableDefault)
{
    ...
    PQ_MNG_SetTNRBlendingAlphaLut(0, u32HandleNo);
...
HI_S32 PQ_MNG_SetTnrDemoModeCoor (HI_U32 u32XPos)
{
    ...
    sg_stPQTNRInfo.u32DemoPos = u32XPos;
...
HI_S32 PQ_MNG_ResetTnrStatus(HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo)
{
    HI_S32 s32Ret         = HI_SUCCESS;
    ...
    s32Ret = PQ_HAL_ResetTnrStatus(pstPqFrameInfo->u32HandleNo, &sg_stPQTNRInfo, (S_VPSSIP_ALG_SET_REGS_TYPE *)(pstVpssRegInfo->pstVpssAlgRegOut));
...
static stPQAlgFuncs stTNRFuncs =
{
    ...
    .ReSetPqStatus      = PQ_MNG_ResetTnrStatus,
#ifdef PQ_ALG_MCNR
    .RefreshMcnrCfg      = PQ_MNG_RefreshMcnrCfg,
