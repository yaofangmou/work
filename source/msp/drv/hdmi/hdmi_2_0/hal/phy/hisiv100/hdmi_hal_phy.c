...
/**** double + diff mode */
    {{ 25000, 100000}, { 0,  0,  0,  0, 22, 23, 23, 23, HI_FALSE, HI_FALSE, HI_FALSE, HI_FALSE, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD, 0x20, PHY_RTERM_MODE_LOAD, 0x20, PHY_RTERM_MODE_LOAD, 0x20, 0x41}},
    {{100001, 165000}, { 0,  2,  2,  2, 22, 23, 23, 23, HI_FALSE,  HI_TRUE,  HI_TRUE,  HI_TRUE, PHY_FEEDTHRU_CAP_DELAY_18PS, PHY_FEEDTHRU_CAP_DELAY_18PS, PHY_FEEDTHRU_CAP_DELAY_18PS, PHY_FEEDTHRU_CAP_DELAY_18PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD, 0x20, PHY_RTERM_MODE_LOAD, 0x20, PHY_RTERM_MODE_LOAD, 0x20, 0x41}},
    {{165001, 340000}, { 0,  3,  3,  3, 22, 26, 26, 26, HI_FALSE,  HI_TRUE,  HI_TRUE,  HI_TRUE, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD, 0x30, PHY_RTERM_MODE_LOAD, 0x30, PHY_RTERM_MODE_LOAD, 0x30, 0x41}},
...
/**** double + diff mode */
    {{ 25000, 100000}, { 0,  0,  0,  0, 22, 28, 28, 28, HI_FALSE, HI_FALSE, HI_FALSE, HI_FALSE, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_SRC_LD, 0x20, PHY_RTERM_MODE_SRC_LD, 0x20, PHY_RTERM_MODE_SRC_LD, 0x20, 0x51}},
    {{100001, 165000}, { 0,  2,  2,  2, 22, 29, 29, 29, HI_FALSE, HI_TRUE,  HI_TRUE,  HI_TRUE,  PHY_FEEDTHRU_CAP_DELAY_45PS,  PHY_FEEDTHRU_CAP_DELAY_45PS, PHY_FEEDTHRU_CAP_DELAY_45PS, PHY_FEEDTHRU_CAP_DELAY_45PS,PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_SRC_LD, 0x20, PHY_RTERM_MODE_SRC_LD, 0x20, PHY_RTERM_MODE_SRC_LD, 0x20, 0x51}},
    {{165001, 340000}, { 0,  3,  3,  3, 22, 30, 30, 30, HI_FALSE, HI_TRUE,  HI_TRUE,  HI_TRUE,  PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_SRC_LD, 0x10, PHY_RTERM_MODE_SRC_LD, 0x10, PHY_RTERM_MODE_SRC_LD, 0x10, 0x51}},
    {{340001, 600000}, { 0,  2,  2,  2, 22, 42, 42, 42, HI_FALSE, HI_FALSE, HI_FALSE, HI_FALSE, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_FEEDTHRU_CAP_DELAY_35PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD  , 0x70, PHY_RTERM_MODE_LOAD  , 0x70, PHY_RTERM_MODE_LOAD  , 0x70, 0x51}},
};
...
static HI_S32 PhyRTermSet(HI_BOOL bEnable)
{
    HI_U32 u32Tmp = 0;
    HDMI_CHIP_TYPE_E eLogicVersion = HDMI_CHIP_HI3798CV200;

    eLogicVersion = DRV_HDMI_ProdChipGet();

    if (HI_TRUE == bEnable)
    {
        if (  (HDMI_CHIP_HI3798MV200 == eLogicVersion)
            ||(HDMI_CHIP_HI3796MV200 == eLogicVersion)
            ||(HDMI_CHIP_HI3716MV450 == eLogicVersion))
        {
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecCfg.enRTermModeClk)->u32ModeDataClk;
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecCfg.enRTermModeD0)->u32ModeDataD0;
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecCfg.enRTermModeD1)->u32ModeDataD1;
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecCfg.enRTermModeD2)->u32ModeDataD2;
        }
        else
        {
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecEnhanceCfg.enRTermModeClk)->u32ModeDataClk;
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecEnhanceCfg.enRTermModeD0)->u32ModeDataD0;
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecEnhanceCfg.enRTermModeD1)->u32ModeDataD1;
            u32Tmp |= PhyRTermModeDataGet(s_stHDMIPhyInfo.stHWSpecEnhanceCfg.enRTermModeD2)->u32ModeDataD2;
        }
    }
    else
    {
