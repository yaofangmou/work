...
static DRV_DISP_XDR_HARDWARE_CAP_S g_stXdrHardwareCap = {HI_TRUE, HI_TRUE, HI_TRUE, HI_TRUE, HI_TRUE};
...
static HI_DRV_DISP_XDR_ENGINE_E g_enXdrEngineList[HI_DRV_VIDEO_FRAME_TYPE_BUTT][HI_DRV_DISP_TYPE_BUTT][XDR_ENGINE_NUM] =
{
    ...
    {
        /* SDR output type : HI_DRV_DISP_TYPE_NORMAL */
        {DRV_XDR_ENGINE_JTP, DRV_XDR_ENGINE_BUTT, DRV_XDR_ENGINE_BUTT, DRV_XDR_ENGINE_BUTT, DRV_XDR_ENGINE_BUTT, DRV_XDR_ENGINE_BUTT},
