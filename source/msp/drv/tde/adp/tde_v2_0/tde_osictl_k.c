...
#define TDE_CHECK_COLORFMT(enColorFmt) do{\
        ...
        {\
            ...
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_COLOR_FMT_BUTT);\
...
#define TDE_CHECK_MBCOLORFMT(enMbColorFmt) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enMbColorFmt);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_MB_COLOR_FMT_BUTT);\
...
#define TDE_CHECK_OUTALPHAFROM(enOutAlphaFrom) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enOutAlphaFrom);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_OUTALPHA_FROM_BUTT);\
...
#define TDE_CHECK_ROPCODE(enRopCode) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enRopCode);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_ROP_BUTT);\
...
#define TDE_CHECK_ALUCMD(enAluCmd) \
    do{\
        ...
        {\
            ...
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_ALUCMD_BUTT);\
...
#define TDE_CHECK_COLORKEYMODE(enColorKeyMode) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enColorKeyMode);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_COLORKEY_MODE_BUTT);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enMbPicMode error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_SUBBYTE_STARTX(startx, w, outFmt) \
    do {\
        ...
        {\
            ...
            {\
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bpp);\
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, startx);\
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, w);\
...
#define TDE_CHECK_DST_FMT(enFmt) do\
    {\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Dest format doesn't support Clut&&A1");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_STRIDE_CHECK_ALIGN(u32Stride, u32AlignNum)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Stride);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32AlignNum);\
...
#define TDE_ADDRESS_CHECK_ALIGN(u32PhyAddr, u32AlignNum)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32PhyAddr);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32AlignNum);\
...
#define TDE_PATTERNBACKGROUNDCATEGORY_CHECK_CLUT(enBackGroundCategory, enForeGroundCategory, enBackGroundFmt,enForeGroundFmt, enDstFmt, enAluCmd , enDstCategory)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enAluCmd);\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundFmt);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enForeGroundFmt);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enDstFmt);\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enForeGroundCategory);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enDstCategory);\
...
#define TDE_BACKGROUNDCATEGORY_CHECK_CLUT(enBackGroundCategory, enForeGroundCategory, bResize, enDeflickerMode, enAluCmd , enDstCategory)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enDeflickerMode);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, bResize);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enAluCmd);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
...
#define TDE_YCBCR422_FMT_CHECK_ODD(enColorFmt, s32Xpos, u32Width)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Xpos);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enColorFmt);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, u32Width);\
...
#define TDE_MB_FMT_CHECK_ODD(enColorFmt, u32Width, u32Height)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Height);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Width);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enColorFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "width,height of SP420 couldn't be odd");\
            return -1;\
        }\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Width);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enColorFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "width of SP422H couldn't be odd");\
            return -1;\
        }\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Height);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enColorFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Height of SP422V couldn't be odd");\
            return -1;\
        }\
    }while(0)
...
#define TDE_YCBCR_FMT_CHECK_STRIDE(u32CbCrStride, enColorFmt)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, u32CbCrStride);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, enColorFmt);\
...
#define TDE_CHECK_SURFACEPARA(pstSurface, pstRect)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstSurface->u32Width);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstSurface->u32Height);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_XINT, pstSurface->u32Stride);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_XINT, pstSurface->u32PhyAddr);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Xpos);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Ypos);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);\
...
#define TDE_CHECK_MBSURFACEPARA(pstMbSurface, pstRect , rectWidth, rectHeight)\
    do{\
        ...
        {\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbSurface->u32YWidth);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbSurface->u32YHeight);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_XINT, pstMbSurface->u32YStride);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_XINT, pstMbSurface->u32YPhyAddr);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Xpos);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Ypos);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);\
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);\
...
#define TDE_CHECK_ROTATERECTAREA(pstForeGroundRect, pstDstRect, enRotateAngle)\
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enRotateAngle);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Rotate operation rect is wrong!");\
            return -1;\
        }\
        if ((TDE_ROTATE_CLOCKWISE_180 == enRotateAngle) && bWrongRotateRectArea)\
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enRotateAngle);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Rotate 180 operation rect is wrong");\
            return -1;\
        }\
    }while(0)
...
STATIC HI_S32 TdeOsiColorConvert(TDE2_FILLCOLOR_S *pstFillColor, TDE2_SURFACE_S *pstSur, HI_U32 *pu32OutColor)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_COLOR_FMT_CLUT1);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_COLOR_FMT_A8);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_COLOR_FMT_YCbCr422);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unsupported color");
        return -1;
    }
...
STATIC HI_S32 TdeOsiCheckResizePara(HI_U32 u32InWidth, HI_U32 u32InHeight, HI_U32 u32OutWidth, HI_U32 u32OutHeight)
{
        ...
        || (TDE_MAX_RECT_HEIGHT < u32OutHeight))
    {
        if ((u32InWidth != u32OutWidth) || (u32InHeight != u32OutHeight))
        {
            ...
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Can not support resize");
            return HI_ERR_TDE_INVALID_PARA;
        }
    }
                                      ...
                                      TDE_HWNode_S *pstHWNode)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pClutSur, HI_ERR_TDE_UNSUPPORTED_OPERATION);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pOutSur, HI_ERR_TDE_UNSUPPORTED_OPERATION);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(penClutUsage, HI_ERR_TDE_UNSUPPORTED_OPERATION);
    ...
    if (((HI_U8 *) - 1 != pClutSur->pu8ClutPhyAddr) && (HI_NULL != pClutSur->pu8ClutPhyAddr))
    {
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE_COLORFMT_CATEGORY_YCbCr);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE_COLORFMT_CATEGORY_ARGB);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enFmtCate);
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "clut fmt not same");
        ...
        *penClutUsage = TdeOsiGetClutUsage(pClutSur->enColorFmt, pOutSur->enColorFmt);
        if (TDE_CLUT_CLUT_BYPASS > *penClutUsage)
        {
            ...
            if (clutPhyaddr % 4)
            {
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pClutSur->pu8ClutPhyAddr);
                return HI_ERR_TDE_NOT_ALIGNED;
            }
            ...
            {
                HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetClutOpt, FAILURE_TAG);
                return HI_ERR_TDE_UNSUPPORTED_OPERATION;
            }
        }
    }
...
STATIC HI_S32  TdeOsiCheckSingleSrc2Opt(TDE2_COLOR_FMT_E enSrc2Fmt, TDE2_COLOR_FMT_E enDstFmt,TDE2_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "It doesn't support colorkey in single source mode");
        return -1;
    }
    ...
    if (pstOpt->enAluCmd & TDE2_ALUCMD_ROP)
    {
        ...
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiIsSingleSrc2Rop, FAILURE_TAG);
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Only support single s2 rop");
            return -1;
        }
    }
#endif
    ...
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Alu mode error");
        return -1;
    }
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE_COLORFMT_TRANSFORM_BUTT);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enColorTransType);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unkown color transport type");
        return -1;
    }
                                       ...
                                       TDE2_COLOR_FMT_E enDstFmt, TDE2_OPT_S *pstOpt)
{
    ...
    if (bUnknownFmt)
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE_COLORFMT_CATEGORY_BYTE);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enSrc1Category);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enSrc2Category);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enDstCategory);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "unkown format");
        return -1;
    }
                                ...
                                TDE_SCANDIRECTION_S *pstDstDirection)
{
     ...
     **/
    if ((pstOpt->enClipMode != TDE2_CLIPMODE_NONE) && (HI_TRUE == pstOpt->bResize))
    {
        HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
        return 0;
    }
    ...
    if ((pSrc->u32Stride != pstDst->u32Stride)||(pSrc->enColorFmt>=TDE2_COLOR_FMT_JPG_YCbCr400MBP))
    {
        HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
        return 0;
    }
...
STATIC HI_S32 TdeOsiGetInterRect(TDE2_RECT_S *pDstRect, TDE2_RECT_S *pClipRect, TDE2_RECT_S *pInterRect)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pDstRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pClipRect, HI_FAILURE);
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Left);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Right);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Top);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bottom);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "TdeOsiGetInterRect failure");
        return -1;
    }
...
STATIC HI_VOID TdeOsiCalcSliceS1(TDE_SLICE_DATA_S *stSliceData)
{
    ...
    stSliceData->hor_loffset_cfg_fraction = (HI_U32)(stSliceData->hor_loffset) & 0xfffff;
...
STATIC HI_VOID TdeOsiCalcSliceSp(TDE_SLICE_DATA_S *stSliceData)
{
    ...
    stSliceData->hor_coffset_cfg_fraction = (HI_U32)(stSliceData->hor_coffset) & 0xfffff;
...
STATIC HI_S32 TdeOsiCalcSlice(TDE_HANDLE s32Handle, TDE_HWNode_S *pNode)
{
    ...
    for (n = 0; n < stSliceData.node_num; n++) //node_num
    {
        ...
        HI_VOID *pBuf = (HI_VOID *)TDE_MALLOC(sizeof(TDE_HWNode_S) + TDE_NODE_HEAD_BYTE + TDE_NODE_TAIL_BYTE);
        if (HI_NULL == pBuf)
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, sizeof(TDE_HWNode_S));
        ...
        if ((Ret = TdeOsiSetNodeFinish(s32Handle, pChildNode, 0, TDE_NODE_SUBM_ALONE)) < 0)
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetNodeFinish, Ret);
...
STATIC void TdeOsiGetDeflickerEnVUpdateInfo(UpdateConfig *reg, UpdateInfo *info, HI_S32 update_vstart, HI_S32 update_vstop)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(reg);
...
STATIC  HI_VOID TdeOsiGetVUpdateInfo(UpdateConfig *pstReg, UpdateInfo *pstInfo, int bScaler, int bDeflicker)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstReg);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstInfo);
                                  ...
                                  TDE2_RECT_S  *pstDstRect, TDE2_DEFLICKER_MODE_E enDeflickerMode, TDE2_FILTER_MODE_E enFilterMode)
{
    ...
    if (bForeGroundOperation)
    {
            ...
            && s_bRegionDeflicker)
        {
            if (bBackGroundOperation)
            {
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstBackGround);
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstBackGroundRect);
                return HI_ERR_TDE_UNSUPPORTED_OPERATION;
            }
            ...
            HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, bScale);
                                ...
                                TDE2_RECT_S  *pstDstRect, TDE2_FILLCOLOR_S *pstFillColor, TDE2_OPT_S *pstOpt)
{
    ...
    if (bContainNullPtr)
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDst);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstFillColor);
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSurface, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeInitNd, FAILURE_TAG);
        return HI_ERR_TDE_NO_MEM;
    }
    ...
    else
    {
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_ALUCMD_BUTT);
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_ALUCMD_NONE);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enAluCmd);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        }
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_OUTALPHA_FROM_BUTT);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_OUTALPHA_FROM_FOREGROUND);
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetClipPara, FAILURE_TAG);
    ...
    if (TDE_NORM_FILL_1OPT == enBaseMode)
    {
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiColorConvert, FAILURE_TAG);
            return HI_ERR_TDE_INVALID_PARA;
        }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetBaseOperate, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetNodeFinish, FAILURE_TAG);
        return s32Ret;
    }
...
STATIC HI_S32 TdeOsiSetForegroundColorKey(TDE_HWNode_S *pstHWNode , TDE2_SURFACE_S *pstSrc, TDE2_OPT_S *pstOpt , TDE_CLUT_USAGE_E enClutUsage)
{
    ...
    if (TDE2_COLORKEY_MODE_FOREGROUND != pstOpt->enColorKeyMode)
    {
        ...
        {
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unsupported solidraw colorkey in background mode");
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        }
        else
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE_COLORFMT_CATEGORY_BUTT);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiGetFmtCategory, enFmtCategory);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetColorKey, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
STATIC HI_S32 TdeOsiSetBlend(TDE_HWNode_S *pstHWNode , TDE2_ALUCMD_E enAluCmd , TDE2_BLEND_OPT_S stBlendOpt , TDE_DRV_ALU_MODE_E *enAluMode, HI_BOOL bCheckBlend)
{
    ...
    *enAluMode = TDE_ALU_BLEND;
    ...
    if (bCheckBlend)
    {
        if (BUnknownBlendCmd)
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_BLENDCMD_BUTT);
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_BLENDCMD_CONFIG);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_BLEND_BUTT);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, stBlendOpt.eBlendCmd);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, stBlendOpt.eSrc1BlendMode);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        }
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetBlend, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
STATIC HI_S32 TdeOsiSetColorize(TDE_HWNode_S *pstHWNode , TDE2_ALUCMD_E enAluCmd , HI_S32 u32Colorize)
{
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetColorize, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
                           ...
                           TDE2_ROP_CODE_E enRopCode_Alpha , TDE_DRV_ALU_MODE_E *enAluMode , HI_BOOL SingleSr2Rop)
{
    ...
    *enAluMode = TDE_ALU_ROP;
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_ROP_BUTT);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enRopCode_Color);
    ...
    if (SingleSr2Rop)
    {
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enRopCode_Alpha);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enRopCode_Color);
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "TdeHalNodeSetRop return HI_FALSE");
            TdeHalFreeNodeBuf(pstHWNode);
            return -1;
        }
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetRop, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
                                ...
                                TDE2_OPT_S *pstOpt)
{
    ...
    if (bContainNullPtr)
    {
        ...
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstFillColor);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstOpt);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstSrc);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstSrcRect);
        return HI_ERR_TDE_NULL_PTR;
    }
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetRop, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetBlend, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetColorize, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiGetScanInfo, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetClutOpt, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetForegroundColorKey, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (bSetFileNode)
    {
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetFilterNode, FAILURE_TAG);
            return s32Ret;
        }
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
...
STATIC HI_S32 TdeOsiPreCheckSurface(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_COLOR_FMT_BUTT);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstSurface->enColorFmt);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unkown color format");
        return -1;
    }
    ...
    if ( bRasterFmt )
    {
        ...
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiRasterFmtCheckAlign, FAILURE_TAG);
            return s32Ret;
        }
    }
    else
...
STATIC INLINE HI_S32 TdeOsiPreCheckSurfaceEX(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "The surface physical address is NULL:0 == pstSurface->u32PhyAddr");
        return -1;
    }
...
STATIC INLINE HI_S32 TdeOsiCheckSurfaceEX(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiPreCheckSurfaceEX, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE_MAX_RECT_WIDTH_EX);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE_MAX_RECT_HEIGHT_EX);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "invalid operation area");
        return -1;
    }
...
STATIC INLINE HI_S32 TdeOsiCheckSurface(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiPreCheckSurface, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (bInvalidOperationArea )
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE_MAX_RECT_WIDTH);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE_MAX_RECT_HEIGHT);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "invalid operation area");
        return -1;
                                                         ...
                                                         TDE2_OPT_S     *pstOpt)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstForeGround, TDE_OPERATION_BUTT);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstForeGroundRect, TDE_OPERATION_BUTT);
                                                         ...
                                                         TDE2_OPT_S     *pstOpt)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstBackGround, TDE_OPERATION_BUTT);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstBackGroundRect, TDE_OPERATION_BUTT);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstForeGroundRect, TDE_OPERATION_BUTT);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstOpt, TDE_OPERATION_BUTT);
    ...
    {/** SRC1 has not zme **/
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Height);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Height);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Width);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "BackGroundRect is not the same with DstRect");
        return TDE_OPERATION_BUTT;
    }
                                                      ...
                                                      TDE2_OPT_S     *pstOpt)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstBackGround);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGround);
        return TDE_OPERATION_BUTT;
    }
                                           ...
                                           TDE2_RECT_S *pstOperationArea)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstSur);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstRect);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstScanInfo);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstDrvSur);
                                ...
                                TDE_HWNode_S *pstHwNode)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstForeGround, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDst, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstOpt, HI_FAILURE);
    ...
    if ((TDE2_CLIPMODE_INSIDE == pstOpt->enClipMode) && (!pstOpt->bResize))
    {
        ...
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiGetInterRect, FAILURE_TAG);
            return HI_ERR_TDE_CLIP_AREA;
        }
    ...
    else if (TDE2_CLIPMODE_INSIDE == pstOpt->enClipMode)
    {
        ...
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetClipping, FAILURE_TAG);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
    }
    else if (TDE2_CLIPMODE_OUTSIDE == pstOpt->enClipMode)
    {
        ...
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiIsRect1InRect2, FAILURE_TAG);
            return HI_ERR_TDE_CLIP_AREA;
        }
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_CLIPMODE_BUTT);
                                  ...
                                  HI_U32 u32WorkBufNum, TDE_NODE_SUBM_TYPE_E enSubmType)
{
    ...
    if (!bValid)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, query_handle HI_FALSE, FAILURE_TAG);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, s32Handle);
...
HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    ...
    if (bBlock)
    {
        if (in_interrupt())
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, in_interrupt, FAILURE_TAG);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
                         ...
                         TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect)
{
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiBlit, FAILURE_TAG);
        return s32Ret;
    }
                                       ...
                                       TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_OPT_S *pstOpt)
{
    ...
    if (bContainNullPtr)
    {
        ...
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstOpt);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGround);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGroundRect);
        return HI_ERR_TDE_NULL_PTR;
    }

    if (TdeOsiCheckSingleSrc2Opt(pstForeGround->enColorFmt, pstDst->enColorFmt, pstOpt) < 0)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSrc2Opt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    if (pstOpt->bResize)
    {
        ...
        {
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckResizePara, FAILURE_TAG);
                            ...
                            TDE2_OPT_S *pstOpt, HI_BOOL bMMZForSrc, HI_BOOL bMMZForDst)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstForeGroundRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_FAILURE);

    s32Ret = TdeOsiCheckSingleSr2Para(pstForeGround, pstForeGroundRect, pstDst, pstDstRect, pstOpt);
    if (HI_SUCCESS != s32Ret)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSr2Para, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_OUTALPHA_FROM_BACKGROUND);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enOutAlphaFrom);
        TdeHalFreeNodeBuf(pstHWNode);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetColorConvert, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
STATIC HI_S32 TdeOsiSetColorKey(TDE2_SURFACE_S *pstForeGround , TDE2_SURFACE_S *pstBackGround , TDE_HWNode_S *pstHWNode , TDE2_COLORKEY_U unColorKeyValue, TDE2_COLORKEY_MODE_E enColorKeyMode,  TDE_CLUT_USAGE_E enClutUsage)
{
    ...
    switch (enColorKeyMode)
    {
        ...
        default:
            ...
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "invalid colorkey mode");
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
    }
                                  ...
                                  TDE2_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckDoubleSrcOpt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    if ( s32Ret )
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetColorKey, FAILURE_TAG);
        return s32Ret;
    }
#endif
    ...
    switch (enOptCategory)
    {
        ...
        case TDE_OPERATION_SINGLE_SRC2:
        {
            if (NULL == pstBackGround)
            {
                ...
                {
                    HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSingleSrc2Blit, FAILURE_TAG);
                    return s32Ret;
                }
            }
            else
        ...
        case TDE_OPERATION_DOUBLE_SRC:
        {
            ...
            {
                HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiDoubleSrcBlit, FAILURE_TAG);
                return s32Ret;
            }
#ifndef HI_BUILD_IN_BOOT
            break;
                                    ...
                                    TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pstMbOpt)
{
    ...
    if (bContainNullPtr)
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMB);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMbRect);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDst);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMbOpt);
        return HI_ERR_TDE_NULL_PTR;
    }
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSurfaceEX, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
                    ...
                    TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pstMbOpt)
{
    ...
    if (sRet != HI_SUCCESS)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckMbBlitPara, FAILURE_TAG);
        return sRet;
    }
    ...
    for (n = 0; n < j; n++)
    {
        ...
        for (m = 0; m < i; m++)
        {
            ...
            {
                HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetMbPara, FAILURE_TAG);
                return sRet;
            }
        ...
        TDE2_RECT_S  *pstDstRect)
{
        ...
        || (NULL == pstMask) || (NULL == pstMaskRect) || (NULL == pstDst) || (NULL == pstDstRect))
    {
        ...
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGround);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGroundRect);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMask);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMaskRect);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDst);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        return HI_ERR_TDE_NULL_PTR;
    }
        ...
        || (pstMaskRect->u32Height != pstDstRect->u32Height))
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Height);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstForeGroundRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstForeGroundRect->u32Height);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMaskRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMaskRect->u32Height);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Don't support scale");
        return HI_ERR_TDE_INVALID_PARA;
    }
                           ...
                           TDE2_ROP_CODE_E enRopCode_Color, TDE2_ROP_CODE_E enRopCode_Alpha)
{
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiBitmapMaskCheckPara, FAILURE_TAG);
        return ret;
    }

    if (!TdeOsiWhetherContainAlpha(pstForeGround->enColorFmt))
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiWhetherContainAlpha, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }

    if (TDE2_COLOR_FMT_A1 != pstMask->enColorFmt)
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_COLOR_FMT_A1);
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_XINT, stMidSurface.u32PhyAddr);
        return HI_ERR_TDE_NO_MEM;
    }
                             ...
                             TDE2_ALUCMD_E enBlendMode)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_COLOR_FMT_A1);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_COLOR_FMT_A8);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMask->enColorFmt);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Alum mode can only be blending in TdeOsiBitmapMaskBlend");
        return HI_ERR_TDE_INVALID_PARA;
    }
...
HI_S32 TdeOsiGetDeflickerLevel(TDE_DEFLICKER_LEVEL_E *pDeflickerLevel)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pDeflickerLevel);
        return HI_FAILURE;
    }
...
HI_S32 TdeOsiGetAlphaThresholdValue(HI_U8 *pu8ThresholdValue)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pu8ThresholdValue);
        return HI_FAILURE;
    }
...
HI_S32 TdeOsiGetAlphaThresholdState(HI_BOOL *pbEnAlphaThreshold)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_VOID, pbEnAlphaThreshold);
        return HI_FAILURE;
    }
                                      ...
                                      TDE2_COLOR_FMT_E enDstFmt, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (pstOpt != HI_NULL)
    {
        ...
        if (TDE2_COLORKEY_MODE_NONE != pstOpt->enColorKeyMode)
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_COLORKEY_MODE_NONE);
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_ALUCMD_NONE);
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enAluCmd);
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Alu mode error");
            return -1;
        }
        if (TDE_COLORFMT_TRANSFORM_CLUT_CLUT == enColorTransType)
        {
            if ((pstOpt->enAluCmd != TDE2_ALUCMD_NONE))
            {
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_ALUCMD_NONE);
                HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enAluCmd);
                HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "It doesn't ROP/Blend/Colorize");
                return -1;
            }
                                      ...
                                      TDE2_COLOR_FMT_E enDstFmt, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT,  TDE_COLORFMT_CATEGORY_BYTE);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enBackGroundCategory);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enForeGroundCategory);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, enDstCategory);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unknown color format");
        return -1;
    }
        ...
        TDE2_PATTERN_FILL_OPT_S      *pstOpt)
{
    ...
    else if (pstForeGround != NULL)
    {
        ...
        {
            HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT,  TDE2_COLOR_FMT_YCbCr422);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstForeGround->enColorFmt);
            return -1;
        }
        ...
        TDE2_PATTERN_FILL_OPT_S      *pstOpt)
{
    ...
    if ((pstBackGroundRect->u32Height != pstDstRect->u32Height)
        || (pstBackGroundRect->u32Width != pstDstRect->u32Width))
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Size of background rect and Dst rect should be the same in two src pattern fill");
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->s32Xpos);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->s32Ypos);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Height);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->s32Xpos);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->s32Ypos);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Width);
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Height);
        return TDE_PATTERN_OPERATION_BUTT;
    }
        ...
        TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutMiniErrValueMsg(HI_GFX_MSG_ERR_INT, TDE2_COLOR_FMT_YCbCr422);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDst->enColorFmt);
        return -1;
    }
        ...
        TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSrcPatternOpt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }

    if (TdeOsiCheckOverlap(pstSrc, pstSrcRect, pstDst, pstDstRect))
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckOverlap, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
                                  ...
                                  TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSrcPatternFillPara, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (pstOpt != HI_NULL)
    {
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetPatternClipPara, FAILURE_TAG);
            return HI_ERR_TDE_CLIP_AREA;
        }
    }
        ...
        TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (TdeOsiCheckDoubleSrcPatternOpt(pstBackGround->enColorFmt, pstForeGround->enColorFmt, pstDst->enColorFmt, pstOpt) < 0)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckDoubleSrcPatternOpt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
                                  ...
                                  TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_GFX_OutMiniErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckDoubleSrcPatternFillPara, FAILURE_TAG);
        return s32Ret;
    }
