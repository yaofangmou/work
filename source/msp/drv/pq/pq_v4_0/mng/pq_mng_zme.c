...
typedef  HI_VOID (*FN_Zme_VpssRegCfg)(HI_U32 u32LayerId, S_VPSS_REGS_TYPE *pstReg, ALG_VZME_RTL_PARA_S *pstZmeRtlPara, HI_BOOL  bFirEnable);
...
HI_S32 PQ_MNG_SetVpssZme(HI_PQ_VPSS_ZME_LAYER_E enLayerId, S_VPSS_REGS_TYPE *pstReg, HI_PQ_ZME_PARA_IN_S *pstZmePara, HI_BOOL  bFirEnable)
{
    ALG_VZME_RTL_PARA_S stZmeRtlParam;
