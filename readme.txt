...
4.  Customize bootargs
    ...
    4.3 For more detail, please refer to <Linux Development Environment User Guide>.
...
6.  Mounting a USB device
    6.1 Load the .ko files.
       insmod ehci-hcd.ko
       insmod ohci-hcd.ko
       If the NTFS is to be supported, load tntfs.ko.
       insmod tntfs.ko
...
9.  CAS: please refer to <XXX CA Development Guide> or <XXX Development Guide>, XXX indicates the CAS vendor name.
