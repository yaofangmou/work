...
typedef struct
{
...
#if 1
    volatile U_VPSS_SMMU_SCR        VPSS_SMMU_SCR                 ; /* 0xf000 */
    volatile unsigned int           reserved_28                     ; /* 0xf004 */
    volatile U_VPSS_SMMU_LP_CTRL         VPSS_SMMU_LP_CTRL             ; /* 0xf008 */
    volatile unsigned int           reserved_29                     ; /* 0xf00c */
    volatile U_VPSS_SMMU_INTMASK_S       VPSS_SMMU_INTMASK_S           ; /* 0xf010 */
    volatile U_VPSS_SMMU_INTRAW_S        VPSS_SMMU_INTRAW_S            ; /* 0xf014 */
    volatile U_VPSS_SMMU_INTSTAT_S       VPSS_SMMU_INTSTAT_S           ; /* 0xf018 */
    volatile U_VPSS_SMMU_INTCLR_S        VPSS_SMMU_INTCLR_S            ; /* 0xf01c */
    volatile U_VPSS_SMMU_INTMASK_NS      VPSS_SMMU_INTMASK_NS          ; /* 0xf020 */
    volatile U_VPSS_SMMU_INTRAW_NS       VPSS_SMMU_INTRAW_NS           ; /* 0xf024 */
    volatile U_VPSS_SMMU_INTSTAT_NS      VPSS_SMMU_INTSTAT_NS          ; /* 0xf028 */
    volatile U_VPSS_SMMU_INTCLR_NS       VPSS_SMMU_INTCLR_NS           ; /* 0xf02c */
    ...
    volatile U_VPSS_SMMU_FAULT_ID_PTW_S   VPSS_SMMU_FAULT_ID_PTW_S     ; /* 0xf314 */
    volatile unsigned int           reserved_34[2]                     ; /* 0xf318~0xf31c */
    volatile unsigned int           VPSS_SMMU_FAULT_ADDR_PTW_NS   ; /* 0xf320 */
    volatile U_VPSS_SMMU_FAULT_ID_PTW_NS   VPSS_SMMU_FAULT_ID_PTW_NS   ; /* 0xf324 */
    volatile U_VPSS_SMMU_FAULT_PTW_NUM   VPSS_SMMU_FAULT_PTW_NUM       ; /* 0xf328 */
    ...
    volatile U_VPSS_SMMU_FAULT_ID_WR_S   VPSS_SMMU_FAULT_ID_WR_S       ; /* 0xf338 */
    ...
    volatile U_VPSS_SMMU_FAULT_ID_WR_NS   VPSS_SMMU_FAULT_ID_WR_NS     ; /* 0xf348 */
    ...
    volatile U_VPSS_SMMU_FAULT_ID_RD_S   VPSS_SMMU_FAULT_ID_RD_S       ; /* 0xf358 */
    ...
    volatile U_VPSS_SMMU_FAULT_ID_RD_NS   VPSS_SMMU_FAULT_ID_RD_NS     ; /* 0xf368 */
    volatile U_VPSS_SMMU_FAULT_TBU_INFO   VPSS_SMMU_FAULT_TBU_INFO     ; /* 0xf36c */
    volatile U_VPSS_SMMU_FAULT_TBU_DBG   VPSS_SMMU_FAULT_TBU_DBG       ; /* 0xf370 */
    volatile U_VPSS_SMMU_PREF_BUFFER_EMPTY   VPSS_SMMU_PREF_BUFFER_EMPTY ; /* 0xf374 */
    volatile U_VPSS_SMMU_PTWQ_IDLE       VPSS_SMMU_PTWQ_IDLE           ; /* 0xf378 */
    volatile U_VPSS_SMMU_RESET_STATE     VPSS_SMMU_RESET_STATE         ; /* 0xf37c */
    volatile U_VPSS_SMMU_MASTER_DBG0     VPSS_SMMU_MASTER_DBG0         ; /* 0xf380 */
    volatile U_VPSS_SMMU_MASTER_DBG1     VPSS_SMMU_MASTER_DBG1         ; /* 0xf384 */
    volatile U_VPSS_SMMU_MASTER_DBG2     VPSS_SMMU_MASTER_DBG2         ; /* 0xf388 */
    volatile U_VPSS_SMMU_MASTER_DBG3     VPSS_SMMU_MASTER_DBG3         ; /* 0xf38c */
    volatile unsigned int           reserved_39[100]                     ; /* 0xf390~0xf51c */
    volatile U_VPSS_SMMU_MASTER_DBG4     VPSS_SMMU_MASTER_DBG4         ; /* 0xf520 */
    volatile U_VPSS_SMMU_MASTER_DBG5     VPSS_SMMU_MASTER_DBG5         ; /* 0xf524 */
    volatile U_VPSS_SMMU_MASTER_DBG6     VPSS_SMMU_MASTER_DBG6         ; /* 0xf528 */
    volatile U_VPSS_SMMU_MASTER_DBG7     VPSS_SMMU_MASTER_DBG7         ; /* 0xf52c */
    volatile U_VPSS_SMMU_MASTER_DBG8     VPSS_SMMU_MASTER_DBG8         ; /* 0xf530 */
#endif
