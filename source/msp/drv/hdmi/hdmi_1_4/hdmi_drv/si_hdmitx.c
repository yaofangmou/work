...
void SI_SetHdmiAudioMute(HI_U8 Enabled)
{
    HI_U8 RegVal = 0;
    HI_U32 u32Abs = 0;
    HI_U32 u32Hw  = 0;
    ...
    COM_INFO(" SI_SetHdmiAudioMute : %d \n ",Enabled);
    if( Enabled )
    {
        RegVal= ReadByteHDMITXP0(ACR_CTRL_ADDR);
        RegVal |= 0x1;
        WriteByteHDMITXP0(ACR_CTRL_ADDR,RegVal);
    }
    else
    {
        RegVal= ReadByteHDMITXP0(ACR_CTRL_ADDR);
        ...
        do
        {
            u32Hw = ReadByteHDMITXP1(0x0b);  // 0x7A:0x05
            u32Hw = (u32Hw<<8) | ReadByteHDMITXP1(0x0a);  // 0x7A:0x04
            u32Hw = (u32Hw<<8) | ReadByteHDMITXP1(0x09);  // 0x7A:0x03
            u32Sw = ReadByteHDMITXP1(0x08);  // 0x7A:0x05
            u32Sw = (u32Sw<<8) | ReadByteHDMITXP1(0x07);  // 0x7A:0x04
            u32Sw = (u32Sw<<8) | ReadByteHDMITXP1(0x06);  // 0x7A:0x03
