...
#else
static inline HI_S32 DMX_DRV_REC_AcquireRecDataIndex(HI_U32 DmxId, HI_U32 RecId, HI_MPI_DMX_REC_DATA_INDEX_S *pstRecDataIdx){return HI_ERR_DMX_NOT_SUPPORT;};
static inline HI_S32 DMX_DRV_REC_ReleaseRecDataIndex(HI_U32 DmxId, HI_U32 RecId, HI_MPI_DMX_REC_DATA_INDEX_S *pstRecDataIdx){return HI_ERR_DMX_NOT_SUPPORT;};
static inline HI_S32 DMX_DRV_REC_AcquireRecIndex(HI_U32 DmxId, HI_U32 RecId, HI_MPI_DMX_REC_INDEX_S *RecIndex, HI_U32 Timeout){return HI_ERR_DMX_NOT_SUPPORT;};
#endif
