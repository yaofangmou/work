...
typedef enum hiPQ_DBG_CMD
{
    ...
    PQ_CMD_READ_LCACM_430_LUT    = 151,
    PQ_CMD_WRITE_LCACM_430_LUT   = 152,

    PQ_CMD_READ_SNR_MOTION_430_LUT   = 153,
    PQ_CMD_WRITE_SNR_MOTION_430_LUT  = 154,
    PQ_CMD_READ_ZME_VID_SEL    = 166,
    PQ_CMD_WRITE_ZME_VID_SEL   = 167,
    PQ_CMD_READ_ZME_WBC_SEL    = 168,
    PQ_CMD_WRITE_ZME_WBC_SEL   = 169,
    PQ_CMD_BUTT,
} PQ_DBG_CMD_E;
