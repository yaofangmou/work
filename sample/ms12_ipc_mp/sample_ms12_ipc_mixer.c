...
HI_VOID TsTthread(HI_VOID* args)
{
    ...
    while (!g_bStopTsThread)
    {
        ...
        s32Ret = HI_UNF_DMX_GetTSBuffer(g_TsBuf, 188 * 50 * 4, &StreamBuf, 1000);
        ...
        Readlen = fread(StreamBuf.pu8Data, sizeof(HI_S8), 188 * 50 * 4, g_pTsFile);
        if (Readlen <= 0)
        {
...
static HI_S32 System_init(HI_VOID)
{
    ...
    s32Ret = HIADP_Disp_Init(HI_UNF_ENC_FMT_1080P_50);
    if (HI_SUCCESS != s32Ret)
    {
...
HI_S32 main(HI_S32 argc, HI_CHAR* argv[])
{
    ...
    HI_CHAR                     InputCmd[32];
    HI_U32                      u32TtsStreamId = TTS_INDEX;
    HI_U32                      u32SysStreamId = SYSTEM_INDEX;
    HI_U32                      u32UiStreamId = UIAUDIO_INDEX;
    ...
    if (HI_TRUE == bTts)
    {
        ...
        u32TtsStreamId = TTS_INDEX;
        pthread_create(&g_hPcmThread[TTS_INDEX], HI_NULL, (HI_VOID*)PcmThread, (HI_VOID*)(&u32TtsStreamId));
    }
    ...
    if (HI_TRUE == bSystem)
    {
        ...
        u32SysStreamId = SYSTEM_INDEX;
        pthread_create(&g_hPcmThread[SYSTEM_INDEX], HI_NULL, (HI_VOID*)PcmThread, (HI_VOID*)(&u32SysStreamId));
    }
    ...
    if (HI_TRUE == bUIAudio)
    {
        ...
        u32UiStreamId = UIAUDIO_INDEX;
        pthread_create(&g_hPcmThread[UIAUDIO_INDEX], HI_NULL, (HI_VOID*)PcmThread, (HI_VOID*)(&u32UiStreamId));
    }
