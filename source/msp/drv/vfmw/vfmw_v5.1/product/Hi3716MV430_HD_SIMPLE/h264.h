...
#define GET_ONE_NALU_SIZE (4 * 1024)   // SCD_BUFFER_TOP_BLANK_LEN
...
typedef struct
{
    ...
    UADDR   bytespos;           // stream VDM will used start bytes ph addr, word addr aligned
    SINT32  StreamID;
} H264_BITSTREAM_S;
...
typedef struct
{
    ...
    UINT32  qmatrix4x4[6][4];
    UINT32  qmatrix8x8[2][16];
...
typedef struct
{
    ...
    SINT32  picid_refidx0;
    SINT32  picid_nearpoc;
    UINT64  PTS;
} H264_SLICE_S;
...
typedef struct
{
    ...
    H264_NALU_S         NalArray[H264_MAX_SLICE_NUM + 1];
    BS                  BS;
    ...
    H264_SLCINFO_S      SlcInfo[H264_MAX_SLICE_NUM];
...
VOID   H264DEC_FlushRemainImg(H264_CTX_S *pH264Ctx);
