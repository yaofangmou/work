...
typedef enum  tagARIBCC_OrnValue_E
{
    ARIBCC_EDGETYPE_ORN_NOTHING = 0x10, //Different from cc 708, arib cc edge type starts from 0x10
    ARIBCC_EDGETYPE_ORN_HEMMING,
    ARIBCC_EDGETYPE_ORN_SHADOW,
    ARIBCC_EDGETYPE_ORN_HOLLOW
} ARIBCC_OrnValue_E;
