...
#define PERI_CRG_CI_RESET        0x10
#define PERI_CRG_CI_CLK          0x01
#define PVR_TSOUT0_BYPASS       (PVR_BASE_ADDR + 0x0FF0)
#define TSA_BOARD_TSI_PORT_ID   0x02  /* TSI1 */
#elif defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450)
#define CI_PHY_BASE_ADDR        (0xF9C60000L)
#define PERI_CTRL_BASE_ADDR     (0xF8A20000L)
#define PERI_CRG_BASE_ADDR      (0xF8A22000L)
#define PVR_BASE_ADDR           (0xF9C00000L)
#define PERI_CRG_CI_ADDR        (PERI_CRG_BASE_ADDR + 0x0424)
#define PERI_CRG_CI_RESET        0x02
#define PERI_CRG_CI_CLK          0x01
#define PVR_TSOUT0_BYPASS       (PVR_BASE_ADDR + 0x0FF0)
#define TSA_BOARD_TSI_PORT_ID   0x02  /* TSI0 */
...
{
    HI_U32* u32VirRegAddr = HI_NULL;
    u32VirRegAddr = ioremap_nocache(u32RegAddr, 0x1000);
    if (HI_NULL == u32VirRegAddr)
    {
        HI_ERR_CI("ioremap nocache for ci write vir reg address.\n");
        return HI_FAILURE;
    }
    (*(volatile HI_U32 *)(u32VirRegAddr)) = u32Value;
    iounmap(u32VirRegAddr);
    u32VirRegAddr = HI_NULL;
...
static HI_U32 HI_SYS_ReadRegister(HI_U32 u32RegAddr, HI_U32* pu32Value)
{
    ...
    if (HI_NULL == u32VirRegAddr)
    {
        HI_ERR_CI("ioremap nocache for ci read vir reg address.\n");
        return HI_FAILURE;
    }

    *pu32Value = (*(volatile HI_U32 *)(u32VirRegAddr));
    iounmap(u32VirRegAddr);
    u32VirRegAddr = HI_NULL;
...
HI_S32 HICI_Init(HI_UNF_CI_PORT_E enCIPort)
{
    ...
    || defined(CHIP_TYPE_hi3716mv430)
        ...
        u32Value |= PERI_CRG_CI_RESET | PERI_CRG_CI_CLK;
        ...
        msleep(50);
#endif
        s_u32CIRegBase = ioremap_nocache(CI_PHY_BASE_ADDR, 0x10000);
...
HI_S32 HICI_PCCD_TSByPass(HI_UNF_CI_PORT_E enCIPort, HI_UNF_CI_PCCD_E enCardId, HI_BOOL bByPass)
{
    ...
    || defined(CHIP_TYPE_hi3716mv430)
        ...
        if (bByPass)
        {
            u32Val |= TSA_BOARD_TSI_PORT_ID;  //TSI from TSOUT0
        }
        else
        {
            u32Val &= ~TSA_BOARD_TSI_PORT_ID; //TSI from CAM
        }
