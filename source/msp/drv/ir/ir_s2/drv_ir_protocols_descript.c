...
static struct ir_protocol ir_protocols[] =
{
	...
	/* dezhou */
	{
		...
		NULL,				/* match error handle */
		NULL,				/* parse error handle */
        120,                  /* key_hold_timeout_time, 0 means using the default value */
        0                   /* 0: enable; 1: disable*/
	},
	/* huizhou */
	{
    ...
    {
        {0},              /* list */
        XMP_1_16BIT,     /* protocol name */
        IR_PROT_XMP1,            /* protocol */
        INFR_UNIQUE | INFR_NO_REPEAT, /* flag */
        {               /* protocol attr */
            {230, 900, 70},      /* header phase */
            {0, 0, 0},      /* second header */
            0,          /* second header at */
            {230, 889, 70},     /* b0 phase */
            {230, 889, 70},     /* b1 phase */
            {230, 12000, 70},   /* burst phase */
            {230, 12000},         /* repeate phase */
            230,            /* time slice */
            16,         /* wanna bits */
            17          /* burst at */
        },
        xmp_match,     /* phase matcher */
        1,              /* private data */
        xmp_parse,     /* frame parser */
        NULL,    /* match error handle */
        NULL,    /* parse error handle */
        130,                                  /* key_hold_timeout_time, 0 means using the default value */
        0                                   /* 0: enable; 1: disable*/
    },
#endif
	/* DO NOT REMOVE THIS. */
