...
typedef struct hiSYS_IO_REGISTER_S
{
    HI_U32 u32BaseAddr;
    HI_U32 u32RegValue;
} HI_SYS_IO_REG_S;

typedef struct hiSYS_REG_ADDR_S
{
    HI_U32 startaddr;
    HI_U32 endaddr;
} HI_SYS_ADDR_RANGE_S;
...
HI_S32  HI_DRV_SYS_WriteRegister(HI_SYS_IO_REG_S *sAddr);
HI_S32  HI_DRV_SYS_ReadRegister(HI_SYS_IO_REG_S * sAddr);
