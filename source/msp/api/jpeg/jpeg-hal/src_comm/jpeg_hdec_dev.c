...
static HI_BOOL JPEG_HDEC_OpenDev(HI_ULONG HdecHandle)
{
     ...
     if (pJpegHandle->JpegDev < 0)
     {
         ...
         {
             HI_GFX_Print("[module-gfx-jpeg] : %s[%d] : open dev failure not support hard decode\n",   __FUNCTION__,__LINE__);
         }
         return HI_FALSE;
     }
     ...
     if (HI_SUCCESS != Ret)
     {
         if (7 == pJpegHandle->LogLevel)
         {
             HI_GFX_Print("[module-gfx-jpeg] : %s[%d] : get device failure not support hard decode\n",   __FUNCTION__,__LINE__);
         }
     ...
     if (MAP_FAILED == pJpegHandle->pJpegRegVirAddr)
     {
         if (7 == pJpegHandle->LogLevel)
         {
             HI_GFX_Print("[module-gfx-jpeg] : %s[%d] : mmap register failure not support hard decode\n",   __FUNCTION__,__LINE__);
         }
         JPEG_DEC_CloseDev(HdecHandle);
         return HI_FALSE;
     }
     ...
     if (pJpegHandle->CscDev < 0)
     {
         if (7 == pJpegHandle->LogLevel)
         {
             HI_GFX_Print("[module-gfx-jpeg] : %s[%d] : open cse dev failure not support hard decode\n",   __FUNCTION__,__LINE__);
         }
         JPEG_DEC_CloseDev(HdecHandle);
         return HI_FALSE;
     }
     ...
     if (pJpegHandle->MemDev < 0)
     {
         if (7 == pJpegHandle->LogLevel)
         {
             HI_GFX_Print("[module-gfx-jpeg] : %s[%d] : open mem dev failure not support hard decode\n",   __FUNCTION__,__LINE__);
         }
         JPEG_DEC_CloseDev(HdecHandle);
         return HI_FALSE;
     }
