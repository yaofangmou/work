...
config  HI_BOOT_LOG_SUPPORT
    ...
    help
        when enabled, messages in boot image can be printed on the screen by UART, if you want to adjust the log level of
        boot image please execute 'set loglevel number; saveenv' command in boot console, 'number' means the loglevel, 
        which ranges from 0 ~ 5 (FATAL/ERROR/WARNING/INFO/DEBUG/TRACE). For example, 'set loglevel 3; saveenv' will set the
        log level of boot image to INFO.
        when not enabled, all messages in boot image will not be printed
...
config HI_UNIFIED_BOOT_SUPPORT
    ...
    default y
    depends on HI3798CV200 || HI3798MV200 || HI3798MV200H || HI3798MV300 || HI3798MV300H || HI3798MV310 || HI3796MV200 || HI3716MV430 || HI3716MV450 || HI3716DV110H || ((HI3716MV410 || HI3716MV420) && ADVCA_NAGRA)
    help
...
config HI_TWOSTAGEBOOT_SUPPORT
    ...
    default n
    depends on (HI3716MV410 || HI3716MV420 || HI3796MV200 || HI3716MV450 || HI3716MV430) && (ADVCA_CONAX || ADVCA_NAGRA)
    help
...
config HI_BOOT_CMD
    ...
    string
      depends on HI_TWOSTAGEBOOT_SUPPORT && (!HI_ADVCA_VERIFY_ENABLE) && (HI3716MV410 || HI3716MV420)
    help
...
config HI_IDWORD_LOCK_SUPPORT
    ...
    depends on HI_BUILD_WITH_PRODUCT && ANDROID_PRODUCT && (HI3798MV200 || HI3798MV300 || HI3798MV310)
    default n
