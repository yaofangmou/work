...
typedef struct
{
    HI_U32                      u32ShootProtectLeft;
    HI_U32                      u32ShootProtectRight;
    HI_U32                      u32ShootProtectTop;
    HI_U32                      u32ShootProtectBottom;

    HI_U32                      u32AddLetterBoxLeft;
    HI_U32                      u32AddLetterBoxRight;
    HI_U32                      u32AddLetterBoxTop;
    HI_U32                      u32AddLetterBoxBottom;
} HI_DRV_AFD_OUT;

typedef struct
{
    HI_DRV_VIDEO_AFD_TYPE_E     eAFD;
    HI_DRV_AFD_SRC_CROP         stSrcCropInfo;
    HI_DRV_AFD_OUT              stOutInfo4_3; // Out 4:3
    HI_DRV_AFD_OUT              stOutInfo16_9;//  Out 16:9
} HI_DRV_AFD;
