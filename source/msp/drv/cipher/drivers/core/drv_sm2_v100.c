...
s32 drv_sm2_init(void)
{
...
#ifdef CRYPTO_OS_INT_SUPPORT
    {
        ...
        HI_LOG_DEBUG("sm2 register interrupt function\n");
...
#ifdef CRYPTO_OS_INT_SUPPORT
    HI_LOG_DEBUG("sm2 interrupt configure\n");
    sm2_set_interrupt();
#endif
