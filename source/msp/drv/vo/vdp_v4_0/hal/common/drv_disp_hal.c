...
static HI_VOID DISP_HdrChangeToSdrProcess(HI_DRV_COLOR_SPACE_E enOutCs)
{
#ifdef CFG_HI3798CV200
    VDP_DRV_HdrRegClean();
    ...
    if ((HI_DRV_CS_BT601_RGB_FULL == enOutCs)
        || (HI_DRV_CS_BT601_RGB_LIMITED == enOutCs)
        || (HI_DRV_CS_BT709_RGB_FULL == enOutCs)
        || (HI_DRV_CS_BT709_RGB_LIMITED == enOutCs)
        || (HI_DRV_CS_BT2020_RGB_FULL == enOutCs)
        || (HI_DRV_CS_BT2020_RGB_LIMITED == enOutCs))
    {
...
*/
HI_VOID PF_WorkModeChangeProcess(HI_BOOL bWorkModeChange, HI_BOOL bCurSdrWorkMode, HI_DRV_COLOR_SPACE_E enOutCs)
{
    ...
    if (bWorkModeChange)
    {
        ...
        if (bCurSdrWorkMode)
        {
            DISP_HdrChangeToSdrProcess(enOutCs);
        }
...
HI_S32 DISP_HAL_GetOperation(DISP_INTF_OPERATION_S **ppstFunction)
{
    if (s_DispIntfFlag < 0)
    {
