...
static COLOR_SPACE_S      sg_stCSCMode[HI_PQ_CSC_TYPE_BUTT] =
{
...
static HI_PQ_VDP_CSC_S   sg_stCscModeStat[HI_PQ_CSC_TYPE_BUTT] =
{
...
static HI_S32 PQ_MNG_SetCSCPictureParam(HI_PQ_CSC_TYPE_E enCscTpyeId, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    if (enCscTpyeId >= HI_PQ_CSC_TYPE_BUTT)
    {
...
{
    if (enCscTypeId >= HI_PQ_CSC_TYPE_BUTT)
    {
