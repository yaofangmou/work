...
int HDMI_HDCP1X_KEY_AKSV0_hdcp1x_key_aksvGet(HI_U8 *pu8KsvData)
{
    HI_U32 *pu32RegAddr = NULL;
    U_HDCP1X_KEY_AKSV0 o_hdcp1x_key_aksv0;
    U_HDCP1X_KEY_AKSV1 o_hdcp1x_key_aksv1;

    if (HI_NULL == pu8KsvData)
    {
    ...
    pu8KsvData[0] = o_hdcp1x_key_aksv0.bits.hdcp1x_key_aksv_byte0;
    pu8KsvData[1] = o_hdcp1x_key_aksv0.bits.hdcp1x_key_aksv_byte1;
    pu8KsvData[2] = o_hdcp1x_key_aksv0.bits.hdcp1x_key_aksv_byte2;
    pu8KsvData[3] = o_hdcp1x_key_aksv0.bits.hdcp1x_key_aksv_byte3;
    pu8KsvData[4] = o_hdcp1x_key_aksv1.bits.hdcp1x_key_aksv_byte4;
...
int HDMI_HDCP1X_ENG_BKSV_hdcp1x_key_bksvSet(HI_U8 *pu8KsvData)
{
    HI_U32 *pu32RegAddr = NULL;
    ...
    o_hdcp1x_eng_bksv0.bits.hdcp1x_key_bksv_byte0 = pu8KsvData[0];
    o_hdcp1x_eng_bksv0.bits.hdcp1x_key_bksv_byte1 = pu8KsvData[1];
    o_hdcp1x_eng_bksv0.bits.hdcp1x_key_bksv_byte2 = pu8KsvData[2];
    o_hdcp1x_eng_bksv0.bits.hdcp1x_key_bksv_byte3 = pu8KsvData[3];
    ...
    o_hdcp1x_eng_bksv1.bits.hdcp1x_key_bksv_byte4 = pu8KsvData[4];
...
int HDMI_HDCP1X_CHK_ERR_hdcp1x_err_cntGet(HI_U32 *pu32RiChkErr)
{
    HI_U32 *pu32RegAddr = NULL;

    if (HI_NULL == pu32RiChkErr)
    {
        HDMI_ERR("null pointer!\n");
        return HI_FAILURE;
    }
    ...
    *pu32RiChkErr = HDMI_RegRead(pu32RegAddr);
