...
HI_U32 HI_SYS_ReadRegister(HI_U32 u32RegAddr)
{
    regAddr.val32 = u32RegAddr;
    read_regVal();

    return regData.val32;
}

void HI_SYS_WriteRegister(HI_U32 u32Value, HI_U32 u32RegAddr)
{
    regAddr.val32 = u32RegAddr;
    regData.val32 = u32Value;
    write_regVal();
