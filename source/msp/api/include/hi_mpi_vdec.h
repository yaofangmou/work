...
typedef struct hiVDEC_RECVFRM_WITH_TIMEOUT_S
{
    HI_U32 TimeOut;
    HI_DRV_VIDEO_FRAME_S *pVidFrm;
} VDEC_RECVFRM_WITH_TIMEOUT_S;
...
#if defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450)  || defined(CHIP_TYPE_hi3798mv310) || defined(CHIP_TYPE_hi3716mv430)
