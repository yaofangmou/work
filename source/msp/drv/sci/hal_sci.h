...
#define SCI_LDO_OFFSET        (0x98)
#define SCI_LDO_IRQ_OFFSET    (0xA8)
#endif
...
#if (defined(CHIP_TYPE_hi3716mv430) && defined(HI_SCI_VCC_AUTO_MATCH_SUPPORT))
    SCI_LDO_INT_OCP   = 0x8000,
    SCI_LEO_INT_SCP   = 0x10000
#endif
}SCI_INT_E;
...
#elif (defined(CHIP_TYPE_hi3716mv430) && defined(HI_SCI_VCC_AUTO_MATCH_SUPPORT))
#define SCI_DFT_INT     ((SCI_INT_CARDIN)|(SCI_INT_CARDOUT)\
                        |(SCI_INT_CARDUP)|(SCI_INT_CARDDOWN)\
                        |(SCI_INT_RXTIDE)|(SCI_INT_ATRSTOUT)\
                        |(SCI_INT_ATRDTOUT)|(SCI_INT_RORI)\
                        |(SCI_INT_BLKTOUT)|(SCI_INT_CHTOUT)\
                        |(SCI_LDO_INT_OCP)|(SCI_LEO_INT_SCP))
#else
#define SCI_DFT_INT     ((SCI_INT_CARDIN)|(SCI_INT_CARDOUT)\
                        |(SCI_INT_CARDUP)|(SCI_INT_CARDDOWN)\
                        |(SCI_INT_RXTIDE)|(SCI_INT_ATRSTOUT)\
...
#if (defined(CHIP_TYPE_hi3716mv430) && defined(HI_SCI_VCC_AUTO_MATCH_SUPPORT))
HI_VOID SCI_HAL_LDO_Init(HI_UNF_SCI_PORT_E enSciPort, SCI_LDO_REG *g_PSciLdoReg);
HI_VOID SCI_HAL_LDO_IRQ_Init(HI_UNF_SCI_PORT_E enSciPort, SCI_LDO_IRQ_REG *g_PSciLdoIrqReg);
