...
static HI_S32 u32PQIoctl_S_SD_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    HI_PQ_DISPLAY_E enPqDisplay = HI_PQ_DISPLAY_0;
...
static HI_S32 u32PQIoctl_S_HD_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    HI_PQ_DISPLAY_E enPqDisplay = HI_PQ_DISPLAY_1;
...
static HI_S32 u32PQIoctl_S_VP_PREVIEW_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPBrightness(HI_DRV_PQ_VP_TYPE_PREVIEW, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_PREVIEW_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPBrightness(HI_DRV_PQ_VP_TYPE_PREVIEW, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_PREVIEW_CONTRAST(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPContrast(HI_DRV_PQ_VP_TYPE_PREVIEW, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_PREVIEW_CONTRAST(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPContrast(HI_DRV_PQ_VP_TYPE_PREVIEW, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_PREVIEW_HUE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPHue(HI_DRV_PQ_VP_TYPE_PREVIEW, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_PREVIEW_HUE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPHue(HI_DRV_PQ_VP_TYPE_PREVIEW, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_PREVIEW_SATURATION(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPSaturation(HI_DRV_PQ_VP_TYPE_PREVIEW, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_PREVIEW_SATURATION(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPSaturation(HI_DRV_PQ_VP_TYPE_PREVIEW, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_REMOTE_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPBrightness(HI_DRV_PQ_VP_TYPE_REMOTE, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_REMOTE_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPBrightness(HI_DRV_PQ_VP_TYPE_REMOTE, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_REMOTE_CONTRAST(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPContrast(HI_DRV_PQ_VP_TYPE_REMOTE, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_REMOTE_CONTRAST(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPContrast(HI_DRV_PQ_VP_TYPE_REMOTE, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_REMOTE_HUE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPHue(HI_DRV_PQ_VP_TYPE_REMOTE, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_REMOTE_HUE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPHue(HI_DRV_PQ_VP_TYPE_REMOTE, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_REMOTE_SATURATION(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    u32Level = *(HI_U32 *)arg;
    s32Ret = DRV_PQ_SetVPSaturation(HI_DRV_PQ_VP_TYPE_REMOTE, u32Level);
...
static HI_S32 u32PQIoctl_G_VP_REMOTE_SATURATION(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    pu32Level = (HI_U32 *)arg;
    s32Ret = DRV_PQ_GetVPSaturation(HI_DRV_PQ_VP_TYPE_REMOTE, pu32Level);
...
static HI_S32 u32PQIoctl_S_VP_PREVIEW_VIDEO_PARAM(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    s32Ret = DRV_PQ_SetVPVideoSetting(HI_DRV_PQ_VP_TYPE_REMOTE, pstAttr);
...
static HI_S32 u32PQIoctl_G_VP_PREVIEW_VIDEO_PARAM(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    s32Ret = DRV_PQ_GetVPVideoSetting(HI_DRV_PQ_VP_TYPE_REMOTE, pstAttr);
...
static HI_S32 u32PQIoctl_S_SD_TEMPERATURE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    s32Ret = DRV_PQ_SetTemperature(HI_PQ_DISPLAY_0, pstAttr);
...
static HI_S32 u32PQIoctl_G_SD_TEMPERATURE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    s32Ret = DRV_PQ_GetTemperature(HI_PQ_DISPLAY_0, pstAttr);
...
static HI_S32 u32PQIoctl_S_HD_TEMPERATURE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    s32Ret = DRV_PQ_SetTemperature(HI_PQ_DISPLAY_1, pstAttr);
...
static HI_S32 u32PQIoctl_G_HD_TEMPERATURE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    ...
    s32Ret = DRV_PQ_GetTemperature(HI_PQ_DISPLAY_1, pstAttr);
