...
typedef Vp9_Prob Vp9_CoeffProbsModel[VP9_REF_TYPES][VP9_COEF_BANDS + 2][VP9_PREV_COEF_CONTEXTS + 2][UNCONSTRAINED_NODES + 1];
...
#define NUM_YV12_BUFFERS                        (VP9_NUM_REF_FRAMES+1)
...
typedef struct
{
    ...
    VP9_REFRESH_STATE_E  RefreshState;
    SINT32 NeedFrmNum;
    SINT32 MaxRefNum;
    SINT32 CurRefNum;
...
SINT32 VP9DEC_DecodeFrame(VP9_CTX_S *pCtx,  UINT8 *data_s);
...
VOID   Vp9_PrepareReadModeInfo(VP9_FRAME_CONTEXT_S *fc, VP9_BSSED_S *r, SINT32 frame_type, SINT32 intra_only, SINT32 mcomp_filter_type, SINT32 allow_comp_inter_inter, SINT32 allow_high_precision_mv, SINT32 *out_comp_pred_mode);
...
VOID   Vp9_ReadCompPred(VP9_FRAME_CONTEXT_S *fc, VP9_BSSED_S *r, SINT32 allow_comp_inter_inter, SINT32 *out_comp_pred_mode);
VOID   Vp9_ReadMvProbs(VP9_BSSED_S *r, VP9_NMV_CONTEXT_S *mvc, SINT32 allow_hp);
VOID   Vp9_ReadMvProbs(VP9_BSSED_S *r, VP9_NMV_CONTEXT_S *mvc, SINT32 allow_hp);
VOID   Vp9_AdaptCoefProbs(VP9_FRAME_CONTEXT_S *fc, VP9_FRAME_CONTEXT_S *pre_fc, VP9_FRAME_COUNTS_S *counts, TX_SIZE tx_size, UINT32 count_sat, UINT32 update_factor);
VOID   Vp9_AdaptResidualProbs(VP9_FRAME_CONTEXT_S *frame_contexts, VP9_FRAME_CONTEXT_S *fc, VP9_FRAME_COUNTS_S *counts, SINT32 frame_context_idx, VP9_FRAME_TYPE frame_type, SINT32 intra_only, VP9_FRAME_TYPE last_frame_type);
UINT32 Vp9_AdaptProbs(UINT32 i, const Vp9_Tree tree, Vp9_Prob this_probs[], Vp9_Prob last_probs[], UINT32 num_events[]);
VOID   Vp9_AdaptModeProbs(VP9_FRAME_CONTEXT_S *fc, VP9_FRAME_CONTEXT_S *pre_fc, VP9_FRAME_COUNTS_S *counts, SINT32 mcomp_filter_type, SINT32 tx_mode);
VOID   Vp9_AdaptMvProbs(VP9_FRAME_CONTEXT_S *fc, VP9_FRAME_CONTEXT_S *pre_fc, VP9_FRAME_COUNTS_S *counts, SINT32 allow_hp);
