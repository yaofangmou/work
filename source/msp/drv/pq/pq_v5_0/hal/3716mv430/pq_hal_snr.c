...
{
    S_VPSS_REGS_TYPE *pstVirReg = HI_NULL;
    ...
    /* ccs_2d follow snr */
    pstVirReg->VPSS_DBM_CTRL.bits.ccs_2d_en = bSNROnOff;
    /* cls_2d follow snr , do not support */
    pstVirReg->VPSS_TNR_CTRL.bits.cls_2d_en = bSNROnOff;
...
HI_S32 PQ_HAL_SetSNRMotionEdgeLut (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_SNR_MOTIONEDGE_LUT_S *pstToolSnrMotionLut, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo)
{
    ...
    pq_mng_ConvertSNRMotionEdgeLut((HI_U8 *)pstToolSnrMotionLut, au32MotionEdgeLUT);

    pstVpssAlgRegOut = (S_VPSSIP_ALG_SET_REGS_TYPE *)(pstVpssRegInfo->pstVpssAlgRegOut);

    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_01.u32 = au32MotionEdgeLUT[0];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_02.u32 = au32MotionEdgeLUT[1];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_03.u32 = au32MotionEdgeLUT[2];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_04.u32 = au32MotionEdgeLUT[3];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_05.u32 = au32MotionEdgeLUT[4];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_06.u32 = au32MotionEdgeLUT[5];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_07.u32 = au32MotionEdgeLUT[6];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_08.u32 = au32MotionEdgeLUT[7];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_09.u32 = au32MotionEdgeLUT[8];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_10.u32 = au32MotionEdgeLUT[9];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_11.u32 = au32MotionEdgeLUT[10];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_12.u32 = au32MotionEdgeLUT[11];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_13.u32 = au32MotionEdgeLUT[12];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_14.u32 = au32MotionEdgeLUT[13];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_15.u32 = au32MotionEdgeLUT[14];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_16.u32 = au32MotionEdgeLUT[15];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_17.u32 = au32MotionEdgeLUT[16];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_18.u32 = au32MotionEdgeLUT[17];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_19.u32 = au32MotionEdgeLUT[18];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_20.u32 = au32MotionEdgeLUT[19];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_21.u32 = au32MotionEdgeLUT[20];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_22.u32 = au32MotionEdgeLUT[21];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_23.u32 = au32MotionEdgeLUT[22];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_24.u32 = au32MotionEdgeLUT[23];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_25.u32 = au32MotionEdgeLUT[24];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_26.u32 = au32MotionEdgeLUT[25];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_27.u32 = au32MotionEdgeLUT[26];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_28.u32 = au32MotionEdgeLUT[27];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_29.u32 = au32MotionEdgeLUT[28];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_30.u32 = au32MotionEdgeLUT[29];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_31.u32 = au32MotionEdgeLUT[30];
    pstVpssAlgRegOut->VPSS_MOTION_EDGE_LUT_32.u32 = au32MotionEdgeLUT[31];
...
HI_S32 PQ_HAL_ResetSnrStatus(HI_U32 u32HandleNo, ALG_SNR_S *pstPQSNRInfo, S_VPSSIP_ALG_SET_REGS_TYPE *pstVpssAlgRegOut)
{
    PQ_CHECK_NULL_PTR_RE_FAIL(pstPQSNRInfo);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstVpssAlgRegOut);

    /* en ctrl */
    pstVpssAlgRegOut->VPSS_SNR_ENABLE.bits.ynr2den = pstPQSNRInfo->bEnable;
    pstVpssAlgRegOut->VPSS_SNR_ENABLE.bits.cnr2den = pstPQSNRInfo->bEnable;
    /* ccs_2d follow snr */
    pstVpssAlgRegOut->VPSS_DBM_CTRL.bits.ccs_2d_en = pstPQSNRInfo->bEnable;
    /* cls_2d follow snr , do not support */
    pstVpssAlgRegOut->VPSS_TNR_CTRL.bits.cls_2d_en = pstPQSNRInfo->bEnable;

    /* demo ctrl */

    /* strength ctrl */
    pstVpssAlgRegOut->VPSS_SNR_STR.bits.ysnrstr = (pstPQSNRInfo->u32Strength * sg_u32YSnrStr * 2) / 100;
    pstVpssAlgRegOut->VPSS_SNR_STR.bits.csnrstr = (pstPQSNRInfo->u32Strength * sg_u32CSnrStr * 2) / 100;
