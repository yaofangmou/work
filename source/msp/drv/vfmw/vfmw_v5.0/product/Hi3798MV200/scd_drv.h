...
#else
#define SCD_MSG_BUFFER  (200*1024)  // 低延迟所需部分空间在这里一起分配
#endif
...
#define SM_MAX_DSP_MSG_SIZE     (0x1180 * 4 + 128)
...
VOID   SCDDRV_CfgDspMem(UADDR MemPhy, SINT32 MemSize);
