...
#define REAL9_PMV_ONECOLMB_ADDR_LEN                   (20*4)
#define REAL9_MSG_SLOT_BURST_LEN                      (64*4)
...
typedef struct
{
    ...
    RV9_VOBUFINF VOBufInf[MAX_QUEUE_IMAGE_NUM];
...
VOID   REAL9DEC_FlushRemainImg(RV9_CTX_S *pCtx);
