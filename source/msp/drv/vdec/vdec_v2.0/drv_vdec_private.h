...
typedef struct tagVDEC_RECORD_TIME_S
{
    HI_U32 u32AllocTime[VDEC_MAX_BUFFER_RECORD];
    HI_U32 u32AllocStartSysTime[VDEC_MAX_BUFFER_RECORD];
    HI_U32 u32AllocEndSysTime[VDEC_MAX_BUFFER_RECORD];
    HI_U32 u32FreeStartTime[VDEC_MAX_BUFFER_RECORD];
    HI_U32 u32FreeEndTime[VDEC_MAX_BUFFER_RECORD];
    HI_U32 u32RecordNum;
    HI_U32 u32FreeNum;
    HI_U32 u32ReportTime;
    HI_U32 u32ConfigTime;
    RECORE_STATE_S RecState;

    HI_U32 u32ResizeStart;
    HI_U32 u32RecvTime[VDEC_MAX_BUFFER_RECORD];
    HI_U32 u32RecvNum;

    HI_U32 u32VpssLastRecvTime;
    HI_U32 u32VpssDelayTime;
    HI_U32 u32VpssFirstIRecvTime;
    HI_U32 u32VpssLastWidth;
    HI_U32 u32VpssLastHeight;
    HI_U32 u32VpssFirstIIndex;

    HI_U32 u32AvplayLastRecvTime;
    HI_U32 u32AvplayDelayTime;
    HI_U32 u32AvPlayFirstIRecvTime;
    HI_U32 u32AvplayLastWidth;
    HI_U32 u32AvplayLastHeight;
}VDEC_RECORD_TIME_S;

typedef struct tagVDEC_DFS_INFO_S
{
    HI_U32 u32RetryCnt;
    HI_U32 u32AllocFailed;
    HI_U32 u32WaitTime;
}VDEC_DFS_INFO_S;
...
typedef struct tagVDEC_CHANNEL_S
{
    ...
    VDEC_RECORD_TIME_S stRecordFrameTime;
    VDEC_DFS_INFO_S stDfsInfo;
} VDEC_CHANNEL_S;
