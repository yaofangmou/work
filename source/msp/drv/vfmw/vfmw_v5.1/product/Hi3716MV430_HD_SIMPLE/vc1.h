...
#define VC1_REG_SIZE        128
#define VC1_PICDNMSG_SIZE   96
#define VC1_SLCDNMSG_SIZE   64
...
#define VC1VFMW_MSG_BUF_SIZE            (((((VC1VFMW_DNMSG_NUM + VC1VFMW_UPMSG_NUM + VC1VFMW_RPMSG_NUM) * 4) + 1023) >> 10) << 10)

#define VC1VFMW_NEIGHBOR_BUF_SIZE       ((((VC1_MAX_PIC_WIDTH_IN_MB * 4) + 1023) >> 10) << 10)
...
typedef struct
{
    ...
    VC1_ADVSLCSYNTAX_S AdvSlcSyntax[256]; //1080p just need these. max is 512 for VC1 original protocol
} VC1_VFMWSYNTAX_S;
...
typedef struct
{
    ...
    SINT8 IsWaitToDec;
    SINT8 IsWaitToReRange;
    UINT8 IsStreamEndFlag;
    UINT8 Is2ndFld;
    UINT8 LastIs2ndFld;
    SINT8 LastPicRNDCTRL;
    UINT8 LastPicCodingType;
    UINT8 CodecVersion;
    UINT8 PostCresent;
    ...
    SINT32 FRFD;
    SINT32 BRFD; //10.4.6.2 & 10.4.6.3 for B mv predict
    UINT32 PPicFound;
    UINT32 BPicCount;
...
VOID   VC1DEC_FlushRemainImg(VC1_CTX_S *pCtx);
