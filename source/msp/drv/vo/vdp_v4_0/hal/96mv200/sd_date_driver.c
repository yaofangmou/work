...
HI_VOID VDP_SDATE_ResetFmt(HI_DRV_DISP_FMT_E enFmt)
{
    ...
    U_DATE_COEFF0 DATE_COEFF0;
    U_DATE_COEFF0 TmpDATE_COEFF0;
    U_DATE_COEFF21 DATE_COEFF21;
    TmpDATE_COEFF0.u32 = VDP_RegRead((HI_ULONG) & (pVdpReg->DATE_COEFF0.u32));
    ...
    DATE_COEFF0.bits.tt_seq = TmpDATE_COEFF0.bits.tt_seq;
    DATE_COEFF0.bits.sync_mode_scart = TmpDATE_COEFF0.bits.sync_mode_scart;
    DATE_COEFF0.bits.rgb_en = TmpDATE_COEFF0.bits.rgb_en;
    DATE_COEFF0.bits.sync_mode_sel = TmpDATE_COEFF0.bits.sync_mode_sel;
