...
/* VDEC VERSION */
#define VDEC_VERSION                (2018102200)
...
typedef struct tagVDEC_CHAN_STATINFO_S
{
    ...
    HI_U32 u32VpssReadImageTime;
    HI_U32 u32VpssReportTime;
...
typedef struct tagVDEC_SPIN_LOCK_S
{
    spinlock_t     irq_lock;
...
typedef struct tagVDEC_PORT_LIST_S
{
    ...
    VDEC_SPIN_LOCK_S stPortFrameListLock;
} VDEC_PORT_LIST_S;
