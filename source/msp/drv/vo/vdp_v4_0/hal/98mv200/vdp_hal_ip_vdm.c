...
HI_VOID VDP_VP0_SetCsc0Csc1Mode(HI_U32 u32Data, VDP_CSC_MODE_E enCscMode)
{
    ...
    if (enCscMode == VDP_CSC_RGB2YUV_601) //limit range
    {
        ...
        st_csc_dc_coef.csc_out_dc0 =  16 * s32DcPre;
        st_csc_dc_coef.csc_out_dc1 = 128 * s32DcPre;
        st_csc_dc_coef.csc_out_dc2 = 128 * s32DcPre;
    }
    else if (enCscMode == VDP_CSC_YUV2RGB_601) //limit range
    {
        ...
        st_csc_dc_coef.csc_in_dc0  = -16  * s32DcPre;
        st_csc_dc_coef.csc_in_dc1  = -128 * s32DcPre;
        st_csc_dc_coef.csc_in_dc2  = -128 * s32DcPre;
