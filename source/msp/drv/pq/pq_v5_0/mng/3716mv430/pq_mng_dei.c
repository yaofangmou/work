...
*****************************************************************************/
HI_S32 PQ_MNG_ALG_GetMcDeiParam(MOTION_INPUT_S *pstMotionInput, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo)
{
    ...
    /* alg out */
    PQ_HAL_SetSoftReg(pstMotionInput->u32HandleNo, sg_pstMcParm, sg_pstDeiVar);/*currently no use*/

    return HI_SUCCESS;
}

HI_S32 PQ_MNG_SetDeiParam(HI_PQ_WBC_INFO_S *pstVpssWbcInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo)
{
    ...
    stMotionInput.u32Stride       = pstVpssWbcInfo->u32Stride;

    PQ_MNG_ALG_GetMcDeiParam(&stMotionInput, pstVpssRegInfo);/*only get globalmotion from 5bin not update reg*/
