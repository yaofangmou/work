...
#define DEMUX_DUMP_PROC        //defined for control demux_dump_reg info, based on DMX_SET_1_BASE
...
#define DMX_REC_ALL_DATA_SUPPORT
...
#define DMX_PES_EXT_DATA_SUPPORT
#define DMX_MMAP_SUPPORT
#define DMX_LOWPOWER_SUPPORT
...
/*=================================CHIP_TYPE_hi3716mv430=========================*/
#elif defined(CHIP_TYPE_hi3716mv430)
#define DMX_CLUSTER_TOTAL_SET_CNT     1

#define DMX_SET_1                     1
#define DMX_SET_1_INT_NUM            (32 + 99)
#define DMX_SET_1_BASE               0xF9C00000
...
#define DMX_REC_CNT                  DMX_CNT
#else
#define DMX_REC_CNT                   1 /* saving the array memory and avoid malloc 0 size */
#endif
#define DMX_1WAY_REC_CNT              1
...
#define DMX_TEE_CMD_DISABLE
#define DMX_REDUNDANCE_CODE_DISABLE
//NonsecKey + SecKey
#ifdef HI_DMX_DESCRAMBLER_SUPPORT
#define DMX_KEY_CNT                  8
#else
#define DMX_KEY_CNT                  1 /* saving the array memory and avoid malloc 0 size */
#endif
...
#define DMX_SCD_RANGE_FILTER_CNT     24
#else
#define DMX_SCD_CNT                  1  /* saving the array memory and avoid malloc 0 size */
#define DMX_SCD_BYTE_FILTER_CNT      1  /* saving the array memory and avoid malloc 0 size */
#define DMX_SCD_RANGE_FILTER_CNT     1  /* saving the array memory and avoid malloc 0 size */
#endif
#define DMX_SCD_NEW_FLT_SUPPORT
...
#define DMX_RAM_PORT_LESS_DESC_DEPTH

#define DMX_SECTION_PARSE_NOPUSI_SUPPORT

#define DMX_FILTER_DEPTH_SUPPORT

/* 16mv430 didn't use Filtered pulse */
//#define DMX_SUPPORT_DMX_CLK_DYNAMIC_TUNE
