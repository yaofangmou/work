...
static const HI_U16 g_hdr102sdrtypc_ylutlim[TM_LUT_SIZE] = //12bit
{
...
static const HI_U16 g_hdr102sdrtypc_ylutfull[TM_LUT_SIZE] = //12bit
{
...
static const HI_U16 g_hdr102sdrtypc_satlutlimit[SatM_LUT_SIZE] =   // 10bit
{
...
static const HI_U16 g_hdr102sdrtypc_satlutfull[SatM_LUT_SIZE] =   // 10bit
{
...
static CBB_FRAME_S             g_stFrmCfg;
static CBB_FUNC_SMMU_S         g_stSMMUCfg;
static CBB_FUNC_CROP_S         g_stFuncCropCfg;
static CBB_FUNC_LBOX_S         g_stLBox;
static CBB_REG_ADDR_S          g_stRegAddr;
static CBB_REG_ADDR_S          g_stRegAddr_MMU;
static CBB_ALG_INFO_S          g_stSnrInfo;
static CBB_ALG_INFO_S          g_stMcTnrInfo;
static CBB_ALG_INFO_S          g_stAlgInfo;
static CBB_INFO_S              g_sttInfoCfg;
static CBB_ALG_INFO_S          g_stMcDeiAlgCfg;
static CBB_FUNC_4PIXEL_S       g_stFunc4PixelCfg;
static CBB_FUNC_TUNNELOUT_S    g_stFuncTunnelOutCfg;
static CBB_FUNC_TRANS_S        g_stTransInfo;
static CBB_FUNC_FLIP_S         g_stFlipInfo;
static CBB_FUNC_ZME_S          g_stFuncZmeCfg;
static CBB_FUNC_VPZME_S        g_stFuncVPZmeCfg;
static CBB_FUNC_TUNNELIN_S     g_stTunnelIn;
static CBB_INFO_S              g_stMadInfo_Tnr;
static CBB_INFO_S              g_stMadInfo_Snr;
static CBB_ALG_INFO_S          g_stDBInfo;
static CBB_ALG_INFO_S          g_stDBDETInfo;
static CBB_ALG_INFO_S          g_stNrInfo;
static CBB_ALG_INFO_S          g_stTnrInfo;
static CBB_ALG_INFO_S          g_stHdrInfo;
static CBB_FUNC_FDIFRO_S       g_stFuncFdIFdOCfg;
static CBB_INFO_BLKMV_S        g_stBlkmvCfg;
static CBB_INFO_RGMV_S         g_stRgmvCfg;
static CBB_INFO_PRJV_S         g_stPrjVCfg;
static CBB_INFO_PRJH_S         g_stPrjHCfg;
static CBB_INFO_BLKMT_S        g_stBlkmtCfg;
static CBB_INFO_DI_S           g_stDiCfg;
static CBB_ALG_INFO_S          g_stIfmdInfo;
static CBB_ALG_INFO_S          g_stDeiAlgCfg;
...
PF_NODE_CFG_FUNC pfSetNodeInfo[VPSS_HAL_NODE_BUTT] =
{
    ...
    VPSS_HAL_Set_2DField_Node,
    VPSS_HAL_Set_2DField_Node,
#ifdef VPSS_NEW_FIRST3FILED
    VPSS_HAL_Set_2DFrame_First1_Node,
    VPSS_HAL_Set_2DFrame_First1_Node,
    VPSS_HAL_Set_2DField_First23_Node,
    VPSS_HAL_Set_2DField_First23_Node,
#endif
...
#ifdef VPSS_NEW_FIRST3FILED
    NUM_2_STRING(2D_DEI_FRAME_1)                ,
    NUM_2_STRING(2D_DEI_FRAME_1_VIRTUAL)                ,
    NUM_2_STRING(2D_DEI_FIELD_23)       ,
    NUM_2_STRING(2D_DEI_FIELD_23_VIRTUAL),
#endif
...
HI_VOID VPSS_Hal_PrintHalInfo(struct seq_file *p, S_VPSS_REGS_TYPE *pstNodeReg)
{
    ...
    PROC_PRINT(p,
               ...
               VPSS_PROC_LEVEL5"next2  yaddr_lb:%08x ystride_lb:%u w*h:%u*%u offsetH:%u offsetV:%u "
               ...
               pstNodeReg->VPSS_CFY_2B_ADDR_LOW.u32,
               pstNodeReg->VPSS_CF_2B_STRIDE.bits.cfy_2b_stride,
                              ...
                              HI_BOOL bNeedRota)
{
    switch ( enTaskNodeId )
    {
        case VPSS_HAL_TASK_NODE_2D_FIELD:
            ...
            if (pstHalInfo->u32DetileFieldIdx == 0)
            {
                VPSS_HAL_ENABLE_NODE(VPSS_HAL_NODE_2D_DEI_FRAME_1);
                if (bNeedVirtualNode)
                {
                    VPSS_HAL_ENABLE_NODE(VPSS_HAL_NODE_2D_DEI_FRAME_1_VIRTUAL);
                }
            }
            else if ((pstHalInfo->u32DetileFieldIdx == 1) || (pstHalInfo->u32DetileFieldIdx == 2))
            {
                VPSS_HAL_ENABLE_NODE(VPSS_HAL_NODE_2D_DEI_FIELD_23);
                if (bNeedVirtualNode)
                {
                    VPSS_HAL_ENABLE_NODE(VPSS_HAL_NODE_2D_DEI_FIELD_23_VIRTUAL);
                }
            }
#else
                            ...
                            HI_BOOL abNodeVaild[VPSS_HAL_NODE_BUTT])
{
    ...
    HI_S32  s32NodeId;
    HI_BOOL abNodeList[VPSS_HAL_NODE_BUTT] = {0};
...
#ifdef VPSS_NEW_FIRST3FILED
                     || (VPSS_HAL_NODE_2D_DEI_FRAME_1  == s32NodeId)
                     || (VPSS_HAL_NODE_2D_DEI_FRAME_1_VIRTUAL == s32NodeId)
                     || (VPSS_HAL_NODE_2D_DEI_FIELD_23 == s32NodeId)
                     || (VPSS_HAL_NODE_2D_DEI_FIELD_23_VIRTUAL == s32NodeId)
#endif
                    )
...
#ifdef VPSS_NEW_FIRST3FILED
         || (enNodeType == VPSS_HAL_NODE_2D_DEI_FIELD_23)
         || (enNodeType == VPSS_HAL_NODE_2D_DEI_FIELD_23_VIRTUAL)
#endif
       )
    {
        return HI_TRUE;
...
HI_S32 VPSS_HAL_SetMcDeiCfg(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, CBB_REG_ADDR_S stRegAddr)
{
    ...
    VPSS_MEM_CLEAR(g_stMcDeiAlgCfg);
    VPSS_MEM_CLEAR(g_stFrmCfg);
    VPSS_MEM_CLEAR(g_stBlkmvCfg);
    VPSS_MEM_CLEAR(g_stRgmvCfg);
    VPSS_MEM_CLEAR(g_stPrjVCfg);
    VPSS_MEM_CLEAR(g_stPrjHCfg);
    VPSS_MEM_CLEAR(g_stBlkmtCfg);
    VPSS_MEM_CLEAR(g_stDiCfg);

    g_stMcDeiAlgCfg.bEnable   = HI_TRUE;

    bMedsEn = g_stMcDeiAlgCfg.bEnable;

    VPSS_AlgCfg_BaseFunc(stRegAddr, CBB_ALG_MCDEI, (HI_VOID *)&g_stMcDeiAlgCfg, &bMedsEn);
    ...
    g_stFrmCfg.bEn = HI_TRUE;
    g_stFrmCfg.u32Width = u32WthReal;
    g_stFrmCfg.u32Height = u32HgtReal;
    g_stFrmCfg.enPixelFmt = pstHalInfo->stInInfo.enFormat;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y  = pstBlendRef->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C  = pstBlendRef->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y   = pstBlendRef->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C   = pstBlendRef->u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
#else
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_FALSE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_FALSE;
#endif

    VPSS_CBB_FRAME_SetConfig(stRegAddr, CBB_FRAME_READ_REE, (HI_VOID *)&g_stFrmCfg, HI_NULL);

    g_stFrmCfg.bEn = HI_TRUE;//dieEn&mcdiEn
    g_stFrmCfg.u32Width = u32WthReal;
    g_stFrmCfg.u32Height = u32HgtReal;
    g_stFrmCfg.enPixelFmt = HI_DRV_PIX_FMT_NV21;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y  = pstBlendWbc->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C  = pstBlendWbc->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y   = pstBlendWbc->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C   = pstBlendWbc->u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
#else
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_FALSE;
#endif
    VPSS_CBB_FRAME_SetConfig(stRegAddr, CBB_FRAME_WRITE_CUE, (HI_VOID *)&g_stFrmCfg, HI_NULL);


    g_stDiCfg.bEn = HI_TRUE;//deiEn&mcdiEn
    g_stDiCfg.u32Width = (u32WthReal + 2) / 4; //pstHalInfo->stMcdeiStInfo.g_stDiCfg.u32Width;
    g_stDiCfg.u32Hight = u32HgtReal;//pstHalInfo->stMcdeiStInfo.g_stDiCfg.u32Height;
    g_stDiCfg.u32WriteAddr = pstHalInfo->stMcdeiStInfo.stDiCntCfg.u32WriteAddr;
    g_stDiCfg.u32ReadAddr = pstHalInfo->stMcdeiStInfo.stDiCntCfg.u32ReadAddr;
    g_stDiCfg.u32Stride = pstHalInfo->stMcdeiStInfo.stDiCntCfg.u32Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stDiCfg.bSmmu_w = HI_TRUE;
    g_stDiCfg.bSmmu_r = HI_TRUE;
#else
    g_stDiCfg.bSmmu_w = HI_FALSE;
    g_stDiCfg.bSmmu_r = HI_FALSE;
#endif
    //    VPSS_DBG_INFO("DI : CurR(%#x), Nx2W(%#x), Str(%#x).\n", g_stDiCfg.u32CurReadAddr, g_stDiCfg.u32Nx2WriteAddr, g_stDiCfg.u32Stride);
    VPSS_CBB_INFO_SetConfig(stRegAddr, CBB_INFO_DI, (HI_VOID *)&g_stDiCfg, HI_NULL);

    g_stBlkmvCfg.bEn = HI_TRUE;//deiEn&mcdiEn

    g_stBlkmvCfg.u32Wth = (u32WthReal + 7) / 8;
    g_stBlkmvCfg.u32Hgt = (u32HgtReal + 3) / 4;
    g_stBlkmvCfg.u32CurReadAddr   = pstHalInfo->stMcdeiStInfo.stBlkmvCfg.u32CurReadAddr;
    g_stBlkmvCfg.u32RefReadAddr   = pstHalInfo->stMcdeiStInfo.stBlkmvCfg.u32RefReadAddr;
    g_stBlkmvCfg.u32Nx1WriteAddr  = pstHalInfo->stMcdeiStInfo.stBlkmvCfg.u32Nx1WriteAddr;
    g_stBlkmvCfg.u32Stride        = pstHalInfo->stMcdeiStInfo.stBlkmvCfg.u32Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stBlkmvCfg.bSmmu_Cur = HI_TRUE;
    g_stBlkmvCfg.bSmmu_Ref = HI_TRUE;
    g_stBlkmvCfg.bSmmu_Nx1 = HI_TRUE;
#else
    g_stBlkmvCfg.bSmmu_Cur = HI_FALSE;
    g_stBlkmvCfg.bSmmu_Ref = HI_FALSE;
    g_stBlkmvCfg.bSmmu_Nx1 = HI_FALSE;
#endif
    VPSS_CBB_INFO_SetConfig(stRegAddr, CBB_INFO_BLKMV, (HI_VOID *)&g_stBlkmvCfg, HI_NULL);

    g_stBlkmtCfg.bEn = HI_TRUE;//deiEn&mcdiEn
    g_stBlkmtCfg.u32Wth = (u32WthReal + 7) / 8;
    g_stBlkmtCfg.u32Hgt = (u32HgtReal + 3) / 4;
    g_stBlkmtCfg.u32CurWriteAddr  = pstHalInfo->stMcdeiStInfo.stBlkmtCfg.u32CurWriteAddr;
    g_stBlkmtCfg.u32RefReadAddr   = pstHalInfo->stMcdeiStInfo.stBlkmtCfg.u32RefReadAddr;
    g_stBlkmtCfg.u32Stride        = pstHalInfo->stMcdeiStInfo.stBlkmtCfg.u32Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stBlkmtCfg.bSmmu_Cur = HI_TRUE;
    g_stBlkmtCfg.bSmmu_Ref = HI_TRUE;
#else
    g_stBlkmtCfg.bSmmu_Cur = HI_FALSE;
    g_stBlkmtCfg.bSmmu_Ref = HI_FALSE;
#endif
    VPSS_CBB_INFO_SetConfig(stRegAddr, CBB_INFO_BLKMT, (HI_VOID *)&g_stBlkmtCfg, HI_NULL);
...
HI_S32 VPSS_HAL_SetRgmvCfg(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, CBB_REG_ADDR_S stRegAddr)
{
    ...
    g_stRgmvCfg.bEn = HI_TRUE;//rmgvEn
    g_stRgmvCfg.u32Wth = u32RgmvNumH;
    g_stRgmvCfg.u32Hgt = u32RgmvNumV;
    g_stRgmvCfg.u32CurReadAddr    = pstHalInfo->stMcdeiStInfo.stRgmeCfg.u32CurReadAddr;
    g_stRgmvCfg.u32Nx1ReadAddr    = pstHalInfo->stMcdeiStInfo.stRgmeCfg.u32Nx1ReadAddr;
    g_stRgmvCfg.u32Nx2WriteAddr   = pstHalInfo->stMcdeiStInfo.stRgmeCfg.u32Nx2WriteAddr;
    g_stRgmvCfg.u32Stride         = pstHalInfo->stMcdeiStInfo.stRgmeCfg.u32Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stRgmvCfg.bSmmu_Cur = HI_TRUE;
    g_stRgmvCfg.bSmmu_Nx2 = HI_TRUE;
    g_stRgmvCfg.bSmmu_Nx1 = HI_TRUE;
#else
    g_stRgmvCfg.bSmmu_Cur = HI_FALSE;
    g_stRgmvCfg.bSmmu_Nx2 = HI_FALSE;
    g_stRgmvCfg.bSmmu_Nx1 = HI_FALSE;
#endif
    VPSS_DBG_INFO("INFO_RGMV : CurR(%#x), Nx1R(%#x), Nx2(%#x), Str(%#x).\n",
                  g_stRgmvCfg.u32CurReadAddr, g_stRgmvCfg.u32Nx1ReadAddr, g_stRgmvCfg.u32Nx2WriteAddr, g_stRgmvCfg.u32Stride);
    VPSS_CBB_INFO_SetConfig(stRegAddr, CBB_INFO_RGMV, (HI_VOID *)&g_stRgmvCfg, HI_NULL);


    g_stPrjVCfg.bEn = HI_TRUE;//rmgvEn
    g_stPrjVCfg.u32Wth = u32RgmvNumH * 16;
    g_stPrjVCfg.u32Hgt = u32RgmvNumV;
    g_stPrjVCfg.u32CurReadAddr    = pstHalInfo->stMcdeiStInfo.stPrjvCfg.u32CurReadAddr;
    g_stPrjVCfg.u32Nx2WriteAddr   = pstHalInfo->stMcdeiStInfo.stPrjvCfg.u32Nx2WriteAddr;
    g_stPrjVCfg.u32Stride         = pstHalInfo->stMcdeiStInfo.stPrjvCfg.u32Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stPrjVCfg.bSmmu_Cur = HI_TRUE;
    g_stPrjVCfg.bSmmu_Nx2 = HI_TRUE;
#else
    g_stPrjVCfg.bSmmu_Cur = HI_FALSE;
    g_stPrjVCfg.bSmmu_Nx2 = HI_FALSE;
#endif
    VPSS_DBG_INFO("PRJ_V : CurR(%#x), Nx2W(%#x), Str(%#x).\n",
                  g_stPrjVCfg.u32CurReadAddr, g_stPrjVCfg.u32Nx2WriteAddr,
                  g_stPrjVCfg.u32Stride);
    VPSS_CBB_INFO_SetConfig(stRegAddr, CBB_INFO_PRJ_V, (HI_VOID *)&g_stPrjVCfg, HI_NULL);



    g_stPrjHCfg.bEn = HI_TRUE;//rmgvEn
    g_stPrjHCfg.u32Wth = u32RgmvNumH * 128;
    g_stPrjHCfg.u32Hgt = u32RgmvNumV;
    g_stPrjHCfg.u32CurReadAddr    = pstHalInfo->stMcdeiStInfo.stPrjhCfg.u32CurReadAddr;
    g_stPrjHCfg.u32Nx2WriteAddr   = pstHalInfo->stMcdeiStInfo.stPrjhCfg.u32Nx2WriteAddr;
    g_stPrjHCfg.u32Stride         = pstHalInfo->stMcdeiStInfo.stPrjhCfg.u32Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stPrjHCfg.bSmmu_Cur = HI_TRUE;
    g_stPrjHCfg.bSmmu_Nx2 = HI_TRUE;
#else
    g_stPrjHCfg.bSmmu_Cur = HI_FALSE;
    g_stPrjHCfg.bSmmu_Nx2 = HI_FALSE;
#endif
    VPSS_DBG_INFO("PRJ_H : CurR(%#x), Nx2W(%#x), Str(%#x).\n",
                  g_stPrjHCfg.u32CurReadAddr, g_stPrjHCfg.u32Nx2WriteAddr, g_stPrjHCfg.u32Stride);
    VPSS_CBB_INFO_SetConfig(stRegAddr, CBB_INFO_PRJ_H, (HI_VOID *)&g_stPrjHCfg, HI_NULL);
...
{
    {
        ...
        */
        ...
        {
            LoadLut((HI_U32 *)&pstVpssReg->VPSS_LCHDR_TMAP_LUT0, g_hdr102sdrtypc_ylutfull, TM_LUT_SIZE);
            LoadLut((HI_U32 *)&pstVpssReg->VPSS_LCHDR_SMAP_LUT0, g_hdr102sdrtypc_satlutfull, SatM_LUT_SIZE);
        }
        else
        {
            LoadLut((HI_U32 *)&pstVpssReg->VPSS_LCHDR_TMAP_LUT0, g_hdr102sdrtypc_ylutlim, TM_LUT_SIZE);
            LoadLut((HI_U32 *)&pstVpssReg->VPSS_LCHDR_SMAP_LUT0, g_hdr102sdrtypc_satlutlimit, SatM_LUT_SIZE);
        }
...
HI_S32 VPSS_HAL_SetPortCfg(VPSS_IP_E enIP, CBB_REG_ADDR_S stRegAddr, VPSS_HAL_INFO_S *pstHalInfo)
{
    ...
    VPSS_MEM_CLEAR(g_stFrmCfg);
    VPSS_MEM_CLEAR(g_stFlipInfo);
    VPSS_MEM_CLEAR(g_stFuncCropCfg);
    VPSS_MEM_CLEAR(g_stFuncZmeCfg);
    VPSS_MEM_CLEAR(g_stLBox);
    VPSS_MEM_CLEAR(g_stFuncVPZmeCfg);
    VPSS_MEM_CLEAR(g_stFunc4PixelCfg);
    VPSS_MEM_CLEAR(g_stFuncTunnelOutCfg);
    VPSS_MEM_CLEAR(g_stTransInfo);
    ...
    if (HI_TRUE == pstHalInfo->bAndroidCts)
    {
        if ((pstHalInfo->stInInfo.u32Height & 0x2) != 0)
        {
            b4PixelClk = HI_FALSE;
        }
    }
    for (u32PortId = 0; u32PortId < DEF_HI_DRV_VPSS_PORT_MAX_NUMBER; u32PortId++)
    {
        ...
        if ((pstHalPort->bEnable)  && (pstHalPort->bConfig == HI_FALSE))
        {
            ...
            /*tunnel*/
            g_stFuncTunnelOutCfg.bEnable = HI_FALSE;
            if (HI_TRUE == pstHalPort->bOutLowDelay)
            {
                g_stFuncTunnelOutCfg.bEnable          = HI_TRUE;
                g_stFuncTunnelOutCfg.eMode            = CBB_TUNOUT_2;
                g_stFuncTunnelOutCfg.u32FinishLine    = pstOutFrm->u32Height * 30 / 100;
#ifdef HI_VPSS_SUPPORT_OUTTUNNEL_SMMU
                g_stFuncTunnelOutCfg.u32WriteAddr     = pstHalInfo->stLowDelayBuf_MMU.u32StartSmmuAddr;
#else
                g_stFuncTunnelOutCfg.u32WriteAddr     = pstHalInfo->stLowDelayBuf_MMZ.u32StartPhyAddr;
#endif
            }
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_TUNNEL_OUT, (HI_VOID *)&g_stFuncTunnelOutCfg, HI_NULL);
#endif

            if (pstHalInfo->enNodeType == VPSS_HAL_NODE_HDR_DETILE_NOALG)
            {
                //if EL carries no metadata, EL NODE donot need to trans metadata
                g_stTransInfo.bEnable    = (pstHalInfo->stInInfo.u32MetaSize == 0) ? HI_FALSE : HI_TRUE;
                g_stTransInfo.u32SrcAddr = pstInInfo->stAddr_META.u32PhyAddr_Y;
                g_stTransInfo.u32DstAddr = pstOutFrm->stAddr_META.u32PhyAddr_Y;
                g_stTransInfo.u32Size    = (pstInInfo->u32MetaSize / 256) + 1;
                g_stTransInfo.bSecure    = pstInInfo->bSecure;
#ifdef HI_VPSS_SMMU_SUPPORT
                g_stTransInfo.bSmmu      = HI_TRUE;
#else
                g_stTransInfo.bSmmu      = HI_FALSE;
#endif
                if (g_stTransInfo.bEnable)
                {
                    if (g_stTransInfo.u32SrcAddr == 0 || g_stTransInfo.u32DstAddr == 0 || g_stTransInfo.u32Size == 0)
                    {
                        VPSS_ERROR("metadata config error.u32SrcAddr %#x u32DstAddr %#x u32TranSize %d\n",
                                   g_stTransInfo.u32SrcAddr,
                                   g_stTransInfo.u32DstAddr,
                                   g_stTransInfo.u32Size);
                        return HI_FAILURE;
                    }
                }
                VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_TRANS, (HI_VOID *)&g_stTransInfo, HI_NULL);
            }


            /*Pre-ZME*/
            bVPZMEEnable = VPSS_HAL_NeedVPZMEEnable(pstHalInfo->enNodeType);
            g_stFuncVPZmeCfg.bEnable = bVPZMEEnable;
            if (HI_TRUE == bVPZMEEnable)
            {
                g_stFuncVPZmeCfg.eFirMode = PREZME_VFIELD;
                if (pstHalInfo->stInInfo.enFieldMode == HI_DRV_FIELD_TOP)
                {
                    g_stFuncVPZmeCfg.eFirMode = PREZME_2X;
                }
            }
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_VHD0_VPZME, (HI_VOID *)&g_stFuncVPZmeCfg, HI_NULL);

            //  VPSS_ERROR("node %d vpzme %d\n", pstHalInfo->enNodeType, bVPZMEEnable);

            /* Flip&Mirro */
            g_stFlipInfo.bFlipH = pstHalPort->bNeedMirror;
            g_stFlipInfo.bFlipV = pstHalPort->bNeedFlip;
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_VHD0_FLIP, (HI_VOID *)&g_stFlipInfo, HI_NULL);
            ...
            g_stFuncCropCfg.stInRect.s32X     = pstCropRect->s32X;
            g_stFuncCropCfg.stInRect.s32Y     = pstCropRect->s32Y;
            g_stFuncCropCfg.stInRect.s32Width = pstCropRect->s32Width;
            g_stFuncCropCfg.stInRect.s32Height = pstCropRect->s32Height;
            g_stFuncCropCfg.stCropCfg = g_stFuncCropCfg.stInRect;
            g_stFuncCropCfg.bEnable = bAlgEnable;

            if (HI_TRUE == bVPZMEEnable)
            {
                g_stFuncCropCfg.stInRect.s32Y         /= 2;
                g_stFuncCropCfg.stInRect.s32Height    /= 2;
                g_stFuncCropCfg.stCropCfg.s32Height   /= 2;
                VPSS_PIXLE_DOWNALIGN_H(g_stFuncCropCfg.stCropCfg.s32Height, HI_FALSE);//2pixel align when 4p/c is disable
            }
            ...
            */
            ...
            if ((0 == g_stFuncCropCfg.stCropCfg.s32X)
                && (0 == g_stFuncCropCfg.stCropCfg.s32Y)
                && (g_stFuncCropCfg.stCropCfg.s32Width == pstInInfo->u32Width)
                && (g_stFuncCropCfg.stCropCfg.s32Height == pstInInfo->u32Height)
               )
            {
                g_stFuncCropCfg.bEnable = HI_FALSE;
            }
#endif
            VPSS_DBG_INFO("CROP(%d) X Y W H %d %d %d %d En:%d\n",
                          g_stFuncCropCfg.bEnable,
                          pstCropRect->s32X,
                          pstCropRect->s32Y,
                          pstCropRect->s32Width,
                          pstCropRect->s32Height,
                          g_stFuncCropCfg.bEnable);
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_VHD0_CROP, (HI_VOID *)&g_stFuncCropCfg, HI_NULL);

            /*ZME*/
            g_stFuncZmeCfg.u32ParAddr = stRegAddr.u32NodePhyAddr + 0x2000;
            g_stFuncZmeCfg.bEnable    = bAlgEnable;
            g_stFuncZmeCfg.eMode      = CBB_ZME_MODE_ALL;

            pstZmeDrvPara  = &(g_stFuncZmeCfg.stZmeDrvPara);
            ...
            {
                g_stFuncZmeCfg.bEnable = HI_FALSE;
            }

#ifdef VPSS_SUPPORT_AUTOASP
            if ((g_stFuncCropCfg.stCropCfg.s32Height == pstZmeDrvPara->u32ZmeFrmHOut)
                && (g_stFuncCropCfg.stCropCfg.s32Width == pstZmeDrvPara->u32ZmeFrmWOut)
            ...
            {
                g_stFuncZmeCfg.bEnable    = HI_TRUE;
            }

            VPSS_DBG_INFO("zme(%d) in w h %d %d out w h %d %d ori w h %d %d\n",

                          g_stFuncZmeCfg.bEnable,
                          g_stFuncZmeCfg.stZmeDrvPara.u32ZmeFrmWIn,
                          g_stFuncZmeCfg.stZmeDrvPara.u32ZmeFrmHIn,
                          g_stFuncZmeCfg.stZmeDrvPara.u32ZmeFrmWOut,
                          g_stFuncZmeCfg.stZmeDrvPara.u32ZmeFrmHOut,
                          g_stFuncZmeCfg.stZmeDrvPara.stOriRect.s32Width,
                          g_stFuncZmeCfg.stZmeDrvPara.stOriRect.s32Height);

            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_VHD0_ZME, (HI_VOID *)&g_stFuncZmeCfg, HI_NULL);

            /* LBX */
            g_stLBox.eBGColor          = pstHalPort->eLetterBoxColor;
            g_stLBox.stLBoxRect.s32X   = pstHalPort->stVideoRect.s32X;
            g_stLBox.stLBoxRect.s32Y   = pstHalPort->stVideoRect.s32Y;

            if (pstHalPort->bNeedRota)
            {
                g_stLBox.stLBoxRect.s32Height = pstOutFrm->u32Width;
                g_stLBox.stLBoxRect.s32Width  = pstOutFrm->u32Height;
                g_stLBox.stOutRect.s32Width   = pstOutFrm->u32Height;
                g_stLBox.stOutRect.s32Height  = pstOutFrm->u32Width;
            }
            else
            {
                g_stLBox.stLBoxRect.s32Height = pstOutFrm->u32Height;
                g_stLBox.stLBoxRect.s32Width  = pstOutFrm->u32Width;
                g_stLBox.stOutRect.s32Width   = pstOutFrm->u32Width;
                g_stLBox.stOutRect.s32Height  = pstOutFrm->u32Height;
            }

            g_stLBox.bEnable              = bAlgEnable;
#ifdef VPSS_SUPPORT_AUTOASP
            if ((0 == pstHalPort->stVideoRect.s32X)
                && (0 == pstHalPort->stVideoRect.s32Y)
               )
            {
                g_stLBox.bEnable = HI_FALSE;
            }
#endif
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_VHD0_LBOX, (HI_VOID *)&g_stLBox, HI_NULL);

            g_stFunc4PixelCfg.bEnable = b4PixelClk; //enable 4p/c to trans lsb2bit data
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_SPEED_UP_4PIXEL, (HI_VOID *)&g_stFunc4PixelCfg, HI_NULL);

            if ((HI_FALSE == g_stFuncZmeCfg.bEnable)
                && (HI_FALSE == g_stLBox.bEnable))
            {
                if (HI_FALSE == g_stFuncCropCfg.bEnable)
                {
                    pstOutFrm->u32Width = pstHalInfo->stInInfo.u32Width;
                    pstOutFrm->u32Height = pstHalInfo->stInInfo.u32Height;
                }
                else
                {
                    //do not align up to 4pixel, equal to crop size
                    pstOutFrm->u32Width  = g_stFuncCropCfg.stCropCfg.s32Width;
                    pstOutFrm->u32Height = g_stFuncCropCfg.stCropCfg.s32Height;
                }
            }
            ...
            if (pstHalPort->bNeedRota)
            {
                g_stFrmCfg.u32Width   = pstOutFrm->u32Height;
                g_stFrmCfg.u32Height  = pstOutFrm->u32Width;
            ...
            {
                g_stFrmCfg.u32Width   = pstOutFrm->u32Width;
                g_stFrmCfg.u32Height  = pstOutFrm->u32Height;
            }
            g_stFrmCfg.enBitWidth = pstOutFrm->enBitWidth;
            g_stFrmCfg.enPixelFmt = pstOutFrm->enFormat;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstOutAddr->u32PhyAddr_Y;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstOutAddr->u32PhyAddr_C;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstOutAddr->u32Stride_Y;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstOutAddr->u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y   = HI_TRUE;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C   = HI_TRUE;
#endif
            ...
            VPSS_DBG_INFO(
                ...
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y,
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C,
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y,
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C,
                g_stFrmCfg.u32Width,
                g_stFrmCfg.u32Height,
                g_stFrmCfg.enBitWidth);

            if ((CBB_BITWIDTH_10BIT == g_stFrmCfg.enBitWidth)
                || (CBB_BITWIDTH_10BIT_CTS == g_stFrmCfg.enBitWidth))
            {
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_Y = pstOutFrm->stAddr_LB.u32PhyAddr_Y;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_C = pstOutFrm->stAddr_LB.u32PhyAddr_C;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_Y  = pstOutFrm->stAddr_LB.u32Stride_Y;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_C  = pstOutFrm->stAddr_LB.u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_Y   = HI_TRUE;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_C   = HI_TRUE;
#endif
            }
            VPSS_CBB_FRAME_SetConfig(stRegAddr, CBB_FRAME_WRITE_VHD0, (HI_VOID *)&g_stFrmCfg, HI_NULL);
                                ...
                                HI_BOOL bRotateY, HI_U32 u32PortId)
{
    ...
    //for (u32PortId = 0; u32PortId < DEF_HI_DRV_VPSS_PORT_MAX_NUMBER; u32PortId++)
    {
        ...
        if (pstHalPort->bEnable) // && pstHalPort->bConfig == HI_FALSE)
        {
            ...
            /* Flip&Mirro */
            g_stFlipInfo.bFlipH = HI_FALSE;
            g_stFlipInfo.bFlipV = HI_FALSE;
            VPSS_CBB_FUNC_SetConfig(stRegAddr, CBB_FUNC_VHD0_FLIP, (HI_VOID *)&g_stFlipInfo, HI_NULL);
            ...
            /* vhd0 frame infomation */
            g_stFrmCfg.bEn        = HI_TRUE;
            g_stFrmCfg.u32Width   = pstHalPort->stOutInfo.u32Width;
            g_stFrmCfg.u32Height  = pstHalPort->stOutInfo.u32Height;

            g_stFrmCfg.enBitWidth = pstHalPort->stOutInfo.enBitWidth;
            g_stFrmCfg.enPixelFmt = pstHalPort->stOutInfo.enFormat;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstHalPort->stOutInfo.stAddr.u32PhyAddr_Y;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstHalPort->stOutInfo.stAddr.u32PhyAddr_C;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstHalPort->stOutInfo.stAddr.u32Stride_Y;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstHalPort->stOutInfo.stAddr.u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y   = HI_TRUE;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C   = HI_TRUE;
#endif

            if (CBB_BITWIDTH_10BIT == g_stFrmCfg.enBitWidth)//judge by output bitwidth
            {
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_Y = pstHalPort->stOutInfo.stAddr_LB.u32PhyAddr_Y;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_C = pstHalPort->stOutInfo.stAddr_LB.u32PhyAddr_C;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_Y  = pstHalPort->stOutInfo.stAddr_LB.u32Stride_Y;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_C  = pstHalPort->stOutInfo.stAddr_LB.u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_Y   = HI_TRUE;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_C   = HI_TRUE;
#endif
...
HI_S32 VPSS_HAL_SetPortCfg_SD_First_dei(VPSS_IP_E enIP,  CBB_REG_ADDR_S stRegAddr, VPSS_HAL_INFO_S *pstHalInfo)
{
    ...
    for (u32PortId = 0; u32PortId < DEF_HI_DRV_VPSS_PORT_MAX_NUMBER; u32PortId++)
    {
        ...
        if (pstHalPort->bEnable && pstHalPort->bConfig == HI_FALSE)
        {
            ...
            g_stFrmCfg.bEn        = HI_TRUE;
            g_stFrmCfg.u32Width   = pstInInfo->u32Width ;
            g_stFrmCfg.u32Height  = pstInInfo->u32Height / 2;

            VPSS_PIXLE_UPALIGN_W(g_stFrmCfg.u32Width, HI_FALSE);
            VPSS_PIXLE_UPALIGN_H(g_stFrmCfg.u32Height, HI_FALSE);
            g_stFrmCfg.enBitWidth = pstHalInfo->stSDDeiFrame.enBitWidth;
            g_stFrmCfg.enPixelFmt = pstHalInfo->stSDDeiFrame.enFormat;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstOutAddr->u32PhyAddr_Y;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstOutAddr->u32PhyAddr_C;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstOutAddr->u32Stride_Y;
            g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstOutAddr->u32Stride_C;
            ...
            if (CBB_BITWIDTH_10BIT == g_stFrmCfg.enBitWidth)//judge by output bitwidth
            {
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_Y = pstOutAddr_LB->u32PhyAddr_Y;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_C = pstOutAddr_LB->u32PhyAddr_C;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_Y  = pstOutAddr_LB->u32Stride_Y;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_C  = pstOutAddr_LB->u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_Y   = HI_TRUE;
                g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_C   = HI_TRUE;
#endif
                              ...
                              VPSS_RWZB_INFO_S *pstRwzbInfo, HI_U32 u32YCMode, HI_BOOL bField)
{
    ...
    HI_U32 u32TileYStrd;
    HI_S32 s32Ret;
    HI_DRV_PIXEL_BITWIDTH_E enImgPixWidth = HI_DRV_PIXEL_BITWIDTH_8BIT; //only support 8bit bitwidth in lastest version
#endif
    ...
    for (ii = 0; ii < 6; ii++)
    {
        ...
        {
#ifdef VPSS_RWZB_FASTCHECK_MODE
            if ((0 == u32YCMode) && (pstRwzbInfo->bIsTile == HI_FALSE))
            {
                for (jj = 0; jj < 8; jj++)
                {
            ...
            else if ((0 == u32YCMode) && (pstRwzbInfo->bIsTile == HI_TRUE) &&
                     (pstRwzbInfo->bIsBufPrivManage == HI_FALSE))
            {
                for (jj = 0; jj < 8; jj++)
                {
                    pstRwzbInfo->u8Data[ii][jj] =
                     ...
                     (pstRwzbInfo->bIsBufPrivManage == HI_TRUE))
            {
                pu8TileY = pu8PixelBaseAddr_vir;
                if (HI_TRUE == bField)
                {
                    u32_blk_ypos = u32_blk_ypos * 2;
                }
                u32TileYStrd = pstRwzbInfo->u32Width;
                for (jj = 0; jj < 8; jj++)
                {
                    s32Ret = VPSS_OSAL_GetTileYvalue(enImgPixWidth, u32_blk_xpos + jj,
                                                     u32_blk_ypos, pu8TileY, u32TileYStrd,
                                                     NULL, 0, &(pstRwzbInfo->u8Data[ii][jj]));
                    if (s32Ret != HI_SUCCESS)
                    {
                        VPSS_ERROR("get rwzb Yvalue error! \n");
                    }
                }
            }
            else
...
#ifdef VPSS_RWZB_FASTCHECK_MODE
    pstHalInfo->stRwzbInfo.bIsTile = VPSS_IS_TILE_FMT(pstHalInfo->stInInfo.enFormat);
    pstHalInfo->stRwzbInfo.bIsBufPrivManage = pstHalInfo->bIsBufPrivManage;
#endif
...
HI_S32 VPSS_HAL_Set_2DFrame_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    HI_U32 u32PageAddr = 0;
    HI_U32 u32ErrReadAddr = 0;
    HI_U32 u32ErrWriteAddr = 0;

    VPSS_MEM_CLEAR(g_stRegAddr);
    VPSS_MEM_CLEAR(g_stRegAddr_MMU);
    VPSS_MEM_CLEAR(g_stFrmCfg);
    VPSS_MEM_CLEAR(g_stTunnelIn);
    VPSS_MEM_CLEAR(g_stSMMUCfg);
    VPSS_MEM_CLEAR(g_stMadInfo_Tnr);
    VPSS_MEM_CLEAR(g_stMadInfo_Snr);
    VPSS_MEM_CLEAR(g_stDBInfo);
    VPSS_MEM_CLEAR(g_stDBDETInfo);
    VPSS_MEM_CLEAR(g_stNrInfo);
    VPSS_MEM_CLEAR(g_stSnrInfo);
    VPSS_MEM_CLEAR(g_stTnrInfo);
    VPSS_MEM_CLEAR(g_stMcTnrInfo);
    VPSS_MEM_CLEAR(g_stIfmdInfo);
    VPSS_MEM_CLEAR(g_sttInfoCfg);
    VPSS_MEM_CLEAR(g_stHdrInfo);
    VPSS_MEM_CLEAR(g_stAlgInfo);

    g_stRegAddr.pu8NodeVirAddr = (HI_U8 *)pu32AppVir;
    g_stRegAddr.u32NodePhyAddr = u32AppPhy;
    ...
    {
        g_stTunnelIn.bEnable = HI_TRUE;
        //        g_stTunnelIn.bSmmu   = pstHalInfo->stInInfo.bTunlSmmu;
#ifdef HI_VPSS_SMMU_SUPPORT
        g_stTunnelIn.bSmmu = HI_TRUE;
#else
        g_stTunnelIn.bSmmu = HI_FALSE;
#endif

        g_stTunnelIn.u32ReadInterval = 0;
        g_stTunnelIn.u32ReadAddr = pstHalInfo->stInInfo.u32TunnelAddr;
    }
    else
    {
        g_stTunnelIn.bEnable = HI_FALSE;
    }
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_TUNNEL_IN, (HI_VOID *)&g_stTunnelIn, HI_NULL);

    g_stDBDETInfo.bEnable = HI_FALSE;
    g_stDBInfo.bEnable    = HI_FALSE;
    g_stNrInfo.bEnable    = HI_FALSE;
    g_stSnrInfo.bEnable   = HI_FALSE;
    g_stTnrInfo.bEnable   = HI_TRUE;
    ...
    {
        g_stMcTnrInfo.bEnable = HI_TRUE;
    }
    else
    {
        g_stMcTnrInfo.bEnable = HI_FALSE;
    }
#else
    g_stMcTnrInfo.bEnable = HI_FALSE;
#endif
    ...
    if (HI_FALSE == g_stTnrInfo.bEnable)
    {
        g_stMcTnrInfo.bEnable = HI_FALSE;
    }
    ...
    g_stSnrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL, VPSS_DB_CTRL) - sizeof(HI_U32);
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_SNR, (HI_VOID *)&g_stSnrInfo, HI_NULL);

    //TNR分为 MA-TNR,  MC-TNR, MC需要单独设置开关, MA的开关即全局tnr开关
    g_stTnrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL, VPSS_TNR_CONTRL) - sizeof(HI_U32);

    if VPSS_IS_YUV420_FMT(pstHalInfo->stInInfo.enFormat)
    {
        g_stTnrInfo.u32Ymotionmode = 1;
    }
    else
    {
        g_stTnrInfo.u32Ymotionmode = 0;
    }
    ...
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_TNR, (HI_VOID *)&g_stTnrInfo, HI_NULL);
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_TNR_MC, (HI_VOID *)&g_stMcTnrInfo, HI_NULL);

#ifdef VPSS_SUPPORT_ALG_MCNR
    if ((HI_TRUE == g_stMcTnrInfo.bEnable) && (HI_TRUE == g_stTnrInfo.bEnable))
    {
        VPSS_HAL_SetRgmvCfg(enIP, pstHalInfo, g_stRegAddr);
    }
#endif
    /* ifmd */
    g_stIfmdInfo.bEnable = HI_FALSE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_IFMD, (HI_VOID *)&g_stIfmdInfo, HI_NULL);
    ...
    g_stFrmCfg.bEn              = HI_TRUE;
    g_stFrmCfg.bSecure          = pstHalInfo->stInInfo.bSecure;
    g_stFrmCfg.enBitWidth       = pstHalInfo->stInInfo.enBitWidth;
    g_stFrmCfg.enPixelFmt       = pstHalInfo->stInInfo.enFormat;
    g_stFrmCfg.u32Width         = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height        = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.bProgressive     = pstHalInfo->stInInfo.bProgressive;
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;


    g_stFrmCfg.bTopFirst = pstHalInfo->stInInfo.bTopFirst;

    if (HI_DRV_FIELD_TOP == pstHalInfo->stInInfo.enFieldMode)
    {
        g_stFrmCfg.bTop = HI_TRUE;
    }
    else
    {
        g_stFrmCfg.bTop = HI_FALSE;
    }

    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y  = pstNext2->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C  = pstNext2->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y   = pstNext2->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C   = pstNext2->u32Stride_C;
    ...
    if ( HI_DRV_PIXEL_BITWIDTH_10BIT == pstHalInfo->stInInfo.enBitWidth )
    {
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_Y   = pstNext2_LB->u32PhyAddr_Y;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32PhyAddr_C   = pstNext2_LB->u32PhyAddr_C;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_Y    = pstNext2_LB->u32Stride_Y;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].u32Stride_C    = pstNext2_LB->u32Stride_C;

#ifdef HI_VPSS_SMMU_SUPPORT
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_Y = HI_TRUE;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_C = HI_TRUE;
#else
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_Y = HI_FALSE;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_2BIT_LB].bSmmu_C = HI_FALSE;
#endif
    }
    ...
    {
        g_stFrmCfg.bCompress = HI_TRUE;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_YHead  = pstNext2->u32PhyAddr_YHead;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_CHead  = pstNext2->u32PhyAddr_CHead;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Head_Size      = pstNext2->u32Head_Size;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Head_Stride    = pstNext2->u32Head_Stride;
#ifdef HI_VPSS_SMMU_SUPPORT
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y   = HI_TRUE;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C   = HI_TRUE;
    ...
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_READ_NX2, (HI_VOID *)&g_stFrmCfg, HI_NULL);
    ...
    if (pstHalInfo->stRwzbInfo.u32EnRwzb)
    {
        ...
        if ((VPSS_IS_TILE_FMT(pstHalInfo->stInInfo.enFormat)) &&
            (pstHalInfo->bIsBufPrivManage == HI_FALSE))
#else
        if (VPSS_IS_TILE_FMT(pstHalInfo->stInInfo.enFormat))
#endif
        {
    ...
    g_stFrmCfg.bEn = ( HI_DRV_PIXEL_BITWIDTH_10BIT == pstHalInfo->stInInfo.enBitWidth ) ? HI_FALSE : HI_TRUE;
    g_stFrmCfg.u32Width     = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height    = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstCur->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstCur->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstCur->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstCur->u32Stride_C;

    g_stFrmCfg.enPixelFmt = pstHalInfo->stInRefInfo[0].enFormat;
    g_stFrmCfg.enBitWidth = pstHalInfo->stInRefInfo[0].enBitWidth;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
#else
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_FALSE;
#endif
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_READ_CUR, (HI_VOID *)&g_stFrmCfg, HI_NULL);
#endif
    /* rfr config */
    pstRfr = &pstHalInfo->stInWbcInfo.stAddr;
    g_stFrmCfg.bEn = ( HI_DRV_PIXEL_BITWIDTH_10BIT == pstHalInfo->stInInfo.enBitWidth ) ? HI_FALSE : HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstRfr->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstRfr->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstRfr->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstRfr->u32Stride_C;
    g_stFrmCfg.enBitWidth = pstHalInfo->stInWbcInfo.enBitWidth;
    g_stFrmCfg.enPixelFmt = pstHalInfo->stInWbcInfo.enFormat;
    g_stFrmCfg.u32Width   = pstHalInfo->stInWbcInfo.u32Width;
    g_stFrmCfg.u32Height  = pstHalInfo->stInWbcInfo.u32Height;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
#else
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_FALSE;
#endif
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_WRITE_RFR, (HI_VOID *)&g_stFrmCfg, &bRfrEnableFlag);
    ...
    g_stFrmCfg.u32Width     = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height    = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstRef->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstRef->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstRef->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstRef->u32Stride_C;

    g_stFrmCfg.enPixelFmt = pstHalInfo->stInRefInfo[0].enFormat;
    g_stFrmCfg.enBitWidth = pstHalInfo->stInRefInfo[0].enBitWidth;
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_READ_REF, (HI_VOID *)&g_stFrmCfg, HI_NULL);
#endif

    g_stHdrInfo.bEnable = pstHalInfo->stHdrInfo.bEnable;
    g_stHdrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL, VPSS_LCHDR_CTRL) - sizeof(HI_U32);
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_HDR, (HI_VOID *)&g_stHdrInfo, &pstHalInfo->stHdrInfo.bHdrIn);


    /* vhd0 config */
    VPSS_HAL_SetPortCfg(enIP, g_stRegAddr, pstHalInfo);

    //逐隔行都要配置
    g_sttInfoCfg.u32WPhyAddr = pstHalInfo->stSttAddr.u32stt_w_phy_addr;
    VPSS_CBB_INFO_SetConfig(g_stRegAddr, CBB_INFO_STT, (HI_VOID *)&g_sttInfoCfg, (HI_VOID *)HI_NULL);

    /* smmu */

#ifdef HI_VPSS_SMMU_SUPPORT
    g_stSMMUCfg.bGlobalBypass = HI_FALSE;
    g_stSMMUCfg.bIntEnable = HI_TRUE;
    g_stSMMUCfg.u32Ptw_pf = 0x3;
    //g_stSMMUCfg.u32BypassFlag_RCH = 0x0;
    //g_stSMMUCfg.u32BypassFlag_WCH = 0x0;

    HI_DRV_SMMU_GetPageTableAddr(&u32PageAddr, &u32ErrReadAddr, &u32ErrWriteAddr);
    g_stSMMUCfg.u32CB_TTBR = g_stSMMUCfg.u32SCB_TTBR = u32PageAddr;
    g_stSMMUCfg.u32Err_s_rd_addr = g_stSMMUCfg.u32Err_ns_rd_addr = u32ErrReadAddr;
    g_stSMMUCfg.u32Err_s_wr_addr = g_stSMMUCfg.u32Err_ns_wr_addr = u32ErrWriteAddr;
#else
    g_stSMMUCfg.bGlobalBypass = HI_TRUE;
    g_stSMMUCfg.bIntEnable = HI_FALSE;
    //g_stSMMUCfg.u32BypassFlag_RCH = 0xffffffff;
    //g_stSMMUCfg.u32BypassFlag_WCH = 0xffffffff;
#endif
    g_stRegAddr_MMU.pu8NodeVirAddr = (HI_U8 *)pu32AppVir;
    g_stRegAddr_MMU.pu8BaseVirAddr = stHalCtx[enIP][0].pu8BaseRegVir;
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr_MMU, CBB_FUNC_SMMU, (HI_VOID *)&g_stSMMUCfg, HI_NULL);

    /* tnr mad */
    // g_stMadInfo_Tnr.bEn = ( HI_DRV_PIXEL_BITWIDTH_10BIT == pstHalInfo->stInInfo.enBitWidth ) ? HI_FALSE : HI_TRUE;
    g_stMadInfo_Tnr.bEn  = HI_FALSE;

    g_stMadInfo_Tnr.u32Wth = pstHalInfo->stInInfo.u32Width;
    g_stMadInfo_Tnr.u32Hgt = pstHalInfo->stInInfo.u32Height;
    g_stMadInfo_Tnr.u32RPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_raddr;
    g_stMadInfo_Tnr.u32WPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_waddr;
    g_stMadInfo_Tnr.u32Stride   = pstHalInfo->stNrInfo.stNrMadCfg.u32madstride;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stMadInfo_Tnr.bSmmu_R = HI_TRUE;
    g_stMadInfo_Tnr.bSmmu_W = HI_TRUE;
#else
    g_stMadInfo_Tnr.bSmmu_R = HI_FALSE;
    g_stMadInfo_Tnr.bSmmu_W = HI_FALSE;
#endif
    VPSS_CBB_INFO_SetConfig(g_stRegAddr, CBB_INFO_TNR_MAD, (HI_VOID *)&g_stMadInfo_Tnr, HI_NULL);
    g_stAlgInfo.bEnable = HI_FALSE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_IGBM, (HI_VOID *)&g_stAlgInfo, HI_NULL);

#if 1
    {
        /* tnr mad */
        g_stMadInfo_Tnr.bEn    = g_stTnrInfo.bEnable;
        g_stMadInfo_Tnr.u32Wth = pstHalInfo->stInInfo.u32Width;
        g_stMadInfo_Tnr.u32Hgt = pstHalInfo->stInInfo.u32Height; // / 2;
        g_stMadInfo_Tnr.u32RPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_raddr;
        g_stMadInfo_Tnr.u32WPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_waddr;
        g_stMadInfo_Tnr.u32Stride   = pstHalInfo->stNrInfo.stNrMadCfg.u32madstride;
        VPSS_DBG_INFO("TnrMad.RP : %#x, TnrMad.WP : %#x. stride%d\n", g_stMadInfo_Tnr.u32RPhyAddr, g_stMadInfo_Tnr.u32WPhyAddr, g_stMadInfo_Tnr.u32Stride);
#ifdef HI_VPSS_SMMU_SUPPORT
        g_stMadInfo_Tnr.bSmmu_R = HI_TRUE;
        g_stMadInfo_Tnr.bSmmu_W = HI_TRUE;
#else
...
#ifdef VPSS_NEW_FIRST3FILED
HI_S32 VPSS_HAL_Set_2DFrame_First1_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    HI_DRV_VID_FRAME_ADDR_S *pstNext2;
    HI_DRV_VID_FRAME_ADDR_S *pstNext2_LB;
    HI_DRV_VID_FRAME_ADDR_S *pstRfr;
    ...
    //  g_stDBDETInfo.bEnable = HI_TRUE;
    // g_stDBInfo.bEnable    = HI_TRUE;
    g_stNrInfo.bEnable    = HI_FALSE;
    // g_stSnrInfo.bEnable   = HI_TRUE;
    g_stTnrInfo.bEnable   = HI_FALSE;
    g_stMcTnrInfo.bEnable = HI_FALSE;
    bRfrEnableFlag      = HI_TRUE;
    ...
    g_stFrmCfg.u32Width         = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height        = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.bProgressive     = HI_TRUE;
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;
    g_stFrmCfg.bTopFirst = pstHalInfo->stInInfo.bTopFirst;
    ...
    VPSS_DBG_INFO("2DNode nx2 read from %#08x %#08x %d %d  topfirst %d top %d\n",
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C,
                  g_stFrmCfg.bTopFirst,
                  g_stFrmCfg.bTop);
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstRfr->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstRfr->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y  = pstRfr->u32Stride_Y / 2;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C  = pstRfr->u32Stride_C / 2;
    g_stFrmCfg.enBitWidth = pstHalInfo->stInWbcInfo.enBitWidth;
    g_stFrmCfg.enPixelFmt = pstHalInfo->stInWbcInfo.enFormat;
    g_stFrmCfg.u32Width   = pstHalInfo->stInWbcInfo.u32Width;
    g_stFrmCfg.u32Height  = pstHalInfo->stInWbcInfo.u32Height;
    ...
    if ((0 == pstHalInfo->u32DetileFieldIdx)
        && (HI_FALSE == pstHalInfo->stInInfo.bTopFirst))
    {
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y -= pstRfr->u32Stride_Y / 2;
        g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C -= pstRfr->u32Stride_C / 2;
    }

    VPSS_DBG_INFO("2DNode rfr write to %#08x %#08x %d %d  w h %d %d\n",
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C,
    ...
    {
        /* tnr mad */
        g_stMadInfo_Tnr.bEn    = g_stTnrInfo.bEnable || g_stSnrInfo.bEnable;
        g_stMadInfo_Tnr.u32Wth = pstHalInfo->stInInfo.u32Width;
        g_stMadInfo_Tnr.u32Hgt = pstHalInfo->stInInfo.u32Height; // / 2;
        //g_stMadInfo_Tnr.u32Hgt = pstHalInfo->stInInfo.u32Height / 2;
        g_stMadInfo_Tnr.u32RPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_raddr;
...
HI_S32 VPSS_HAL_Set_2DField_First23_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    //VPZME, 单场模式开
    ...
    if (1 != pstHalInfo->u32DetileFieldIdx)
    {
    ...
    //g_stDBInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL, VPSS_DB_CTRL) - sizeof(HI_U32);
    //VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_DB, (HI_VOID *)&g_stDBInfo, HI_NULL);
    //VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_DB_DET, (HI_VOID *)&g_stDBDETInfo, HI_NULL);
    //VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_NR, (HI_VOID *)&g_stNrInfo, HI_NULL);
    ...
    g_stFrmCfg.bSecure          = pstHalInfo->stInInfo.bSecure;
    g_stFrmCfg.enBitWidth       = pstHalInfo->stInInfo.enBitWidth;
    g_stFrmCfg.enPixelFmt       = pstHalInfo->stInInfo.enFormat;    // TODO: 做格式转换
    g_stFrmCfg.u32Width         = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height        = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.bProgressive     = HI_FALSE;
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;
    g_stFrmCfg.bTopFirst = pstHalInfo->stInInfo.bTopFirst;
    ...
    /* cur config */
    pstCur = &pstHalInfo->stInRefInfo[0].stAddr;
    g_stFrmCfg.bEn          = g_stTnrInfo.bEnable;
    g_stFrmCfg.u32Width     = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height    = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y = pstCur->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C = pstCur->u32PhyAddr_C;
    ...
    VPSS_DBG_INFO("2DField rfr write to %#08x %#08x %d %d\n",
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C);
    ...
    /* tnr mad */
    //if ((HI_TRUE == g_stTnrInfo.bEnable) || (HI_TRUE == g_stSnrInfo.bEnable))
    {
        /* tnr mad */
        g_stMadInfo_Tnr.bEn    = g_stTnrInfo.bEnable || g_stSnrInfo.bEnable;
        g_stMadInfo_Tnr.u32Wth = pstHalInfo->stInInfo.u32Width;
...
HI_S32 VPSS_HAL_Set_2DDei_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    VPSS_MEM_CLEAR(g_stMcDeiAlgCfg);
    VPSS_MEM_CLEAR(g_stHdrInfo);
    VPSS_MEM_CLEAR(g_stFuncFdIFdOCfg);
    ...
    pstRfr      = &pstHalInfo->stInWbcInfo.stAddr;
#if 1
    VPSS_DBG_INFO("Ref  Yphy:%#08x, stride %d Cphy:%#08x, stride %d\n",
                  pstRef->u32PhyAddr_Y,
                  pstRef->u32Stride_Y,
                  pstRef->u32PhyAddr_C,
                  pstRef->u32Stride_C
                 );
    VPSS_DBG_INFO("Cur  Yphy:%#08x, stride %d Cphy:%#08x, stride %d\n",
    ...
    VPSS_DBG_INFO("Nx1  Yphy:%#08x, stride %d Cphy:%#08x, stride %d\n",
                  pstNxt1->u32PhyAddr_Y,
                  pstNxt1->u32Stride_Y,
                  pstNxt1->u32PhyAddr_C,
                  pstNxt1->u32Stride_C
                 );
    VPSS_DBG_INFO("Nx2  Yphy:%#08x, stride %d Cphy:%#08x, stride %d\n",
                  pstNext2->u32PhyAddr_Y,
                  pstNext2->u32Stride_Y,
                  pstNext2->u32PhyAddr_C,
                  pstNext2->u32Stride_C
                 );
    VPSS_DBG_INFO("Rfr  Yphy:%#08x, stride %d Cphy:%#08x, stride %d\n",
                  pstRfr->u32PhyAddr_Y,
                  pstRfr->u32Stride_Y,
                  pstRfr->u32PhyAddr_C,
                  pstRfr->u32Stride_C
    ...
    bRfrEnableFlag      = HI_TRUE;
    //snr_en 是db,dm, nr的总开关， SNR包括db,dm,nr
    g_stSnrInfo.bEnable   = HI_FALSE; //只支持标清的SNR
    g_stTnrInfo.bEnable   = HI_TRUE;  //只需开MA-TNR, 关闭MC-TNR
    g_stMcTnrInfo.bEnable = HI_FALSE;
    ...
    g_stHdrInfo.bEnable = pstHalInfo->stHdrInfo.bEnable;
    g_stHdrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL,
                              VPSS_LCHDR_CTRL) - sizeof(HI_U32);
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_HDR, (HI_VOID *)&g_stHdrInfo, &
    ...
    g_stFrmCfg.u32Height        = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.bProgressive     = pstHalInfo->stInInfo.bProgressive;
    g_stFrmCfg.bSpecialTile     = HI_FALSE;
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;
    ...
    VPSS_DBG_INFO("2DDEI nx2 read from %#08x %#08x %d %d  topfirst %d top %d\n",
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C,
    ...
    g_stFuncFdIFdOCfg.bEnable = HI_FALSE; //pstHalInfo->stInInfo.bSpecField;
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_FDIFRO, (HI_VOID *)&g_stFuncFdIFdOCfg, HI_NULL);
    ...
    g_stFrmCfg.u32Width     = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height    = pstHalInfo->stInInfo.u32Height;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y  = pstNxt1->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C  = pstNxt1->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y   = pstNxt1->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C   = pstNxt1->u32Stride_C;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
#else
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_FALSE;
#endif
    g_stFrmCfg.enPixelFmt = pstHalInfo->stInRefInfo[2].enFormat;
    g_stFrmCfg.enBitWidth = pstHalInfo->stInRefInfo[2].enBitWidth;
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_READ_NX1, (HI_VOID *)&g_stFrmCfg, HI_NULL);
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_FALSE;
#endif
    g_stFrmCfg.enPixelFmt = pstHalInfo->stInRefInfo[1].enFormat;
    g_stFrmCfg.enBitWidth = pstHalInfo->stInRefInfo[1].enBitWidth;
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_READ_CUR, (HI_VOID *)&g_stFrmCfg, HI_NULL);
    ...
    VPSS_HAL_SetDeiCfg(enIP, pstHalInfo, g_stRegAddr);

    bMedsEn = (g_stMcTnrInfo.bEnable || g_stMcDeiAlgCfg.bEnable);
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_MCDEI, (HI_VOID *)&g_stMcDeiAlgCfg, &bMedsEn);
    ...
    if ((pstHalInfo->bSplitEnable) || (g_stMcDeiAlgCfg.bEnable))
    {
        VPSS_HAL_SetMcDeiCfg(enIP, pstHalInfo, g_stRegAddr);
        VPSS_HAL_SetRgmvCfg(enIP, pstHalInfo, g_stRegAddr);
    }


    /* igbm */
    g_stAlgInfo.bEnable = HI_TRUE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_IGBM, (HI_VOID *)&g_stAlgInfo, HI_NULL);

    /* ifmd */
    g_stAlgInfo.bEnable = HI_TRUE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_IFMD, (HI_VOID *)&g_stAlgInfo, HI_NULL);
    ...
    /* tnr mad */
    if (HI_TRUE == g_stTnrInfo.bEnable)
    {
        /* tnr mad */
        g_stMadInfo_Tnr.bEn    = g_stTnrInfo.bEnable;
        g_stMadInfo_Tnr.u32Wth = pstHalInfo->stInInfo.u32Width;
...
HI_S32 VPSS_HAL_Set_2DField_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    g_stFrmCfg.enPixelFmt = pstHalInfo->stInWbcInfo.enFormat;
    g_stFrmCfg.u32Width   = pstHalInfo->stInWbcInfo.u32Width;
    // g_stFrmCfg.u32Height  = pstHalInfo->stInWbcInfo.u32Height / 2;
    g_stFrmCfg.u32Height  = pstHalInfo->stInWbcInfo.u32Height;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
...
HI_S32 VPSS_HAL_Set_2DSDFirst_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    bRfrEnableFlag      = HI_TRUE;
    //snr_en 是db,dm, nr的总开关， SNR包括db,dm,nr
    g_stSnrInfo.bEnable   = HI_FALSE; //node-seconed enable snr
    g_stTnrInfo.bEnable   = HI_TRUE;  //开MA-TNR, MC-TNR
    g_stMcTnrInfo.bEnable = HI_TRUE;
    ...
    //In 98mv200 all of SNR,DB,DM use DB'coef addr(VPSS_DB_CTRL).
    g_stSnrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL, VPSS_DB_CTRL) - sizeof(HI_U32);
    g_stSnrInfo.bMad_vfir_en = HI_FALSE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_SNR, (HI_VOID *)&g_stSnrInfo, HI_NULL);
    ...
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;
    //   g_stFrmCfg.bSpecialTile     = pstHalInfo->stInInfo.bSpecField;
    g_stFrmCfg.bSpecialTile     = HI_FALSE;
    g_stFrmCfg.bTopFirst = pstHalInfo->stInInfo.bTopFirst;
    ...
    //    HI_PRINT("g_stFrmCfg.bTopFirst : %u\n", g_stFrmCfg.bTopFirst);
    //   HI_PRINT("g_stFrmCfg.bTop : %u\n", g_stFrmCfg.bTop);
    ...
    VPSS_DBG_INFO("SDDEI nx2 read from %#08x %#08x %d %d  topfirst %d top %d\n",
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y,
                  g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C,
    ...
    /* vhd0 config */
    VPSS_HAL_SetPortCfg_SD_First_dei(enIP, g_stRegAddr, pstHalInfo);
...
HI_S32 VPSS_HAL_Set_2DSDSecond_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    /*tunnel*/
    g_stTunnelIn.bEnable = HI_FALSE; //second node's tunnel-in fix to disable
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_TUNNEL_IN, (HI_VOID *)&g_stTunnelIn, HI_NULL);
    ...
    //------------------------------------------------------
    //g_stSnrInfo.bEnable = pstHalInfo->stNrInfo.bSnrEn | pstHalInfo->stNrInfo.bDbEn | pstHalInfo->stNrInfo.bDmEn;
    ...
    //    g_stSnrInfo.bEnable = HI_TRUE;
    g_stSnrInfo.bMad_vfir_en = HI_TRUE;
    g_stSnrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL,
    ...
    /* snr, tnr */
    //In 98mv200 all of SNR,DB,DM use DB'coef addr(VPSS_DB_CTRL).
    // g_stSnrInfo.u32ParaAddr = u32AppPhy +  u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL,  VPSS_DB_CTRL);;
    // VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_SNR, (HI_VOID *)&g_stSnrInfo, HI_NULL);
    ...
    g_stDeiAlgCfg.bEnable     = HI_FALSE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_DEI, (HI_VOID *)&g_stDeiAlgCfg, HI_NULL);

    g_stMcDeiAlgCfg.bEnable   = HI_FALSE;
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_MCDEI, (HI_VOID *)&g_stMcDeiAlgCfg, HI_NULL);
    ...
    /* snr mad */
    g_stMadInfo_Snr.bEn    = HI_TRUE;
    g_stMadInfo_Snr.u32Wth = pstHalInfo->stInInfo.u32Width;
    // stMadInfo_Snr.u32Hgt = (pstHalInfo->stDieInfo.bEnable) ? pstHalInfo->stInInfo.u32Height / 2 : pstHalInfo->stInInfo.u32Height;
    g_stMadInfo_Snr.u32Hgt =  pstHalInfo->stInInfo.u32Height / 2 ;
    if (pstHalInfo->stInInfo.bProgressive)
    {
        g_stMadInfo_Snr.u32RPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_waddr;
    }
    else
    {
        g_stMadInfo_Snr.u32RPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Tnrmad_raddr;
    }
    g_stMadInfo_Snr.u32Stride   = pstHalInfo->stNrInfo.stNrMadCfg.u32madstride;

    //VPSS_FATAL("SnrMad.RP : %#x  stride:%d.\n", stMadInfo_Snr.u32RPhyAddr, stMadInfo_Snr.u32Stride );

#ifdef HI_VPSS_SMMU_SUPPORT
    g_stMadInfo_Snr.bSmmu_R = HI_TRUE;
    g_stMadInfo_Snr.bSmmu_W = HI_TRUE;
#else
    g_stMadInfo_Snr.bSmmu_R = HI_FALSE;
    g_stMadInfo_Snr.bSmmu_W = HI_FALSE;
#endif
    VPSS_CBB_INFO_SetConfig(g_stRegAddr, CBB_INFO_SNR_MAD, (HI_VOID *)&g_stMadInfo_Snr, HI_NULL);
...
HI_S32 VPSS_HAL_Set_CTS10_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    g_stDBInfo.bEnable    = HI_FALSE;
    g_stNrInfo.bEnable    = HI_FALSE;
    g_stSnrInfo.bEnable   = HI_FALSE;  //此时打开SNR也没有意义
    g_stTnrInfo.bEnable   = HI_FALSE;
    ...
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_CTS10BIT, (HI_VOID *)&stFuncCTS10bitCfg, HI_NULL);

    g_stFunc4PixelCfg.bEnable = HI_TRUE;
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_SPEED_UP_4PIXEL, (HI_VOID *)&g_stFunc4PixelCfg, HI_NULL);

    /* vhd0 config */
    VPSS_HAL_SetPortCfg_CTS10Bit(g_stRegAddr, pstHalInfo);
    ...
    if (g_stSnrInfo.bEnable)
    {
        /* snr mad */
        g_stMadInfo_Snr.u32RPhyAddr = pstHalInfo->stNrInfo.stNrMadCfg.u32Snrmad_raddr;
        g_stMadInfo_Snr.u32Stride   = pstHalInfo->stNrInfo.stNrMadCfg.u32madstride;
        VPSS_CBB_INFO_SetConfig(g_stRegAddr, CBB_INFO_SNR_MAD, (HI_VOID *)&g_stMadInfo_Snr, HI_NULL);
    }
...
HI_S32 VPSS_HAL_Set_2D_UHDFrame_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    g_stDBInfo.bEnable = HI_FALSE;
    g_stNrInfo.bEnable = HI_FALSE;
    g_stSnrInfo.bEnable   = HI_FALSE; //D1 720以上都是逐行，不开
    g_stTnrInfo.bEnable   = HI_FALSE;
    g_stMcTnrInfo.bEnable = HI_FALSE;
    ...
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_WRITE_RFR, (HI_VOID *)&g_stFrmCfg, HI_NULL);
#endif
    ...
    if (HI_TRUE == pstHalInfo->bAndroidCts)
    {
        if ((pstHalInfo->stInInfo.u32Height & 0x2) != 0)
        {
            g_stFunc4PixelCfg.bEnable = HI_FALSE;
        }
    }
    VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_SPEED_UP_4PIXEL, (HI_VOID *)&g_stFunc4PixelCfg, HI_NULL);
...
HI_S32 VPSS_HAL_SetRotateNode(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy, HI_BOOL bRotateY, HI_U32 u32PortId)
{
    ...
    g_stFrmCfg.bSecure          = pstHalInfo->stInInfo.bSecure;
    g_stFrmCfg.enBitWidth       = pstHalInfo->stInInfo.enBitWidth;
    g_stFrmCfg.enPixelFmt       = HI_DRV_PIX_FMT_NV21; //pstHalInfo->stInInfo.enFormat; // TODO: 做格式转换

    g_stFrmCfg.u32Width         = pRotaFrame->u32Width;
    g_stFrmCfg.u32Height        = pRotaFrame->u32Height;
    g_stFrmCfg.bProgressive     = HI_TRUE; //pstHalInfo->stInInfo.bProgressive;
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;
    ...
    /* vhd0 config */
    VPSS_HAL_SetPortCfg_Rota(g_stRegAddr, pstHalInfo, bRotateY, u32PortId);
...
HI_S32 VPSS_HAL_Set_HDR_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    g_stHdrInfo.bEnable = HI_FALSE; //lchdr
    g_stHdrInfo.u32ParaAddr = u32AppPhy + VPSS_REG_SIZE_CALC(VPSS_CTRL, VPSS_LCHDR_CTRL) - sizeof(HI_U32);
    VPSS_AlgCfg_BaseFunc(g_stRegAddr, CBB_ALG_HDR, (HI_VOID *)&g_stHdrInfo, HI_NULL);
        ...
        HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    if (pstHalPort->bEnable && pstHalPort->bConfig == HI_FALSE)
    {
        ...
        */
        g_stFuncTunnelOutCfg.bEnable = HI_FALSE;
        VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_TUNNEL_OUT, (HI_VOID *)&g_stFuncTunnelOutCfg, HI_NULL);

        g_stFuncCropCfg.bEnable = HI_FALSE;
        VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_VHD0_CROP, (HI_VOID *)&g_stFuncCropCfg, HI_NULL);
        g_stLBox.bEnable = HI_FALSE;
        VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_VHD0_LBOX, (HI_VOID *)&g_stLBox, HI_NULL);

#if 0
        /*ZME*/
        stFuncZmeCfg.u32ParAddr = g_stRegAddr.u32NodePhyAddr + 0x2000;
        ...
        VPSS_CBB_FUNC_SetConfig(g_stRegAddr, CBB_FUNC_VHD0_ZME, (HI_VOID *)&stFuncZmeCfg, HI_NULL);
        ...
        VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_WRITE_VHD0, (HI_VOID *)&g_stFrmCfg, HI_NULL);
                                       ...
                                       HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    */
    ...
    bRfrEnableFlag      = HI_FALSE;
    //snr_en 是db,dm, nr的总开关， SNR包括db,dm,nr
    g_stSnrInfo.bEnable   = HI_FALSE; //DEI与SNR共用BUFFER, 开DEI则关闭SNR
    g_stTnrInfo.bEnable   = HI_TRUE;  //只需开MA-TNR, 关闭MC-TNR
    g_stMcTnrInfo.bEnable = HI_FALSE;
    ...
    g_stFrmCfg.enPixelFmt       = HI_DRV_PIX_FMT_NV21;
    g_stFrmCfg.u32Width         = pstHalInfo->stInInfo.u32Width;
    g_stFrmCfg.u32Height        = pstHalInfo->stInInfo.u32Height * 2;
    g_stFrmCfg.bProgressive     = HI_FALSE;
    g_stFrmCfg.stOffset.s32X    = 0;
    g_stFrmCfg.stOffset.s32Y    = 0;
    /*
    ...
    */
    g_stFrmCfg.bSpecialTile     = HI_TRUE;
    ...
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_Y  = pstNxt2->u32PhyAddr_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32PhyAddr_C  = pstNxt2->u32PhyAddr_C;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_Y   = pstNxt2->u32Stride_Y;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].u32Stride_C   = pstNxt2->u32Stride_C;
    g_stFrmCfg.bCompress = HI_FALSE;
#ifdef HI_VPSS_SMMU_SUPPORT
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_Y = HI_TRUE;
    g_stFrmCfg.stAddr[CBB_FREAM_BUF_8BIT].bSmmu_C = HI_TRUE;
    ...
    g_stFrmCfg.enPixelFmt = HI_DRV_PIX_FMT_NV21;
    g_stFrmCfg.enBitWidth = HI_DRV_PIXEL_BITWIDTH_8BIT;
    VPSS_CBB_FRAME_SetConfig(g_stRegAddr, CBB_FRAME_READ_NX1, (HI_VOID *)&g_stFrmCfg, HI_NULL);
...
HI_S32 VPSS_HAL_Set_2DDei_Last2Field_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy)
{
    ...
    //snr_en 是db,dm, nr的总开关， SNR包括db,dm,nr
    g_stSnrInfo.bEnable   = HI_FALSE; //只支持标清的SNR
    g_stTnrInfo.bEnable   = HI_FALSE;  //只需开MA-TNR, 关闭MC-TNR
    g_stMcTnrInfo.bEnable = HI_FALSE;
                          ...
                          HI_U32 u32FrameIdx)
{
    ...
    HI_U32 u32RfrYStride;
    HI_U32 u32RfrCStride;

    HI_U32 u32ImgChmHgt;
    HI_U32 u32AddrOffsetHorY = 0;
    HI_U32 u32AddrOffsetHorC = 0;
    HI_U32 u32AddrOffsetVerY = 0;
    HI_U32 u32AddrOffsetVerC = 0;
    ...
    {
        VPSS_ERROR("u32FrameIdx=%#x\n", u32FrameIdx);
        u32LastFieldFlag = 1;
    }
    else if ((u32FrameIdx == 1) || (u32FrameIdx == 2))
    {
        u32SeCThirdFieldFlag = 1;
    }
    else if (u32FrameIdx == 0 )
    {
        u32FirstFieldFlag = 1;
    }
    ...
    for (u32Idx = 0; u32Idx < u32NodeCount; u32Idx++)
    {
        ...
        if (pstVirAddrBase->VPSS_OUT0_WTUNL_CTRL.bits.out0_wtunl_en)
        {
            if (u32Idx < 8)
            {
                pstVirAddrNodeX->VPSS_OUT0_WTUNL_CTRL.bits.out0_wtunl_en = 0;
            }
        }
        ...
        //p1,p2,p3 follow rfr's bitwidth
        ...
        u32P1PixWth  = u32RfrPixWth;
        u32P2PixWth  = u32RfrPixWth;
        u32P3PixWth  = u32RfrPixWth;

        //计算色度高度
        u32ImgChmHgt = (pstVirAddrNodeX->VPSS_CF_CTRL.bits.cf_format == 0) ? u32SrcImgHgtReal / 2 : u32SrcImgHgtReal;
        u32RfrYStride = pstVirAddrNodeX->VPSS_NR_RFR_STRIDE.bits.nr_rfry_stride ;
        u32RfrCStride = pstVirAddrNodeX->VPSS_NR_RFR_STRIDE.bits.nr_rfrc_stride ;
        ...
        else if (1 == u32Idx)
        {
            u32AddrOffsetHorY = 0;
            u32AddrOffsetHorC = 0;
            u32AddrOffsetVerY = u32RfrYStride * u32SrcImgHgtReal;
            u32AddrOffsetVerC = u32RfrCStride * u32ImgChmHgt;
        }
        else if (2 == u32Idx)
        {
            u32AddrOffsetHorY = HI_ALIGN_8BIT_YSTRIDE((u32FirstWth * u32RfrPixWth + 7) / 8) ;
            u32AddrOffsetHorC = HI_ALIGN_8BIT_YSTRIDE((u32FirstWth * u32RfrPixWth + 7) / 8);
            u32AddrOffsetVerY = u32RfrYStride * u32SrcImgHgtReal;
            u32AddrOffsetVerC = u32RfrCStride * u32ImgChmHgt;
        }
        else
        {
            u32AddrOffsetHorY =  HI_ALIGN_8BIT_YSTRIDE(((u32FirstWth + (u32Idx - 2) * u32MidWth) * u32RfrPixWth + 7) / 8) ;
            u32AddrOffsetHorC =  HI_ALIGN_8BIT_YSTRIDE(((u32FirstWth + (u32Idx - 2) * u32MidWth) * u32RfrPixWth + 7) / 8) ;
            u32AddrOffsetVerY = u32RfrYStride * u32SrcImgHgtReal;
            u32AddrOffsetVerC = u32RfrCStride * u32ImgChmHgt;
        }
        u32AddrOffsetCurY = u32AddrOffsetHorY + u32AddrOffsetVerY;
        u32AddrOffsetCurC = u32AddrOffsetHorC + u32AddrOffsetVerC;
        u32AddrOffsetP1Y = u32AddrOffsetHorY + u32AddrOffsetVerY;
        u32AddrOffsetP1C = u32AddrOffsetHorC + u32AddrOffsetVerC;
        u32AddrOffsetP2Y = u32AddrOffsetHorY + u32AddrOffsetVerY;
        u32AddrOffsetP2C = u32AddrOffsetHorC + u32AddrOffsetVerC;
        u32AddrOffsetP3Y = u32AddrOffsetHorY + u32AddrOffsetVerY;
        u32AddrOffsetP3C = u32AddrOffsetHorC + u32AddrOffsetVerC;
        u32AddrOffsetRfrY = u32AddrOffsetHorY + u32AddrOffsetVerY;
        u32AddrOffsetRfrC = u32AddrOffsetHorC + u32AddrOffsetVerC;
        if ((u32Idx == 0) || (u32Idx > 4))
        {
            pstVirAddrNodeX->VPSS_DIECTRL.bits.ma_only = 1;
            pstVirAddrNodeX->VPSS_CTRL.bits.mcdi_en = 0;
        }
        if ((1 == u32FirstFieldFlag) || (1 == u32SeCThirdFieldFlag))
        {
            if (u32Idx < 5)
            {
                ...
                {
                    pstVirAddrNodeX->VPSS_VHD0_ZMEORESO.bits.vhd0_zme_oh = u32NodeImgHgt - 1;
                    pstVirAddrNodeX->VPSS_VHD0_ZMEORESO.bits.vhd0_zme_ow = u32NodeImgWth - 1;
                }
        ...
        else
        {
...
#if 1
                VPSS_DBG_INFO("CF yadd %#08x caddr %#08x ystride %d cstride %d\n",
                              pstVirAddrNodeX->VPSS_CFY_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_CFC_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_CF_STRIDE.bits.cfy_stride,
                              pstVirAddrNodeX->VPSS_CF_STRIDE.bits.cfc_stride);
                VPSS_DBG_INFO("P1 yadd %#08x caddr %#08x ystride %d cstride %d\n",
                              pstVirAddrNodeX->VPSS_P1Y_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_P1C_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_P1_STRIDE.bits.p1y_stride,
                              pstVirAddrNodeX->VPSS_P1_STRIDE.bits.p1c_stride);
                VPSS_DBG_INFO("P2 yadd %#08x caddr %#08x ystride %d cstride %d\n",
                              pstVirAddrNodeX->VPSS_P2Y_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_P2C_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_P2_STRIDE.bits.p2y_stride,
                              pstVirAddrNodeX->VPSS_P2_STRIDE.bits.p2c_stride);
                VPSS_DBG_INFO("P3 yadd %#08x caddr %#08x ystride %d cstride %d\n",
                              pstVirAddrNodeX->VPSS_P3Y_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_P3C_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_P3_STRIDE.bits.p3y_stride,
                              pstVirAddrNodeX->VPSS_P3_STRIDE.bits.p3c_stride);
                VPSS_DBG_INFO("OUT0 yadd %#08x caddr %#08x ystride %d cstride %d\n",
                              pstVirAddrNodeX->VPSS_OUT0Y_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_OUT0C_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_OUT0_STRIDE.bits.out0y_stride,
                              pstVirAddrNodeX->VPSS_OUT0_STRIDE.bits.out0c_stride);
                VPSS_DBG_INFO("RFR yadd %#08x caddr %#08x ystride %d cstride %d\n",
                              pstVirAddrNodeX->VPSS_NR_RFRY_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_NR_RFRC_ADDR_LOW.u32,
                              pstVirAddrNodeX->VPSS_NR_RFR_STRIDE.bits.nr_rfry_stride,
                              pstVirAddrNodeX->VPSS_NR_RFR_STRIDE.bits.nr_rfrc_stride);
#endif
            ...
            else //5.6.7.8
            {
                ...
                pstVirAddrNodeX->VPSS_CF_CTRL.bits.cf_bitw = pstVirAddrNodeX->VPSS_OUT0_CTRL.bits.out0_bitw; //incase of nx2 is 10bit, split 6789 should follow 12345's output bitw
                if (u32Idx == 5)
                {
