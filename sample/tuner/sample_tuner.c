...
HI_VOID set_pin_mux(void)
{
    ...
    if (HI_UNF_DEMOD_DEV_TYPE_MXL541 == HIADP_INI_Getl("tunernum", "DemodType", DEFAULT_DEMOD_TYPE, FRONTEND_CONFIG_FILE))
    {
        //H24 I2C2_SCL IOSHARE69
        HI_SYS_ReadRegister(0xf8a21114, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 3;
        HI_SYS_WriteRegister(0xf8a21114, u32RegValue);

        //H26 I2C2_SDA IOSHARE68
        HI_SYS_ReadRegister(0xf8a21110, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 3;
        HI_SYS_WriteRegister(0xf8a21110, u32RegValue);

        //J24 GPIO9-0  IOSHARE61
        HI_SYS_ReadRegister(0xf8a210f4, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        HI_SYS_WriteRegister(0xf8a210f4, u32RegValue);

        //G24 TSI0_D0  IOSHARE67
        HI_SYS_ReadRegister(0xf8a2110c, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 1;
        HI_SYS_WriteRegister(0xf8a2110c, u32RegValue);

        //G25 TSI0_CLK IOSHARE66
        HI_SYS_ReadRegister(0xf8a21108, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 2;
        HI_SYS_WriteRegister(0xf8a21108, u32RegValue);

        //H23 TSI1_D0  IOSHARE65
        HI_SYS_ReadRegister(0xf8a21104, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 1;
        HI_SYS_WriteRegister(0xf8a21104, u32RegValue);

        //H25 TSI1_CLK IOSHARE64
        HI_SYS_ReadRegister(0xf8a21100, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 2;
        HI_SYS_WriteRegister(0xf8a21100, u32RegValue);

        //J25 TSI2_CLK IOSHARE63
        HI_SYS_ReadRegister(0xf8a210fc, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 1;
        HI_SYS_WriteRegister(0xf8a210fc, u32RegValue);

        //J26 TSI2_D0  IOSHARE62
        HI_SYS_ReadRegister(0xf8a210f8, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 1;
        HI_SYS_WriteRegister(0xf8a210f8, u32RegValue);

        //K25 TSI3_D0  IOSHARE60
        HI_SYS_ReadRegister(0xf8a210f0, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 1;
        HI_SYS_WriteRegister(0xf8a210f0, u32RegValue);

        //K24 TSI3_CLK IOSHARE59
        HI_SYS_ReadRegister(0xf8a210ec, &u32RegValue);
        u32RegValue &= ~(0x7<<0);
        u32RegValue |= 2;
        HI_SYS_WriteRegister(0xf8a210ec, u32RegValue);
    }
#endif
#if defined (CHIP_TYPE_hi3716mv410)

    //config reset gpio output
    HI_SYS_ReadRegister(0xf8a21068, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D7  ioshare_26  demod_reset
    HI_SYS_WriteRegister(0xf8a21068, u32RegValue);

    //config i2c scl/sda multiplex
    HI_SYS_ReadRegister(0xf8a21078, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D3  ioshare_30  SCL
    u32RegValue |= 3;
    HI_SYS_WriteRegister(0xf8a21078, u32RegValue);
    HI_SYS_ReadRegister(0xf8a2107c, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D2  ioshare_31  SDA
    u32RegValue |= 3;
    HI_SYS_WriteRegister(0xf8a2107c, u32RegValue);

    //config TS0 multiplex
    HI_SYS_ReadRegister(0xf8a21084, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D0  ioshare_33  tsi0_d0
    u32RegValue |= 1;
    HI_SYS_WriteRegister(0xf8a21084, u32RegValue);

    HI_SYS_ReadRegister(0xf8a21080, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D1  ioshare_32  tsi0_d1
    u32RegValue |= 1;
    HI_SYS_WriteRegister(0xf8a21080, u32RegValue);

    //config TS1 multiplex
    HI_SYS_ReadRegister(0xf8a2106c, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D6  ioshare_27  tsi1_d0
    u32RegValue |= 3;
    HI_SYS_WriteRegister(0xf8a2106c, u32RegValue);
    HI_SYS_ReadRegister(0xf8a21070, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D5  ioshare_28  tsi1_clk
    u32RegValue |= 3;
    HI_SYS_WriteRegister(0xf8a21070, u32RegValue);
    HI_SYS_ReadRegister(0xf8a21074, &u32RegValue);
    u32RegValue &= ~(0x7<<0);     //TSI0_D4  ioshare_29  tsi1_valid
    u32RegValue |= 3;
    HI_SYS_WriteRegister(0xf8a21074, u32RegValue);
...
void set_demux()
{
    ...
    HI_SYS_ReadRegister(0xf9c01200, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01200, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01300, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01300, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01400, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01400, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01500, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01500, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01600, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01600, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01700, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01700, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01800, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01800, u32RegValue);
#endif

#if defined (CHIP_TYPE_hi3798mv200)

    HI_SYS_ReadRegister(0xf9c01100, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01100, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01200, &u32RegValue);
    u32RegValue |= 0x8000;
    HI_SYS_WriteRegister(0xf9c01200, u32RegValue);
    HI_SYS_ReadRegister(0xf9c01300, &u32RegValue);
...
HI_S32 dev_init()
{
    ...
    CfgTunerNum = HIADP_INI_Getl("tunernum", "TunerNum", DEFAULT_TUNER_NUM, FRONTEND_CONFIG_FILE);
    if(CfgTunerNum > HI_TUNER_NUMBER)
    {
        sample_common_printf("[%s] CfgTunerNum[%d] is out of max number[%d].\n", __FUNCTION__, CfgTunerNum, HI_TUNER_NUMBER);
        return HI_FAILURE;
    }

    for (i = 0; i < CfgTunerNum; i++)
    {
...
static HI_S32 hi_tuner_getplpinfo()
{
    ...
    HI_U8 u8PLPNUM = 0;
    HI_UNF_TUNER_TER_PLP_PARA_S stPLPPara[16];
    HI_UNF_TUNER_TER_PLP_INFO_S stPlpAttr[16],stPlpBuf;
    HI_U8 i = 0,j,k,u8GrpNum = 0,u8Cnt = 0,u8CommExist = 0;
    ...
    {
        s32Ret = HI_UNF_TUNER_GetPLPInfo(s_s32TunerPort, i, &stPlpAttr[i]);
        if(HI_SUCCESS != s32Ret)
        {
            HI_TUNER_ERR("HI_UNF_TUNER_GetPLPInfo error.\n");
        }
    }
    ...
    for(i=0;i<u8PLPNUM-1;i++)
    {
        for(j=0;j<u8PLPNUM - 1-i;j++)
        {
            ...
            {
                memcpy(&stPlpBuf,&stPlpAttr[j],sizeof(HI_UNF_TUNER_TER_PLP_INFO_S));
                memcpy(&stPlpAttr[j],&stPlpAttr[j+1],sizeof(HI_UNF_TUNER_TER_PLP_INFO_S));
                memcpy(&stPlpAttr[j+1],&stPlpBuf,sizeof(HI_UNF_TUNER_TER_PLP_INFO_S));
            }
        }
    }
    ...
    printf("plp id       group plp id       plp type\n");
    for(i=0;i<u8PLPNUM;i++)
    {
       printf("%d              %d                  %d\n",stPlpAttr[i].u8PlpId,stPlpAttr[i].u8PlpGrpId,stPlpAttr[i].enPlpType);
    }
    printf("---------------------------------------------\n");
    ...
    for(i=0,k=0;i<u8PLPNUM;i++)
    {
        ...
        stPLPPara[k].u8PlpId = stPlpAttr[i].u8PlpId;
        stPLPPara[k].u8CommPlpId = T2PLPArray[j].u8CommId;
        stPLPPara[k].u8Combination = T2PLPArray[j].u8Combination;
        k++;
    }

    printf("plp id       common plp id       combination\n");
    for(i=0;i<k;i++)
    {
        printf("%d              %d                  %d\n",stPLPPara[i].u8PlpId,stPLPPara[i].u8CommPlpId,stPLPPara[i].u8Combination);
    }
...
HI_S32 hi_tuner_connect()
{
    ...
    switch ((HI_U32)s_stConnectPara[s_s32TunerPort].enSigType)
    {
        ...
        case HI_UNF_TUNER_SIG_TYPE_J83B:
            ...
            if (HI_UNF_MOD_TYPE_QAM_16 == s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.enModType)
                u32ModType = 16;
            else if (HI_UNF_MOD_TYPE_QAM_32 == s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.enModType)
                u32ModType = 32;
            else if (HI_UNF_MOD_TYPE_QAM_64 == s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.enModType)
                u32ModType = 64;
            else if (HI_UNF_MOD_TYPE_QAM_128 == s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.enModType)
                u32ModType = 128;
            else if (HI_UNF_MOD_TYPE_QAM_256 == s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.enModType)
                u32ModType = 256;
            else
                return HI_FAILURE;
...
HI_VOID hi_tuner_selectCurrentPort(char * pPort)
{
    ...
    if(s_s32TunerPort >= CfgTunerNum)
    {
        s_s32TunerPort %= CfgTunerNum;
    }
...
HI_VOID hi_tuner_setchannel(char * channel)
{
            ...
            || (s_stConnectPara[s_s32TunerPort].enSigType == HI_UNF_TUNER_SIG_TYPE_J83B))
    {
        ...
        {
            case 16:
                enModType = HI_UNF_MOD_TYPE_QAM_16;
                break;
            case 32:
                enModType = HI_UNF_MOD_TYPE_QAM_32;
                break;
            case 64:
                enModType = HI_UNF_MOD_TYPE_QAM_64;
                break;
            case 128:
                enModType = HI_UNF_MOD_TYPE_QAM_128;
                break;
            case 256:
                enModType = HI_UNF_MOD_TYPE_QAM_256;
                break;
            default:
                printf("qam type:%d err.\n",u32Polar);
                return;
        }
        s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.u32Freq = u32Freq;
        s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.u32SymbolRate = u32Symb*1000;
        s_stConnectPara[s_s32TunerPort].unConnectPara.stCab.enModType = enModType;
    }
...
{
    HI_CHAR *acGuardIntv[] = {"1/128", "1/32", "1/16", "1/8", "1/4", "19/128", "19/256"};
    HI_CHAR *acFFTType[] = {"1K", "2K", "4K", "8K", "16K", "32K", "64K"};

    hi_tuner_getsignalinfo_fec(enSigType, pstTer->enFECRate);

    printf("GI:\t\t\t");
    /* enGuardIntv = 0 is HI_UNF_TUNER_FE_GUARD_INTV_DEFALUT, so valid enGuardIntv range is 1 to sizeof(acGuardIntv)/sizeof(acGuardIntv[0]) */
    if (pstTer->enGuardIntv <= 0 || pstTer->enGuardIntv > sizeof(acGuardIntv)/sizeof(acGuardIntv[0]))
    {
        printf("Unknown\n");
    }
    else
    {
        printf("%s\n", acGuardIntv[pstTer->enGuardIntv - 1]);
    }
    ...
    printf("FFTMode:\t\t");
    if (pstTer->enFFTMode <= 0 || pstTer->enFFTMode >= sizeof(acFFTType)/sizeof(acFFTType[0]))
    {
        printf("Unknown\n");
    }
    else
    {
        if ((HI_UNF_TUNER_SIG_TYPE_DVB_T2 == enSigType)
            && (HI_UNF_TUNER_TER_EXTEND_CARRIER == pstTer->enCarrierMode))
        {
            printf("%s Ext\n", acFFTType[pstTer->enFFTMode - 1]);
        }
        else
        {
            printf("%s\n", acFFTType[pstTer->enFFTMode - 1]);
    ...
    {
        if (pstTer->enPilotPattern < HI_UNF_TUNER_T2_PILOT_PATTERN_BUTT)
        {
            printf("Pilot Pattern:\t\tPP%d\n", pstTer->enPilotPattern + 1);
        }
        else
        {
            printf("Pilot Pattern:\t\tUnknown\n");
        }
        switch (pstTer->enPLPType)
        {
            case HI_UNF_TUNER_T2_PLP_TYPE_COM:
                printf("Current PLP type:\tCommon\n");
                break;
            case HI_UNF_TUNER_T2_PLP_TYPE_DAT1:
                printf("Current PLP type:\tType1\n");
                break;
            case HI_UNF_TUNER_T2_PLP_TYPE_DAT2:
                printf("Current PLP type:\tType2\n");
                break;
            default:
                printf("Current PLP type:\tUnknown\n");
                break;
        }
        switch (pstTer->enChannelMode)
        {
            case HI_UNF_TUNER_TER_MODE_BASE:
                printf("BaseLite:\t\tBase\n");
                break;
            case HI_UNF_TUNER_TER_MODE_LITE:
                printf("BaseLite:\t\tLite\n");
                break;
            default:
                printf("BaseLite:\t\tUnknown\n");
                break;
        }
        switch (pstTer->enDVBT2ISSY)
        {
            case HI_UNF_TUNER_DVBT2_ISSY_NO:
                printf("ISSY:\t\t\tNO\n");
                break;
            case HI_UNF_TUNER_DVBT2_ISSY_LONG:
                printf("ISSY:\t\t\tLong\n");
                break;
            case HI_UNF_TUNER_DVBT2_ISSY_SHORT:
                printf("ISSY:\t\t\tShort\n");
                break;
            default:
                printf("ISSY:\t\t\tUnknown\n");
        ...
        switch (pstTer->enStreamType)
        {
            case HI_UNF_TUNER_TER_STREAM_TYPE_GFPS:
                printf("Stream Type:\t\tGFPS\n");
                break;
            case HI_UNF_TUNER_TER_STREAM_TYPE_GCS:
                printf("Stream Type:\t\tGCS\n");
                break;
            case HI_UNF_TUNER_TER_STREAM_TYPE_GSE:
                printf("Stream Type:\t\tGSE\n");
                break;
            case HI_UNF_TUNER_TER_STREAM_TYPE_TS:
                printf("Stream Type:\t\tTS\n");
                break;
            case HI_UNF_TUNER_TER_STREAM_TYPE_GSE_HEM:
                printf("Stream Type:\t\tGSE_HEM\n");
                break;
            case HI_UNF_TUNER_TER_STREAM_TYPE_TS_HEM:
                printf("Stream Type:\t\tTS_HEM\n");
                break;
            default:
...
static HI_VOID hi_tuner_getsignalinfo_isdbt(HI_UNF_TUNER_ISDB_T_SIGNALINFO_S *pstIsdbT)
{
    ...
    switch (pstIsdbT->enGuardIntv)
    {
        case HI_UNF_TUNER_FE_GUARD_INTV_1_32:
            printf("Guard Intv:\t\t1/32\n");
            break;
        case HI_UNF_TUNER_FE_GUARD_INTV_1_16:
            printf("Guard Intv:\t\t1/16\n");
            break;
        case HI_UNF_TUNER_FE_GUARD_INTV_1_8:
            printf("Guard Intv:\t\t1/8\n");
            break;
        case HI_UNF_TUNER_FE_GUARD_INTV_1_4:
            printf("Guard Intv:\t\t1/4\n");
            break;
        default:
            printf("Guard Intv:\t\tUnknown\n");
            break;
    }
    switch (pstIsdbT->enFFTMode)
    {
...
HI_VOID hi_tuner_setplpid(char * plpid)
{
    ...
    HI_UNF_TUNER_TER_PLP_PARA_S stPLPPara = {0};
    HI_S32 s32Return;
    HI_UNF_AVPLAY_STOP_OPT_S    stStop;
    HI_UNF_VCODEC_ATTR_S        stVdecAttr;
    ...
    stPLPPara.u8PlpId = u32PLPID;
    stPLPPara.u8CommPlpId = u32ComPlpId;
    stPLPPara.u8Combination = u32Combination;
    if (HI_SUCCESS != HI_UNF_TUNER_SetPLPPara(s_s32TunerPort, &stPLPPara))
    {
        printf("set plp para %d %d %d failed.\n", stPLPPara.u8PlpId, stPLPPara.u8CommPlpId, stPLPPara.u8Combination);
    }
...
static HI_VOID hi_show_tuner_type(HI_UNF_TUNER_DEV_TYPE_E enTunerDevType, HI_CHAR **ppTunerType)
{
    ...
    HI_U32 u32TunerNum = sizeof(acTunerName) / sizeof(acTunerName[0]);

    if (enTunerDevType < u32TunerNum)
    {
