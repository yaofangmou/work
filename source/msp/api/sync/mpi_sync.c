...
HI_VOID SYNC_ResetStatInfo(SYNC_S *pSync, SYNC_CHAN_E enChn)
{
    if (enChn == SYNC_CHAN_VID)
    {
        ...
        pSync->VidLastValidPts = HI_INVALID_PTS;
    }
    ...
    if (enChn == SYNC_CHAN_AUD)
    {
        ...
        pSync->SyncFinish = HI_FALSE;
        pSync->AudLastValidPts = HI_INVALID_PTS;
    ...
    if ((!pSync->VidEnable) && (!pSync->AudEnable))
    {
        ...
        pSync->PcrSyncInfo.PcrLeadSeriesCnt = 0;
        pSync->PcrSyncInfo.PcrLagSeriesCnt = 0;
        pSync->PcrSyncInfo.StcInfo.StcLast = HI_INVALID_PTS;
        ...
        pSync->PcrSyncInfo.PcrLastValid = HI_INVALID_PTS;
