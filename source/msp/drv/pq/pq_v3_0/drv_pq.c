...
HI_S32 DRV_PQ_SetVpssZme(HI_PQ_VPSS_ZME_LAYER_E enLayerId, HI_VOID *pstReg, HI_PQ_ZME_PARA_IN_S *pstZmePara, HI_BOOL  bFirEnable)
{
    ...
    PQ_MNG_SetVpssZme(enLayerId, (S_VPSS_REGS_TYPE *)pstReg, (ALG_VZME_DRV_PARA_S *)pstZmePara, bFirEnable);
    return HI_SUCCESS;
}
...
HI_S32 DRV_PQ_SetAlgCalcCfg(HI_PQ_WBC_INFO_S *pstVpssWbcInfo, HI_PQ_CFG_INFO_S *pstVpssCfgInfo)
{
    ...
    if (0 == pstVpssWbcInfo->bProgressive) /* Progressive */
    {
        ...
        stIfmdCalcInfo.pstIfmdHardOutReg = (S_VPSS_STT_REGS_TYPE *)(pstVpssWbcInfo->pstVPSSWbcReg);
