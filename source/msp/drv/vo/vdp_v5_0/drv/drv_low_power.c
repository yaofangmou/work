...
static HI_S32 LowPower_OpenLayerClock(VDP_LAYER_VID_E enLayer)
{
    ...
    switch (enLayer)
    {
        ...
        case VDP_LAYER_SD0 :
            ...
            s32Ret = LowPower_SetLayerClockEn(VDP_LAYER_SD0, HI_TRUE);
            break;
        default:
            s32Ret = HI_SUCCESS;
    }
...
static HI_S32 LowPower_Callback(const ASYNC_MSG_S *pAsyncMsg)
{
    ...
    switch (msg.enRegName)
    {
        ...
        case REG_V3_LAYER_CLOCK_GATE :
            if (HI_SUCCESS != LowPower_SetLayerClockEn(VDP_LAYER_SD0, msg.bRegStatus))
            {
                return HI_FAILURE;
            }
            break;
...
HI_S32 LowPower_OpenIsogeny(HI_VOID)
{
    ...
    /* Open V3 clock gate */
    LowPower_DelMsg(REG_V3_LAYER_CLOCK_GATE, HI_FALSE);
    if (HI_SUCCESS != LowPower_SetLayerClockEn(VDP_LAYER_SD0, HI_TRUE))
    {
        return HI_FAILURE;
    }
