...
CONFIG_EXTERN_FLAGS := \
        ...
        $(if $(CFG_HI_BOOT_HSL_SUPPORT),CONFIG_HSL_SUPPORT=1,) \
        $(if $(CFG_FPGA),CFG_$(BOOTCONFIG_UPPER)_FPGA=1,) \
        ...
        $(if $(CFG_HI_TEE_ATF_SUPPORT),CONFIG_TEE_ATF_SUPPORT=$(CFG_HI_TEE_ATF_SUPPORT)) \
...
ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv410 hi3716mv420 hi3798cv200 hi3798mv200 hi3798mv300 hi3796mv200 hi3716mv450 hi3716mv430),)
