...
typedef struct
{
    ...
    HI_BOOL                 bAllocFrmFlag;  /* Alloc Frame flag */
    wait_queue_head_t       stAllocQue;     /* Alloc queue */
} VDEC_GLOBAL_PARAM_S;
...
static HI_S32 VDEC_EventHandle(HI_S32 s32ChanID, HI_S32 s32EventType, HI_VOID *pArgs)
{
    ...
    switch (s32EventType)
    {
        ...
        case EVNT_ARRANGE_FRAME_BUF:
            ...
            s_stVdecDrv.bAllocFrmFlag = HI_TRUE;
            VDEC_GiveEvent(s_stVdecDrv.stAllocQue);
...
static HI_S32 VDEC_GetCap(VDEC_IOCTL_MSG *pMsg)
{
    ...
    s32Ret = (s_stVdecDrv.pVfmwFunc->pfnVfmwControl)(HI_INVALID_HANDLE, VDEC_CID_GET_CAPABILITY, &stCap);
...
static SINT32 VdecTaskFunc(VOID *param)   //sdk
{
    ...
    while (1)
    {
        ...
        VDEC_WaitEvent(s_stVdecDrv.stAllocQue, s_stVdecDrv.bAllocFrmFlag != HI_FALSE, msecs_to_jiffies(10));
        s_stVdecDrv.bAllocFrmFlag = HI_FALSE;
...
static HI_S32 VDEC_OpenDev(HI_VOID)
{
    ...
    s_stVdecDrv.bAllocFrmFlag = HI_FALSE;
    VDEC_InitEvent(s_stVdecDrv.stAllocQue);
    /* Init buffer manager */
    BUFMNG_Init();
...
HI_S32 HI_DRV_VDEC_ChanBufferInit(HI_HANDLE hHandle, HI_U32 u32BufSize, HI_HANDLE hDmxVidChn)
{
    ...
    memset(&stBuf, 0, sizeof(HI_DRV_VDEC_STREAM_BUF_S));
