...
#include "./hi3716mv430/hi_reg_sys.h"
#include "./hi3716mv430/hi_reg_peri.h"
#include "./hi3716mv430/hi_reg_io.h"
#include "./hi3716mv430/hi_reg_crg.h"

#endif

#define HI_SYS_BASE_ADDR        0xF8000000
#define HI_SYS_END_ADDR         0xF8000FFF

#define HI_PERI_BASE_ADDR       0xF8A20000
#define HI_PERI_END_ADDR        0xF8A20FFF

#define HI_IO_BASE_ADDR         0xF8A21000
#define HI_IO_END_ADDR          0xF8A21FFF

#define HI_CRG_BASE_ADDR        0xF8A22000
#define HI_CRG_END_ADDR         0xF8A22FFF

#define HI_OTP_BASE_ADDR        0xF8AB0000
#define HI_OTP_END_ADDR         0xF8ABFFFF
