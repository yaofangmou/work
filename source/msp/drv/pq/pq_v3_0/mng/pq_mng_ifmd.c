...
static HI_S32 PQ_MNG_GetIfmdSoftTable(HI_BOOL bInit)
{
    ...
    g_u32IPDetect     = 0;//PQ_MNG_GetSoftTable(PQ_SOFT_IP_DETECT,    PQ_SOURCE_MODE_NO, PQ_OUTPUT_MODE_NO, IP_DECTECT_INTERLACE_PRIMARY);
#if defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420)
    g_u32FrmRateThr_L = 23800;//PQ_MNG_GetSoftTable(PQ_SOFT_FRMRATETHR_L, PQ_SOURCE_MODE_NO, PQ_OUTPUT_MODE_NO, PLAYBACK_FRMRATETHR_L);
    g_u32FrmRateThr_H = 24200;//PQ_MNG_GetSoftTable(PQ_SOFT_FRMRATETHR_H, PQ_SOURCE_MODE_NO, PQ_OUTPUT_MODE_NO, PLAYBACK_FRMRATETHR_H);
#endif
