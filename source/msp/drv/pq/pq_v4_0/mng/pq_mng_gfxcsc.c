...
HI_S32 PQ_MNG_GetGfxCscColorTemp(HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    pstTemperature->u32Red   = stGfxCscTuning.u32Kr;
    pstTemperature->u32Green = stGfxCscTuning.u32Kg;
    pstTemperature->u32Blue  = stGfxCscTuning.u32Kb;

    return HI_SUCCESS;
}

HI_S32  PQ_MNG_SetGfxCscColorTemp(HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    stGfxCscTuning.u32Kr = pstTemperature->u32Red;
    stGfxCscTuning.u32Kg = pstTemperature->u32Green;
    stGfxCscTuning.u32Kb = pstTemperature->u32Blue;
...
static stPQAlgFuncs stGfxCSCFuncs =
{
    ...
    .GetColorTemp             = PQ_MNG_GetGfxCscColorTemp,
    .SetColorTemp             = PQ_MNG_SetGfxCscColorTemp,
};
