...
static HI_S32 WINProcessCmdSetTechnicolorLibStatus( HI_VOID *arg, WIN_STATE_S *pstWinState);
...
static HI_S32 WINProcessCmdGetTechniOutputBright( HI_VOID *arg, WIN_STATE_S *pstWinState);
...
static const stWINProcessCmdFunc s_aWINCmdFuncTab[] =
{
    ...
    {CMD_WIN_SET_TECHNI_LIB_STATUS, WINProcessCmdSetTechnicolorLibStatus},
    ...
    {CMD_WIN_GET_TECHNI_OUT_BRIGHT, WINProcessCmdGetTechniOutputBright},
};
    ...
    */
    ...
    if (g_pWinProcLevel >= WIN_PROC_EXTREN_WIN_POSI)
    {
        PROC_PRINT(p,
                   ...
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.stInRect.s32X, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stInRect.s32Y, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stInRect.s32Width, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stInRect.s32Height,
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.stVideo.s32X, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stVideo.s32Y, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stVideo.s32Width, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stVideo.s32Height,
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.stDisp.s32X, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stDisp.s32Y, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stDisp.s32Width, pstProcInfo->stWinDebugInfo.stWinLogicInfo.stDisp.s32Height,
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.surface_en,
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.data_width,
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.nosec_flag,
                   pstProcInfo->stWinDebugInfo.stWinLogicInfo.mute_en,
    ...
    if (g_pWinProcLevel >= WIN_PROC_EXTREN_WIN_POSI)
    {
        PROC_PRINT(p,
                           "------------------------------AFD debug info----------------------------\n"
                           "active_format:                              (%d)\n"
                           "active_format_flag:                         (%d)\n"
                           "DrvPara:\n"
                           "           eAspMode(full/let/pan/cmb):      (%d)\n"
                           "           AspectWidth:                     (%d)\n"
                           "           AspectHeight:                    (%d)\n"
                           "           DeviceWidth:                     (%d)\n"
                           "           DeviceHeight:                    (%d)\n"
                           "           stUsrAsp(Ratio,W,H):             (%d,%d,%d)\n"
                           "           stInWnd:                         (%d,%d,%d,%d)\n"
                           "           stSrcRect:                       (%d,%d,%d,%d)\n"
                           "           stOutWnd:                        (%d,%d,%d,%d)\n"
                           "           stScreen:                        (%d,%d,%d,%d)\n"
                    ...
                    pstProcInfo->stBufState.stCurrentFrame.active_format,
                    pstProcInfo->stBufState.stCurrentFrame.active_format_flag,

                    pstProcInfo->stWinDebugInfo.stDrvPara.eAspMode,

                    pstProcInfo->stWinDebugInfo.stDrvPara.AspectWidth,
                    pstProcInfo->stWinDebugInfo.stDrvPara.AspectHeight,
                    pstProcInfo->stWinDebugInfo.stDrvPara.DeviceWidth,
                    pstProcInfo->stWinDebugInfo.stDrvPara.DeviceHeight,

                    pstProcInfo->stWinDebugInfo.stDrvPara.stUsrAsp.bUserDefAspectRatio,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stUsrAsp.u32UserAspectWidth,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stUsrAsp.u32UserAspectHeight,

                    pstProcInfo->stWinDebugInfo.stDrvPara.stInWnd.s32X,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stInWnd.s32Y,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stInWnd.s32Width,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stInWnd.s32Height,

                    pstProcInfo->stWinDebugInfo.stDrvPara.stSrcRect.s32X,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stSrcRect.s32Y,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stSrcRect.s32Width,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stSrcRect.s32Height,

                    pstProcInfo->stWinDebugInfo.stDrvPara.stOutWnd.s32X,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stOutWnd.s32Y,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stOutWnd.s32Width,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stOutWnd.s32Height,

                    pstProcInfo->stWinDebugInfo.stDrvPara.stScreen.s32X,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stScreen.s32Y,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stScreen.s32Width,
                    pstProcInfo->stWinDebugInfo.stDrvPara.stScreen.s32Height,


                    pstProcInfo->stWinDebugInfo.stOutPara.stCropWnd.s32X,
                    pstProcInfo->stWinDebugInfo.stOutPara.stCropWnd.s32Y,
                    pstProcInfo->stWinDebugInfo.stOutPara.stCropWnd.s32Width,
                    pstProcInfo->stWinDebugInfo.stOutPara.stCropWnd.s32Height,

                    pstProcInfo->stWinDebugInfo.stOutPara.stOutWnd.s32X,
                    pstProcInfo->stWinDebugInfo.stOutPara.stOutWnd.s32Y,
                    pstProcInfo->stWinDebugInfo.stOutPara.stOutWnd.s32Width,
                    pstProcInfo->stWinDebugInfo.stOutPara.stOutWnd.s32Height,

                    pstProcInfo->stWinDebugInfo.stOutPara.stOutScreen.s32X,
                    pstProcInfo->stWinDebugInfo.stOutPara.stOutScreen.s32Y,
                    pstProcInfo->stWinDebugInfo.stOutPara.stOutScreen.s32Width,
                    pstProcInfo->stWinDebugInfo.stOutPara.stOutScreen.s32Height,

                    pstProcInfo->stWinDebugInfo.stOutPara.u32ZmeW,
                    pstProcInfo->stWinDebugInfo.stOutPara.u32ZmeH,

                    pstProcInfo->stWinDebugInfo.stOutPara.bEnAsp,
                    pstProcInfo->stWinDebugInfo.stOutPara.bEnCrop,
                    pstProcInfo->stWinDebugInfo.stOutPara.u32BgColor,
                    pstProcInfo->stWinDebugInfo.stOutPara.u32BgAlpha
...
HI_VOID WIN_ProcWriteHelp(HI_VOID)
{
    ...
    HI_DRV_PROC_EchoHelper("echo AFD     (8/9/10/11/13/14/15)   > /proc/msp/winXXXX  \n");
...
{
    HI_S32  s32Ret = HI_SUCCESS;
    HI_U32  u32Value = (HI_U32)simple_strtol(pArg2, NULL, 10);

    switch (u32Value)
    {
        case 0:
            s32Ret = WIN_SetRotation(hWin, HI_DRV_ROT_ANGLE_0);
            break;
        case 90:
            s32Ret = WIN_SetRotation(hWin, HI_DRV_ROT_ANGLE_90);
            break;
        case 180:
            s32Ret = WIN_SetRotation(hWin, HI_DRV_ROT_ANGLE_180);
            break;
        case 270:
            s32Ret = WIN_SetRotation(hWin, HI_DRV_ROT_ANGLE_270);
            break;
        default:
            HI_ERR_WIN("Error Rotation:%d\n", u32Value);
            break;
    }
...
HI_S32 WinProcFlip(HI_HANDLE hWin, HI_CHAR *pArg2)
{
    ...
    HI_CHAR chHoriFlip[2] = {0}, chVertFlip[2] = {0};
    HI_U32 u32Index = 0, u32HIndex = 0, u32VIndex = 0;
    HI_BOOL bHoriFlip = 0, bVertFlip = 0;

    pTmpCh = pArg2;
    while ((*pTmpCh != ' ') && (*pTmpCh != '\0') && (*pTmpCh != '\n'))
    {
        if (*pTmpCh != ',')
        {
            switch (u32Index)
            {
                case 0:
                    if (u32HIndex >= 1)
                    {
                        HI_ERR_WIN("Hori:[0 or 1]\n");
                        return HI_FAILURE;
                    }
                    chHoriFlip[u32HIndex++] = *pTmpCh;
                    break;
                case 1:
                    if (u32VIndex >= 1)
                    {
                        HI_ERR_WIN("Vert:[0 or 1]\n");
                        return HI_FAILURE;
                    }
                    chVertFlip[u32VIndex++] = *pTmpCh;
                    break;
                default:
                    HI_ERR_WIN("Too many parameters.[%d]\n", u32Index);
                    break;
            }
        }
        else
    ...
    chHoriFlip[u32HIndex] = '\0';
    chVertFlip[u32VIndex] = '\0';

    /* transfer to integer. */
    if (0 == simple_strtol(chHoriFlip, NULL, 10))
    {
        bHoriFlip = HI_FALSE;
    }
    else if (1 == simple_strtol(chHoriFlip, NULL, 10))
    {
        bHoriFlip = HI_TRUE;
    }
    else
    {
        HI_ERR_WIN("u32H:[0 or 1]\n");

        return HI_FAILURE;
    }

    if (0 == simple_strtol(chVertFlip, NULL, 10))
    {
        bVertFlip = HI_FALSE;
    }
    else if (1 == simple_strtol(chVertFlip, NULL, 10))
    {
        bVertFlip = HI_TRUE;
    }
    else
    {
        HI_ERR_WIN("u32V:[0 or 1]\n");

        return HI_FAILURE;
    }

    s32Ret = WIN_SetFlip(hWin, bHoriFlip, bVertFlip);
...
HI_S32 WinProcShowTechniLibInfo(HI_HANDLE hWin, HI_CHAR *pArg2)
{
    WIN_ShowTechniLibInfo();
...
HI_S32 WinProcSetAFD( HI_HANDLE hWin, HI_CHAR *pArg2)
{
    HI_S32  s32Ret = HI_SUCCESS;
    HI_U32 u32Value = (HI_U32)simple_strtol(pArg2, NULL, 10);
    WINDOW_S *pstWin = HI_NULL;
    ...
    if ((u32Value >= HI_DRV_AFD_TYPE_SAME_AS_SRC) && (u32Value < HI_DRV_AFD_TYPE_BUTT))
    {
        pstWin->stWinDebugInfo.stDebugAFDInfo.bEnable = HI_TRUE;
        pstWin->stWinDebugInfo.stDebugAFDInfo.eActiveFormat = u32Value;
    }
    else
    {
        pstWin->stWinDebugInfo.stDebugAFDInfo.bEnable = HI_FALSE;
        HI_ERR_WIN("Input Value Error!\n");
    }

    //HI_ERR_WIN("Not support set AFD now\n");
...
static const WIN_PROC_COMMAND WinProcCmds[] =
{
    ...
    {"technilib", WinProcShowTechniLibInfo},
...
{
    HI_S32 Ret = HI_SUCCESS;
    WIN_SYNCFRAME_S  *pstSyncFrame;

    pstSyncFrame = (WIN_SYNCFRAME_S *)arg;

    Ret = WIN_CheckHanlde(pstSyncFrame->stXdrFrame.hWindow, pstWinState);
    if (HI_SUCCESS == Ret)
    {
        Ret = WIN_QueueSyncFrame(pstSyncFrame->stXdrFrame.hWindow, &pstSyncFrame->stXdrFrame, &pstSyncFrame->u32FenceFd);
    }
...
{
    HI_S32 Ret = HI_SUCCESS;
    WIN_TECHNICOLOR_LIB_INFO_S *pstWinTechnicolorLibInfo;
    pstWinTechnicolorLibInfo = (WIN_TECHNICOLOR_LIB_INFO_S *)arg;
    Ret = WIN_SetTechnicolorLibInfo(pstWinTechnicolorLibInfo);
...
static HI_S32 WINProcessCmdGetTechniOutputBright( HI_VOID *arg, WIN_STATE_S *pstWinState)
{
    WIN_TECHNI_DISP_BRIGHT *pstTechniDispBright = HI_NULL ;

    pstTechniDispBright = (WIN_TECHNI_DISP_BRIGHT *)arg;

    return WIN_GetTechniOutputBright(&pstTechniDispBright->u32TechniDispBright);
}
...
HI_S32 HI_DRV_WIN_CapturePicture(HI_HANDLE hWin, HI_DRV_VIDEO_FRAME_S *pstPic)
{
    ...
    g_stCapture.hWindow = hWin;

    Ret = DRV_WIN_Process(CMD_VO_WIN_CAPTURE_START, &g_stCapture);
    if (HI_SUCCESS != Ret)
    {
    ...
    g_stCapture.hWindow = hWin;
    pstPic->stBufAddr[0].u32PhyAddr_Y = g_stCapture.driver_supply_addr.startPhyAddr;

    (HI_VOID)Make_CaptureFrame(&(g_stCapture.CapPicture), pstPic);

    g_stCapture.hWindow = hWin;
    Ret = DRV_WIN_Process(CMD_VO_WIN_CAPTURE_RELEASE, &g_stCapture);
    if (HI_SUCCESS != Ret)
    {
...
HI_S32 HI_DRV_WIN_CapturePictureRelease(HI_HANDLE hWin, HI_DRV_VIDEO_FRAME_S *pstPic)
{
    ...
    g_stCapture.hWindow = hWin;
    g_stCapture.CapPicture = *pstPic;

    Ret = DRV_WIN_Process(CMD_VO_WIN_CAPTURE_FREE, &g_stCapture);
...
HI_DRV_WIN_PLAY_INFO_S g_stDrvWinPlayInfo;
...
HI_S32 HI_DRV_WIN_GetDelayMs(HI_HANDLE hWindow, HI_U32 *pu32DelayTime)
{
    ...
    Ret = HI_DRV_WIN_GetPlayInfo(hWindow, &g_stDrvWinPlayInfo);
    if (HI_SUCCESS == Ret)
    {
        *pu32DelayTime =  g_stDrvWinPlayInfo.u32DelayTime;
    }

    return Ret;
}

WIN_PLAY_INFO_S g_stWinPlayInfo = {0};
...
HI_S32 HI_DRV_WIN_GetPlayInfo(HI_HANDLE hWindow, HI_DRV_WIN_PLAY_INFO_S *pInfo)
{
    ...
    memset(&g_stWinPlayInfo, 0, sizeof(WIN_PLAY_INFO_S));
    WinCheckNullPointer(pInfo);
    g_stWinPlayInfo.hWindow = hWindow;

    Ret = DRV_WIN_Process(CMD_WIN_GET_PLAY_INFO, &g_stWinPlayInfo);
    *pInfo = g_stWinPlayInfo.stPlayInfo;
    return Ret;
}
