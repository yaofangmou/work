...
#ifdef HI_SYNC_PROC_SUPPORT
    SYNC_ProcDebugInfo(g_SyncGlobalState.SyncInfo[i].pSync, SYNC_DBG_INFO_LIST_INITIAL, HI_NULL);
#endif
#endif
...
#ifdef HI_SYNC_PROC_SUPPORT
#ifdef SYNC_DEBUG_DETAIL
    SYNC_ProcDebugInfo(g_SyncGlobalState.SyncInfo[SyncId].pSync, SYNC_DBG_INFO_LIST_RELEASE, HI_NULL);
#endif
    if (g_pSyncProcPara)
    {
...
static SYNC_EXPORT_FUNC_S g_SyncExportFuncs =
{
    ...
    .pfnSYNC_SetHpllConfigFlg = SYNC_SetHpllConfigFlg,
#else
    .pfnSYNC_SetHpllConfigFlg = HI_NULL,
#endif
};
