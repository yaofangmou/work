...
PRODUCT_DIR := Hi3716MV430_HD_FULL
else ifeq ($(CFG_HI_VDEC_DECODE_CAPABILITY),HD_BASIC)
PRODUCT_DIR := Hi3716MV430_HD_BASIC
else ifeq ($(CFG_HI_VDEC_DECODE_CAPABILITY),HD_SIMPLE)
PRODUCT_DIR := Hi3716MV430_HD_SIMPLE
else
PRODUCT_DIR := Hi3716MV430_HD_FULL
endif
ASM_CFLAGS += -DCHIP_TYPE_hi3716mv430
endif
...
OPEN_SRC += $(VFMW_BASE)/module/vmm/vmm_command_intf.S $(VFMW_BASE)/module/vmm/vmm_core.S $(VFMW_BASE)/module/vmm/vmm_list_common.S $(VFMW_BASE)/module/vmm/vmm_memlist_manager.S $(VFMW_BASE)/module/vmm/vmm_memory_ops.S $(VFMW_BASE)/module/vmm/vmm_msglist_manager.S $(VFMW_BASE)/module/vmm/vmm_osal.S $(VFMW_BASE)/module/vmm/vmm_memory_dynamic.S $(VFMW_BASE)/module/vmm/vmm_memory_preserve.S $(VFMW_BASE)/module/vmm/vmm_custom.S $(VFMW_BASE)/module/vmm/vmm_memory_common.S
