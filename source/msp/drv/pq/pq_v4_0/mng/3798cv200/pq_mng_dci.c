...
static HI_BOOL  bHdrProcessEn = HI_FALSE;
...
HI_S32 PQ_MNG_EnableDCI(HI_BOOL bOnOff)
{
    ...
    HI_BOOL bDciEn1 = HI_TRUE;
    HI_BOOL bDciEn2 = HI_TRUE;
    HI_BOOL bDciEn3 = HI_TRUE;
    ...
    sg_bDciEn = bOnOff & bDciEn1 & bDciEn2 & bDciEn3;

    PQ_HAL_EnableDCI(PQ_HAL_LAYER_VID0, sg_bDciEn);
...
static HI_S32 PQ_MNG_GetHdrDciCfg(HI_PQ_XDR_FRAME_INFO *pstXdrFrameInfo, HI_PQ_HDR_CFG *pstPqHdrCfg)
{
    ...
    {
        bHdrProcessEn = HI_FALSE;
    }
    else
    {
        bHdrProcessEn = HI_TRUE;
    }
