...
typedef struct
{
    ...
    HI_S32  (*DRV_HIFB_GFX2D_Blit)           (HIFB_BUFFER_S *pSrcImg, HIFB_BUFFER_S *pDstImg,  HIFB_BLIT_OPT_S *pstOpt,HI_BOOL bScreenRefresh);
    HI_S32  (*DRV_HIFB_GFX2D_MbBlitEx)       (HIFB_BLIT_BUFFER_S *pSrcImg, HIFB_BLIT_BUFFER_S *pDstImg,  HIFB_BLIT_OPT_S *pstOpt);
    ...
    HI_BOOL (*DRV_HIFB_GFX2D_SupportFmt)     (HIFB_COLOR_FMT_E fmt);
    HI_S32  (*DRV_HIFB_GFX2D_CalScaleRect)   (const TDE2_RECT_S* pstSrcRect, const TDE2_RECT_S* pstDstRect,TDE2_RECT_S* pstRectInSrc, TDE2_RECT_S* pstRectInDst);
    HI_S32  (*DRV_HIFB_GFX2D_WaitForDone)    (TDE_HANDLE s32Handle, HI_U32 u32TimeOut);
