...
/************************************************************************************************/
   ...
   extern "C" {
    ...
    #if    defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3716mv450) \
        || defined(CHIP_TYPE_hi3796mv200) && !defined(HI_BUILD_IN_BOOT)
        /**hi3798mv310 not support, mv300 bin should same as 310, so should close this func**/
