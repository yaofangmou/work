...
typedef struct _FRONTEND_TSOUT_PLP_PARAM_S
{
    U8    u8PlpId;                  /* PLP ID. *//**<CNcomment: PLP ID*/
    U8    u8CommPlpId;              /* Common PLP ID. *//**<CNcomment: 共享物理层管道ID. */
    U8    u8Combination;            /* Common plp and data plp combination flag, 1-combinate, 0-no need. *//**<CNcomment: 共享物理层管道和数据物理层管道是否需要组合标志，1-组合，0-不组合。 */
} FRONTEND_TSOUT_PLP_PARAM_S;

typedef struct _FRONTEND_TSOUT_PLP_INFO_S
{
    U8                          u8PlpIndex;             /* PLP Index. *//**<CNcomment: PLP Index. */
    U8                          u8PlpId;                /* PLP ID. *//**<CNcomment: PLP ID. */
    U8                          u8PlpGrpId;             /* PLP group ID. *//**<CNcomment: PLP group ID. */
    FRONTEND_TER2_PLP_TYPE_E    enPlpType;              /**< Get PLP type, Reference:FRONTEND_TER2_PLP_TYPE_E*//**<CNcomment:得到PLP的类型,FRONTEND_TER2_PLP_TYPE_E*/
} FRONTEND_TSOUT_PLP_INFO_S;
...
#if 1//Retain below code for compatibility. And will be delete later
...
#endif
    FRONTEND_TSOUT_TER2_GET_PLPINFO,                /*Get PLP info, data type FRONTEND_TSOUT_PLP_INFO_S*.  When get plp info, FRONTEND_TSOUT_PLP_INFO_S::u8PlpIndex will be as input param.*/
                                                    /**<CNcomment: 获取PLP信息，类型FRONTEND_TSOUT_PLP_INFO_S*. 其中，获取plp 信息时，FRONTEND_TSOUT_PLP_INFO_S::u8PlpIndex将作为入参*/
    FRONTEND_TSOUT_TER2_SET_PLPPARAM,               /* Sets plp param, data type FRONTEND_TSOUT_PLP_PARAM_S*. *//**<CNcomment: 设置PLP参数，类型FRONTEND_TSOUT_PLP_PARAM_S*. */
...
typedef struct _FRONTEND_DEVICE_S
{
    ...
    */
    ...
    CNcomment: 设置和获取T2多PLP模式，设置和获取S2多ISI模式 CNend
     ...
     \param[in/out] pParam: Data type acording to enTsoutCmd. CNcomment: 需要设置的参数信息 CNend
     \retval 0  SUCCESS Success.CNcomment:成功。CNend
     \retval ::ERROR_FRONTEND_OP_FAILED do this funtion error.CNcomment:操作失败。CNend
     \retval ::ERROR_NULL_PTR null ptr.CNcomment:空指针。CNend
     \retval ::ERROR_INVALID_PARAM invalid param, such as invalid hanlde.CNcomment:无效参数，如无效句柄。CNend
