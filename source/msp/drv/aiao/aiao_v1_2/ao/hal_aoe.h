...
#if !defined(HI_SND_HBRA_PASSTHROUGH_SUPPORT) && defined(HI_SOUND_PORT_DELAY_SUPPORT)
#error "You need to enable HI_SND_HBRA_PASSTHROUGH_SUPPORT if you want to enable HI_SOUND_PORT_DELAY_SUPPORT"
#endif
