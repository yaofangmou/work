...
#define PVR_MAX_FILE_NAME_LEN       (256)
...
typedef struct _PVR_PLAY_OPENPARAMS_S
{
    ...
    CHAR                 szFileName[PVR_MAX_FILE_NAME_LEN];     /**<Name of the file that contains the streams to be played, static attribute        *//**<CNcomment: 待播放码流的文件名，静态属性。        */
