...
typedef enum hiIOC_NR_SYS_E
{
    ...
    IOC_NR_SYS_WRITE_REGISTER,
    IOC_NR_SYS_READ_REGISTER,
} IOC_NR_SYS_E;
...
#define SYS_WRITE_REGISTER          _IOW(HI_ID_SYS, IOC_NR_SYS_WRITE_REGISTER, HI_SYS_IO_REG_S)
#define SYS_READ_REGISTER           _IOWR(HI_ID_SYS, IOC_NR_SYS_READ_REGISTER, HI_SYS_IO_REG_S)
