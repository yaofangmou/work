...
const HI_PQ_CSC_COEF_S  PQ_GFX_CSCTable_YCbCr601L_to_YCbCr709L =
{
    1024, -118, -213,
    0,    1043,  117,
    0,      77, 1050
...
const HI_PQ_CSC_COEF_S  PQ_GFX_CSCTable_YCbCr709L_to_YCbCr601L =
{
    1024, 102,  196,
    0,   1014, -113,
    0,    -74, 1007
...
const HI_PQ_CSC_COEF_S  PQ_GFX_CSCTable_sRGBF_to_YCbCr709L =
{
    188,   629,  63,
    -103, -347, 450,
    450,  -409, -41
...
const HI_PQ_CSC_COEF_S  PQ_GFX_CSCTable_sRGBF_to_YCbCr601L =
{
    264,   516, 100,
    -152, -298, 450,
    450,  -377, -73
...
const HI_PQ_CSC_COEF_S  PQ_GFX_CSCTable_YCbCr709L_to_sRGBF =
{
    1192,    0, 1836,
    1192, -218, -547,
    1192, 2166,    0
...
const HI_PQ_CSC_COEF_S  PQ_GFX_CSCTable_YCbCr601L_to_sRGBF =
{
    1192,    0, 1634,
    1192, -400, -833,
    1192, 2066,    0
...
**************************************************/
/* identity matrix */
const HI_PQ_CSC_COEF_S PQ_GFX_CSCTable_Identity =
{
    1024,   0,   0,
    0,   1024,   0,
    0,      0, 1024
...
const static HI_PQ_CSC_COEF_S *PQ_GFX_CSC_MatrixTbl[PQ_GFX_CS_TYPE_BUTT][PQ_GFX_CS_TYPE_BUTT] =
{
    /* PQ_GFX_CS_eUnknown = 0 */
    {
...
HI_VOID GetCscType(HI_PQ_GFX_COLOR_SPACE_E eCSDrv, PQ_GFX_CS_S *pstCsAlg)
{
    switch (eCSDrv)
    {
        ...
        case PQ_GFX_CS_BT601_YUV_FULL:
            ...
            break;
        case PQ_GFX_CS_BT601_RGB_FULL:
            pstCsAlg->eCsType  = PQ_GFX_CS_eRGB_601;
            pstCsAlg->eCsRange = PQ_GFX_CS_RANGE_FULL;
            break;
...
static HI_VOID pq_mng_CalcCscDcYUV2YUV(PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
...
static HI_VOID pq_mng_CalcCscDcYUV2RGB(PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    HI_S32 tmpBright  = (HI_S32)stGfxCscTuning.u32Bright - 50;
...
static HI_VOID pq_mng_CalcCscDcRGB2YUV(PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    HI_S32 tmpBright  = (HI_S32)stGfxCscTuning.u32Bright - 50;
...
static HI_VOID pq_mng_CalcCscDcRGB2RGB(PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    HI_S32 tmpBright  = (HI_S32)stGfxCscTuning.u32Bright - 50;
...
* others:       : NA
***************************************************************************************/
HI_VOID PQ_MNG_CalcCscDc(HI_PQ_CSC_CRTL_S *pstCscCtrl, PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
...
/* for RGB -> RGB */
static HI_VOID PQ_MNG_CalcCscCoef_RGBtoRGB(PQ_GFX_CSC_TUNING_S *pstGfxCscTuning, const HI_PQ_CSC_COEF_S *pMatrixOri, HI_PQ_CSC_COEF_S *pMatrixDst)
{
...
/* for RGB -> YCbCr */
static HI_VOID PQ_MNG_CalcCscCoef_RGBtoYCbCr(PQ_GFX_CSC_TUNING_S *pstGfxCscTuning, const HI_PQ_CSC_COEF_S *pMatrixOri, HI_PQ_CSC_COEF_S *pMatrixDst)
{
    HI_S32 s32ContrstAdj, s32SatAdj, s32Rgain, s32Ggain, s32Bgain;
    HI_U32 u32Hue;
...
/* for YCbCr -> RGB */
static HI_VOID PQ_MNG_CalcCscCoef_YCbCrtoRGB(PQ_GFX_CSC_TUNING_S *pstGfxCscTuning, const HI_PQ_CSC_COEF_S *pMatrixOri, HI_PQ_CSC_COEF_S *pMatrixDst)
{
    HI_S32 s32ContrstAdj, s32SatAdj, s32Rgain, s32Ggain, s32Bgain;
    HI_U32 u32Hue;
...
static HI_VOID PQ_MNG_CalcCscTmprtMat(PQ_GFX_CSC_TUNING_S *pstGfxCscTuning, HI_PQ_CSC_COEF_S *pMatrixOri, HI_PQ_CSC_COEF_S *pMatrixDst)
{
    HI_S32 s32Rgain, s32Ggain, s32Bgain;
    HI_PQ_CSC_COEF_S stYCbCrColrTemp;
...
static HI_VOID PQ_MNG_CalcCscCoef_YCbCrtoYCbCr(PQ_GFX_CSC_TUNING_S *pstGfxCscTuning, const HI_PQ_CSC_COEF_S *pMatrixOri, HI_PQ_CSC_COEF_S *pMatrixDst)
{
    HI_S32 s32ContrstAdj, s32SatAdj;
    HI_U32 u32Hue;
    HI_PQ_CSC_COEF_S DstCSCTableTmp;
...
HI_VOID PQ_MNG_CalcCscMatrix(PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_COEF_S *pstGfxCscCoef, HI_BOOL bIsBGRIn)
{
    const HI_PQ_CSC_COEF_S *pCSCMatrixOri  = HI_NULL;
    HI_PQ_CSC_COEF_S        stCscTbl       = {0};
...
* others:       : NA
***************************************************************************************/
HI_VOID PQ_MNG_CalcWcgMatrix(PQ_GFX_CSC_MODE_S *pstGfxCscMode, HI_PQ_CSC_COEF_S *pstGfxCscCoef)
{
...
static HI_VOID pq_mng_CalcWcgDcYUV2YUV(PQ_GFX_CSC_MODE_S *pstCscMode, HI_PQ_CSC_DCCOEF_S *pstGfxCscDcCoef)
{
...
static HI_VOID pq_mng_CalcWcgDcYUV2RGB(PQ_GFX_CSC_MODE_S *pstCscMode, HI_PQ_CSC_DCCOEF_S *pstGfxCscDcCoef)
{
    PQ_GFX_CS_RANGE_E eGfxInputRange  = pstCscMode->stGfxCscInputCs.eCsRange;
    PQ_GFX_CS_RANGE_E eGfxOutputRange = pstCscMode->stGfxCscOutputCs.eCsRange;
...
static HI_VOID pq_mng_CalcWcgDcRGB2YUV(PQ_GFX_CSC_MODE_S *pstCscMode, HI_PQ_CSC_DCCOEF_S *pstGfxCscDcCoef)
{
    PQ_GFX_CS_RANGE_E eGfxInputRange  = pstCscMode->stGfxCscInputCs.eCsRange;
    PQ_GFX_CS_RANGE_E eGfxOutputRange = pstCscMode->stGfxCscOutputCs.eCsRange;
...
static HI_VOID pq_mng_CalcWcgDcRGB2RGB(PQ_GFX_CSC_MODE_S *pstCscMode, HI_PQ_CSC_DCCOEF_S *pstGfxCscDcCoef)
{
    PQ_GFX_CS_RANGE_E eGfxInputRange  = pstCscMode->stGfxCscInputCs.eCsRange;
    PQ_GFX_CS_RANGE_E eGfxOutputRange = pstCscMode->stGfxCscOutputCs.eCsRange;
...
* others:       : NA
***************************************************************************************/
HI_VOID PQ_MNG_CalcWcgDc(PQ_GFX_CSC_MODE_S *pstCscMode, HI_PQ_CSC_DCCOEF_S *pstGfxCscDcCoef)
{
...
static HI_S32 pq_mng_CalcGfxCscCoef(HI_PQ_CSC_CRTL_S *pstCscCtrl, HI_PQ_GFX_CSC_MODE_S *pstGfxCscPara, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    if (HI_PQ_CSC_NORMAL_SETTING == pstCscCtrl->enCscType) /* It does not be tuned */
    {
        ...
        {
            PQ_MNG_CalcCscDc    (pstCscCtrl, &stGfxCscMode, pstCscDcCoef);
...
static HI_S32 pq_mng_TransGfxCscCoef(HI_PQ_CSC_CRTL_S *pstCscCtrl,
                                     HI_PQ_CSC_COEF_S *pstInCscCoef,
                                     HI_PQ_CSC_DCCOEF_S *pstInCscDcCoef,
                                     HI_PQ_CSC_COEF_S *pstOutCscCoef,
                                     HI_PQ_CSC_DCCOEF_S *pstOutCscDcCoef)
{
...
HI_S32 PQ_MNG_GetGfxCscCoef(HI_PQ_CSC_CRTL_S *pstCscCtrl, HI_PQ_GFX_CSC_MODE_S *pstGfxCscPara, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    HI_PQ_CSC_COEF_S      stPQGfxCscCoef   = {0};
    HI_PQ_CSC_DCCOEF_S    stPQGfxCscDcCoef = {0};
...
HI_S32 PQ_MNG_SetGfxCscCoef(HI_PQ_GFX_LAYER_E enGfxCscLayer, HI_PQ_GFX_CSC_MODE_S *pstGfxCscMode)
{
    ...
    HI_PQ_CSC_COEF_S     stCscCoef;
    HI_PQ_CSC_DCCOEF_S   stCscDcCoef;
...
HI_S32 PQ_MNG_SetGfxCSCPictureSetting(HI_PQ_DISPLAY_E enDisp, HI_PQ_PICTURE_SETTING_S *pstPicSetting)
{
    ...
    if (HI_PQ_DISPLAY_SD0 == enDisp) /* SD */
    {
