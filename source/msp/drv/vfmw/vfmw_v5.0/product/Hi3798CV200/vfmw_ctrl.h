...
typedef struct
{
    SIZE_CHANGE_STATE_E        eSizeChangeState;
    UINT32        u32OldWidth;
    UINT32        u32OldHeight;
    UINT32        u32NewWidth;
    UINT32        u32NewHeight;
    UINT32        u32SizeChangeTime;
    UINT32        u32ReportTime;
    UINT32        u32BindTime;
    UINT32        u32GetFsTime;
    UINT32        u32StartDecTime;
    UINT32        u32FinishDecTime;
    UINT32        u32OutputTime;
}SIZE_CHANGE_STATE_ST;
...
typedef struct hiVFMW_GLOBAL_STAT
{
    ...
    UINT32        u32VdhLastStartTimeInUs;      /* 上一次启动硬件的时间 */
...
typedef struct hiVFMW_CHAN_S
{
    ...
    UADDR          s32ChanHalMemAddr;
    SINT32         s32ChanHalMemSize;
...
SINT32 VCTRL_GetVfmwChanNum(VOID);
