...
HI_VOID VDP_FUNC_SetTchdrMode(HI_TECHNICOLOR_PS_CFG_S        *pstSlHdrPsParam)
{
    //drv transfer
    VDP_TCHDR_SetTchdrDemoPos(pstSlHdrPsParam->stPsParam.tchdr_demo_pos);
    VDP_TCHDR_SetTchdrDemoMode(pstSlHdrPsParam->stPsParam.tchdr_demo_mode);
    VDP_TCHDR_SetTchdrDemoEn(pstSlHdrPsParam->stPsParam.tchdr_demo_en);
    VDP_TCHDR_SetTchdrCertEn(pstSlHdrPsParam->stPsParam.tchdr_cert_en);
    VDP_TCHDR_SetTchdrYuvRange(pstSlHdrPsParam->stPsParam.yuv_range);
    VDP_TCHDR_SetTchdrAlphaA(pstSlHdrPsParam->stPsParam.mu0);
    VDP_TCHDR_SetTchdrAlphaB(pstSlHdrPsParam->stPsParam.mu1);
    VDP_TCHDR_SetTchdrOct0(pstSlHdrPsParam->stPsParam.OCT[0]);
    VDP_TCHDR_SetTchdrOct1(pstSlHdrPsParam->stPsParam.OCT[1]);
    VDP_TCHDR_SetTchdrOct2(pstSlHdrPsParam->stPsParam.OCT[2]);
    VDP_TCHDR_SetTchdrOct3(pstSlHdrPsParam->stPsParam.OCT[3]);
    VDP_TCHDR_SetTchdrOct4(pstSlHdrPsParam->stPsParam.OCT[4]);
    VDP_TCHDR_SetTchdrOct5(pstSlHdrPsParam->stPsParam.OCT[5]);
    VDP_TCHDR_SetTchdrOct6(pstSlHdrPsParam->stPsParam.OCT[6]);
    VDP_TCHDR_SetTchdrDLutStep0(pstSlHdrPsParam->stPsParam.D_LUT_STEP[0]);
    VDP_TCHDR_SetTchdrDLutStep1(pstSlHdrPsParam->stPsParam.D_LUT_STEP[1]);
    VDP_TCHDR_SetTchdrDLutStep2(pstSlHdrPsParam->stPsParam.D_LUT_STEP[2]);
    VDP_TCHDR_SetTchdrDLutStep3(pstSlHdrPsParam->stPsParam.D_LUT_STEP[3]);
    VDP_TCHDR_SetTchdrDLutThr0(pstSlHdrPsParam->stPsParam.D_LUT_THRESHOLD[0]);
    VDP_TCHDR_SetTchdrDLutThr1(pstSlHdrPsParam->stPsParam.D_LUT_THRESHOLD[1]);
    VDP_TCHDR_SetTchdrDLutThr2(pstSlHdrPsParam->stPsParam.D_LUT_THRESHOLD[2]);
    VDP_TCHDR_SetTchdrR2yCoef0(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[0]);
    VDP_TCHDR_SetTchdrR2yCoef1(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[1]);
    VDP_TCHDR_SetTchdrR2yCoef2(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[2]);
    VDP_TCHDR_SetTchdrR2yCoef3(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[3]);
    VDP_TCHDR_SetTchdrR2yCoef4(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[4]);
    VDP_TCHDR_SetTchdrR2yCoef5(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[5]);
    VDP_TCHDR_SetTchdrR2yCoef6(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[6]);
    VDP_TCHDR_SetTchdrR2yCoef7(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[7]);
    VDP_TCHDR_SetTchdrR2yCoef8(pstSlHdrPsParam->stPsR2yParam.s16R2yCoef[8]);
    VDP_TCHDR_SetTchdrR2yScale2p(pstSlHdrPsParam->stPsR2yParam.s16R2yScale2P);
    VDP_TCHDR_SetTchdrR2yOutDc0(pstSlHdrPsParam->stPsR2yParam.s16R2yDcOut[0]);
    VDP_TCHDR_SetTchdrR2yOutDc1(pstSlHdrPsParam->stPsR2yParam.s16R2yDcOut[1]);
    VDP_TCHDR_SetTchdrR2yOutDc2(pstSlHdrPsParam->stPsR2yParam.s16R2yDcOut[2]);
    VDP_TCHDR_SetTchdrR2yClipMin(pstSlHdrPsParam->stPsR2yParam.s16R2yClipMin);
    VDP_TCHDR_SetTchdrR2yClipMax(pstSlHdrPsParam->stPsR2yParam.s16R2yClipMax);
    VDP_TCHDR_SetTchdrR2yClipEn( pstSlHdrPsParam->stPsR2yParam.tchdr_r2y_clip_en);
