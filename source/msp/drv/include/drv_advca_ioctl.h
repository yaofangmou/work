...
typedef union
{
    struct
    {
        ...
        HI_U32 MISC_RK_CSA3   :1; //[9 ]
        HI_U32 STB_RootKey    :1; //[10]
        HI_U32 MISC_RK_SM4    :1; //[11]
        HI_U32 stb_ta_rootkey :1; //[12]
        HI_U32 hisi_rootkey   :1; //[13]
        HI_U32 MISC_RK_AES    :1; //[14]
        HI_U32 lp_rootkey     :1; //[15]
        HI_U32 deob_ext_key   :1; //[16]
        HI_U32 smk_ext_key    :1; //[17]
        HI_U32 reserved       :14; //[18~31]
    }bits;
    HI_U32 u32;
