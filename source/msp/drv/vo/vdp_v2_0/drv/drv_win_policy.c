                                 ...
                                 HI_DRV_DISP_STEREO_E enStereo)
{
    ...
    pstVpssZmeSize->s32Width = (HI_U32)(pstVpssZmeSize->s32Width) & HI_WIN_OUT_RECT_WIDTH_ALIGN;
    pstVpssZmeSize->s32Height = (HI_U32)(pstVpssZmeSize->s32Height) & HI_WIN_OUT_RECT_HEIGHT_ALIGN;
                        ...
                        HI_DRV_DISP_STEREO_E enStereo)
{
    ...
    *pbVerSrEnable = HI_FALSE;
    ...
    pstV0DisPosition->s32X = (HI_U32)(pstV0DisPosition->s32X) & HI_WIN_OUT_RECT_X_ALIGN;
    pstV0DisPosition->s32Y =  (HI_U32)(pstV0DisPosition->s32Y) & HI_WIN_OUT_RECT_Y_ALIGN;
    pstV0DisPosition->s32Width = (HI_U32)(pstV0DisPosition->s32Width) & HI_WIN_OUT_RECT_WIDTH_ALIGN;
    pstV0DisPosition->s32Height = (HI_U32)(pstV0DisPosition->s32Height) & HI_WIN_OUT_RECT_HEIGHT_ALIGN;
