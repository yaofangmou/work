...
Font* FTLib::loadMemoryFont (const char* font_path, int resolution) const {
  const int glyphMargin = (int)ceil(resolution*0.1f);
  ...
  if (FT_New_Face(library, font_path, 0, &fontFace)) {
