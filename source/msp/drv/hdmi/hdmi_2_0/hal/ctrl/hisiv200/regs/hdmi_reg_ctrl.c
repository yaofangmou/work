...
int HDMI_PWD_MST_CMD_pwd_mst_cmdSet(unsigned int upwd_mst_cmd)
{
    ...
    HDMI_RegWrite((HI_U32*)&(goptx_ctrl_regAllReg->PWD_MST_CMD.u32), upwd_mst_cmd);
    return HI_SUCCESS;
}

HI_VOID HDMI_REG_CTRL_PWD_SLAVE_CFG_Set(HI_U32 u32Value)
{
    HDMI_RegWrite((HI_U32*)&(goptx_ctrl_regAllReg->PWD_SLAVE_CFG.u32) , u32Value);
    return;
}

HI_VOID HDMI_REG_CTRL_PWD_RST_CTRL_AudioSet(HI_BOOL bEnable)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    ...
    //o_tx_pwd_rst_ctrl.bits.tx_hdmi_srst_req = bEnable;
    o_tx_pwd_rst_ctrl.bits.tx_aud_srst_req = bEnable;
    o_tx_pwd_rst_ctrl.bits.tx_acr_srst_req = bEnable;
    o_tx_pwd_rst_ctrl.bits.tx_afifo_srst_req = bEnable;
