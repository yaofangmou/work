...
static const HI_U32 au32GfxHdrTMLut_SDR2HDR1500[PQ_GFXHDR_TMAP_LUT_SIZE] =                   //U1.15 [0,65535]
{
    0,      4080,   3996,   3952,   3940,   3930,   3937,   3944,
    3953,   3974,   3983,   4002,   4023,   4043,   4074,   4094,
    4126,   4173,   4225,   4284,   4351,   4414,   4474,   4533,
    4611,   4899,   5221,   5943,   6835,   7914,   9252,   10923,
};
...
static HI_S32 pq_hal_SetGfxHDRTMap(HI_DRV_COLOR_SPACE_E enInCS, HI_PQ_GFXHDR_CFG *pstPqGfxHdrCfg)
{
    ...
    switch (sg_enGfxHdrMode)
    {
        case HI_PQ_HDR_MODE_SDR_TO_HDR10:
            pstPqGfxHdrCfg->stTMAP.u16ScaleCoefTM = 15;
...
HI_S32 PQ_HAL_InitGfxHdr(PQ_PARAM_S *pstPqParam, HI_BOOL bParaUseTableDefault)
{
    ...
    if (HI_TRUE != bParaUseTableDefault)
    {
        ...
        {
            PQ_SAFE_MEMCPY(sg_stGfxHdrTmClutBinOrCode.au32TMSdr2HDRClut, au32GfxHdrTMLut_SDR2HDR1500, sizeof(sg_stGfxHdrTmClutBinOrCode.au32TMSdr2HDRClut));
