...
typedef enum tagDISP_INTERRUPT_E
{
    ...
    DISP_INTERRUPT_WBC_VP    = 0x200,
    DISP_INTERRUPT_RETURN_FRAME    = 0x8000,

    DISP_INTERRUPT_VPSS_FRMAE_FINISH  = 0x1,
    DISP_INTERRUPT_VPSS_FRMAE_TIMEOUT0  = 0x2,

    DISP_INTERRUPT_VPSS_FRMAE_TIMEOUT1  = 0x4,
    DISP_INTERRUPT_VPSS_FRMAE_RXERR  = 0x40,
    DISP_INTERRUPT_ALL           = 0xFFFFFFFF,
} DISP_INTERRUPT_E;



#define VDP_CLK_MODE_240MHZ     0
#define VDP_CLK_MODE_200MHZ     1
