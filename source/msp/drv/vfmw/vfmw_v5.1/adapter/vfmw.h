...
*/
#define SET_CHAN_UID(CreateTime, ChanID)        (((UINT64)(CreateTime) << 32) + ((ChanID) & 0xffff))
#define SET_MEM_UID(ChanUID, MemGroup, MemType) ((ChanUID) | (((MemGroup) & 0xff) << 24) | (((MemType) & 0xff) << 16))
...
typedef enum hiVDEC_CID_E
{
    ...
    VDEC_CID_SET_DEIMEMQUERY_INTF,
    VDEC_CID_GET_MEM_INFO,
    VDEC_CID_BUTT,
} VDEC_CID_E;
...
typedef struct
{
    VBOOL active_format_flag;
    UINT32 active_format;
} AFD_INFO;
...
typedef struct
{
    YUV_FORMAT_E yuvFormat;           /* color format */
...
typedef struct hiDEI_INTF_S
{
    SINT32 inst_id;
    SINT32(*alloc_dei_mem)(SINT32 InstID, VOID *pMem);
    SINT32(*release_dei_mem)(SINT32 InstID, VOID *pMem);
} DEI_MEM_INTF_S;
...
typedef struct hiVFMW_DEI_MEM_INFO_S
{
    UINT32 Width;
    UINT32 Height;
    UINT32 BitDepth;
    UINT32 DeiMemSize;
    UINT32 DeiMemPhyAddr;
} VFMW_DEI_MEM_INFO_S;
...
typedef struct hiDEI_MEM_QUERY_INTF_S
{
    SINT32  inst_id;
    SINT32  (*query_dei_mem_size)(SINT32 InstID, VOID *pMem);
} DEI_MEM_QUERY_INTF_S;

typedef struct hiCHAN_MEM_INFO_S
{
    UINT8  BitDepth;
    UINT32 DecFsWidth;
    UINT32 DecFsHeight;
...
typedef struct
{
    ...
    MEM_SUPPLEMENT_S SupplementInfo;
} MEM_REPORT_S;
