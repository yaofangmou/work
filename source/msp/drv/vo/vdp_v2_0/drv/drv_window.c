                                             ...
                                             HI_RECT_S *pI, HI_RECT_S *pO)
{
    ...
    pO->s32X      = (HI_U32)(pO->s32X) & HI_WIN_OUT_RECT_X_ALIGN;
    pO->s32Width  = (HI_U32)(pO->s32Width) & HI_WIN_OUT_RECT_WIDTH_ALIGN;
    pO->s32Y      = (HI_U32)(pO->s32Y) & HI_WIN_OUT_RECT_Y_ALIGN;
    pO->s32Height = (HI_U32)(pO->s32Height) & HI_WIN_OUT_RECT_HEIGHT_ALIGN;
...
HI_VOID Win_PqProcess(WINDOW_S *pstWin,HI_DRV_VIDEO_FRAME_S *pstFrame,WIN_HAL_PARA_S *pstLayerPara)
{
    ...
    DRV_PQ_UpdateVdpPQ((HI_PQ_DISPLAY_E)pstWin->enDisp, &stTimingInfo, (HI_VOID *)s_u32VdpBaseAddr);
...
HI_S32 WinGetOutputCaptureFrame(HI_DRV_VIDEO_FRAME_S *pstFrame, DISP_MMZ_BUF_S *pstDstMem, HI_U32 u32Size)
{
    HI_U32  s32Ret = HI_FAILURE, u32TmpSize = 0;
    HI_U32  u32Y_stride = 0, u32Height = 0;
    ...
    u32TmpSize = u32Size;
    stSrcMem.u32Size = u32Size;
    stSrcMem.u32StartVirAddr = 0;
    ...
    memcpy((HI_U32 *)(pstDstMem->u32StartVirAddr),
           (HI_U32 *)(stSrcMem.u32StartVirAddr),
           u32TmpSize);
...
HI_S32 WinCaptureFrame(HI_HANDLE hWin, HI_DRV_VIDEO_FRAME_S *pstFrame, HI_U32 *stMMZPhyAddr, HI_U32 *stMMZlen)
{
    ...
    HI_DRV_VIDEO_FRAME_S *pstFrmTmp = NULL;
    HI_VDEC_PRIV_FRAMEINFO_S *pstPrivInfo = HI_NULL;
    HI_U32 datalen = 0, y_stride = 0, height = 0, s32Ret = HI_FAILURE, u32Size = 0;
    ...
    *pstFrame = *(pstFrmTmp);
    ...
    {
        datalen = height * y_stride * 3 / 2 + height * 4;
        u32Size = pstFrame->u32Height * y_stride * 3 / 2;
    }
    else
    {
        datalen = height * y_stride * 2 + height * 4;
        u32Size = pstFrame->u32Height * y_stride * 2;
    }
    ...
    *stMMZlen      = pstWin->stWinCaptureMMZ.u32Size;
    ...
    stDstMem.u32StartVirAddr = 0;

    s32Ret = WinGetOutputCaptureFrame(pstFrame, &stDstMem, u32Size);
    if (s32Ret != HI_SUCCESS)
    {
        WinBuf_ReleaseCaptureFrame(&pstWin->stBuffer.stWinBP, pstFrame, HI_FALSE);
