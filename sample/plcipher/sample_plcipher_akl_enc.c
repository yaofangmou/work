 ...
 ******************************************************************************
  File Name     : sample_plcipher_akl_enc.c
...
{
    printf(" usage: sample_plcipher_akl_enc configfile file_to_encrypt file_encrypted pid1 pid2 pid3 pid4 pid5 \n");
    printf(" examples: \n");
    printf("   sample_plcipher_akl_enc cw_key_config_akl.ini plain.ts encrypted.ts 0x20 0x21\n");
}
...
HI_S32 main(HI_S32 argc, HI_CHAR *argv[])
{
    ...
    while((ReadLen=fread(PlainBuf1.user_viraddr, 1, MAXBB, pEncInTsFile)) != 0)
    {
        ...
        Ret = HI_UNF_PLCIPHER_Encrypt(ctl_data.hHandle, (HI_VOID *)((HI_ULONG)(PlainBuf1.phyaddr)), (HI_VOID *)((HI_ULONG)EncrytedBuf1.phyaddr), ReadLen);
        if (HI_SUCCESS != Ret)
        {
