...
HI_S32 VDP_DRV_SetHdrZmeCfg(XDP_LAYER_VID_INFO_S  *stXdpHdrCfgOut, XDP_HDR_CTRL_S *pstXdpHdrCtrl)
{
    ...
    VDP_VID_SetZme2InFmt(VDP_LAYER_VID0, VDP_PROC_FMT_SP_420);
    VDP_VID_SetZme2OutFmt(VDP_LAYER_VID0,VDP_PROC_FMT_SP_420);
...
HI_S32 VDP_DRV_SetHdrMode(XDP_LAYER_VID_INFO_S  *stXdpHdrCfgIn, VDP_FIXPT_MAIN_CFG_S *pstCompCfg, DmKsFxp_t *pstDmKs)
{
    ...
    VDP_VID_SetMuteEnable     (VDP_LAYER_VID0, HI_FALSE);
    ...
    VDP_DRV_SetHdrFdr(stXdpHdrCfgOut, &stXdpHdrCtrl);

    XDP_DRV_GetVidAddrAfterCrop(VDP_LAYER_VID0, stXdpHdrCfgIn, stXdpHdrCfgOut);

    VDP_DRV_SetHdrAddr(stXdpHdrCfgOut, &stXdpHdrCtrl);
