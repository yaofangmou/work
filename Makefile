...
ifeq ($(CFG_HI_ADVCA_SUPPORT),y)
	ifeq ($(CFG_HI_ADVCA_TYPE),CONAX)
		ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3796mv200 hi3716mv450 hi3716mv430),)
		    SIGNATURE_SCRIPT_DIR := Conax/v2
		else
		    SIGNATURE_SCRIPT_DIR := Conax/v1
		endif
		...
		ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3796mv200 hi3716mv450),)
		    ...
		    SIGNATURE_SCRIPT_DIR := Nagra/3716mv430
        else
...
ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3796mv200 hi3716mv450 hi3798mv200),)
...
ifeq ($(CFG_HI_ADVCA_TYPE),NAGRA)
  ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv410 hi3716mv420 hi3716mv450 hi3796mv200 hi3716mv430),)
    HI_APPSQUASHFS_DIR := $(HI_INSTALL_DIR)/appsquashfs
    IMAGES += appsquashfs
    ifeq ($(CFG_HI_NAND_FLASH_SUPPORT),y)
      HI_DATAUBIFS_DIR := $(HI_INSTALL_DIR)/dataubifs
      IMAGES += dataubifs
      ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv450 hi3796mv200),)
...
ifneq ($(findstring $(CFG_HI_ADVCA_TYPE),NAGRA CONAX),)
  ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv410 hi3716mv420 hi3716mv450 hi3796mv200 hi3716mv430),)
appsquashfs:
...
ifeq ($(CFG_HI_SPI_SUPPORT),y)
	...
	$(AT)rm -rf $(HI_IMAGE_DIR)/app.squashfs
...
trusted_storageubifs:
      ...
      endif  # /*ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv450 hi3796mv200),)*/
