...
HI_S32 HI_UNF_OTP_COMMON_CA_DisableKlad(HI_UNF_OTP_COMMON_CA_KLAD_TYPE_E enType)
{
    ...
    case HI_UNF_OTP_COMMON_CA_SP:
        id = HI_OTP_CM0_SP_KL_DISABLE;
        break;
    case HI_UNF_OTP_COMMON_CA_LP:
        id = HI_OTP_CM0_LP_KL_DISABLE;
        break;
#endif
    default:
        HI_ERR_OTP("keyladder type(%x) is invalid\n", enType);
...
#if defined(CHIP_TYPE_hi3716mv430)
    return OTP_PVItemWrite(HI_OTP_JTAG_KEY, pu8Key, &value_len);
#else
