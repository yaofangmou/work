...
static HI_VOID OSAL_kernel_neon_begin(HI_VOID)
{
#ifdef CONFIG_NEON
    kernel_neon_begin();
#endif
...
static HI_VOID OSAL_kernel_neon_end(HI_VOID)
{
#ifdef CONFIG_NEON
    kernel_neon_end();
#endif
...
HI_VOID ASDP_OSAL_InterfaceInit(ADSP_OSAL_FUNC_S* pstOsalFunc)
{
    ...
    pstOsalFunc->pfun_OSAL_adsp_kneon_begin     = OSAL_kernel_neon_begin;
    pstOsalFunc->pfun_OSAL_adsp_kneon_end       = OSAL_kernel_neon_end;
