...
static UINT32 R858_ADC_READ_DELAY = 2;
static UINT8  R858_ADC_READ_COUNT = 1;
...
static UINT8   R858_Divider_Manual = 0;    //*not release
...
HI_S32 r858_init_tuner(HI_U32 u32TunerPort)
{
    ...
    HI_INFO_TUNER("[%s] 2017-9-14 16:30 u32TunerPort=%d, R858_ExtTunerNum=%d, R858_IntTunerNum=%d\n", \
            __FUNCTION__, u32TunerPort, R858_ExtTunerNum, R858_IntTunerNum);
    ...
    if ((u32TunerPort == 0)||(u32TunerPort == 2))
    {
        ...
        if(g_stTunerOps[u32TunerPort].u32TunerAddress == 0xd4)
        {
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum] = 0xd4;
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum + 1] = 0xf4;
        }
        else if(g_stTunerOps[u32TunerPort].u32TunerAddress == 0x94)
        {
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum] = 0x94;
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum + 1] = 0xb4;
        }
        else if(g_stTunerOps[u32TunerPort].u32TunerAddress == 0x54)
        {
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum] = 0x54;
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum + 1] = 0x74;
        }
        else
        {
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum] = 0x14;
            R858_ADDRESS[R858_ExtTunerNum][R858_IntTunerNum + 1] = 0x34;
        }
