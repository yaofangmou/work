...
)
{
    ...
    if (0 == pstUpgradeInfo->u8PartitionCount || pstUpgradeInfo->u8PartitionCount > HIOTA_D_MAXNUM_PARTITION)
    {
        COM_PrintErrCode(COM_ERR_IMAGE_ILLEGAL);
        return COM_ERR_IMAGE_ILLEGAL;
    }

    HI_SKIP_BYTES(pu8Data, 1, u32TotalRead)  /**< Reserved Data Length*/
    ...
    for (i = 0; i < pstUpgradeInfo->u8PartitionCount; i++)
    {
        ...
        HI_SKIP_BYTES(pu8Data, 1, u32TotalRead); /**< Download Mode Data Length*/
    ...
    HI_SKIP_BYTES(pu8Data, 2, u32TotalRead); /**< Reserved Data Length*/
...
)
{
    ...
    HI_SKIP_BYTES(pu8SectionData, 4, u32TotalRead);    /**< Magic Number*/
