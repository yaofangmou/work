...
#define adp_for_hard_decode                 HI_BOOL HdecSuccess = HI_FALSE;\
                                            ...
                                            {\
                                               ...
                                               if (cinfo->output_height == cinfo->output_scanline){adp_for_save_softdec_times}\
                                               return row_ctr;\
                                            }\
...
#define adp_for_save_softdec_times          JPEG_DEC_SaveSoftDecTimes((unsigned long)cinfo->client_data);
#define adp_for_save_jdapistd_call_func     JPEG_DEC_SaveCallFunc((unsigned long)cinfo->client_data, __FUNCTION__, __LINE__);
