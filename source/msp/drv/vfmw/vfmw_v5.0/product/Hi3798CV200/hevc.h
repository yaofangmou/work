...
#endif
#ifdef MV_HEVC_SUPPORT
SINT32 HEVC_CheckVpsExtOverlap(HEVC_VPS_EXTENSION_SET_S *pVPSExt, UINT32 *pOverlap);
SINT32 HEVC_CheckPpsExtOverlap(HEVC_PPS_EXTENSION_SET_S *pPPSExt, UINT32 *pOverlap);
SINT32 HEVC_CheckSliceExtOverlap(HEVC_SLICE_EXTENSION_SET_S *pSlcExt, UINT32 *pOverlap);
#endif
