...
ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3798mv100 hi3796mv100 hi3716dv100 hi3716mv410 hi3716mv420 hi3716mv430),)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_driver.c)
endif

ifneq ($(findstring $(DRIVER_PATH), vdp_v4_0 vdp_v5_0),)
...
ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3798mv310 hi3716mv430),)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vpss_hal_sysctrl.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_offline.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_cycbuf.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_wd_lbox.c)
endif
