...
//HI_VOID VDP_VID_SetZmeCVFIRCoef        (HI_U32 u32Data, VDP_VID_ZME_CVFIR_COEF_S stCvfirCoef);
HI_VOID VDP_VID_SetDcmpOffset          (HI_U32 u32Data, HI_U32 u32laddr_offset, HI_U32  u32caddr_offset);
...
//SR_BEGIN
//-------------------------------------------------------------------
//HI_VOID VDP_FUNC_SetSrMode            (VDP_SR_PARA_INFO SrParaInfo, VDP_SR_MODE_E SrMode);
HI_VOID VDP_VID_SetSrEnable           (HI_U32 u32Data, HI_U32 u32Enable);
HI_VOID VDP_VID_SetSrGrdSubRatio      (HI_U32 u32Data, HI_U32 u32GrdSubRatio);
HI_VOID VDP_VID_SetSrGrdThr           (HI_U32 u32Data, HI_U32 u32HighThr, HI_U32 u32LowThr);
HI_VOID VDP_VID_SetSrGrdThrSub        (HI_U32 u32Data, HI_U32 u32GrdThrSub);
HI_VOID VDP_VID_SetSrLtexAdd          (HI_U32 u32Data, HI_U32 u32DetaiGain);
HI_VOID VDP_VID_SetSrDiscDetailGain   (HI_U32 u32Data, HI_U32 u32DetaiGain);
HI_VOID VDP_VID_SetSrSharpenEnable    (HI_U32 u32Data, HI_U32 u32Enable);
//HI_VOID VDP_VID_SetSrSharpenMode      (HI_U32 u32Data, VDP_SR_SHARP_MODE_E Mode);
HI_VOID VDP_VID_SetSrEiscDetailGain   (HI_U32 u32Data, HI_U32 u32DetaiGain);
HI_VOID VDP_VID_SetSrSharpenCoring    (HI_U32 u32Data, HI_U32 u32SharpCoring);
HI_VOID VDP_VID_SetSrSharpenGain      (HI_U32 u32Data, HI_U32 u32SharpGain);
HI_VOID VDP_VID_SetSrSharpenThrsh     (HI_U32 u32Data, HI_U32 u32LowThr, HI_U32 u32HighThr);
HI_VOID VDP_VID_SetSrSmoothEnable     (HI_U32 u32Data, HI_U32 u32Enable);
HI_VOID VDP_VID_SetSrSmoothPlusEnable (HI_U32 u32Data, HI_U32 u32Enable);
HI_VOID VDP_VID_SetSrSmoothPlusCtrl   (HI_U32 u32Data, HI_U32 u32PlusCtrl);

HI_VOID VDP_VID_SetSrZmeEnable        (HI_U32 u32Data, VDP_ZME_MODE_E enMode, HI_U32 u32bEnable);
HI_VOID VDP_VID_SetSrZmePhase         (HI_U32 u32Data, VDP_ZME_MODE_E enMode, HI_S32 s32Phase);
HI_VOID VDP_VID_SetSrZmeFirEnable     (HI_U32 u32Data, VDP_ZME_MODE_E enMode, HI_U32 u32bEnable);
HI_VOID VDP_VID_SetSrZmeMidEnable     (HI_U32 u32Data, VDP_ZME_MODE_E enMode, HI_U32 u32bEnable);
HI_VOID VDP_VID_SetSrZmeHorRatio      (HI_U32 u32Data, HI_U32 u32Ratio);
HI_VOID VDP_VID_SetSrZmeVerRatio      (HI_U32 u32Data, HI_U32 u32Ratio);
HI_VOID VDP_VID_SetSrZmeCoefAddr      (HI_U32 u32Data, HI_U32 u32Mode, HI_U32 u32Addr);
HI_VOID VDP_VID_SetSrZmeInFmt         (HI_U32 u32Data, VDP_PROC_FMT_E u32Fmt);
HI_VOID VDP_VID_SetSrZmeOutFmt        (HI_U32 u32Data, VDP_PROC_FMT_E u32Fmt);
HI_VOID VDP_VID_SetSrHfirOrder        (HI_U32 u32Data, HI_U32 u32HfirOrder);
//HI_VOID VDP_VID_SetSrDispStat         (HI_U32 u32Data, VDP_SR_DISP_STAT_E u32DispStat);
HI_VOID VDP_VID_SetSrOutReso          (HI_U32 u32Data, VDP_RECT_S stRect);
//HI_VOID VDP_VID_SetSrHorCoef          (HI_U32 u32Data, VDP_SR_HORCOEF_S stSrHorCoef);
//HI_VOID VDP_VID_SetSrVerCoef          (HI_U32 u32Data, VDP_SR_VERCOEF_S stSrVerCoef);
//HI_VOID VDP_VID_SetSrCoefMode         (HI_U32 u32Data, VDP_SR_COEF_MODE_E enSrMode);
...
//HI_VOID VDP_FUNC_SetSharpenMode         ( HI_U32 u32EnLayer, VDP_VID_SHARPEN_MODE_E SharpenMode)               ;
...
HI_VOID VDP_WBC_SetConnection  (HI_U32 u32LayerId, HI_U32 u32WbcVpConnect);
//WBC P2I
...
HI_VOID VDP_VP_SetAcmDbgMode          ( HI_U32 u32Data, HI_U32 u32AcmDbgMode);
HI_VOID VDP_VP_SetAcmDbgPos           ( HI_U32 u32Data, HI_U32 u32AcmDbgPos);
...
HI_VOID  VDP_WBC_SetRegUpAuto (VDP_LAYER_WBC_E enLayer,HI_U32 mm);
...
extern HI_U32 u32aSDDATESrcCoef[][10];
...
extern HI_VOID VDP_VBI_TtxEnableInt(HI_VOID);
extern HI_VOID VDP_VBI_TtxSetPackOff(HI_U32 PackOff);
extern HI_VOID VDP_VBI_TtxPiorityHighest(HI_BOOL Highest);
extern HI_VOID VDP_VBI_SetTtxFullPage(HI_BOOL Flag);
extern HI_VOID VDP_VBI_VbiFilterEnable(HI_BOOL VbiFilterEnable);
extern HI_VOID VDP_VBI_TtxIntClear(HI_VOID);
extern HI_VOID VDP_VBI_TtxDisableInt(HI_VOID);
extern HI_VOID VDP_VBI_CCSetSeq(HI_BOOL CCSeq);
extern HI_VOID VDP_VBI_WSSConfig(HI_BOOL WssEnable, HI_U16 WssData);
extern HI_VOID VDP_VBI_CCLineConfig(HI_BOOL TopEnable, HI_BOOL BottomEnable, HI_U16 TopLine, HI_U16 BottomLine);
extern HI_VOID VDP_VBI_TtxSetSeq(HI_BOOL TtxSeq);
extern HI_VOID VDP_VBI_TtxLineEnable(HI_U32 WhichRow, HI_U32 WhichExtRow);
extern HI_VOID VDP_VBI_TtxSetAddr(HI_U32 StartAddr, HI_U32 EndAddr);
extern HI_VOID VDP_VBI_TtxSetReady(HI_VOID);
extern HI_VOID VDP_VBI_TtxSetMode(HI_U32 TtxMode);

extern HI_VOID VDP_VBI_CCDataConfig(HI_U16 TopData, HI_U16 BottomData);

extern HI_BOOL VDP_VBI_IntStatus(HI_VOID);
