                             ...
                             HI_U32 u32DestPhyAddr, HI_U32 u32ByteLength)
{
    ...
    HI_DBG_PrintU32(hCipher);
    HI_DBG_PrintU32(u32SrcPhyAddr);
    HI_DBG_PrintU32(u32DestPhyAddr);
    HI_DBG_PrintU32(u32ByteLength);
                            ...
                            HI_U32 u32KeySize)
{
    ...
    if (HI_NULL == pu8InputPrivKey)
    {
        ...
        if (HI_SUCCESS != ret)
        {
            HI_LOG_PrintFuncErr(CRYP_CIPHER_GetMultiRandomBytes, ret);
            return ret;
        }
                           ...
                           HI_U8 u8S[SM2_LEN_IN_BYTE])
{
    ...
    HI_DBG_PrintU32(pstSm2Sign->u16IdLen);
    HI_DBG_PrintU32(u32MsgLen);
                             ...
                             HI_U8 u8S[SM2_LEN_IN_BYTE])
{
    ...
    CHECK_CIPHER_OPEN();
    HI_DBG_PrintU32(pstSm2Verify->u16IdLen);
    HI_DBG_PrintU32(u32MsgLen);
                            ...
                            CRYP_CIPHER_SUBSAMPLE_S *pstSubSample, HI_U32 u32SubsampleNum)
{
    ...
    HI_DBG_PrintU32(hCipher);
    HI_DBG_PrintU32(u32NonSecInPhyAddr);
    HI_DBG_PrintU32(u32SecOutPhyAddr);
    HI_DBG_PrintU32(u32ByteLength);
    HI_DBG_PrintU32(u32FirstEncryptOffset);
    HI_DBG_PrintU32(u32SubsampleNum);
                               ...
                               HI_U8 *pu8Q, HI_U8 *pu8DP, HI_U8 *pu8DQ, HI_U8 *pu8QP)
{
    ...
    HI_DBG_PrintU32(u32NumBits);
    HI_DBG_PrintU32(u32Exponent);
...
HI_S32 CRYP_CIPHER_RsaGenKey(HI_U32 u32NumBits, HI_U32 u32Exponent, CRYP_CIPHER_RSA_PRI_KEY_S *pstRsaPriKey)
{
    ...
    HI_DBG_PrintU32(pstRsaPriKey->u16NLen);
                                  ...
                                  HI_U8 *pu8SharedSecret)
{
    ...
    HI_DBG_PrintU32(ecc.ksize);
    HI_DBG_PrintU32(ecc.h);
                             ...
                             HI_U8 *pu8OutputPrivKey, HI_U8 *pu8PubKeyX, HI_U8 *pu8PubKeyY)
{
    ...
    HI_DBG_PrintU32(pstParams->u32keySize);
    HI_DBG_PrintU32(pstParams->u32h);
                               ...
                               HI_U8 *pu8SigR, HI_U8 *pu8SigS)
{
    ...
    ecc_param_t ecc = {0};
    HI_U32 hashid = 0;
    HI_U8 u8Hash[HASH_RESULT_MAX_SIZE] = {0};
    HI_U32 u32Hlen = 0;
    ...
    HI_DBG_PrintU32(enShaType);
    HI_DBG_PrintU32(u32MessageSize);
    HI_DBG_PrintU32(pstParams->u32keySize);
    HI_DBG_PrintU32(pstParams->u32h);
                           ...
                           HI_U8 *pOutputMAC, HI_BOOL bIsLastBlock)
{
    ...
    HI_DBG_PrintU32(hCipherHandle);
    HI_DBG_PrintU32(u32InputDataLen);
    HI_DBG_PrintU32(bIsLastBlock);
