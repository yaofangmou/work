 ...
 * hisi iommu domain interface
 */
static inline __maybe_unused int hisi_iommu_map_domain(struct scatterlist *sg,
		struct iommu_map_format *format)
{
	return 0;
}
...
static inline bool __maybe_unused hisi_iommu_off_on(void)
{
	return false;
}

static inline int __maybe_unused hisi_iommu_get_info(unsigned int *iova_start,
