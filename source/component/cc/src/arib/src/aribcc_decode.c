...
/*source monitor*/
static HI_S32 _ARIBCC_DEC_DecodeDataGroup_ChkParam (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8DataGroup, HI_U16 u16DataSize, HI_U64 u64Pts)
{
    if (((enCaptionType != ARIB_CAP_CAPTION) && (enCaptionType != ARIB_CAP_SUPERIMPOSE))
...
static HI_S32 _ARIBCC_DEC_DecodeDataGroup_ChkData (HI_U8 u8DataGroupID, HI_U8 u8DataGroupLinkNumber, HI_U8 u8LastDataGroupLinkNumber, HI_U16 u16DataGroupSize)
{
...
static HI_S32 _ARIBCC_DEC_DecodeDataGroup_ChkOTM (ARIBCC_CaptionType_E enCaptionType, HI_U8 *u8DataGroupDataByte, HI_U64 *pu64Pts)
{
    HI_U8              u8TMD = 0;
    HI_U64             u64Stm = 0;
...
static HI_S32 _ARIBCC_DEC_DecodeDataGroup_MngData (ARIBCC_CaptionType_E enCaptionType, HI_U8 u8DataGroupID, ARIBCC_DataGroup_S *pstDataGroup,
                                                                                                                           HI_U8 *u8DataGroupDataByte, HI_U8 **ppu8DataUnitLoop, HI_U32 *pu32DataUnitLoopLength,
                                                                                                                           ARIBCC_UnitGroup_S **ppstUnitGroup)
{
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret = _ARIBCC_DEC_DecodeManagement(enCaptionType, pstDataGroup, u8DataGroupDataByte,
                                                   ppu8DataUnitLoop, pu32DataUnitLoopLength);
        if (s32Ret != HI_SUCCESS)
        {
    ...
    {
        s32Ret = _ARIBCC_DEC_DecodeStatement (enCaptionType, pstDataGroup, u8DataGroupDataByte,
                                                  ppu8DataUnitLoop, pu32DataUnitLoopLength);
        if (s32Ret != HI_SUCCESS)
        {
    ...
    if (*pu32DataUnitLoopLength)
    {
        s32Ret = _ARIBCC_DEC_DecodeDataUnitLoop (enCaptionType, *ppu8DataUnitLoop, *pu32DataUnitLoopLength,
                                                     ppstUnitGroup, &u32UnitGroupLength);
        if (s32Ret != HI_SUCCESS)
        {
...
HI_S32 _ARIBCC_DEC_DecodeDataGroup (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8DataGroup, HI_U16 u16DataSize, HI_U64 u64Pts)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeDataGroup_ChkParam (enCaptionType, pu8DataGroup, u16DataSize, u64Pts);
    if (s32Ret != HI_SUCCESS)
    {
        HI_ERR_CC("parameter error !\n");
        return HI_FAILURE;
    ...
    s32Ret = _ARIBCC_DEC_DecodeDataGroup_ChkData (u8DataGroupID, u8DataGroupLinkNumber, u8LastDataGroupLinkNumber, u16DataGroupSize);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
    ...
    if (pstDecParam->bReception)
    {
        ...
        if (IS_DGI_TYPE_STATE (u8DataGroupID))
        {
            ...
            s32Ret = _ARIBCC_DEC_DecodeDataGroup_ChkOTM (enCaptionType, u8DataGroupDataByte, &u64Pts);
            if (s32Ret != HI_SUCCESS)
            {
                return HI_FAILURE;
            }
    ...
    else
    {
        ...
        s32Ret = _ARIBCC_DEC_DecodeDataGroup_MngData (enCaptionType, u8DataGroupID, &stDataGroup, u8DataGroupDataByte, &pu8DataUnitLoop,
                                                                                                        &u32DataUnitLoopLength, &pstUnitGroup);
                                    ...
                                    HI_U8 *pu8ManagementData, HI_U8 **ppu8DataUnitLoop, HI_U32 *pu32DataUnitLoopLength)
{
    ...
    *pu32DataUnitLoopLength = 0;
    ...
    if (u8NumLanguages > CC_LANG_MAX)
    {
        HI_ERR_CC("Num Languages : %u\n", u8NumLanguages);
        return HI_FAILURE;
    }
    else if (u8NumLanguages == 0)
    {
        //use default config
        u8NumLanguages = 1;
        astLanguageData[0].u8LanguageTag = 0;
        astLanguageData[0].u8DMF = DMF_AUTO_AND_AUTO;
        astLanguageData[0].u8DC = DC_RAIN_ATTENUATION;
        astLanguageData[0].cISO639LanguageCode[0] = 'e';
        astLanguageData[0].cISO639LanguageCode[1] = 'n';
        astLanguageData[0].cISO639LanguageCode[2] = 'g';
        astLanguageData[0].cISO639LanguageCode[3] = '\0';
        astLanguageData[0].u8Format = DF_HORI_960X540;
        astLanguageData[0].u8TCS = TCS_8UNIT;
        astLanguageData[0].u8RollupMode = RM_NON_ROLLUP;
    }
    else
    {
...
HI_S32 _ARIBCC_DEC_DecodeStatement_ChkPara (ARIBCC_CaptionType_E enCaptionType, ARIBCC_DataGroup_S *pstDataGroup,
                                    HI_U8 *pu8ManagementData, HI_U8 **ppu8DataUnitLoop, HI_U32 *pu32DataUnitLoopLength)
{
                                    ...
                                    HI_U8 *pu8ManagementData, HI_U8 **ppu8DataUnitLoop, HI_U32 *pu32DataUnitLoopLength)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeStatement_ChkPara (enCaptionType, pstDataGroup,
                                                                                              pu8ManagementData, ppu8DataUnitLoop, pu32DataUnitLoopLength);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
...
HI_S32 _ARIBCC_DEC_DecodeDataUnitLoop_ChkPara (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8DataUnitLoop, HI_U32 s32DataUnitLoopLength,
                                ARIBCC_UnitGroup_S **ppstUnitGroup, HI_U32 *pu32UnitGroupLength)
{
...
HI_S32 _ARIBCC_DEC_DecodeDataUnitLoop_ChkData (HI_U8 u8UnitSeparator, HI_U8 u8DataUnitParameter, HI_U32 u32DataUnitSize)
{
    HI_S32      s32Ret = HI_SUCCESS;
                                ...
                                ARIBCC_UnitGroup_S **ppstUnitGroup, HI_U32 *pu32UnitGroupLength)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeDataUnitLoop_ChkPara (enCaptionType, pu8DataUnitLoop, s32DataUnitLoopLength,
                                                                                                  ppstUnitGroup, pu32UnitGroupLength);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
    ...
    *pu32UnitGroupLength = 0;
         ...
         pu8DataUnit += (u32DataUnitSize + DU_HEADER_LENGTH))
    {
        ...
        s32Ret = _ARIBCC_DEC_DecodeDataUnitLoop_ChkData (u8UnitSeparator, u8DataUnitParameter, u32DataUnitSize);
...
/*source monitor*/
HI_S32 _ARIBCC_DEC_DecodeStatementBody_ChkParam (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8StatementBody, HI_U32 u32StatementBodySize,
                                 ARIBCC_StatementBody_S *pstStatementBody, HI_U32 *pu32StatementBodySize)
{
...
HI_VOID _ARIBCC_DEC_DecodeStatementBody_GLGR (HI_U8 **ppu8CodePtr, ARIBCC_Data_S **ppstDataPtr, ARIBCC_GraphSet_E *paenDesignation, ARIBCC_CodeElement_E *paenInvocation,
                                                                                                                    ARIBCC_Control_S *pstControlPtr, HI_U32 u32ControlLength, HI_U32 *pu32DataLength,
                                                                                                                    HI_BOOL *pbSingleShift, ARIBCC_CodeElement_E enInvocationPrev)
{
    ...
    /* (G0/G1/G2/G3) */
    u32DesignArea = (HI_U32)paenInvocation[u32InvocationArea] - (HI_U32)ARIB_CELEMENT_G0;

    if (ARIB_GSET_MACRO == paenDesignation[u32DesignArea])
    {
        if (IS_DEFAULT_MACRO (u8Code))
        {
            (*ppstDataPtr) = (ARIBCC_Data_S*) (((HI_U8*) pstControlPtr) + u32ControlLength);
            (*ppstDataPtr)->pu8Data = ((HI_U8*) (*ppstDataPtr)) + sizeof(ARIBCC_Data_S);
            *((*ppstDataPtr)->pu8Data + (*pu32DataLength)) = u8Code;
            (*pu32DataLength) ++;

            u8MacroId = GET_MACRO_ID(u8Code);
            for (i = 0; i < 4; i++)
            {
                paenDesignation[i] = gDefaultMacro[u8MacroId].astDesignation[i].enGraphSet;
            }
            for (i = 0; i < 2; i++)
            {
                paenInvocation[i] = CTRL_TO_INVOKE_ELEM (gDefaultMacro[u8MacroId].aenInvocationId[i]);
            }
        }
    ...
    else
    {
        ...
        *((*ppstDataPtr)->pu8Data + (*pu32DataLength)) = u8Code;
        ...
        if ((paenDesignation[u32DesignArea]) & 0x0100) /* 2-byete code */
        {
            *((*ppstDataPtr)->pu8Data + (*pu32DataLength)) = *(*ppu8CodePtr);
            (*ppu8CodePtr) ++;
            (*pu32DataLength) ++;
        }
    }

    if ((IS_AREA_GL (u8Code)) && (*pbSingleShift))
    {
        paenInvocation[0] = enInvocationPrev;
        (*pbSingleShift) = HI_FALSE;
    }
...
HI_S32 _ARIBCC_DEC_DecodeStatementBody_Run (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8CodePtr, HI_U32 *pu32CodeSize,
                                                                                                                 ARIBCC_Control_S *pstControl, HI_U32 *pu32ControlSize)
{
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret = _ARIBCC_DEC_DecodeC0Control (enCaptionType, pu8CodePtr, pu32CodeSize, pstControl, pu32ControlSize);
    }
    else if (IS_AREA_CSI(*pu8CodePtr))
    {
        s32Ret = _ARIBCC_DEC_DecodeCsiControl (enCaptionType, pu8CodePtr, pu32CodeSize, pstControl, pu32ControlSize);
    }
    else if (IS_AREA_C1 (*pu8CodePtr))
    {
        s32Ret = _ARIBCC_DEC_DecodeC1Control (enCaptionType, pu8CodePtr, pu32CodeSize, pstControl, pu32ControlSize);
    }
                                 ...
                                 ARIBCC_StatementBody_S *pstStatementBody, HI_U32 *pu32StatementBodySize)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeStatementBody_ChkParam (enCaptionType, pu8StatementBody, u32StatementBodySize, pstStatementBody, pu32StatementBodySize);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
    ...
    *pu32StatementBodySize = 0;
    ...
    while (pu8CodePtr < (pu8StatementBody + u32StatementBodySize))
    {
        ...
        while (pu8CodePtr < (pu8StatementBody + u32StatementBodySize))
        {
            ...
            {
                (HI_VOID)_ARIBCC_DEC_DecodeStatementBody_GLGR (&pu8CodePtr, &pstDataPtr, &aenDesignation[0], &aenInvocation[0],
                                                                                                                    pstControlPtr, u32ControlLength, &u32DataLength,
                                                                                                                    &bSingleShift, enInvocationPrev);
            }
            ...
            else if (IS_AREA_CONTROL (*pu8CodePtr))
            {
                ...
                s32Ret = _ARIBCC_DEC_DecodeStatementBody_Run (enCaptionType, pu8CodePtr, &u32CodeSize,
...
/*source monitor*/
static HI_S32 _ARIBCC_DEC_DecodeC0Control_ChkParam (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8Code, HI_U32 *pu32CodeSize,
                             ARIBCC_Control_S *pstControl, HI_U32 *pu32ControlSize)
{
...
static HI_S32 _ARIBCC_DEC_DecodeC0Control_ESC (HI_U8 *pu8CodePtr, HI_S32 *ps32ControlData, ARIBCC_CtrlSet_E *penControlId,
                                                                                                                    HI_U8 *pu8Code, HI_U32 u32CodeSize)
{
    HI_U8    u8Class1= 0, u8Class2 = 0;
    HI_U8    *pu8FinalBytePtr = HI_NULL;
    ...
    do
    {
        ...
        {
            *penControlId = ARIB_ESC_LS2;
            break;
        }
        else if (ESC_LS3 == *pu8CodePtr)
        {
            *penControlId = ARIB_ESC_LS3;
            break;
        }
        else if (ESC_LS1R == *pu8CodePtr)
        {
            *penControlId = ARIB_ESC_LS1R;
            break;
        }
        else if (ESC_LS2R == *pu8CodePtr)
        {
            *penControlId = ARIB_ESC_LS2R;
            break;
        }
        else if (ESC_LS3R == *pu8CodePtr)
        {
            *penControlId = ARIB_ESC_LS3R;
            break;
        }
        ...
        *penControlId = ARIB_ESC_DES;
        ps32ControlData[0] = enCodeElement;
        ps32ControlData[1] = enGraphSet;
                             ...
                             ARIBCC_Control_S *pstControl, HI_U32 *pu32ControlSize)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeC0Control_ChkParam (enCaptionType, pu8Code, pu32CodeSize, pstControl, pu32ControlSize);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
...
//            break;
        ...
        case C0_ESC:
            pu8CodePtr ++;
            s32Ret = _ARIBCC_DEC_DecodeC0Control_ESC(pu8CodePtr, as32ControlData, &enControlId, pu8Code, u32CodeSize);
            break;
...
//        *pu32CodeSize = sizeof(HI_U8);
    ...
    *pu32CodeSize    = (HI_U32)(pu8CodePtr - pu8Code + 1);
    ...
    else
    {
        pstControl->enControlId = enControlId;
        *pu32ControlSize = sizeof(enControlId) + u32ControlDataSize;
        u32ControlDataSize = (u32ControlDataSize > CONTROL_MAX_DATA_SIZE) ? CONTROL_MAX_DATA_SIZE : u32ControlDataSize;
        memcpy (pstControl->u8ControlData, as32ControlData, u32ControlDataSize);
    }
...
/*source monitor*/
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_SWF (ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    if((ps32ControlData[0] >= SWF_FORMAT_960_540_SIDE) && (ps32ControlData[0] <= SWF_FORMAT_720_480_LENGTH))
    {
        *penControlId = ARIB_CSI_SWF_1;
    }
    else
    {
        s32Ret = HI_FAILURE;
...
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_SSM (ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    if(ps32ControlData[0] == ps32ControlData[1])
    {
        if((ps32ControlData[0] == SSM_SIZE_16) || (ps32ControlData[0] == SSM_SIZE_20) ||
           (ps32ControlData[0] == SSM_SIZE_24) || (ps32ControlData[0] == SSM_SIZE_30) ||
           (ps32ControlData[0] == SSM_SIZE_36)                                     )
        {
            *penControlId = ARIB_CSI_SSM;
        }
        else
        {
            s32Ret = HI_FAILURE;
...
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_ORN (ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    if((ps32ControlData[0] >= ORN_NOTHING) && (ps32ControlData[0] <= ORN_HEMMING))
    {
        if((ps32ControlData[1] >= ORN_INDEX_MIN) && (ps32ControlData[1] <= ORN_INDEX_MAX))
        {
            *penControlId = ARIB_CSI_ORN;
        }
        else
        {
            s32Ret = HI_FAILURE;
...
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_SCR (ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    if((ps32ControlData[0] >= SCR_MODE_FIXED) && (ps32ControlData[0] <= SCR_MODE_SCREEN_ROLLOUT))
    {
        *penControlId = ARIB_CSI_SCR;
    }
    else
    {
        s32Ret = HI_FAILURE;
...
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_PRA (ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    if((ps32ControlData[0] >= PRA_NEWS_FLUSH_CHIME_1) && (ps32ControlData[0] <= PRA_ALERT))
    {
        *penControlId = ARIB_CSI_PRA;
    }
    else
    {
        s32Ret = HI_FAILURE;
...
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_RCS (ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    if((ps32ControlData[0] >= RCS_INDEX_MIN) && (ps32ControlData[0] <= RCS_INDEX_MAX))
    {
        *penControlId = ARIB_CSI_RCS;
    }
    else
    {
        s32Ret = HI_FAILURE;
...
static HI_S32 _ARIBCC_DEC_DecodeCsiControl_FinalByte (HI_U8 *pu8CodePtr, ARIBCC_CtrlSet_E *penControlId, HI_S32 *ps32ControlData)
{
    HI_S32 s32Ret = HI_SUCCESS;

    switch (*pu8CodePtr)
    {
        #if 0 /* source monitor: similar with default branch */
        case CSI_GSM:
        case CSI_CCC:
        case CSI_PLD:
        case CSI_PLU:
        ...
        case CSI_ACS:
        case CSI_SCS:
            HI_ERR_CC("CSI:0x%X Error!\n", *pu8CodePtr);
            //*penControlId = ARIB_CSI_XXX;
            s32Ret = HI_FAILURE;
            break;
        #endif
        case CSI_SWF:
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_SWF (penControlId, ps32ControlData);
            break;
        case CSI_SDF:
            *penControlId = ARIB_CSI_SDF;
            break;
        case CSI_SSM:
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_SSM (penControlId, ps32ControlData);
            break;
        case CSI_SHS:
            *penControlId = ARIB_CSI_SHS;
            break;
        case CSI_SVS:
            *penControlId = ARIB_CSI_SVS;
            break;
        case CSI_SDP:
            *penControlId = ARIB_CSI_SDP;
            break;
        case CSI_ACPS:
            *penControlId = ARIB_CSI_ACPS;
            break;
        case CSI_ORN:
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_ORN (penControlId, ps32ControlData);
            break;
        case CSI_SCR:
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_SCR (penControlId, ps32ControlData);
            break;
        case CSI_PRA:
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_PRA (penControlId, ps32ControlData);
            break;
        case CSI_RCS:
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_RCS (penControlId, ps32ControlData);
            break;
        default:
...
//    HI_U8     OrnAdr[4];
    ...
    *pu32ControlSize = 0;
    ...
    for(i=j=0,TempBuff=0; i < u32CodeSize; i++ )
    {
        ...
        {
            s32Ret = _ARIBCC_DEC_DecodeCsiControl_FinalByte(pu8CodePtr, &enControlId, &as32ControlData[0]);
            break;
        }
        else if((*pu8CodePtr == 0x20) || (*pu8CodePtr == 0x3B))
        {
...
//        *pu32CodeSize = sizeof(HI_U8);
    ...
    HI_INFO_CC("as32ControlData= %d %d %d %d\n",
            as32ControlData[0], as32ControlData[1], as32ControlData[2], as32ControlData[3]);
...
HI_S32 _ARIBCC_DEC_DecodeDrcsData_ChkPara (ARIBCC_CaptionType_E enCaptionType, ARIBCC_DrcsType_E enDrcsType, HI_U8 *pu8InDrcsData,
                                   HI_U32 u32InDrcsDataSize, HI_U8 *pu8OutDrcsData, HI_U32 *pu32OutDrcsDataSize)
{
                                   ...
                                   HI_U32 u32InDrcsDataSize, HI_U8 *pu8OutDrcsData, HI_U32 *pu32OutDrcsDataSize)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeDrcsData_ChkPara (enCaptionType, enDrcsType, pu8InDrcsData,
                                                                                            u32InDrcsDataSize, pu8OutDrcsData, pu32OutDrcsDataSize);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
...
HI_S32 _ARIBCC_DEC_DecodeBitmapData_ChkPara (ARIBCC_CaptionType_E enCaptionType, HI_U8 *pu8InBitmapData, HI_U32 u32InBitmapDataSize,
                              HI_U8 *pu8OutBitmapData, HI_U32 *pu32OutBitmapDataSize)
{
    HI_ERR_CC("DecodeCsiControl (enCaptionType = %s, "
...
HI_S32 _ARIBCC_DEC_DecodeBitmapData_ChkData (HI_U8 *pu8InBitmapData, HI_U8 *pu8ChunkData)
{
    HI_U8   u8BitDepth = 0, u8ColorType = 0;
                              ...
                              HI_U8 *pu8OutBitmapData, HI_U32 *pu32OutBitmapDataSize)
{
    ...
    s32Ret = _ARIBCC_DEC_DecodeBitmapData_ChkPara (enCaptionType, pu8InBitmapData, u32InBitmapDataSize,
                                                                                               pu8OutBitmapData, pu32OutBitmapDataSize);
    if (s32Ret != HI_SUCCESS)
    {
        return HI_FAILURE;
    }
    ...
    *pu32OutBitmapDataSize = 0;
    ...
    for (pu8Chunk = pu8PngData + PNG_SIG_SIZE; pu8Chunk < pu8PngData + u32PngLength; pu8Chunk += (u32ChunkLength + (sizeof(HI_U32) * 3)))
    {
        ...
        if (memcmp (pu8ChunkType, CHUNK_TYPE_IHDR, strlen(CHUNK_TYPE_IHDR)) == 0)
        {
            ...
            s32Ret = _ARIBCC_DEC_DecodeBitmapData_ChkData (pu8InBitmapData, pu8ChunkData);
            if (s32Ret != HI_SUCCESS)
            {
                break;
            }
...
HI_S32 _ARIBCC_DEC_GetPresentTimeFromPTS (ARIBCC_CaptionType_E enCaptionType, HI_U64 u64PtsFromPES90k, struct timeval *pstTimeValue)
{
    ...
    s32Ret = ARIBCC_GRAPHIC_GetCurPts(&s64CurPts);
    if(s32Ret != HI_SUCCESS)
    {
        return s32Ret;
    }
