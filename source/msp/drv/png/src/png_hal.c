...
static volatile PNG_HAL_REGISTER_S *g_pstPngReg = NULL;
...
{
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(g_pstPngReg, HI_FAILURE);
...
#endif
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE( g_pstPngReg);
...
HI_VOID PngHalStartDecode(HI_VOID)
{
    ...
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32BitBufStAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32BitBufEndAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32BitStreamStAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32BitStreamEndAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32RdcStAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32FltStAddr);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(0, g_pstPngReg->u32FltEndAddr);
...
HI_U32 PngHalGetIntStatus(HI_VOID)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(g_pstPngReg, PNG_INT_ERR_MASK);
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_GFX_SmmuIsr,  FAILURE_TAG);
 ...
 **BEG SYS FUNC
 **===========================================================================================**/
HI_VOID PNG_Memcpy(HI_VOID *pDst, const HI_VOID *pSrc, HI_U32 SrcSize)
{
    if ((NULL != pDst) && (NULL != pSrc) && (0 != SrcSize)) { memcpy(pDst, pSrc, SrcSize); }
}

HI_VOID PNG_Memset(HI_VOID *pDst, HI_S32 InitValue, HI_U32 DstSize)
{
