...
{
#if defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798cv200)
    return HI_ERR_CA_NOT_SUPPORT;
#else
    HI_BOOL bValue = *(HI_BOOL *)pstCmdParam->pu8ParamBuf;
...
{
#if defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3798mv100)
