...
#ifndef __CONFIG_HI3716MV430_H__
#define __CONFIG_HI3716MV430_H__
#define CONFIG_ARCH_HI3716MV430
...
#include "hi3716mv430_config.h"

#undef CONFIG_BOOT_SIMULATE

#ifdef CONFIG_BOOT_SIMULATE
#define step(x)  writel(x, REG_BASE_SCTL + REG_SC_GEN31)
#undef CFG_HI3716MV430_FPGA
#else
#define step(x)
#endif

#if CFG_HI3716MV430_FPGA
#  define CONFIG_HI3716MV430_FPGA
#else
#  undef CONFIG_HI3716MV430_FPGA
#endif
...
#define  CONFIG_SMCU_LOAD_SIZE  0x9000
...
#define CONFIG_RESERVE_MEM_GAP        0
...
#define CONFIG_PL01x_PORTS {(void *)REG_BASE_UART0}

#define CONFIG_PRODUCTNAME            "hi3716mv430"
...
#  define CONFIG_NET_HISFV300_HI3716MV430     1
...
#ifdef CONFIG_HSL_SUPPORT
#define CONFIG_HSL_AREA_LEN         0x10000
#else
#define CONFIG_HSL_AREA_LEN         0
#endif
...
#define CONFIG_ASCAREA_LEN          0

/*--------Encrypted Auxcode Protection Key------*/
/* 0D 4A 63 6C D0 7D 89 D9 9E 83 B5 63 12 9B EC F5 */
#if 1
#define CONFIG_AUXKEY_0             0x91E634B5
#define CONFIG_AUXKEY_1             0xD718EC4C
#define CONFIG_AUXKEY_2             0x244B4982
#define CONFIG_AUXKEY_3             0x7739BEBA
#else
#define CONFIG_AUXKEY_0             0x03020100
#define CONFIG_AUXKEY_1             0x07060504
#define CONFIG_AUXKEY_2             0x0b0a0908
#define CONFIG_AUXKEY_3             0x0f0e0d0c
#endif
...
#endif /* __CONFIG_HI3716MV430_H__ */
