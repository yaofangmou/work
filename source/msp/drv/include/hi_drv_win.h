...
typedef enum tagWIN_FORCEFRAMEPROG_FLAG_E{
    WIN_FRAME_FORCE_CLOSE = 0,
    WIN_FRAME_FORCE_PROG,
    WIN_FRAME_FORCE_INTERLEAVE,
    WIN_FRAME_FORCE_BUTT
}HI_DRV_WIN_FORCEFRAMEPROG_FLAG_E ;

typedef enum tagHI_DRV_WIN_FIELDORDER_E{
    WIN_FIELDORDER_TOPFIRST = 0,
    WIN_FIELDORDER_BOTTOMFIRST,
    WIN_FIELDORDER_UNKOWN,
    WIN_FIELDORDER_BUTT
}HI_DRV_WIN_FIELDORDER_E;

typedef enum tagWIN_CLOSE_SOFTALG_FLAG_E{
    WIN_FRAME_SHUTDOWN_CTRL = 0,
    WIN_FRAME_SOFTALG_CLOSE,
    WIN_FRAME_SOFTALG_OPEN,
    WIN_FRAME_SOFTALG_BUTT
}HI_WIN_CLOSE_SOFTALG_FLAG_E ;

typedef enum tagWIN_HW_CONFIG_CHECK_FLAG_E{
    WIN_HW_CONFIG_CHECK_CLOSE = 0,
    WIN_HW_CONFIG_CHECK_OPEN,
    WIN_HW_CONFIG_CHECK_BUTT
}HI_WIN_HW_CONFIG_CHECK_FLAG_E ;

typedef enum tagWIN_QUEUE_CTRL_FLAG_E{
    WIN_QUEUE_CTRL_NORMAL = 0,
    WIN_QUEUE_CTRL_STEP_BY_STEP,
    WIN_QUEUE_CTRL_BUTT
}HI_WIN_QUEUE_CTRL_FLAG_E ;


typedef enum hi_DRV_WIN_PLAYCTRL_TYPE_E{
...
}HI_DRV_WIN_PLAYCTRL_TYPE_E;


typedef struct hi_DRV_WIN_PLAYCTRL_OPERATION_INFOR_S{
    HI_DRV_WIN_PLAYCTRL_TYPE_E ePlayctrlType;
    struct
    {
        HI_DRV_WIN_FORCEFRAMEPROG_FLAG_E eProgRevise;
        HI_WIN_CLOSE_SOFTALG_FLAG_E eSoftAlgCtrl;
        HI_WIN_HW_CONFIG_CHECK_FLAG_E eWinConfigCheck;
        HI_WIN_QUEUE_CTRL_FLAG_E eQueueCtrl;
    } stPlayCtrlInfor;

}HI_DRV_WIN_PLAYCTRL_OPERATION_INFOR_S ;
...
typedef struct hiWIN_TECHNICOLOR_LIB_INFO_S
{
    HI_CHAR cBuildtime[128];
    HI_CHAR cVersion[128];
    HI_U32  bValid;
}WIN_TECHNICOLOR_LIB_INFO_S;
...
HI_S32 HI_DRV_WIN_GetWindowProgInterleave(HI_HANDLE hWin, HI_DRV_WIN_FORCEFRAMEPROG_FLAG_E *peForceFrameProgFlag);
