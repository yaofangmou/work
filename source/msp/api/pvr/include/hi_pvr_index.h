...
typedef struct hiPVR_INDEXER_S
{
    ...
    PVR_INDEX_REC_PID_CTRL_S *pstPidCtrl;   /*记录PID变更信息*/
#endif
#if defined(HI_PVR_APPEND_RECORD_SUPPORT) || defined(HI_PVR_PID_CHANGE_SUPPORT)
...
/*Private data, saved in the header of the index file*//**<CNcomment: 私有数据，保存在索引文件头中*/
...
/*Record information about file handles used in linearization or truncate processes*//**<CNcomment: 用来记录线性化或truncate过程中使用的文件相关信息*/
...
/*Record the data distribution of the current processing frame*//**<CNcomment: 记录当前处理帧的数据分布情况(offset，length)*/
...
/*Intermediate cache buffer information, similar to ExtraBuffer*//**<CNcomment: 用来缓存离线线性化或truncate过程中的Ts数据，作用类似于ExtraBuffer*/
...
/*Record information about linearization processing*//**<CNcomment:记录线性化处理相关信息*/
...
/*Record information about truncate processing*//**<CNcomment:记录truncate 处理相关信息*/
