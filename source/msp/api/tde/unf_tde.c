...
#ifndef HI_BUILD_IN_BOOT
#define HI_GFX_Memcpy  TDE_Memcpy
static HI_VOID TDE_Memcpy(HI_VOID *pDst, const HI_VOID *pSrc, HI_U32 SrcSize)
{
                       ...
                       TDE2_OPT_S *pstOpt)
{
    ...
    {
        stBlitCmd.stBackGroundRect.s32Xpos   = pstBackGroundRect->s32Xpos;
        stBlitCmd.stBackGroundRect.s32Ypos   = pstBackGroundRect->s32Ypos;
        stBlitCmd.stBackGroundRect.u32Width  = pstBackGroundRect->u32Width;
        stBlitCmd.stBackGroundRect.u32Height = pstBackGroundRect->u32Height;
    }
    ...
    {
        stBlitCmd.stForeGroundRect.s32Xpos   = pstForeGroundRect->s32Xpos;
        stBlitCmd.stForeGroundRect.s32Ypos   = pstForeGroundRect->s32Ypos;
        stBlitCmd.stForeGroundRect.u32Width  = pstForeGroundRect->u32Width;
        stBlitCmd.stForeGroundRect.u32Height = pstForeGroundRect->u32Height;
    }
    ...
    {
        stBlitCmd.stDstRect.s32Xpos   = pstDstRect->s32Xpos;
        stBlitCmd.stDstRect.s32Ypos   = pstDstRect->s32Ypos;
        stBlitCmd.stDstRect.u32Width  = pstDstRect->u32Width;
        stBlitCmd.stDstRect.u32Height = pstDstRect->u32Height;
    }
