...
typedef struct hiVPSS_PORT_S
{
    ...
    HI_BOOL bFixdOmxBuf;
    HI_U32 u32OmxBufWidth;
    HI_U32 u32OmxBufHeight;
} VPSS_PORT_S;
...
typedef struct hiVPSS_INSTANCE_S
{
    ...
    S_VPSS_STT_REGS_TYPE stPqWbcReg[VPSS_SPLIT_MAX_NODE]; //PQ初始化数据
    ...
    HI_ULONG aulTrySrcTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulGetSrcTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulInBufDoneTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulPQInitStartTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulPQInitEndTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulSrcReadyTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulOutBufReadyTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulInstReadyTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulLogicStartTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulTunnelOutTime[VPSS_PROC_TIMESTAMP_MAXCNT];
    HI_ULONG aulSendOutTime[VPSS_PROC_TIMESTAMP_MAXCNT];
