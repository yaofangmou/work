...
HI_ULONG VDP_FhdShpVirAddr;
HI_ULONG VDP_MrgVirAddr;
...
HI_S32 VDP_DRV_AllocateCfgMem(HI_U32 u32Size, VDP_MMZ_BUFFER_S* pstVdpCfgBuffer)
{
    ...
    VDP_MrgVirAddr = (HI_ULONG)(pstVdpCfgBuffer->pu8StartVirAddr);
    VDP_MrgPhyAddr = pstVdpCfgBuffer->u32StartPhyAddr;
#endif
    return HI_SUCCESS;
}
...
#endif
	VDP_FhdShpVirAddr = (HI_ULONG)stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_SHARP ];
