...
typedef struct
{
    ...
    AVS2_SEQ_S     syn_seq;
    AVS2_SDEXT_S   syn_sdext;
    AVS2_PIC_S     syn_pic;
    AVS2_PDEXT_S   syn_pdext;
    AVS2_TEMEXT_S  syn_tsext;
    //AVS2_ROIEXT_S  syn_roiext;    // not support now for it is unnecessary and with null pointer crash risk
...
#ifdef VFMW_EPB_REMOVAL
    UINT8 aucTmpStrBuf[EPB_MAX_PIC_HEADER_SIZE]; /* For EPB removal in picture header */
#endif
...
VOID   AVS2DEC_FlushRemainImg(AVS2_CTX_S *pCtx);
