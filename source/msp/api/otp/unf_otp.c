...
HI_S32 HI_UNF_OTP_DisableTdes(HI_VOID)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_DisableTdes();
#endif
}

HI_S32 HI_UNF_OTP_GetDisableTdesStat(HI_BOOL *pbDisable)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_GetDisableTdesStat(pbDisable);
#endif
}

HI_S32 HI_UNF_OTP_DisableSwKl(HI_VOID)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_DisableSwKl();
#endif
}

HI_S32 HI_UNF_OTP_GetDisableSwKlStat(HI_BOOL *pbDisable)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_GetDisableSwKlStat(pbDisable);
#endif
}

HI_S32 HI_UNF_OTP_SetSpHardOnly(HI_VOID)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_SetSpHardOnly();
#endif
}

HI_S32 HI_UNF_OTP_GetSpHardOnlyStat(HI_BOOL *pbStatus)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_GetSpHardOnlyStat(pbStatus);
#endif
}

HI_S32 HI_UNF_OTP_SetCsa2HardOnly(HI_VOID)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_SetCsa2HardOnly();
#endif
}

HI_S32 HI_UNF_OTP_GetCsa2HardOnlyStat(HI_BOOL *pbStatus)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_GetCsa2HardOnlyStat(pbStatus);
#endif
}

HI_S32 HI_UNF_OTP_SetCsa3HardOnly(HI_VOID)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_SetCsa3HardOnly();
#endif
}

HI_S32 HI_UNF_OTP_GetCsa3HardOnlyStat(HI_BOOL *pbStatus)
{
#ifdef OTP_VERSION_V100
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#else
    return HI_MPI_OTP_GetCsa3HardOnlyStat(pbStatus);
#endif
}
