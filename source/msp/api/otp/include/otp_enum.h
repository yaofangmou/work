...
typedef enum
{
    ...
    HI_OTP_CM0_LP_KL_DISABLE,
    HI_OTP_CM0_LP_ROOTKEY,
    HI_OTP_CM0_MISC_CTRL,
    HI_OTP_CM0_MISC_KL_CSA2_DISABLE,
    HI_OTP_CM0_MISC_KL_DISABLE,
    ...
    HI_OTP_CM1_MISC_KL_CSA2_DISABLE,
    HI_OTP_CM1_MISC_KL_DISABLE,
    HI_OTP_CM1_MISC_KL_MODE,
    HI_OTP_CM1_MISC_LV_SEL,
    HI_OTP_CM1_MISC_ROOTKEY,
    HI_OTP_CM1_MISC_XOR_EN,
    HI_OTP_CM1_R2R_DISABLE,
    HI_OTP_CM1_R2R_KL_DISABLE,
    HI_OTP_CM1_R2R_LV_SEL,
    HI_OTP_CM1_R2R_ROOTKEY,
    HI_OTP_CM1_SP_CTRL,
    HI_OTP_CM1_SP_KL_CSA2_DISABLE,
    HI_OTP_CM1_SP_KL_DISABLE,
    HI_OTP_CM1_SP_LV_SEL,
    ...
    HI_OTP_HSL_AREA_LEN,
    HI_OTP_HSL_CA_VERIFY_EN,
    HI_OTP_HSL_HISI_VERIFY_EN,
    ...
    HI_OTP_MC_RSV_EN,
    HI_OTP_MISC_ROOTKEY_AES,
    HI_OTP_MISC_ROOTKEY_CSA3,
    HI_OTP_MSID,
    ...
    HI_OTP_OTP_CONTROL_CPU,
    HI_OTP_OTP_DLA_SENSOR_DISABLE,
    HI_OTP_OTP_GLOBAL_LOCK_EN,
    HI_OTP_OTP_PE_SENSOR_DISABLE,
    HI_OTP_OTP_QAM_B_DISABLE,
    HI_OTP_OTP_QAM_C_DISABLE,
    HI_OTP_OTP_QAM_I_DISABLE,
    HI_OTP_OTP_QAM_S_DISABLE,
    HI_OTP_OTP_QAM_T_DISABLE,
    HI_OTP_OTP_QAM_X_DISABLE,
    HI_OTP_OTP_SDF_SENSOR_DISABLE,
    HI_OTP_OTP_SFD_SENSOR_DISABLE,
    HI_OTP_OTP_TZ_AREA_ENABLE,
    HI_OTP_PACKAGE_ID,
    HI_OTP_PANDA_CHIPID,
    HI_OTP_PANDA_CPU_CLEARCWMODE_DISABLE,
    HI_OTP_PANDA_CW_ROOTKEY,
    HI_OTP_PANDA_FM_DEC_KEY,
    HI_OTP_PANDA_FW_DEC_KEY,
    HI_OTP_PANDA_FW_ROOTKEY,
    HI_OTP_PANDA_JTAG_MODE,
    HI_OTP_PANDA_KL_DISABLE,
    HI_OTP_PANDA_R2R_LV_SEL,
    HI_OTP_PANDA_R2R_ROOTKEY,
    HI_OTP_PERSO_DONE,
    ...
    HI_OTP_RESERVED_BYTE_1,
    HI_OTP_RESERVED_BYTE_2,
    HI_OTP_RESERVED_BYTE_3,
    HI_OTP_RESERVED_LONG_0,
    HI_OTP_RESERVED_LONG_1,
    HI_OTP_RESERVED_LONG_2,
    HI_OTP_RESERVED_LONG_7,
    HI_OTP_RK_CM_DEOB_ENABLE,
    HI_OTP_RK_CRC_RD_DISABLE,
    HI_OTP_RK_DEOB_DATA0,
    HI_OTP_RK_DEOB_DATA1,
    HI_OTP_RK_PRM_EN,
    HI_OTP_RO_SEL_EN,
