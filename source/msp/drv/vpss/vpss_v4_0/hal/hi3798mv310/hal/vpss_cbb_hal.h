...
typedef enum hiVPSS_HAL_NODE_TYPE_E //根据逻辑设计走
{
    ...
    VPSS_HAL_NODE_2D_DEI_FRAME_1,
    VPSS_HAL_NODE_2D_DEI_FRAME_1_VIRTUAL,
    VPSS_HAL_NODE_2D_DEI_FIELD_23,
    VPSS_HAL_NODE_2D_DEI_FIELD_23_VIRTUAL,
#endif

    VPSS_HAL_NODE_2D_DEI_LAST_2FIELD            ,
    VPSS_HAL_NODE_2D_DEI_LAST_2FIELD_VIRTUAL    ,

    VPSS_HAL_NODE_ROTATION_Y ,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_Y_VIRTUAL ,
    VPSS_HAL_NODE_ROTATION_C        ,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_C_VIRTUAL ,

    VPSS_HAL_NODE_2D_MC_SPLIT_NODE1 ,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE2 ,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE3 ,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE4 ,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE5 ,

    VPSS_HAL_NODE_2D_MC_SPLIT_NODE6 ,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE7,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE8 ,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE9 ,
    VPSS_HAL_NODE_BUTT
...
extern HI_S32 VPSS_HAL_Set_2DDei_Last2Field_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32
        u32AppPhy);
extern HI_S32 VPSS_HAL_Set_2DField_First23_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy);

extern HI_S32 VPSS_HAL_Set_2DFrame_First1_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy);
