...
#elif defined(CHIP_TYPE_hi3798mv310)
    return DRV_OTP_SetTrustZoneEnable();
...
#if defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3798mv200) \
...
{
#if(defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3716mv430))
    return DRV_OTP_GetStbSN(pu8StbSN, pu32Len);
#else
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#endif
}
...
{
#if (defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3716mv430))
    return DRV_OTP_SetStbSN(pu8StbSN, u32Len);
#else
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#endif
}
...
{
#if (defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3716mv430))
    return DRV_OTP_GetMSID(pu8MSID, pu32Len);
#else
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#endif
}
...
{
#if (defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3716mv430))
    return DRV_OTP_SetMSID(pu8MSID, u32Len);
#else
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#endif
}
...
{
#if (defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3716mv430))
    return DRV_OTP_GetVendorID(pu32VerdorId);
#else
    return HI_ERR_OTP_NOT_SUPPORT_INTERFACE;
#endif
}
