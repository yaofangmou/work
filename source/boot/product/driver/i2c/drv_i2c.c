...
#define I2C1_PHY_ADDR       (0xF8B11000)
#define I2C2_PHY_ADDR       (0xF8B12000)
#define QAMI2C_PHY_ADDR       (0xF8B16000)
#define ADCI2C_PHY_ADDR       (0xF8B17000)
...
HI_S32 HI_DRV_I2C_Init(HI_VOID)
{
    ...
    g_I2cKernelAddr[4] = (ADCI2C_PHY_ADDR);
...
HI_VOID HI_DRV_I2C_Exit(HI_VOID)
{
    ...
    u32RegVal  |= 0x2222222;
    g_pstRegCrg->PERI_CRG27.u32 = u32RegVal;
#elif defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3716mv430)
    u32RegVal  = g_pstRegCrg->PERI_CRG27.u32;
    u32RegVal  |= 0x22222222;
    g_pstRegCrg->PERI_CRG27.u32 = u32RegVal;
#endif
