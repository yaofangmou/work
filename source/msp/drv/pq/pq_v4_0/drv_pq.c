...
HI_DISP_PARAM_S g_stSDDispParam;
HI_DISP_PARAM_S g_stHDDispParam;
...
#if 1
//vpss csc
HI_S32 DRV_PQ_GetVPBrightness(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 *pu32Brightness)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;

    PQ_CHECK_NULL_PTR_RE_FAIL(pu32Brightness);
    PQ_CHECK_OVER_RANGE_RE_FAIL(enVpMode, HI_DRV_PQ_VP_TYPE_BUTT);

    if (PQ_FUNC_CALL(HI_PQ_MODULE_VPSSCSC, GetVPCscSetting))
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->GetVPCscSetting(enVpMode, &stPictureSetting);
        if (HI_SUCCESS == s32Ret)
        {
            *pu32Brightness = NUM2LEVEL(stPictureSetting.u16Brightness);
        }
    ...
    pqprint(PQ_PRN_VPSSCSC, "Get Type %d; Get VPSS Brightness: %d\n", enVpMode, *pu32Brightness);
    return s32Ret;
}



HI_S32 DRV_PQ_GetVPContrast(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 *pu32Contrast)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    pqprint(PQ_PRN_VPSSCSC, "Get Type %d;Get VPSS Contrast: %d\n", enVpMode, *pu32Contrast);
    return s32Ret;
}

HI_S32 DRV_PQ_GetVPHue(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 *pu32Hue)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    pqprint(PQ_PRN_VPSSCSC, "Get Type %d;Get VPSS Hue: %d\n", enVpMode, *pu32Hue);
    return s32Ret;
}

HI_S32 DRV_PQ_GetVPSaturation(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 *pu32Saturation)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    pqprint(PQ_PRN_VPSSCSC, "Get Type %d;Get VPSS Saturation: %d\n", enVpMode, *pu32Saturation);
    return s32Ret;
}

HI_S32 DRV_PQ_SetVPBrightness(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 u32Brightness)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret |= GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->SetVPCscSetting(enVpMode, &stPictureSetting);
        stPqParam.stVpssVideoSetting[enVpMode].u16Brightness   = LEVEL2NUM(u32Brightness);
    }

    pqprint(PQ_PRN_VPSSCSC, "Set Type %d;Set VPSS Brightness: %d\n", enVpMode, u32Brightness);

    return s32Ret;
}

HI_S32 DRV_PQ_SetVPContrast(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 u32Contrast)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret |= GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->SetVPCscSetting(enVpMode, &stPictureSetting);
        stPqParam.stVpssVideoSetting[enVpMode].u16Contrast = LEVEL2NUM(u32Contrast);
    }

    pqprint(PQ_PRN_VPSSCSC, "Set Type %d;Set VPSS Contrast: %d\n", enVpMode, u32Contrast);
    return s32Ret;
}



HI_S32 DRV_PQ_SetVPHue(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 u32Hue)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    ...
    if (PQ_FUNC_CALL(HI_PQ_MODULE_VPSSCSC, GetVPCscSetting))
    {
        GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->GetVPCscSetting(enVpMode, &stPictureSetting);
    }
    ...
    if (PQ_FUNC_CALL(HI_PQ_MODULE_VPSSCSC, SetVPCscSetting))
    {
        GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->SetVPCscSetting(enVpMode, &stPictureSetting);
        stPqParam.stVpssVideoSetting[enVpMode].u16Hue   = LEVEL2NUM(u32Hue);
    }

    pqprint(PQ_PRN_VPSSCSC, "Set Type %d;Set VPSS Hue: %d\n", enVpMode, u32Hue);
    return HI_SUCCESS;
}


HI_S32 DRV_PQ_SetVPSaturation(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_U32 u32Saturation)
{
    HI_PQ_PICTURE_SETTING_S stPictureSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret |= GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->SetVPCscSetting(enVpMode, &stPictureSetting);
        stPqParam.stVpssVideoSetting[enVpMode].u16Saturation   = LEVEL2NUM(u32Saturation);
    }

    pqprint(PQ_PRN_VPSSCSC, "Set Type %d;Set VPSS Saturation: %d\n", enVpMode, u32Saturation);
...
HI_S32 DRV_PQ_GetVPVideoSetting(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_PQ_PICTURE_SETTING_S *pstSetting)
{
    ...
    if (PQ_FUNC_CALL(HI_PQ_MODULE_VPSSCSC, GetVPCscSetting))
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->GetVPCscSetting(enVpMode, &stSetting);
        if (HI_SUCCESS == s32Ret)
        {
        ...
        {
            pqprint(PQ_PRN_VPSSCSC, "Get Type %d;get vpss csc error\n", enVpMode);
        }
    }
...
HI_S32 DRV_PQ_SetVPVideoSetting(HI_DRV_PQ_VP_TYPE_E enVpMode, HI_PQ_PICTURE_SETTING_S *pstSetting)
{
    HI_PQ_PICTURE_SETTING_S stSetting;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    if (PQ_FUNC_CALL(HI_PQ_MODULE_VPSSCSC, SetVPCscSetting))
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_VPSSCSC)->SetVPCscSetting(enVpMode, &stSetting);
    }

    /* up drv layer; we use 0~100 level value */
    stPqParam.stVpssVideoSetting[enVpMode].u16Brightness = LEVEL2NUM(pstSetting->u16Brightness);
    stPqParam.stVpssVideoSetting[enVpMode].u16Contrast   = LEVEL2NUM(pstSetting->u16Contrast);
    stPqParam.stVpssVideoSetting[enVpMode].u16Hue        = LEVEL2NUM(pstSetting->u16Hue);
    stPqParam.stVpssVideoSetting[enVpMode].u16Saturation = LEVEL2NUM(pstSetting->u16Saturation);
...
HI_S32 DRV_PQ_SetTemperature(HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    HI_S32 s32Ret = HI_SUCCESS;

    PQ_CHECK_NULL_PTR_RE_FAIL(pstTemperature);
    PQ_CHECK_OVER_RANGE_RE_FAIL(enDisp, HI_PQ_DISPLAY_BUTT);
    ...
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_CSC)->SetColorTemp(enDisp, pstTemperature);
    }

    /*gfx*/
    if (PQ_FUNC_CALL(HI_PQ_MODULE_GFXCSC, SetColorTemp))
    {
        s32Ret |= GET_ALG_FUN(HI_PQ_MODULE_GFXCSC)->SetColorTemp(enDisp, pstTemperature);
    }

    return s32Ret;
}

HI_S32 DRV_PQ_GetTemperature(HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_CSC)->GetColorTemp(enDisp, pstTemperature);
    }
...
HI_S32 DRV_PQ_UpdateVpssPQ(HI_U32 u32HandleNo, HI_VPSS_PQ_INFO_S *pstTimingInfo, HI_VOID *pstVPSSReg, HI_VOID *pstWbcReg, HI_PQ_VPSS_MODULE_S *pstPQModule)
{
    ...
    PQ_HAL_UpdateVpssReg(u32HandleNo, (S_VPSS_REGS_TYPE *)pstVPSSReg, (S_VPSS_STT_REGS_TYPE *) pstWbcReg);
...
HI_S32 DRV_PQ_UpdateVdpPQ(HI_PQ_DISPLAY_E enDisplayId, HI_VDP_PQ_INFO_S *pstTimingInfo, HI_VOID *pstVDPReg)
{
    ...
    PQ_HAL_UpdateVdpReg((S_VDP_REGS_TYPE *)pstVDPReg);
...
HI_S32 DRV_PQ_SetVpssZme(HI_PQ_VPSS_ZME_LAYER_E enLayerId, HI_VOID *pstReg, HI_PQ_ZME_PARA_IN_S *pstZmePara, HI_BOOL  bFirEnable)
{
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_ZME)->SetVpssZme(enLayerId, (S_VPSS_REGS_TYPE *)pstReg, pstZmePara, bFirEnable);
    }
...
HI_S32 DRV_PQ_SetVpssLCHDR(HI_PQ_VPSS_ZME_LAYER_E enLayerId, HI_VOID *pstReg, HI_PQ_XDR_FRAME_INFO *pstXdrFrameInfo)
{
    ...
    {
        s32Ret = GET_ALG_FUN(HI_PQ_MODULE_LCHDR)->GetLCHdrCfg(enLayerId, (S_VPSS_REGS_TYPE *) pstReg, pstXdrFrameInfo);
    }
...
HI_S32 DRV_PQ_GetVdpZmeStrategy (HI_PQ_ZME_LAYER_E enLayerId, HI_PQ_ZME_STRATEGY_IN_U *pstZmeIn, HI_PQ_ZME_STRATEGY_OUT_U *pstZmeOut)
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_BOOL     bTimingChange = HI_FALSE;
    static HI_U32  u32FrmWOut = 0;     /* zme output frame width  */
    static HI_U32  u32FrmHOut = 0;     /* zme output frame height */
    ...
    /* v0 acc reset */
    if (HI_PQ_DISP_V0_LAYER_ZME == enLayerId)
    {
        bTimingChange  =  ((u32FrmWOut != pstZmeIn->stLayerStrategy.u32FrmWOut)
                           || (u32FrmHOut != pstZmeIn->stLayerStrategy.u32FrmHOut));
        if (u32FrmWOut * 3 < pstZmeIn->stLayerStrategy.u32FrmWOut * 4 || u32FrmHOut * 3 < pstZmeIn->stLayerStrategy.u32FrmHOut * 4)
        {
            bTimingChange = HI_FALSE;
        }
        if (PQ_FUNC_CALL(HI_PQ_MODULE_DCI, SetAccReset))
        {
            s32Ret = GET_ALG_FUN(HI_PQ_MODULE_DCI)->SetAccReset(bTimingChange);
        }

        u32FrmWOut = pstZmeIn->stLayerStrategy.u32FrmWOut;
        u32FrmHOut = pstZmeIn->stLayerStrategy.u32FrmHOut;
    }
...
HI_S32 DRV_PQ_GetWbcInfo(HI_PQ_WBC_INFO_S *pstVpssWbcInfo)
{
    ...
    pstVpssWbcInfo->bStaticImage = HI_FALSE;
...
HI_S32 DRV_PQ_SetAlgCalcCfg(HI_PQ_WBC_INFO_S *pstVpssWbcInfo, HI_PQ_CFG_INFO_S *pstVpssCfgInfo)
{
    ...
    if (PQ_FUNC_CALL(HI_PQ_MODULE_DB, DBCalcConfigCfg) && (HI_PQ_ALGIP_SEL_VPSS == g_enAlgIPSel))
    {
        ...
        stDbCalcInfo.pstVPSSWbcReg     = (S_VPSS_STT_REGS_TYPE *)(pstVpssWbcInfo->pstVPSSWbcReg);
...
HI_S32 DRV_PQ_SetVdpAlgCalcCfg(HI_PQ_VDP_WBC_INFO_S *pstVdpWbcInfo)
{
        ...
        && (PQ_COMM_GetMoudleCtrl(HI_PQ_MODULE_DB, PQ_SOURCE_MODE_UHD) == HI_TRUE))
    {
        ...
        stDbCalcInfo.pstVPSSWbcReg     = (S_VPSS_STT_REGS_TYPE *)(pstVdpWbcInfo->pstVdpWbcReg);
...
HI_S32 DRV_PQ_GetPicSetting(HI_VOID)
{
    ...
    s32Ret = pstPdmFuncs->pfnPDM_GetDispParam(HI_UNF_DISPLAY0, &g_stSDDispParam);
    if (HI_SUCCESS != s32Ret)
    {
    ...
    stPqParam.stSDPictureSetting.u16Brightness = g_stSDDispParam.u32Brightness;
    stPqParam.stSDPictureSetting.u16Contrast   = g_stSDDispParam.u32Contrast;
    stPqParam.stSDPictureSetting.u16Hue        = g_stSDDispParam.u32HuePlus;
    stPqParam.stSDPictureSetting.u16Saturation = g_stSDDispParam.u32Saturation;

    stPqParam.stSDVideoSetting.u16Brightness = LEVEL2NUM(g_stSDDispParam.u32Brightness);
    stPqParam.stSDVideoSetting.u16Contrast   = LEVEL2NUM(g_stSDDispParam.u32Contrast);
    stPqParam.stSDVideoSetting.u16Hue        = LEVEL2NUM(g_stSDDispParam.u32HuePlus);
    stPqParam.stSDVideoSetting.u16Saturation = LEVEL2NUM(g_stSDDispParam.u32Saturation);

    s32Ret = pstPdmFuncs->pfnPDM_GetDispParam(HI_UNF_DISPLAY1, &g_stHDDispParam);
    if (HI_SUCCESS != s32Ret)
    {
        HI_WARN_PQ("baseparam may not burned\r\n");
        return HI_FAILURE;
    ...
    stPqParam.stHDPictureSetting.u16Brightness = g_stHDDispParam.u32Brightness;
    stPqParam.stHDPictureSetting.u16Contrast   = g_stHDDispParam.u32Contrast;
    stPqParam.stHDPictureSetting.u16Hue        = g_stHDDispParam.u32HuePlus;
    stPqParam.stHDPictureSetting.u16Saturation = g_stHDDispParam.u32Saturation;

    stPqParam.stHDVideoSetting.u16Brightness = LEVEL2NUM(g_stHDDispParam.u32Brightness);
    stPqParam.stHDVideoSetting.u16Contrast   = LEVEL2NUM(g_stHDDispParam.u32Contrast);
    stPqParam.stHDVideoSetting.u16Hue        = LEVEL2NUM(g_stHDDispParam.u32HuePlus);
    stPqParam.stHDVideoSetting.u16Saturation = LEVEL2NUM(g_stHDDispParam.u32Saturation);
