...
typedef enum
{
    ADEC_OUTPUT_FILL_THIS_BUF = 0,  /* this buffer is empty or do not has enough data, you can not read data from this buffer */
    ADEC_OUTPUT_EMPTY_THIS_BUF,     /* this buffer has enough data and ready for output */
    ADEC_OUTPUT_BUF_STATUS_BUTT
} ADEC_OUTPUT_BUF_STATUS_E;
