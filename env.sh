...
function setpaths()
{
    ...
    arm_histbv400_path=${PWD}/tools/linux/toolchains/arm-histbv400-linux/bin
    aarch64_histbv100_path=${PWD}/tools/linux/toolchains/aarch64-histbv100-linux/bin
    aarch64_histbv400_path=${PWD}/tools/linux/toolchains/aarch64-histbv400-linux/bin
    ...
    PATH=${arm_histbv400_path}:${PATH//${arm_histbv400_path}:/}
    PATH=${aarch64_histbv100_path}:${PATH//${aarch64_histbv100_path}:/}
    PATH=${aarch64_histbv400_path}:${PATH//${aarch64_histbv400_path}:/}
