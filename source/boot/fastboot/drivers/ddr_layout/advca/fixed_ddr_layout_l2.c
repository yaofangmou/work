...
struct ddr_layout_t fixed_ddr_layout[] = {
	...
	DDR_LAYOUT(DDR_LAYOUT_START_BOOTARGS, DDR_LAYOUT_END_BOOTARGS, LAYOUT_NAME_BOOTARGS),
	DDR_LAYOUT(DDR_LAYOUT_START_RESERVE, DDR_LAYOUT_END_RESERVE, LAYOUT_NAME_RESERVE),
	{NULL}
};
