...
/**Defines of video hdr type*//**CNcomment: 定义视频HDR类型*/
typedef enum _VOUT_VIDEO_HDR_TYPE_E
{
    VOUT_VIDEO_HDR_TYPE_SDR = 0,            /**< Normal SDR. */
    VOUT_VIDEO_HDR_TYPE_DOLBYVISION,        /**< Dolby Vision. */
    VOUT_VIDEO_HDR_TYPE_HDR10,              /**< HDR10. */
    VOUT_VIDEO_HDR_TYPE_HLG,                /**< HLG. */
    VOUT_VIDEO_HDR_TYPE_SLF,                /**< SLF. */
    VOUT_VIDEO_HDR_TYPE_TECHNICOLOR,        /**< TECHNICOLOR. */
    VOUT_VIDEO_HDR_TYPE_HDR10PLUS,          /**< HDR10 Plus. */
    VOUT_VIDEO_HDR_TYPE_BUTT
} VOUT_VIDEO_HDR_TYPE_E;
...
typedef struct _VOUT_DEVICE_S
{
    ...
    */
    ...
    /**
    \brief get video hdr type. CNcomment:获取视频的HDR类型
    \attention \n
    \param[in] hVoutWindow Window handle.CNcomment:窗口句柄 CNend
    \param[out] penHdrType: hdr type.CNcomment: HDR类型
    \retval ::SUCCESS CNcomment:成功 CNend
    \retval ::ERROR_VO_NOT_INITED  Module has not been inited.CNcomment:模块未初始化。CNend
    \retval ::FAILURE  other error.CNcomment:其它错误 CNend
    \see \n
    ...
    \endcode
    */
    S32 (*vout_window_get_hdr_type)(struct _VOUT_DEVICE_S* pstVoutDev, const HANDLE hVoutWindow,  VOUT_VIDEO_HDR_TYPE_E * const penHdrType);
