...
#ifndef _DRV_PQ_DEFINE_V5_H_
#define _DRV_PQ_DEFINE_V5_H_
...
#define PQ_GFX_ZMECOEF_BUFF "PQ_GfxZmeCoef"

#if defined(CHIP_TYPE_hi3716mv430)
#define PQ_CHIP_NAME    "3716MV430"

#define PQ_LCACM_SUPPORT
...
{
    /*ToneMapping*/
    HI_S16 as16TMLut[16][PQ_HDR_TM_512_CLUT_SIZE];
} PQ_HDR_TM_COEF_S;
...
typedef struct hiPQ_COEF_S
{
    ...
    HI_PQ_SNR_MOTIONEDGE_LUT_S  stSnrMotionCoef;
    HI_PQ_ZME_COEF_SEL_S        stZmeCoefSel;
