...
#if (defined(HI_VPSS_VER_YDJC) && defined(CHIP_TYPE_hi3798mv310))
...
#define VPSS_FIELDORDER_UNKNOWN 2
...
#define VPSS_HDR_TYPE_NEED_DETILE_NOALG(type) ( \
        ...
        || (HI_DRV_VIDEO_FRAME_TYPE_JTP_SL_HDR == (type)))
#else
