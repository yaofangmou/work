...
#define    CMD_SM2_SIGN                      _IOWR(HI_ID_CIPHER, 0x12, SM2_SIGN_DATA_S)
#define    CMD_SM2_VERIFY                    _IOWR(HI_ID_CIPHER, 0x13, SM2_VERIFY_DATA_S)
#define    CMD_SM2_ENCRYPT                   _IOWR(HI_ID_CIPHER, 0x14, SM2_ENC_DATA_S)
#define    CMD_SM2_DECRYPT                   _IOWR(HI_ID_CIPHER, 0x15, SM2_ENC_DATA_S)
#define    CMD_SM2_KEY                       _IOWR(HI_ID_CIPHER, 0x16, SM2_KEY_DATA_S)
