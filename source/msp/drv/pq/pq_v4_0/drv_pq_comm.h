...
typedef struct hiPQ_ALG_FUNCS_S
{
    ...
    HI_S32 (*GetColorTemp)       (HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature);
    HI_S32 (*SetColorTemp)       (HI_PQ_DISPLAY_E enDisp, HI_PQ_COLORTEMPERATURE_S *pstTemperature);
    /*GFX CSC*/
    ...
    HI_S32 (*SetAccReset)    (HI_BOOL bReset);
    /*ACM*/
