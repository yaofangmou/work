...
#define TDE_STRIDE_CHECK_ALIGN(u32Stride, u32AlignNum)\
    do{\
        ...
        {\
            HI_U32 Value = u32Stride; \
            HI_U32 Value1 = u32AlignNum; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "stride is not aligned");\
...
#define TDE_ADDRESS_CHECK_ALIGN(u32PhyAddr, u32AlignNum)\
    do{\
        ...
        {\
            HI_U32 Value = u32PhyAddr; \
            HI_U32 Value1 = u32AlignNum; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Bitmap address is not aligned");\
            return HI_ERR_TDE_NOT_ALIGNED;\
        }\
    }while(0)
...
#define TDE_CHECK_COLORFMT(enColorFmt) do{\
        ...
        {\
            HI_U32 Value = TDE2_COLOR_FMT_BUTT; \
            HI_U32 Value1 = enColorFmt; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "color format error");\
...
#define TDE_CHECK_MBCOLORFMT(enMbColorFmt) \
    do{\
        ...
        {\
            HI_U32 Value = TDE2_MB_COLOR_FMT_BUTT; \
            HI_U32 Value1 = enMbColorFmt; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "mb color format error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_OUTALPHAFROM(enOutAlphaFrom) \
    do{\
        ...
        {\
            HI_U32 Value = TDE2_OUTALPHA_FROM_BUTT; \
            HI_U32 Value1 = enOutAlphaFrom; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enOutAlphaFrom error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_ROPCODE(enRopCode) \
    do{\
        ...
        {\
            HI_U32 Value = TDE2_ROP_BUTT; \
            HI_U32 Value1 = enRopCode; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enRopCode error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_ALUCMD(enAluCmd) \
    do{\
        ...
        {\
            HI_U32 Value = TDE2_ALUCMD_BUTT; \
            HI_U32 Value1 = enAluCmd; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value1);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enAluCmd error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_MIRROR(enMirror) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enMirror);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enMirror error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_CLIPMODE(enClipMode) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enClipMode);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enClipMode error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_MBRESIZE(enMbResize) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enMbResize);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enMbResize error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_MBPICMODE(enMbPicMode) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enMbPicMode);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enMbPicMode error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_COLORKEYMODE(enColorKeyMode) \
    do{\
        ...
        {\
            HI_U32 Value = TDE2_COLORKEY_MODE_BUTT; \
            HI_U32 Value1 = enColorKeyMode; \
            HI_UNUSED(Value);\
            HI_UNUSED(Value1);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value1);\
...
#define TDE_CHECK_FILTERMODE(enFilterMode) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enFilterMode);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enFilterMode error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_ROTATE(enRotate) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enRotate);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "enRotate error");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_SUBBYTE_STARTX(startx, w, outFmt) \
    do {\
        ...
        if (0 > s32Bpp)\
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bpp);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unkown color format");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
        \
        if (s32Bpp < 8)\
        {\
            ...
            {\
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bpp);\
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, startx);\
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, w);\
                HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Subbyte's start or width for writing is not aligned");\
                return HI_ERR_TDE_INVALID_PARA;\
            }\
        }\
    }while(0)
...
#define TDE_CHECK_BLENDCMD(enBlendCmd) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBlendCmd);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unknown blend cmd");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_BLENDMODE(enBlendMode) \
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBlendMode);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unknown blend mode");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_CHECK_NOT_MB(enFmt) do\
    {\
        ...
        {\
            ...
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "This operation doesn't support Semi-plannar");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    } while (0)
...
#define TDE_PATTERNBACKGROUNDCATEGORY_CHECK_CLUT(enBackGroundCategory, enForeGroundCategory, enBackGroundFmt,enForeGroundFmt, enDstFmt, enAluCmd , enDstCategory)\
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enAluCmd);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "It doesn't support ROP");\
            return -1;\
        }\
        if (( TDE_COLORFMT_CATEGORY_CLUT == enBackGroundCategory )&& ((enBackGroundFmt != enForeGroundFmt) || (enBackGroundFmt != enDstFmt)))\
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundFmt);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enForeGroundFmt);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enDstFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "If background, foreground , dst are clut, they should be the same fmt");\
            return -1;\
        }\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enForeGroundCategory);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enDstCategory);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unsupported operation");\
            return -1;\
        }\
    }while(0)
...
#define TDE_BACKGROUNDCATEGORY_CHECK_CLUT(enBackGroundCategory, enForeGroundCategory, bResize, enDeflickerMode, enAluCmd , enDstCategory)\
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enDeflickerMode);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, bResize);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enAluCmd);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enBackGroundCategory);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "It doesn't support deflicker or ROP or mirror");\
            return -1; \
        }\
    }while (0)
...
#define TDE_PATTERNBACKGROUNDCATEGORY_CHECK_AN(enBackGroundCategory, enForeGroundCategory, enDstCategory ,enAluCmd )\
    do{\
        ...
        {\
            ...
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enDstCategory);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enAluCmd);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "It doesn't support ROP or mirror");\
            return -1;\
        }\
    }while(0)
...
#define TDE_BACKGROUNDCATEGORY_CHECK_ARGB(enBackGroundCategory, enForeGroundCategory, enDstFmt)\
    do{\
        ...
        {\
            ...
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enForeGroundCategory);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enDstFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Target must have alpha component");\
            return -1;\
        }\
    }while(0)
...
#define TDE_YCBCR422_FMT_CHECK_ODD(enColorFmt, s32Xpos, u32Width)\
    do{\
        ...
        {\
            HI_U32 Value = s32Xpos; \
            HI_UNUSED(Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, Value);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Width);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enColorFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "x, width of YCbCr422R couldn't be odd");\
            return -1;\
        }\
    }while(0)
...
#define TDE_YCBCR_FMT_CHECK_STRIDE(u32CbCrStride, enColorFmt)\
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32CbCrStride);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32CbCrStride);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, enColorFmt);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Invalid CbCr stride");\
            return -1;\
        }\
    }while(0)
...
#define TDE_CHECK_SURFACEPARA(pstSurface, pstRect)\
    do{\
        ...
        {\
            ...
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_XINT, pstSurface->u32Stride);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_XINT, pstSurface->u32PhyAddr);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Xpos);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Ypos);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "invalid surface phyaddr or invalid surface size or operation area");\
            return -1;\
        }\
    }while(0)
...
#define TDE_CHECK_MBCBCRPARA(pstMbSurface)\
    do{\
        ...
        {\
            ...
            {\
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbSurface->u32CbCrStride);\
                HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "mb u32CbCrStride is null ");\
                return HI_ERR_TDE_INVALID_PARA;\
            }\
            if (0 == pstMbSurface->u32CbCrPhyAddr)\
            {\
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbSurface->u32CbCrPhyAddr);\
                HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "mb u32CbCrPhyAddr is 0");\
                return HI_ERR_TDE_INVALID_PARA;\
            }\
        }\
    }while(0)
...
#define TDE_CHECK_MBSURFACEPARA(pstMbSurface, pstRect , rectWidth, rectHeight)\
    do{\
        ...
        {\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbSurface->u32YWidth);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbSurface->u32YHeight);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_XINT, pstMbSurface->u32YStride);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_XINT, pstMbSurface->u32YPhyAddr);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Xpos);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstRect->s32Ypos);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);\
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);\
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "invalid mbsurface phyaddr or invalid surface size or operation area");\
            return -1;\
        }\
    }while(0)
...
STATIC HI_S32 TdeOsiColorConvert(TDE2_FILLCOLOR_S *pstFillColor, TDE2_SURFACE_S *pstSur, HI_U32 *pu32OutColor)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstFillColor, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstSur, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pu32OutColor, HI_FAILURE);
    ...
    {
        u32Ret = TDE2_COLOR_FMT_CLUT1;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        u32Ret = TDE2_COLOR_FMT_A8;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        u32Ret = TDE2_COLOR_FMT_YCbCr422;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstFillColor->enColorFmt);
        return -1;
    }

    HI_GFX_CHECK_ARRAY_OVER_RETURN_VALUE(pstFillColor->enColorFmt, TDE2_COLOR_FMT_AYCbCr8888 + 1, HI_FAILURE);
    ...
    switch (enColorTrans)
    {
        ...
        default:
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enColorTrans);
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Unsupported color transport");
            return -1;
    }
}
                                           ...
                                           HI_U32 u32OutWidth, HI_U32 u32OutHeight)
{
        ...
        || (TDE_MAX_RECT_HEIGHT < u32OutHeight))
    {
        ...
        {
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32InWidth);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32OutWidth);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32InHeight);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32OutHeight);
            return HI_ERR_TDE_INVALID_PARA;
        }
    }
    ...
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Resize parameter error");
        return -1;
    }
    else
    {
...
static HI_S32 TdeOsiSetBlend(TDE_HWNode_S *pstHWNode, TDE2_ALUCMD_E enAluCmd, TDE2_BLEND_OPT_S stBlendOpt, TDE_DRV_ALU_MODE_E *enAluMode, HI_BOOL bCheckBlend)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(enAluMode, HI_FAILURE);
    ...
    *enAluMode = TDE_ALU_BLEND;
    ...
    if (bCheckBlend)
    {
        if (BUnknownBlendCmd)
        {
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, TDE2_BLENDCMD_BUTT);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, stBlendOpt.eBlendCmd);
        ...
        {
            u32Ret = TDE2_BLENDCMD_CONFIG;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            u32Ret = TDE2_BLEND_BUTT;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, stBlendOpt.eBlendCmd);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, stBlendOpt.eSrc2BlendMode);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        }
    }
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetBlend, FAILURE_TAG);
        TdeHalFreeNodeBuf(pstHWNode);
...
static HI_S32 TdeOsiSetColorize(TDE_HWNode_S *pstHWNode , TDE2_ALUCMD_E enAluCmd , HI_S32 u32Colorize)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetColorize, FAILURE_TAG);
        TdeHalFreeNodeBuf(pstHWNode);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
                           ...
                           TDE2_ROP_CODE_E enRopCode_Alpha , TDE_DRV_ALU_MODE_E *enAluMode , HI_BOOL SingleSr2Rop)
{
    ...
    *enAluMode = TDE_ALU_ROP;
    ...
    if (bErrorRopCode)
    {
        u32Ret = TDE2_ROP_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enRopCode_Color);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enRopCode_Alpha);
        TdeHalFreeNodeBuf(pstHWNode);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    if (SingleSr2Rop)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiIsSingleSrc2Rop, FAILURE_TAG);
            TdeHalFreeNodeBuf(pstHWNode);
            return -1;
        }
    }
                                      ...
                                      HI_BOOL bClutReload, TDE_HWNode_S *pstHWNode)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_UNUSED(u32Ret);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pClutSur, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pOutSur, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(penClutUsage, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstHWNode, HI_FAILURE);
    ...
    if (((HI_U8 *) - 1 != pClutSur->pu8ClutPhyAddr) && (HI_NULL != pClutSur->pu8ClutPhyAddr))
    {
        ...
        {
            u32Ret = TDE_COLORFMT_CATEGORY_YCbCr;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            u32Ret = TDE_COLORFMT_CATEGORY_ARGB;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enFmtCate);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pClutSur->bYCbCrClut);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
        ...
        *penClutUsage = TdeOsiGetClutUsage(pClutSur->enColorFmt, pOutSur->enColorFmt);
        if (TDE_CLUT_CLUT_BYPASS > *penClutUsage)
        {
            ...
            if (clutPhyaddr % 4)
            {
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pClutSur->pu8ClutPhyAddr);
                return HI_ERR_TDE_NOT_ALIGNED;
            }
            ...
            if (HI_NULL == pMmzClut)
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TDE_MALLOC, FAILURE_TAG);
            ...
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, wgetphy, FAILURE_TAG);
            ...
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetClutOpt, FAILURE_TAG);
                return HI_ERR_TDE_UNSUPPORTED_OPERATION;
            }
        }
    }
...
{
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pInSur);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pOutSur);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstFilterOpt);
...
STATIC HI_S32 TdeOsiCheckSingleSrc2Opt(TDE2_COLOR_FMT_E enSrc2Fmt, TDE2_COLOR_FMT_E enDstFmt, TDE2_OPT_S *pstOpt)
{
    ...
    {
        u32Ret = TDE2_COLORKEY_MODE_NONE;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enColorKeyMode);
        return -1;
    }
    ...
    {
        u32Ret = TDE2_ALUCMD_BLEND;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enAluCmd);
        return -1;
    }
    ...
    {
        u32Ret = TDE_COLORFMT_TRANSFORM_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enColorTransType);
        return -1;
    }
    ...
    if (TDE_COLORFMT_TRANSFORM_CLUT_CLUT == enColorTransType)
    {
        ...
        {
            u32Ret = TDE2_DEFLICKER_MODE_NONE;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            u32Ret = TDE2_ALUCMD_ROP;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            u32Ret = TDE2_ALUCMD_COLORIZE;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enDeflickerMode);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->bResize);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enAluCmd);
            return -1;
        }
    }
                                       ...
                                       TDE2_COLOR_FMT_E enDstFmt, TDE2_OPT_S *pstOpt)
{
    ...
    if (bUnknownFmt)
    {
        u32Ret = TDE_COLORFMT_CATEGORY_BYTE;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enSrc1Category);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enSrc2Category);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enDstCategory);
        return -1;
    }
...
{
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstConv);
                                ...
                                TDE_SCANDIRECTION_S *pstDstDirection)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pSrc, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstSrcRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDst, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstSrcDirection, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstDirection, HI_FAILURE);
    ...
    if (enMirror && bFilter)
    {
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Could not support VF/FF/HF and Mirror");
        return -1;
    }
    ...
    else
    {
        ...
        {
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32DstBpp);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32SrcdBpp);
            return -1;
        }
...
STATIC HI_S32 TdeOsiGetInterRect(TDE2_RECT_S *pRect1, TDE2_RECT_S *pRect2, TDE2_RECT_S *pInterRect)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pRect1, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pRect2, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pInterRect, HI_FAILURE);
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Left);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Right);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Top);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bottom);
        return -1;
    }
...
STATIC INLINE HI_BOOL TdeOsiIsRect1InRect2(TDE2_RECT_S *pRect1, TDE2_RECT_S *pRect2)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pRect1, HI_FALSE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pRect2, HI_FALSE);
    ...
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pRect1->s32Xpos);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pRect2->s32Xpos);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pRect1->s32Ypos);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pRect2->s32Ypos);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Right1);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Right2);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bottom1);
    HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Bottom2);
    return HI_FALSE;
}
#ifndef HI_BUILD_IN_BOOT
        ...
        TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pMbOpt, TDE_MBPARA_S *stMbPara)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstMB, HI_FAILURE);
    //HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstHWNode, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pMbOpt, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(stMbPara, HI_FAILURE);
    ...
    if (TdeHalNodeInitNd(&pstHWNode) < 0)
    {
        ...
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeInitNd, FAILURE_TAG);
        return HI_ERR_TDE_NO_MEM;
    }
    ...
    if (TdeHalNodeSetBaseOperate(pstHWNode, TDE_MB_Y_OPT, TDE_ALU_NONE, 0) < 0)
    {
        TdeOsiListPutPhyBuff(stMbPara->u32WorkBufNum);
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetBaseOperate, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    ...
    {
        TdeOsiListPutPhyBuff(stMbPara->u32WorkBufNum);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetFilterChildNode, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetColorConvert, FAILURE_TAG);
        TdeOsiListPutPhyBuff(stMbPara->u32WorkBufNum);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    ...
    if (s32Ret < 0)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetCsc, FAILURE_TAG);
        TdeOsiListPutPhyBuff(stMbPara->u32WorkBufNum);
        return s32Ret;
    }
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiMbSetClipPara, FAILURE_TAG);
        TdeOsiListPutPhyBuff(stMbPara->u32WorkBufNum);
        return s32Ret;
    }
    if ((s32Ret = TdeOsiSetNodeFinish(s32Handle, pstHWNodePass3, stMbPara->u32WorkBufNum, TDE_NODE_SUBM_ALONE)) < 0)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetNodeFinish, FAILURE_TAG);
        TdeOsiListPutPhyBuff(stMbPara->u32WorkBufNum);
        return s32Ret;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
        ...
        TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pMbOpt, TDE_MBPARA_S *stMbPara)
{
    ...
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "Mb CUS by Filter");
        ...
        TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pMbOpt, TDE_MBPARA_S *stMbPara)
{
    ...
    switch (pMbOpt->enResize)
    {
        ...
        case TDE2_MBRESIZE_QUALITY_HIGH:
        {
            ...
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetHighQualityMbReizePara, FAILURE_TAG);
                return s32Ret;
            }
        ...
        case TDE2_MBRESIZE_QUALITY_MIDDLE:
        {
            ...
            if (s32Ret != HI_SUCCESS)
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetMiddleQualityMbReizePara, FAILURE_TAG);
                return s32Ret;
            }
        ...
        case TDE2_MBRESIZE_QUALITY_LOW:
        {
            ...
            if (s32Ret != HI_SUCCESS)
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetLowQualityMbReizePara, FAILURE_TAG);
                return s32Ret;
            }
        ...
        default:     /*TDE_MBRESIZE_NONE*/
        {
            ...
            if (s32Ret != HI_SUCCESS)
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetNoneMbReizePara, FAILURE_TAG);
                return s32Ret;
            }
                                     ...
                                     TDE2_MBOPT_S *pMbOpt)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstMB, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstMbRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDst, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pMbOpt, HI_FAILURE);
    ...
    if (TDE2_MB_COLOR_FMT_JPG_YCbCr400MBP == pstMB->enMbFmt)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiConvertMbSurface, FAILURE_TAG);
            return HI_ERR_TDE_INVALID_PARA;
        }
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, u32WorkBufNum);
    ...
    if (HI_NULL == stMbPara)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, stMbPara);
        return HI_ERR_TDE_NO_MEM;
    }
                                      ...
                                      TDE_PIC_MODE_E enPicMode, TDE2_MBOPT_S *pMbOpt)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pS1Tmp, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pS2Tmp, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstMB, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstMbRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDst, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_FAILURE);
                                       ...
                                       TDE2_MB_COLOR_FMT_E enInFmt, TDE2_MB_COLOR_FMT_E enOutFmt, HI_BOOL bCbCr)
{
    ...
    if (1 >= u32Wo)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Wo);
        return 0;
    }
    if (enInFmt != enOutFmt && TDE2_MB_COLOR_FMT_JPG_YCbCr444MBP != enOutFmt)
    {
        u32Ret = TDE2_MB_COLOR_FMT_JPG_YCbCr444MBP;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enInFmt);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enOutFmt);
        //return 0;
    }
#ifndef HI_BUILD_IN_BOOT
    ...
    if (bCbCr && TDE2_MB_COLOR_FMT_JPG_YCbCr444MBP == enOutFmt)
    {
        ...
        {
            HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_VALUE(0, (u32Wo - 1), 0);
            HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
                                       ...
                                       TDE2_MB_COLOR_FMT_E enInFmt, TDE2_MB_COLOR_FMT_E enOutFmt, HI_BOOL bCbCr)
{
    ...
    if (1 >= u32Ho)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ho);
        return 0;
    }
    if (enInFmt != enOutFmt && TDE2_MB_COLOR_FMT_JPG_YCbCr444MBP != enOutFmt)
    {
    ...
    if (bCbCr && TDE2_MB_COLOR_FMT_JPG_YCbCr444MBP == enOutFmt)
    {
        ...
        {
            HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_VALUE(0, (u32Ho - 1), 0);
            HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
...
#define TDE_GET_STARTX_BY_SCANINFO(hScan, sliceW, x) \
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pSliceInfo, 0);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstFilterOpt, 0);
    ...
    else
    {
        ...
        HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_VALUE(0, pstFilterOpt->u32Bppi, 0);
...
STATIC INLINE HI_VOID TdeOsiCalcOverLapSliceWi(TDE_OVERLAPSLICE_DATUM *stOverSlapSliceDatum, TDE_FILTER_OPT *pstFilterOpt)
{
    ...
    else
    {
        ...
        HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(pstFilterOpt->u32Bppi, 0);
...
STATIC INLINE HI_VOID TdeOsiCalcOverLapSliceWo( TDE_OVERLAPSLICE_DATUM *stOverSlapSliceDatum, TDE_FILTER_OPT *pstFilterOpt)
{
    ...
    else
    {
        ...
        {
            HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE(pstFilterOpt->u32HStep, 0);
                                     ...
                                     TDE2_RECT_S  *pOutRect, HI_U32 u32Num)
{
    ...
    {
        wgetfreenum();
        s32Ret = (sizeof(TDE_HWNode_S) + TDE_NODE_HEAD_BYTE + TDE_NODE_TAIL_BYTE);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Ret);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TDE_MALLOC, FAILURE_TAG);
#ifndef HI_BUILD_IN_BOOT
...
#endif
        TDE_FREE(pBuf);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetResize, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
                                       ...
                                       TDE_FILTER_OPT *pstFilterOpt)
{
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, u32MaxSliceNum);
#ifndef HI_BUILD_IN_BOOT
    ...
    {
        HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "one slice block for filter");
        u32SliceNum = 1;
    ...
    {
        HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "NoLap slice block for filter");
    ...
    {
        HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "OverLap slice block for filter");
        ...
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, u32SliceNum);
        stChildInfo.u64Update = 0x1F;
    }
...
#endif
            TdeHalFreeNodeBuf(pNode);
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetDeflickerPara, FAILURE_TAG);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
    }
    ...
    if (0 == u32FirstNum)    /* from left to right */
    {
        for (i = u32FirstNum + 1; i < (HI_S32)u32SliceNum; i++)
        {
            ...
            if (s32Ret != HI_SUCCESS)
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetChildNodeInfo, FAILURE_TAG);
                return s32Ret;
            }
        }
    }
...
STATIC void TdeOsiGetHUpdateInfo(UpdateConfig *reg, UpdateInfo *info, int scaler_en)
{
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, update_hstart);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, update_hstop);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg->ori_in_width);

    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE((reg->zme_out_width - 1), 0);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE((reg->ori_in_width - 1), 0);
        ...
        HI_S32 update_vstop, HI_S32 ratio, HI_S32 dratio )
{
    ...
    if (update_vstop > (reg->ori_in_height - 3) && update_vstop < reg->ori_in_height)
    {
        ...
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, update_vstop);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, zme_voutstop);
    }
    else
    {
        /*the update outstreatched area didn't exceed the down limit bordline*/
    ...
    info->zme_in_height = zme_vinstop - zme_vinstart + 1;
    info->zme_instart_h = zme_vinstart;
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, zme_voutstart);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, zme_voutstop);
    info->zme_outstart_h = zme_voutstart;
    info->zme_out_height = zme_voutstop - zme_voutstart + 1;
...
STATIC void TdeOsiGetVUpdateInfo(UpdateConfig *reg, UpdateInfo *info, int scaler_en, int deflicker_en)
{
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, update_vstart);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, update_vstop);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg->ori_in_height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, ratio);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, dratio);

    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE((reg->zme_out_height - 1), 0);
    HI_GFX_CHECK_LEFT_EQUAL_RIGHT_RETURN_NOVALUE((reg->ori_in_height - 1), 0);
                                  ...
                                  TDE2_RECT_S *pInRect, TDE2_RECT_S  *pOutRect, TDE2_DEFLICKER_MODE_E enDeflickerMode, TDE_FILTER_OPT *pstFilterOpt)
{
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.ori_in_height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.ori_in_width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.zme_out_height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.zme_out_width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.update_instart_w);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.update_instart_h);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.update_in_width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, reg.update_in_height);
    ...
    if (bLocalDeflicker)
    {
        ...
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, bScale);
        ...
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_instart_w);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_instart_h);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_in_width);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_in_height);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_outstart_w);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_outstart_h);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_out_width);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_out_height);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_hphase);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.zme_vphase);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.def_offsetup);
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, info.def_offsetdown);
                                ...
                                TDE2_RECT_S  *pstDstRect, TDE2_FILLCOLOR_S *pstFillColor, TDE2_OPT_S *pstOpt)
{
    ...
    if (bContainNullPtr)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDst);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstFillColor);
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSurface, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    else
    {
        ...
        {
            s32Ret = TDE2_ALUCMD_BUTT;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, s32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enAluCmd);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        }
        ...
        {
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enOutAlphaFrom);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        }
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetClipPara, FAILURE_TAG);
    ...
    if (TDE_NORM_FILL_1OPT == enBaseMode)
    {
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiColorConvert, FAILURE_TAG);
            return HI_ERR_TDE_INVALID_PARA;
        }
    ...
    else
    {
        ...
        HI_GFX_CHECK_ARRAY_OVER_RETURN_VALUE(pstFillColor->enColorFmt, TDE2_COLOR_FMT_BUTT + 1, HI_FAILURE);
...
STATIC INLINE HI_S32 TdeOsiPreCheckSurface(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    if (bUnknownColorFmt)
    {
        s32Ret = TDE2_COLOR_FMT_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, s32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstSurface->enColorFmt);
        return -1;
    }
    ...
    if ( bRasterFmt )
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiRasterFmtCheckAlign, FAILURE_TAG);
            return s32Ret;
        }
    }
    else
...
STATIC HI_S32 TdeOsiSetForegroundColorKey(TDE_HWNode_S *pstHWNode , TDE2_SURFACE_S *pstSrc, TDE2_OPT_S *pstOpt , TDE_CLUT_USAGE_E enClutUsage)
{
    ...
    if (TDE2_COLORKEY_MODE_FOREGROUND != pstOpt->enColorKeyMode)
    {
        ...
        {
            u32Ret = TDE2_COLORKEY_MODE_BACKGROUND;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enColorKeyMode);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        u32Ret = TDE_COLORFMT_CATEGORY_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enFmtCategory);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetColorKey, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                ...
                                TDE2_OPT_S *pstOpt)
{
    ...
    if (bContainNullPtr)
    {
        ...
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstFillColor);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstOpt);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstSrc);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstSrcRect);
        return HI_ERR_TDE_NULL_PTR;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetRop, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetBlend, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetColorize, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiGetScanInfo, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetClutOpt, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetForegroundColorKey, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (bSetFileNode)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetFilterNode, FAILURE_TAG);
            return s32Ret;
        }
        HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
        return HI_SUCCESS;
...
INLINE HI_S32 TdeOsiCheckSurfaceEX(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiPreCheckSurfaceEX, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        s32Ret = TDE_MAX_RECT_WIDTH_EX;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Ret);
        s32Ret = TDE_MAX_RECT_HEIGHT_EX;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);
        return -1;
...
STATIC INLINE HI_S32 TdeOsiCheckSurface(TDE2_SURFACE_S *pstSurface, TDE2_RECT_S  *pstRect)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiPreCheckSurface, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if ( bInvalidOperationArea )
    {
        s32Ret = TDE_MAX_RECT_WIDTH;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Ret);
        s32Ret = TDE_MAX_RECT_HEIGHT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstRect->u32Height);
        return -1;
        ...
        TDE2_OPT_S      *pstOpt)
{
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pTmpSrc2Rect);
        ...
        TDE2_OPT_S      *pstOpt)
{
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstBackGroundRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGroundRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstOpt);
        return TDE_OPERATION_BUTT;
    }
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Height);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Height);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Width);
        return TDE_OPERATION_BUTT;
    }
        ...
        TDE2_OPT_S      *pstOpt)
{
    ...
    if ((HI_NULL == pstBackGround) && (HI_NULL == pstForeGround))
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstBackGround);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGround);
        return TDE_OPERATION_BUTT;
    }
...
STATIC INLINE HI_VOID TdeOsiConvertSurface(TDE2_SURFACE_S *pstSur, TDE2_RECT_S *pstRect,
        ...
        TDE2_RECT_S *pstOperationArea)
{
    HI_GFX_CHECK_ARRAY_OVER_RETURN_NOVALUE(pstSur->enColorFmt, TDE2_COLOR_FMT_BUTT + 1);
                                      ...
                                      TDE_PIC_MODE_E enPicMode)
{
    ...
    if (HI_NULL == pstDrvY)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDrvY);
        return ;
    }
    ...
    if (TDE_FRAME_PIC_MODE == enPicMode)
    {
        ...
        switch (enAdjColorFmt)
        {
            case TDE_DRV_COLOR_FMT_YCbCr400MBP:
                HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "TDE_DRV_COLOR_FMT_YCbCr400MBP");
                return -1;
            ...
            case TDE_DRV_COLOR_FMT_YCbCr420MB:
            {
                ...
                pstDrvCbCr->u32Height =
                    TDE_ADJ_SIZE_BY_START_P(pstMbRect->s32Ypos, pstMbRect->u32Height);
                HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pstDrvCbCr->u32Width);
                HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pstDrvCbCr->u32Height);
            }
            break;
            ...
            break;
            default:
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enAdjColorFmt);
                return -1;
        }
        HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
        return HI_SUCCESS;
                                     ...
                                     TDE_DRV_SURFACE_S *pstDrvCbCr, TDE_PIC_MODE_E enPicMode, HI_BOOL bCbCr2Opt)
{
    ...
    if (bContainNullPtr)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMB);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMbRect);
        return -1;
    }
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetMbSurfaceDrvCbCr, FAILURE_TAG);
        return s32Ret;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                ...
                                TDE_HWNode_S *pstHwNode)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_UNUSED(u32Ret);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstForeGround, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDst, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstOpt, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstHwNode, HI_ERR_TDE_NULL_PTR);

    if ((TDE2_CLIPMODE_INSIDE == pstOpt->enClipMode) && (!pstOpt->bResize))
    {
        if (TdeOsiGetInterRect(pstDstRect, &pstOpt->stClipRect, &stInterRect) < 0)
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiGetInterRect, FAILURE_TAG);
            return HI_ERR_TDE_CLIP_AREA;
        }
    ...
    else if (TDE2_CLIPMODE_INSIDE == pstOpt->enClipMode)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetClipping, FAILURE_TAG);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
    }
    else if (TDE2_CLIPMODE_OUTSIDE == pstOpt->enClipMode)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiIsRect1InRect2, FAILURE_TAG);
            return HI_ERR_TDE_CLIP_AREA;
        }
    ...
    {
        u32Ret = TDE2_CLIPMODE_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enClipMode);
        return HI_ERR_TDE_INVALID_PARA;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return 0;
                                  ...
                                  TDE_HWNode_S *pstHwNode)
{
    ...
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_ENTER_FUNC);
    HI_UNUSED(u32Ret);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstMbOpt, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstHwNode, HI_ERR_TDE_NULL_PTR);
    ...
    else if (pstMbOpt->enClipMode >= TDE2_CLIPMODE_BUTT)
    {
        u32Ret = TDE2_CLIPMODE_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMbOpt->enClipMode);
        return HI_ERR_TDE_INVALID_PARA;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return 0;
        ...
        TDE_OPERATION_CATEGORY_E enOptCategory, TDE_HWNode_S *pstHwNode)
{
    ...
    if (pstOpt->enAluCmd & TDE2_ALUCMD_ROP)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetRop, FAILURE_TAG);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
    }
#ifndef HI_BUILD_IN_BOOT
...
STATIC INLINE HI_S32 TdeOsiSetDeflickerPara(TDE_HWNode_S *pstHwNode, TDE2_DEFLICKER_MODE_E enDeflickerMode, TDE_FILTER_OPT *pstFilterOpt)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeHalNodeSetFlicker, FAILURE_TAG);
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                  ...
                                  HI_U32 u32WorkBufNum, TDE_NODE_SUBM_TYPE_E enSubmType)
{
    ...
    if (!bValid)
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Handle);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "invalid handle");
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, s32Handle);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "job handle already submitted");
        return HI_ERR_TDE_INVALID_HANDLE;
    }
                        ...
                        HI_BOOL bSync, TDE_FUNC_CB pFuncComplCB, HI_VOID *pFuncPara)
{
    ...
    if (bBlock)
    {
        if (in_interrupt())
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, in_interrupt, FAILURE_TAG);
            return HI_ERR_TDE_UNSUPPORTED_OPERATION;
        }
...
HI_S32     TdeOsiQuickCopy(TDE_HANDLE s32Handle, TDE2_SURFACE_S *pstSrc, TDE2_RECT_S  *pstSrcRect,
                           TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect)
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstSrc, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstSrcRect, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDst, HI_ERR_TDE_NULL_PTR);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pstDstRect, HI_ERR_TDE_NULL_PTR);
                             ...
                             TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiBlit, FAILURE_TAG);
        return s32Ret;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                       ...
                                       TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSrc2Opt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    if (pstOpt->bResize)
    {
        ...
        {
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckResizePara, FAILURE_TAG);
                                   ...
                                   TDE2_OPT_S *pstOpt, HI_BOOL bMMZForSrc, HI_BOOL bMMZForDst)
{
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSr2Para, FAILURE_TAG);
        return s32Ret;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        u32Ret = TDE2_OUTALPHA_FROM_BUTT;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enOutAlphaFrom);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        TdeHalFreeNodeBuf(pstHWNode);
        u32Ret = TDE2_OUTALPHA_FROM_BACKGROUND;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enOutAlphaFrom);
        return HI_ERR_TDE_INVALID_PARA;
    }
...
STATIC HI_S32 TdeOsiSetColorKey(TDE2_SURFACE_S *pstForeGround , TDE2_SURFACE_S *pstBackGround , TDE_HWNode_S *pstHWNode , TDE2_COLORKEY_U unColorKeyValue, TDE2_COLORKEY_MODE_E enColorKeyMode,  TDE_CLUT_USAGE_E enClutUsage)
{
    ...
    switch (enColorKeyMode)
    {
        ...
        default:
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enColorKeyMode);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
    }
                                  ...
                                  TDE2_OPT_S *pstOpt)
{
    ...
    if (TdeOsiCheckDoubleSrcOpt(pstBackGround->enColorFmt, pstForeGround->enColorFmt, pstDst->enColorFmt,
                                pstOpt) < 0)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckDoubleSrcOpt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    if ( s32Ret )
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetColorKey, FAILURE_TAG);
        return s32Ret;
    }
    ...
    switch (enOptCategory)
    {
        ...
        case TDE_OPERATION_SINGLE_SRC2:
        {
            if (NULL == pstBackGround)
            {
                ...
                {
                    HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSingleSrc2Blit, FAILURE_TAG);
                    return s32Ret;
                }
            }
            else
        ...
        case TDE_OPERATION_DOUBLE_SRC:
        {
            ...
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiDoubleSrcBlit, FAILURE_TAG);
                return s32Ret;
            }
            break;
        }
        default:
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enOptCategory);
            return HI_ERR_TDE_INVALID_PARA;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                    ...
                                    TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pstMbOpt)
{
    ...
    if (bContainNullPtr)
    {
        ...
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDst);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMbOpt);
        return HI_ERR_TDE_NULL_PTR;
    }
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSurfaceEX, FAILURE_TAG);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckMbSurfaceEX, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
#endif
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
                        ...
                        TDE2_SURFACE_S *pstDst, TDE2_RECT_S  *pstDstRect, TDE2_MBOPT_S *pstMbOpt)
{
    ...
    if (sRet != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckMbBlitPara, FAILURE_TAG);
        return sRet;
    }
    ...
    for (n = 0; n < j; n++)
    {
        ...
        for (m = 0; m < i; m++)
        {
            ...
            {
                HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetMbPara, FAILURE_TAG);
                return sRet;
            }
        ...
        TDE2_RECT_S  *pstDstRect)
{
    ...
    if (bContainNullPtr)
    {
        ...
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGround);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstForeGroundRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMask);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstMaskRect);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDst);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pstDstRect);
        return HI_ERR_TDE_NULL_PTR;
    }
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstForeGroundRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMaskRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstBackGroundRect->u32Height);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstForeGroundRect->u32Height);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMaskRect->u32Height);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstDstRect->u32Height);
        return HI_ERR_TDE_INVALID_PARA;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
                               ...
                               TDE2_ROP_CODE_E enRopCode_Color, TDE2_ROP_CODE_E enRopCode_Alpha)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiBitmapMaskCheckPara, FAILURE_TAG);
        return ret;
    }

    if (!TdeOsiWhetherContainAlpha(pstForeGround->enColorFmt))
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiWhetherContainAlpha, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }

    if (TDE2_COLOR_FMT_A1 != pstMask->enColorFmt)
    {
        ret = TDE2_COLOR_FMT_A1;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstMask->enColorFmt);
        return HI_ERR_TDE_INVALID_PARA;
    }
                                 ...
                                 TDE2_ALUCMD_E enBlendMode)
{
    ...
    {
        ret = TDE2_ALUCMD_BLEND;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enBlendMode);
        return HI_ERR_TDE_INVALID_PARA;
    }
...
HI_S32 TdeOsiGetDeflickerLevel(TDE_DEFLICKER_LEVEL_E *pDeflickerLevel)
{
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pDeflickerLevel);
        return HI_FAILURE;
    }
...
HI_S32 TdeOsiGetAlphaThresholdValue(HI_U8 *pu8ThresholdValue)
{
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pu8ThresholdValue);
        return HI_FAILURE;
    }
...
HI_S32 TdeOsiGetAlphaThresholdState(HI_BOOL *pbEnAlphaThreshold)
{
    ...
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_VOID, pbEnAlphaThreshold);
        return HI_FAILURE;
    }
                                      ...
                                      TDE2_COLOR_FMT_E enDstFmt, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (pstOpt != HI_NULL)
    {
        ...
        if (TDE_COLORFMT_TRANSFORM_CLUT_CLUT == enColorTransType)
        {
            ...
            {
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enSrcFmt);
                HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enDstFmt);
                HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "If src fmt and dst fmt are clut, they shoulod be the same fmt");
                return -1;
            }
        }
    }
                                      ...
                                      TDE2_COLOR_FMT_E enDstFmt, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (bUnknownColorFormat)
    {
        u32Ret = TDE_COLORFMT_CATEGORY_BYTE;
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, u32Ret);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enBackGroundCategory);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enForeGroundCategory);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, enDstCategory);
        return -1;
    }
        ...
        TDE2_PATTERN_FILL_OPT_S      *pstOpt)
{
    ...
    if (pTmpSrc2 != HI_NULL)
    {
        ...
        {
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pTmpSrc2Rect->u32Width);
            HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Max pattern width is 256");
            return TDE_PATTERN_OPERATION_BUTT;
        }
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
        ...
        TDE2_PATTERN_FILL_OPT_S      *pstOpt)
{
    ...
    if ((pstBackGroundRect->u32Height != pstDstRect->u32Height)
        || (pstBackGroundRect->u32Width != pstDstRect->u32Width))
    {
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstBackGroundRect->s32Xpos);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstBackGroundRect->s32Ypos);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstBackGroundRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstBackGroundRect->u32Height);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstDstRect->s32Xpos);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstDstRect->s32Ypos);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstDstRect->u32Width);
        HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_INT, pstDstRect->u32Height);
        return TDE_PATTERN_OPERATION_BUTT;
    }
...
HI_BOOL TdeOsiCheckOverlap(TDE2_SURFACE_S *pstSur1, TDE2_RECT_S *pstRect1, TDE2_SURFACE_S *pstSur2, TDE2_RECT_S *pstRect2)
{
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, u32Rect1StartPhy);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, u32Rect1EndPhy);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, u32Rect2StartPhy);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, u32Rect2EndPhy);
        ...
        TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSrcPatternOpt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckOverlap, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                  ...
                                  TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (s32Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckSingleSrcPatternFillPara, FAILURE_TAG);
        return s32Ret;
    }
    ...
    if (pstOpt != HI_NULL)
    {
        ...
        {
            s32Ret = TDE2_OUTALPHA_FROM_BUTT;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, s32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enOutAlphaFrom);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        ...
        {
            s32Ret = TDE2_OUTALPHA_FROM_BACKGROUND;
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, s32Ret);
            HI_GFX_OutErrValueMsg(HI_GFX_MSG_ERR_UINT, pstOpt->enOutAlphaFrom);
            TdeHalFreeNodeBuf(pstHWNode);
            return HI_ERR_TDE_INVALID_PARA;
        ...
        {
            TdeHalFreeNodeBuf(pstHWNode);
            HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiSetPatternClipPara, FAILURE_TAG);
            return HI_ERR_TDE_CLIP_AREA;
        }
    }
        ...
        TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckDoubleSrcPatternOpt, FAILURE_TAG);
        return HI_ERR_TDE_INVALID_PARA;
    }
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckOverlap, FAILURE_TAG);
        HI_GFX_OutErrInfoMsg(HI_GFX_MSG_ERR_INFO, "Surface overlap");
        return HI_ERR_TDE_INVALID_PARA;
    }
    HI_GFX_OutDebugFuncMsg(HI_GFX_MSG_INNER_EXIT_FUNC);
    return HI_SUCCESS;
                                  ...
                                  TDE2_SURFACE_S *pstDst, TDE2_RECT_S *pstDstRect, TDE2_PATTERN_FILL_OPT_S *pstOpt)
{
    ...
    if (HI_SUCCESS != s32Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, TdeOsiCheckDoubleSrcPatternFillPara, FAILURE_TAG);
        return s32Ret;
    }
