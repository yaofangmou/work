...
#define  PCR_STC_DIFF_MAX_PERCENT       2
...
typedef enum hiSYNC_DBG_INFO_E
{
...
typedef struct
{
    HI_U64                     StcLastValue;        /* last stc value 27M*/
    HI_U32                     StcLast;             /* last stc value ms*/
...
typedef struct hiSYNC_PCR_INFO_S
{
    ...
    HI_U32                     PcrLast;              /* last  pcr value ms*/
    HI_U32                     PcrLastValid;
    HI_BOOL                    IsPcrValid;
    ...
    HI_U32                     PcrLeadSeriesCnt;
    HI_U32                     PcrLagSeriesCnt;
    HI_U32                     PcrAbnormalSeriesCnt;
...
typedef struct hiSYNC_S
{
    ...
    HI_U32                     LoopBackStartTime;

    HI_BOOL                    SyncFinish;        /* finish flag of synchronization */

    HI_U32                     SyncFinishContinueCnt;
    HI_U32                     SyncNovelContinueCnt;
    HI_U32                     AudLoopBackPts;
    HI_U32                     VidLoopBackPts;

    HI_BOOL                    IsShowDebugDetail;
    HI_U32                     SyncDbgListNodeIdx;
    HI_U32                     SyncDbgListNodeCnt;
    HI_U32                     SyncDbgListMaxLen;
#ifdef SYNC_DEBUG_DETAIL
    struct list_head           SyncDbgInfoListHead;
#endif
    /* can't add para behind the pSyncMutex */
#ifndef __KERNEL__
