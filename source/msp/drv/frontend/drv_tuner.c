...
static HI_VOID select_demod_hi3137(HI_U32 u32TunerPort)
{
    ...
    g_stTunerOps[u32TunerPort].tuner_get_plp_info = hi3137_get_plp_info;
    g_stTunerOps[u32TunerPort].tuner_set_plp_para = hi3137_set_plp_para;
    ...
    g_stTunerOps[u32TunerPort].tuner_get_cir_plot_data = hi3137_get_cir_plot_data;
    #endif
}
#endif
...
static HI_VOID select_demod_mn88472(HI_U32 u32TunerPort)
{
    ...
    g_stTunerOps[u32TunerPort].tuner_get_plp_info = MN88472_get_plp_info;
    g_stTunerOps[u32TunerPort].tuner_set_plp_para = MN88472_set_plp_para;
...
static HI_VOID select_demod_mn88473(HI_U32 u32TunerPort)
{
    ...
    g_stTunerOps[u32TunerPort].tuner_get_plp_info = MN8847x_get_plp_info;
    g_stTunerOps[u32TunerPort].tuner_set_plp_para = MN8847x_set_plp_para;
...
#if defined(DEMOD_DEV_TYPE_HISDTV100)
static HI_VOID select_demod_hisdtv100(HI_U32 u32TunerPort)
{
    g_stTunerOps[u32TunerPort].demod_init = HiSDTV100_ADP_Init;
    g_stTunerOps[u32TunerPort].tuner_connect = HiSDTV100_ADP_Connect;
    g_stTunerOps[u32TunerPort].tuner_get_status = HiSDTV100_ADP_GetStatus;
    g_stTunerOps[u32TunerPort].tuner_get_ber = HiSDTV100_ADP_GetBer;
    g_stTunerOps[u32TunerPort].tuner_get_snr = HiSDTV100_ADP_GetSnr;
    g_stTunerOps[u32TunerPort].tuner_get_signal_strength = HiSDTV100_ADP_GetSignalStrength;
    g_stTunerOps[u32TunerPort].tuner_get_signal_info = HiSDTV100_ADP_GetSignalInfo;
    g_stTunerOps[u32TunerPort].tuner_get_freq_symb_offset = HiSDTV100_ADP_GetFreqSymbOffset;
    g_stTunerOps[u32TunerPort].tuner_deinit = HiSDTV100_ADP_DeInit;
#if defined(HISDTV100_TER_SUPPORT)
    g_stTunerOps[u32TunerPort].tuner_get_plp_num = HiSDTV100_ADP_GetPlpNum;
    g_stTunerOps[u32TunerPort].tuner_get_plp_info = HiSDTV100_ADP_GetPLPInfo;
    g_stTunerOps[u32TunerPort].tuner_set_plp_para = HiSDTV100_ADP_SetPLPPara;
    g_stTunerOps[u32TunerPort].tuner_monitor_ISDBT_layer = HiSDTV100_ADP_MonitorLayersConfig;
#endif
#if defined(HISDTV100_SAT_SUPPORT)
    g_stTunerOps[u32TunerPort].tuner_set_sat_attr = HiSDTV100_ADP_SetSatAttr;
    g_stTunerOps[u32TunerPort].tuner_set_lnb_out = HiSDTV100_ADP_SetLnbOut;
    g_stTunerOps[u32TunerPort].tuner_send_continuous_22K = HiSDTV100_ADP_SendContinuous22K;
    g_stTunerOps[u32TunerPort].tuner_send_tone = HiSDTV100_ADP_SendTone;
    g_stTunerOps[u32TunerPort].tuner_DiSEqC_send_msg = HiSDTV100_ADP_DiSEqCSendMsg;
    g_stTunerOps[u32TunerPort].tuner_DiSEqC_recv_msg = HiSDTV100_ADP_DiSEqCRecvMsg;
    g_stTunerOps[u32TunerPort].tuner_blindscan_init = HiSDTV100_ADP_BlindscanInit;
    g_stTunerOps[u32TunerPort].tuner_blindscan_action = HiSDTV100_ADP_BlindscanAction;
    g_stTunerOps[u32TunerPort].tuner_tp_verify = HiSDTV100_ADP_TpVerify;
    g_stTunerOps[u32TunerPort].tuner_get_agc = HiSDTV100_ADP_GetAgc;
    g_stTunerOps[u32TunerPort].tuner_set_vcm_acm_stream = HiSDTV100_ADP_SetIsiID;
    g_stTunerOps[u32TunerPort].tuner_get_vcm_acm_stream = HiSDTV100_ADP_GetTotalStream;
    g_stTunerOps[u32TunerPort].tuner_get_isi_id = HiSDTV100_ADP_GetIsiID;
    g_stTunerOps[u32TunerPort].tuner_set_scramble = HiSDTV100_ADP_SetScramble;
    g_stTunerOps[u32TunerPort].tuner_get_sig_state = HiSDTV100_ADP_UNIC_GetSigStat;
    g_stTunerOps[u32TunerPort].tuner_get_chan_change = HiSDTV100_ADP_UNIC_CheckTPChange;
    g_stTunerOps[u32TunerPort].tuner_clear_chan_change = HiSDTV100_ADP_UNIC_ClearChangeFlag;
#endif
    g_stTunerOps[u32TunerPort].tuner_standby = HiSDTV100_ADP_Standby;
#ifdef HI_PROC_SUPPORT
    g_stTunerOps[u32TunerPort].tuner_get_registers = HiSDTV100_ADP_GetRegisters;
    g_stTunerOps[u32TunerPort].tuner_get_qtc_data = HiSDTV100_ADP_QTC_GetDataContinues;
    g_stTunerOps[u32TunerPort].tuner_get_cir_plot_data = HiSDTV100_ADP_GetCIR;
    g_stTunerOps[u32TunerPort].tuner_get_data_sample = HiSDTV100_ADP_GetSampleData;
    g_stTunerOps[u32TunerPort].tuner_mcu_operate = HiSDTV100_ADP_MCU_Operate;
#endif
}
#endif

HI_BOOL check_internal_demod(HI_U32 u32TunerPort, HI_CHIP_TYPE_E enChipType, HI_CHIP_VERSION_E enChipVersion)
{
    if (HI_UNF_DEMOD_DEV_TYPE_INTERNAL0 == g_stTunerOps[u32TunerPort].enDemodDevType)
    {
        HI_CHIP_TYPE_E enType = HI_CHIP_TYPE_BUTT;
        HI_CHIP_VERSION_E enVersion = HI_CHIP_VERSION_BUTT;
        HI_DRV_SYS_GetChipVersion(&enType, &enVersion);
        return (enChipType == enType && enChipVersion == enVersion);
    }
    else
    {
        return HI_FALSE;
...
static HI_S32 select_demod_type_internal(HI_U32 u32TunerPort)
{
    ...
    {
#if defined(DEMOD_DEV_TYPE_HISDTV100)
        select_demod_hisdtv100(u32TunerPort);
#endif
    }
    return HI_SUCCESS;
}
...
static HI_S32 select_demod_type(HI_U32 u32TunerPort, HI_U32 u32ResetGpioNo)
{
    switch (g_stTunerOps[u32TunerPort].enDemodDevType)
    {
        ...
        {
            /*externel demod need chip reset, internel do not need.*/
            tuner_chip_reset(u32ResetGpioNo);
        ...
        {
            select_demod_type_internal(u32TunerPort);
            break;
        }
...
static HI_VOID select_tuner_MXL661(HI_U32 u32TunerPort)
{
    g_stTunerOps[u32TunerPort].tuner_init = mxl661_init_tuner;
...
static HI_S32 select_tuner_type(HI_U32 u32TunerPort)
{
    ...
    switch (g_stTunerOps[u32TunerPort].enTunerDevType)
    {
        ...
        {
    #if defined(DEMOD_DEV_TYPE_HI3136) || defined(DEMOD_DEV_TYPE_HISDTV100)
            ...
            {
                g_stTunerOps[u32TunerPort].tuner_get_signal_strength = RDA5815m_get_signal_strength;
            }
    #endif
            break;
        }
        ...
        {
            select_tuner_MXL661(u32TunerPort);
                         ...
                         HI_DemodAttr_S *pstDemodAttr, HI_U32 u32ResetGpioNo)
{
    ...
    g_stTunerOps[u32TunerPort].stTunerCfg.bSingle3_3V = HI_TRUE;
...
HI_S32 tuner_set_sat_attr(HI_U32 u32TunerPort, HI_UNF_TUNER_SAT_ATTR_S *pstSatTunerAttr)
{
    ...
    g_stTunerOps[u32TunerPort].stTunerCfg.enIQSpectrum = pstSatTunerAttr->enIQSpectrum;
    ...
    switch (pstSatTunerAttr->enDiSEqCWave)
    {
        ...
        default:
        {
            switch (pstSatTunerAttr->enLNBCtrlDev)
            {
                ...
                case HI_UNF_LNBCTRL_DEV_TYPE_TPS65233:
                    g_stTunerOps[u32TunerPort].tuner_lnbctrl_dev_init = TPS65233_init;
                    g_stTunerOps[u32TunerPort].tuner_lnbctrl_dev_standby = TPS65233_standby;
                    g_stTunerOps[u32TunerPort].tuner_set_lnb_out = TPS65233_set_lnb_out;
                    break;
#endif
    ...
    || defined(DEMOD_DEV_TYPE_MXL541) || defined(DEMOD_DEV_TYPE_MXL582) \
    || defined(DEMOD_DEV_TYPE_HISDTV100)
...
HI_S32 tuner_osr_set_plp_para(TUNER_SETPLPPARA_S *pstPara)
{
    HI_U32 u32TunerPort = 0;
    HI_S32 s32Ret = 0;
    ...
    if (!g_stTunerOps[u32TunerPort].tuner_set_plp_para)
    {
        HI_INFO_TUNER( "this device do not support this function:%s!\n", __func__);
        return HI_SUCCESS;
    }

    s32Ret = g_stTunerOps[u32TunerPort].tuner_set_plp_para(u32TunerPort, &pstPara->stPLPPara);
    if (HI_SUCCESS != s32Ret)
    {
...
HI_S32 tuner_osr_get_plp_info(TUNER_GETPLPINFO_S *pstPara)
{
    HI_U32 u32TunerPort = 0;
    HI_S32 s32Ret = 0;
    ...
    /* if tuner set plp no operation is not setted, return fault */
    if (!g_stTunerOps[u32TunerPort].tuner_get_plp_info)
    {
        HI_INFO_TUNER( "this device do not support this function:%s!\n", __func__);
        return HI_SUCCESS;
    }

    s32Ret = g_stTunerOps[u32TunerPort].tuner_get_plp_info(u32TunerPort, pstPara->u32Index, &pstPara->stPLPInfo);
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER( "tuner_set_common_plp_combination failed!\n");
        return s32Ret;
...
HI_S32 tuner_osr_deinit(PTR_TUNER_DATA_S pstTunerDataStr)
{
    ...
    for(i = 0; i < TUNER_NUM; i++)
    {
        ...
        s32Ret |= g_stTunerOps[i].tuner_deinit(i);
...
HI_S32 tuner_osr_get_sig_stat(PTR_TUNER_DATA_S pstTunerDataStr)
{
    HI_U32 u32TunerPort = 0;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    /* if tuner_get_sig_state is not setted, return fault */
    if (!g_stTunerOps[u32TunerPort].tuner_get_sig_state)
    {
        HI_INFO_TUNER( "this device do not support this function:%s!\n", __func__);
        return HI_SUCCESS;
    }
    ...
    /* tuner_get_sig_state */
    s32Ret = g_stTunerOps[u32TunerPort].tuner_get_sig_state(u32TunerPort, &(pstTunerDataStr->u32Data));
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER( "\n tuner_get_sig_state failed \n");
        return s32Ret;
    }
...
HI_S32 tuner_osr_get_chan_change(PTR_TUNER_DATABUF_S pstTunerDataStr)
{
    HI_U32 u32TunerPort = 0;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    /* if tuner_get_chan_change is not setted, return fault */
    if (!g_stTunerOps[u32TunerPort].tuner_get_chan_change)
    {
        HI_INFO_TUNER( "this device do not support this function:%s!\n", __func__);
        return HI_SUCCESS;
    }

    /* tuner_get_chan_change */
    s32Ret = g_stTunerOps[u32TunerPort].tuner_get_chan_change(u32TunerPort, g_stTunerOps[u32TunerPort].stCurrPara.unSRBW.u32SymbolRate/1000,
                                                                    pstTunerDataStr->u32DataBuf);
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER( "\n tuner_get_chan_change failed \n");
        return s32Ret;
    }
...
HI_S32 tuner_osr_clear_chan_change(PTR_TUNER_DATA_S pstTunerDataStr)
{
    HI_U32 u32TunerPort = 0;
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    /* if tuner_clear_chan_change is not setted, return fault */
    if (!g_stTunerOps[u32TunerPort].tuner_clear_chan_change)
    {
        HI_INFO_TUNER( "this device do not support this function:%s!\n", __func__);
        return HI_SUCCESS;
    }

    /* tuner_clear_chan_change */
    s32Ret = g_stTunerOps[u32TunerPort].tuner_clear_chan_change(u32TunerPort);
    if (HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER( "\n tuner_clear_chan_change failed \n");
        return s32Ret;
    }
...
static HI_S32 tuner_ioctl_plp(HI_U32 cmd, HI_VOID *arg)
{
    ...
    switch (cmd)
    {
        ...
        case TUNER_GET_PLP_INFO_CMD:
        {
            TUNER_GETPLPINFO_S *pstInfo = (TUNER_GETPLPINFO_S *)arg;
            s32Ret = tuner_osr_get_plp_info(pstInfo);
            break;
        }
        case TUNER_SET_PLP_PARA_CMD:
        {
            TUNER_SETPLPPARA_S *pstPara = (TUNER_SETPLPPARA_S *)arg;
            s32Ret = tuner_osr_set_plp_para(pstPara);
            break;
        }
    }
...
HI_S32 tuner_ioctl(struct inode *inode, struct file *file, HI_U32 cmd, HI_VOID *arg)
{
    ...
    switch (cmd)
    {
        ...
        case TUNER_GET_SIG_STAT_CMD:
        {
            TUNER_DATA_S *pstPara = (TUNER_DATA_S *)arg;
            s32Ret = tuner_osr_get_sig_stat(pstPara);
            break;
        }
         case TUNER_CLEAR_CHANGE_FLAG_CMD:
        {
            TUNER_DATA_S *pstPara = (TUNER_DATA_S *)arg;
            s32Ret = tuner_osr_clear_chan_change(pstPara);
            break;
        }
         case TUNER_GET_CHAN_CHANGE_CMD:
        {
            TUNER_DATABUF_S *pstPara = (TUNER_DATABUF_S *)arg;
            s32Ret = tuner_osr_get_chan_change(pstPara);
            break;
        }
        default:
        {
    ...
    for (i = 0; i < TUNER_NUM; i++)
    {
        switch (g_stTunerOps[i].enDemodDevType)
        {
            ...
            case HI_UNF_DEMOD_DEV_TYPE_INTERNAL0:
                ...
                if (HI_UNF_TUNER_SIG_TYPE_SAT == g_stTunerOps[i].enSigType)
                {
                    if (g_stTunerOps[i].tuner_set_sat_attr)
                    {
                        g_stTunerOps[i].tuner_set_sat_attr(i, &(s_stTunerResumeInfo[i].stSatTunerAttr));
...
HI_S32 qam_read_byte(HI_U32 u32TunerPort, HI_U8 u8RegAddr, HI_U8 *pu8RegVal)
{
    ...
    if(check_internal_demod(u32TunerPort, HI_CHIP_TYPE_HI3716M, HI_CHIP_VERSION_V430))
    {
        s32Ret = tuner_i2c_receive_data(HISDTV100_I2C_CHANNEL, HISDTV100_DEV_ADDR, &stI2cDataStr);
    }
    else
    {
...
HI_VOID tuner_udelay(HI_U32 u32US)
{
    ktime_t wait;
    HI_U64 u64ns;
    u64ns = (HI_U64)u32US * 1000;
...
HI_S32 qam_write_byte(HI_U32 u32TunerPort, HI_U8 u8RegAddr, HI_U8 u8RegVal)
{
    ...
    if (check_internal_demod(u32TunerPort, HI_CHIP_TYPE_HI3716M, HI_CHIP_VERSION_V430))
    {
        s32Ret = tuner_i2c_send_data(HISDTV100_I2C_CHANNEL, HISDTV100_DEV_ADDR, &stI2cDataStr);
    }
    else
    {
...
static HI_S32 HI_DRV_TUNER_Connect_S(HI_U32 u32tunerId, const HI_UNF_TUNER_CONNECT_PARA_S *pstConnectPara, HI_U32 u32TimeOut)
{
    ...
    HI_U32 u32TimeSpan = 0;
    HI_UNF_TUNER_LOCK_STATUS_E enTunerStatus = HI_UNF_TUNER_SIGNAL_DROPPED;
    HI_UNF_TUNER_FE_LNB_22K_E enLNB22K = HI_UNF_TUNER_FE_LNB_22K_OFF;
