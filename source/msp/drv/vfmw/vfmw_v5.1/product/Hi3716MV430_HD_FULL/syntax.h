...
VOID   SYNTAX_GetQueueImgNum(IMAGE_VO_QUEUE *pstVoQue, SINT32 *pReadImgNum, SINT32 *pNewImgNum);
...
SINT32 SYNTAX_MarkImageOutHanging(SINT32 ChanID, SYNTAX_CTX_S *pSynCtx);
...
SINT32 SYNTAX_MarkImageEos(SINT32 ChanID, SYNTAX_CTX_S *pSynCtx);
#endif
