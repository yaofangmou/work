...
HI_S32 WIN_SetSoftAlgEnable(HI_HANDLE hWin, HI_BOOL bEnable);
...
HI_S32 Win_GetAlgMemsize(HI_HANDLE hWin, HI_U32 u32BitWidth, HI_U32 *pu32BufSize,HI_U32 *pu32OtherBufSize);
...
typedef struct tagWIN_DEBUG_PLAYCTRL_INFO_S
{
    HI_DRV_WIN_FORCEFRAMEPROG_FLAG_E eWinProgInterleaveCtrl;
} WIN_DEBUG_PLAYCTRL_INFO_S;

typedef struct tagWIN_DEBUG_PLAYSTATUS_INFO_S
{
    HI_U32 u32TotalPlayCnt;
    HI_U32 u32TotalFrame;
    HI_U32 u32FirstQueueTime;
    HI_U32 u32CurrentTime;
} WIN_DEBUG_PLAYSTATUS_INFO_S;
...
typedef struct tagWIN_DEBUG_INFO_S
{
    ...
    WIN_CRITICAL_PlayCtrl_S stWinPlayCtrl;
    WIN_DEBUG_PLAYSTATUS_INFO_S  stWinPlayStatus;
} WIN_DEBUG_INFO_S;
...
typedef struct tagWIN_PROC_INFO_S
{
    ...
    HI_U32 u32ULSOut;
    HI_U32 u32UnderLoad;
    HI_U32 u32BuffedPlayCnts;
    HI_U32 u32BuffedQueueNodeCnts;
    HI_U32 u32BuffedDequeueNodeCnts;
...
HI_VOID Win_UpWinPosionDebugInfo(HI_VOID *pstWin, WIN_INFO_S *pstLayerPara);
