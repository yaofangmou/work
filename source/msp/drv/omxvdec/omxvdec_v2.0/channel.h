...
typedef struct
{
    ...
    HI_U32             alloc_frame_time;
    HI_U32             alloc_pmv_time;
    HI_U32             frame_wait_time;
    HI_U32             pmv_wait_time;
} DSF_SINGLE_BUF_S;
...
typedef struct
{
    ...
    HI_U32             delay_time;
    HI_U32             retry_count;
    HI_U32             alloc_from_cached_failed;
...
typedef struct
{
    ...
    HI_S32  (*read_stream)(HI_S32 InstID, HI_VOID *pPacket);
    HI_S32  (*release_stream)(HI_S32 InstID, HI_VOID *pPacket);
} OMX_STREAM_INTF_S;

typedef struct
{
    HI_S32  image_provider_inst_id;
    HI_S32  (*read_image)(HI_S32 InstID, HI_VOID *pExternalFrame);
    HI_S32  (*release_image)(HI_S32 InstID, HI_VOID *pExternalFrame);
} OMX_IMAGE_INTF_S;
...
typedef struct
{
    ...
    OMX_STREAM_INTF_S stream_ops;
    OMX_IMAGE_INTF_S  image_ops;
