...
)
{
    ...
    stRect.w = s32Width;
    stRect.h = s32Height;
    s32Ret = HI_GFX_FillRect(hSurface, &stRect, u32Color, HI_GFX_COMPOPT_NONE);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_FillRect, s32Ret);
        return s32Ret;
    }
...
HI_S32 UI_DrawText(HI_HANDLE hSurface, HI_CHAR* pcContent, HI_S32 s32PosX, HI_S32 s32PosY)
{
    ...
    s32Ret = UI_GFX_TextOut(hSurface, pcContent, s32PosX, s32PosY);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(UI_GFX_TextOut, s32Ret);
        return s32Ret;
    }
...
HI_S32 UI_DrawTextEx(HI_HANDLE hSurface, HI_CHAR* pcContent, HI_S32 s32PosX, HI_S32 s32PosY, HI_S32 s32Width, HI_S32 s32Height, HI_S32 enAlignType)
{
    ...
    s32Ret = UI_GFX_GetTextExtent(pcContent, &s32TWidth, &s32THeigh);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(UI_GFX_GetTextExtent, s32Ret);
        return s32Ret;
    }

    if ((s32TWidth < s32Width)
        || (s32THeigh < s32Height))
    {
...
HI_S32 UI_GetTextExtent(HI_CHAR* pcText, HI_S32* ps32Width, HI_S32* ps32Height)
{
    ...
    s32Ret = UI_GFX_GetTextExtent(pcText, ps32Width, ps32Height);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(UI_GFX_GetTextExtent, s32Ret);
        return s32Ret;
...
HI_S32 UI_SetTextColor(HI_U32 u32Color)
{
    ...
    s32Ret = UI_GFX_SetTextColor(u32Color);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(UI_GFX_SetTextColor, s32Ret);
        return s32Ret;
    }
...
HI_S32 UI_SetTextBGColor(HI_U32 u32Color)
{
    ...
    s32Ret = UI_GFX_SetTextBGColor(u32Color);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(UI_GFX_SetTextBGColor, s32Ret);
        return s32Ret;
    }
...
HI_S32 UI_ScreenRefresh(HI_VOID)
{
    ...
    s32Ret = HI_GFX_GetLayerSurface(&hLayerSurface);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_GetLayerSurface, s32Ret);
        return HI_FAILURE;
    }

    s32Ret = HI_GFX_RefreshLayer(hLayerSurface);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_RefreshLayer, COM_ERR_EXTERNAL);
        return COM_ERR_EXTERNAL;
    }
...
HI_S32 UI_ScreenClean(HI_VOID)
{
    ...
    s32Ret = HI_GFX_FillRect(hLayerSurface, HI_NULL_PTR, UI_D_SCREEN_BGCOLOR, HI_GFX_COMPOPT_NONE);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_FillRect, s32Ret);
        return HI_FAILURE;
    ...
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_RefreshLayer, s32Ret);
        return HI_FAILURE;
    }
...
HI_S32 UI_SurfaceCreate(HI_S32 s32Width, HI_S32 s32Height, HI_HANDLE* phSurface)
{
    ...
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_DRV_PDM_GetDispParam, s32Ret);
        return COM_ERR_EXTERNAL;
    }

    s32Ret = HI_GFX_CreateSurface(s32Width, s32Height, stDispParam.enPixelFormat, phSurface);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_CreateSurface, s32Ret);
        return COM_ERR_EXTERNAL;
    }
...
HI_S32 UI_SurfaceDestory(HI_HANDLE hSurface)
{
    ...
    s32Ret = HI_GFX_FreeSurface(hSurface);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_FreeSurface, s32Ret);
        return COM_ERR_EXTERNAL;
    }
...
HI_S32 UI_SurfaceBlit(HI_HANDLE hSurface)
{
    ...
    HI_U32 s32LayerSurfaceW = 0;
    HI_U32 s32LayerSurfaceH = 0;
    HI_HANDLE hLayerSurface = HI_INVALID_HANDLE;
    ...
    s32Ret = HI_GFX_GetSurfaceSize(hLayerSurface, &s32LayerSurfaceW, &s32LayerSurfaceH);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_GetSurfaceSize, s32Ret);
        return s32Ret;
    }

    s32Ret = HI_GFX_GetSurfaceSize(hSurface, &u32W, &u32H);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_GetSurfaceSize, s32Ret);
        return COM_ERR_EXTERNAL;
    ...
    stRect.w = (s32LayerSurfaceH * u32W) / UI_D_SCREEN_HEIGHT;
    stRect.h = (s32LayerSurfaceH * u32H) / UI_D_SCREEN_HEIGHT;
    stRect.x = (s32LayerSurfaceW - stRect.w) / 2;
    stRect.y = (s32LayerSurfaceH - stRect.h) / 2;

    COM_MemSet(&stBltOpt, 0x00, sizeof(stBltOpt));
    stBltOpt.EnableScale = HI_TRUE;

    s32Ret = HI_GFX_Blit(hSurface, HI_NULL_PTR, hLayerSurface, &stRect, &stBltOpt);
    if (HI_SUCCESS != s32Ret)
    {
        COM_PrintFuncErr(HI_GFX_Blit, s32Ret);
        return COM_ERR_EXTERNAL;
    }
...
HI_S32 UI_GraphicsInit(HI_VOID* pstDispParam)
{
    return HI_SUCCESS;
}
