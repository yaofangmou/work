                              ...
                              HI_U32 u32Fidelity)
{
    ...
    HI_RECT_S stWbcInputDispRect = {0};
...
HI_S32 Win_ConfigWbc(HI_DRV_WIN_WBC_Linker_S *pstWbcLinker)
{
    ...
    {
        if (HI_NULL != stFunction.PF_SetWbcEnable)
        {
            stFunction.PF_SetWbcEnable(DISP_WBC_Video, HI_FALSE);
        }
        if (HI_NULL != stFunction.PF_UpdateWbc)
        {
    ...
    if (HI_NULL != stFunction.PF_SetWbcPixFmt)
    {
    ...
    {
        if (HI_NULL != stFunction.PF_SetWbc3DInfo)
        {
    ...
    if (HI_NULL != stFunction.PF_SetWbcAddr)
    {
                                    ...
                                    const HI_DRV_DISP_CALLBACK_INFO_S *pstInfo)
{
    ...
    if (HI_NULL != stFunction.PF_GetIsoWbcPartFinishPoint)
    {
