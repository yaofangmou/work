...
#define PVR_INDEX_GET_FRAMETYPE(u32Version, u16FrameTypeAndGop) (((u16FrameTypeAndGop) >> 13) & 0x7UL)
...
#define PVRINDEX_GET_GLOBALOFFSET(u32Version, pstEntry) ((pstEntry)->stEntry2.u64GlobalOffset)
#define PVRINDEX_GET_DISPTIME(u32Version, pstEntry) ((pstEntry)->stEntry2.u32DisplayTimeMs)
#define PVRINDEX_GET_FRAMESIZE(u32Version, pstEntry) ((pstEntry)->stEntry2.u32FrameSize)
#define PVRINDEX_GET_OFFSET(u32Version, pstEntry) ((pstEntry)->stEntry2.u64Offset)
#define PVRINDEX_GET_PTS(u32Version, pstEntry) ((pstEntry)->stEntry2.u32PtsMs)
#define PVRINDEX_GET_INDEXTYPE(u32Version, pstEntry) ((pstEntry)->stEntry2.u16IndexType)
#define PVRINDEX_GET_UPOVERFLOW(u32Version, pstEntry) ((pstEntry)->stEntry2.u16UpFlowFlag)
#define PVRINDEX_GET_CYCTIMES(u32Version, pstEntry) ((pstEntry)->stEntry2.s32CycTimes)
#define PVRINDEX_GET_FRAMETYPEANDGOP(u32Version, pstEntry) ((pstEntry)->stEntry2.u16FrameTypeAndGop)
#define PVRINDEX_GET_REFCNT(u32Version, pstEntry) ((pstEntry)->stEntry2.u8RefCnt)
#define PVRINDEX_GET_REFINFO(u32Version, pstEntry, pstRefInfo) (memcpy(pstRefInfo, pstEntry->stEntry2.au32RefNum, sizeof(HI_U32)*16))
#define PVRINDEX_GET_PREIOFFSET(u32Version, pstEntry) (PVRINDEX_GET_FRAMETYPEANDGOP(u32Version, pstEntry) & 0x1fffUL)
#define PVRINDEX_GET_ENTRY_BYNUM(handle, pEntry, u32FrameNum, ret) ((ret) = PVRIndex_GetEntryByNum1(handle, pEntry, u32FrameNum))
#define PVRINDEX_SET_GLOBALOFFSET(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u64GlobalOffset = (value))
#define PVRINDEX_SET_DISPTIME(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u32DisplayTimeMs = (value))
#define PVRINDEX_SET_FRAMESIZE(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u32FrameSize = (value))
#define PVRINDEX_SET_OFFSET(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u64Offset = (value))
#define PVRINDEX_SET_PTS(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u32PtsMs = (value))
#define PVRINDEX_SET_INDEXTYPE(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u16IndexType = (value))
#define PVRINDEX_SET_UPOVERFLOW(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u16UpFlowFlag = (value))
#define PVRINDEX_SET_CYCTIMES(u32Version, pstEntry, value) ((pstEntry)->stEntry2.s32CycTimes = (value))
#define PVRINDEX_SET_FRAMETYPEANDGOP(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u16FrameTypeAndGop = (value))
#define PVRINDEX_SET_LASTFRAMEOFTT(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u161stFrameOfTT = (value))
#define PVRINDEX_SET_CURPOC(u32Version, pstEntry, value) ((pstEntry)->stEntry2.s32Poc = (value))
#define PVRINDEX_SET_REFCNT(u32Version, pstEntry, value) ((pstEntry)->stEntry2.u8RefCnt = (value))
#define PVRINDEX_SET_REFINFO(u32Version, pstEntry, value, index) ((pstEntry)->stEntry2.au32RefNum[index] = (value))
#else
...
#ifdef CHIP_TYPE_hi3716mv430
#define PVR_READ_ONE_INDEX(readSz, pstEntryBuf, fd, offset, handle) (readSz = PVRIndex_ReadIndex1(pstEntryBuf,fd,offset, handle))
#else
...
#ifdef CHIP_TYPE_hi3716mv430
#define PVR_READ_ONE_ENTRY(readSz, pstEntryBuf, fd, offset, version) (readSz = PVR_READ(pstEntryBuf, sizeof(PVR_INDEX_ENTRY_NEW_S), fd, offset))
#else
