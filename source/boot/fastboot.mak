...
ifeq ($(CFG_HI3798MV200H),y)
BOOTCONFIG := hi3798mv310
SYSREG         = $(SYSREGDIR)/hi3798mv200h/$(CFG_HI_BOOT_REG_NAME)
ifeq ($(CFG_HI_UNIFIED_BOOT_SUPPORT), y)
SYSREG1        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG1)
SYSREG2        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG2)
SYSREG3        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG3)
SYSREG4        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG4)
SYSREG5        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG5)
SYSREG6        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG6)
SYSREG7        = $(SYSREGDIR)/hi3798mv200h/$(CONFIG_SYSREG7)
endif
endif

ifeq ($(CFG_HI3716DV110H),y)
BOOTCONFIG := hi3798mv310
SYSREG         = $(SYSREGDIR)/hi3716dv110h/$(CFG_HI_BOOT_REG_NAME)
ifeq ($(CFG_HI_UNIFIED_BOOT_SUPPORT), y)
SYSREG1        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG1)
SYSREG2        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG2)
SYSREG3        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG3)
SYSREG4        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG4)
SYSREG5        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG5)
SYSREG6        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG6)
SYSREG7        = $(SYSREGDIR)/hi3716dv110h/$(CONFIG_SYSREG7)
endif
endif
...
ifeq ($(CFG_HI_GPIO_LIGHT_SUPPORT), y)
	...
	@$(CONFIG_EXPORT) "CONFIG_USB_SUPPORT=$(CFG_HI_BOOT_USB_SUPPORT)" \
		"USB Driver config" $@
	@$(CONFIG_EXPORT) "CONFIG_HSL_SUPPORT=$(CFG_HI_BOOT_HSL_SUPPORT)" \
		"HSL area support" $@
