...
#define TUNER_NUM 8
#define HISDTV100_I2C_CHANNEL 3
#define HISDTV100_DEV_ADDR 0xb8
...
typedef struct hiTUNER_ACC_QAM_PARAMS_S
{
    ...
    HI_UNF_TUNER_LOCK_STATUS_E enSyncLockStatus;
...
typedef struct hiTUNER_SETPLPPARA_S
{
    HI_U32        u32Port;
    HI_UNF_TUNER_TER_PLP_PARA_S    stPLPPara;
}TUNER_SETPLPPARA_S, *PTR_TUNER_SETPLPPARA_S;

typedef struct hiTUNER_GETPLPINFO_S
{
    HI_U32        u32Port;
    HI_U32        u32Index;
    HI_UNF_TUNER_TER_PLP_INFO_S    stPLPInfo;
}TUNER_GETPLPINFO_S, *PTR_TUNER_GETPLPINFO_S;
...
typedef struct hiTUNER_TP_VERIFY_PARAMS_S
{
    ...
    HI_U32 u32SymbolRate;           /**<symbolrate HZ*/                         /**<CNcomment:符号率，单位HZ*/
...
typedef enum hiTuner_SignalStat_E
{
    TUNER_SIGNAL_BAD = 0,
    TUNER_SIGNAL_NORMAL,
    TUNER_SIGNAL_GOOD,
...
typedef enum hiTuner_NormalSignal_CheckTime_E
{
    TUNER_NORMALSIGNAL_FIRST = 0,
    TUNER_NORMALSIGNAL_SECOND,
}TUNER_NORMALSIGNAL_CHECKTIME_E;

/* standard tuner configure */
typedef struct _TUNER_CFG_S
{
    HI_U32 u32IFFreqKHz;
    HI_U32 u32XtalCapPF;
    HI_U32 u32XtalFreqKHz;
    HI_BOOL bSingle3_3V;
    HI_UNF_TUNER_IQSPECTRUM_MODE_E enIQSpectrum;
}TUNER_CFG_S;

typedef enum hiUNICABLE2_MSG_CMD_E
{
    ODU_CHANNEL_CHANGE      = 0x70,
    ODU_CHANNEL_CHANGE_PIN  = 0x71,
    ODU_UB_AVAIL            = 0x7A,
    ODU_UB_PIN              = 0x7B,
    ODU_UB_INUSE            = 0x7C,
    ODU_UB_FREQ             = 0x7D,
    ODU_UB_SWITCHES         = 0x7E
}UNICABLE2_MSG_CMD_E;
...
typedef struct _TUNER_OPS_S
{
    ...
    HI_S32 (*tuner_deinit)(HI_U32 u32TunerPort);
    HI_S32 (*tuner_monitor_ISDBT_layer)(HI_U32 u32TunerPort, HI_UNF_TUNER_MONITOR_LAYERS_CONFIG_S* pMonLayerConfig);
    HI_S32 (*tuner_ts_output_swap)(HI_U32 u32TunerPort, HI_BOOL bSwapFlag);
    /* DiSEqC回传接口 */
    HI_S32 (*tuner_get_sig_state)(HI_U32 u32TunerId, HI_U32 *pu32SigStat);
    HI_S32 (*tuner_get_chan_change)(HI_U32 u32TunerId, HI_U32 u32SymbRateKHz, HI_U32 au32Chanchange[3]);
    HI_S32 (*tuner_clear_chan_change)(HI_U32 u32TunerId);
    /* End DiSEqC */
    /* Added end:sdk 2011-11-28 For DVB-S/S2 */
    HI_S32 (*tuner_get_qtc_data)(HI_U32 u32TunerPort, HI_U32 u32QtcBuffSizeMB, HI_U32 u32RecordFileSizeMB);
    HI_S32 (*tuner_get_cir_plot_data)(HI_U32 u32TunerPort,HI_U32 u32DataLen);
    HI_S32 (*tuner_mcu_operate)(HI_U32 u32TunerPort, const HI_CHAR *pMcuCmd);
    HI_S32 (*tuner_set_plp_para)(HI_U32 u32TunerPort, HI_UNF_TUNER_TER_PLP_PARA_S *pstPLPPara);
    HI_S32 (*tuner_get_plp_info)(HI_U32 u32TunerPort, HI_U32 u32Index, HI_UNF_TUNER_TER_PLP_INFO_S *pstPLPInfo);
} TUNER_OPS_S;
...
#define TUNER_SET_PLP_PARA_CMD _IOWR(HI_TUNER_IOC_MAGIC, 57, TUNER_SETPLPPARA_S)
#define TUNER_GET_PLP_INFO_CMD _IOWR(HI_TUNER_IOC_MAGIC, 58, TUNER_GETPLPINFO_S)
#define TUNER_GET_SIG_STAT_CMD _IOWR(HI_TUNER_IOC_MAGIC, 59, TUNER_DATA_S)
#define TUNER_CLEAR_CHANGE_FLAG_CMD _IOWR(HI_TUNER_IOC_MAGIC, 60, TUNER_DATA_S)
#define TUNER_GET_CHAN_CHANGE_CMD _IOWR(HI_TUNER_IOC_MAGIC, 61, TUNER_DATABUF_S)
...
extern HI_VOID tuner_udelay(HI_U32 u32US);
