...
HI_S32 VPSS_CTRL_FixTask(VPSS_IP_E enIp, HI_DRV_BUF_ADDR_E enLR, VPSS_TASK_S *pstTask)
{
...
#endif
    {
        ...
        HI_PQ_CFG_INFO_S stVpssCfgInfo = {0};
        ...
        stVpssWbcInfo.pstVPSSWbcReg = (HI_VOID *)(&(pstInst->stPqWbcReg));
...
HI_S32 VPSS_CTRL_UpdatePqWbcData(VPSS_INSTANCE_S *pstInstance, S_VPSS_STT_REGS_TYPE *pstLocalWbcReg)
{
    ...
    stPqWbcInfo.pstVPSSWbcReg = (HI_VOID *)(&pstInstance->stPqWbcReg);
...
HI_S32 VPSS_CTRL_CompleteTask(VPSS_IP_E enIp, VPSS_TASK_S *pstTask)
{
    ...
    VPSS_CTRL_UpdatePqWbcData(pstTask->pstInstance, (S_VPSS_STT_REGS_TYPE *)pstTask->stVpssHalInfo.u32stt_w_vir_addr);
