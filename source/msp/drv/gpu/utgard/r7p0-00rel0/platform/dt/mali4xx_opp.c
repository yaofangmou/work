...
static char *clock_table_96mv200_15x15[3] = {"operating-points-ff-15x15", "operating-points-tt-15x15", "operating-points-ss-15x15"};
static char *clock_table_96mv200_21x21[3] = {"operating-points-ff-21x21", "operating-points-tt-21x21", "operating-points-ss-21x21"};
#endif
...
static char *clock_table_98mv200[3] = {"operating-points-ff", "operating-points-tt", "operating-points-ss"};
static char *clock_table_98mv200_youtube[3] = {"operating-points-ff-youtube", "operating-points-tt-youtube", "operating-points-ss-youtube"};
#endif
...
char* opps_get_svb_type(void)
{
	...
	if (PackageType == HI_CHIP_PACKAGE_TYPE_BGA_21_21) {
		...
		return clock_table_96mv200_21x21[svb_type - 1];
		...
		return clock_table_96mv200_15x15[svb_type - 1];
	...
	if ((HI_CHIP_TYPE_HI3798M == ChipType) && (HI_CHIP_VERSION_V300 == ChipID)) {
		...
		return clock_table_98mv200_youtube[svb_type - 1];
	}
	else
	{
		...
		return clock_table_98mv200[svb_type - 1];
	}
#endif
}
