...
typedef struct hiPQ_DB_CALC_INFO_S
{
    ...
    HI_U32  u32FieldOrder;            /* 当前场极性标识 */

    S_VPSS_STT_REGS_TYPE *pstVpssWbcReg;
...
typedef struct hiPQ_ALG_FUNCS_S
{
    ...
    /*HI_S32 (*SetVpssZme)        (HI_PQ_VPSS_ZME_LAYER_E enLayerId, S_VPSS_REGS_TYPE *pstReg, HI_PQ_ZME_PARA_IN_S *pstZmePara, HI_BOOL  bFirEnable);*/
    ...
    HI_S32 (*SetProcVdpZmeVidCoefSel) (HI_PQ_ZME_VID_COEF_SEL_S stProcVdpZmeVidCoefSel);
    HI_S32 (*GetProcVdpZmeVidCoefSel) (HI_PQ_ZME_VID_COEF_SEL_S *pstProcVdpZmeVidCoefSel);
    HI_S32 (*SetProcVdpZmeWbcCoefSel) (HI_PQ_ZME_WBC_COEF_SEL_S stProcVdpZmeWbcCoefSel);
    HI_S32 (*GetProcVdpZmeWbcCoefSel) (HI_PQ_ZME_WBC_COEF_SEL_S *pstProcVdpZmeWbcCoefSel);
    ...
    /*DEI*/
    HI_S32 (*SetDeiParam) (HI_PQ_WBC_INFO_S *pstVpssWbcInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);

    HI_S32 (*GetMaEnable) (HI_BOOL *pbOnOff);
    HI_S32 (*GetMcEnable) (HI_BOOL *pbOnOff);
    /*FMD*/
    HI_S32 (*SofeParaInitByHandle) (HI_U32 u32FrameIndex, HI_U32 u32HandleNo, HI_BOOL bInit);
    //HI_S32 (*IfmdDect)             (HI_PQ_IFMD_CALC_S *pstIfmdCalc, HI_PQ_IFMD_PLAYBACK_S *pstIfmdResult, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);
    HI_S32 (*IfmdDect)             (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo, HI_PQ_VPSS_OUT_INFO_S *pstPqVpssOutInfo);
    ...
    /*DB*/
    HI_S32 (*DBCfgRefresh)     (HI_U32 u32FrameIndex, HI_U32 u32HandleNo, HI_U32 u32Height, HI_U32 u32Width, HI_U32 u32FRate);
    HI_S32 (*DBCalcConfigCfg)  (HI_U32 u32FrameIndex, HI_PQ_DB_CALC_INFO_S *pstDbCalcInfo);
    HI_S32 (*SetVdpDbmParaUpd) (HI_U32 u32Data);
    HI_S32 (*InitVdpDbm)       (HI_VOID);
    HI_S32 (*SetVdpDbmInfo)    (HI_PQ_VDP_WBC_INFO_S *pstInfo);

    HI_S32 (*RefreshDbCfg)    (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);

    /*DM*/
    /*HI_S32 (*DMCfgRefresh)    (HI_U32 u32FrameIndex, HI_U32 u32HandleNo, HI_U32 u32Height, HI_U32 u32Width, HI_U32 u32FRate);*/
    HI_S32 (*DMCalcConfigCfg) (HI_U32 u32FrameIndex, HI_PQ_DB_CALC_INFO_S *pstDbCalcInfo);

    HI_S32 (*RefreshDmCfg)    (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);
    ...
    HI_S32 (*RefreshMcnrCfg) (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);
    HI_S32 (*EnableMCNR)       (HI_BOOL bOnOff);
    HI_S32 (*GetMCNREnable)    (HI_BOOL *pbOnOff);
    HI_S32 (*SetTNRBlendingAlphaLut) (HI_U32 u32FrameIndex, HI_U32 u32HandleNo);
    /*SNR*/
    HI_S32 (*SetSNRCbCrLut)       (HI_VOID);
    HI_S32 (*SetSNRMotionEdgeLut) (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);
    ...
    /*LCHDR*/
    /*HI_S32 (*GetLCHdrCfg)          (HI_PQ_VPSS_ZME_LAYER_E enLayerId, S_VPSS_REGS_TYPE *pstReg, HI_PQ_XDR_FRAME_INFO *pstXdrFrameInfo);
    ...
    HI_S32 (*ReSetPqStatus) (HI_PQ_FRAME_INFO_S *pstPqFrameInfo, HI_PQ_VPSS_REG_INFO_S *pstVpssRegInfo);
} stPQAlgFuncs;
