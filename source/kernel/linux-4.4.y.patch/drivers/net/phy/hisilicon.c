...
static struct phy_driver hisilicon_drivers[] = {
	...
	},
	{
		...
		.phy_id_mask = HISILICON_PHY_ID_MASK_ALL,
	...
	{
		.phy_id = HISILICON_PHY_ID_FESTA_S28V113,
		.phy_id_mask = HISILICON_PHY_ID_MASK_ALL,
		.name = "HiSilicon Festa s28v113",
		.features = PHY_BASIC_FEATURES,
		.flags = PHY_IS_INTERNAL | PHY_HAS_INTERRUPT,
		.driver_data = &festa_v330_data,
		.probe = festa_phy_probe,
...
static struct mdio_device_id __maybe_unused hisilicon_tbl[] = {
	...
	{ HISILICON_PHY_ID_FESTA_S28V112, HISILICON_PHY_ID_MASK_ALL },
	{ HISILICON_PHY_ID_FESTA_S28V113, HISILICON_PHY_ID_MASK_ALL },
	{ }
};
