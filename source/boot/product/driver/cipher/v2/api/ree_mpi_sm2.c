...
static HI_S32 SM2_KDF(HI_U32 u32X[8], HI_U32 u32Y[8], HI_U8* pu8k, HI_U32 u32klen)
{
    ...
    for(i=0; i<u32Block; i++)
    {
        ...
        if (i == (u32Block - 1))
        {
            cipher_memcpy_s(pu8k+i*SM2_LEN_IN_BYTE, SM2_LEN_IN_BYTE, u8H, u32klen - i * SM2_LEN_IN_BYTE);
        }
        else
        {
            cipher_memcpy_s(pu8k+i*SM2_LEN_IN_BYTE, SM2_LEN_IN_BYTE, u8H, sizeof(u8H));
        }
    }
...
//    HI_PRINT_HEX("C2", &pu8C[SM2_LEN_IN_BYTE*2], u32MsgLen);
                          ...
                          HI_U32 u32Clen, HI_U8 *pu8Msg, HI_U32 *pu32MsgLen)
{
    ...
    stHashAttr.eShaType = HI_UNF_CIPHER_HASH_TYPE_SM3;
    u32Index = 0;
    u32Mlen = u32Clen - (SM2_LEN_IN_BYTE*2) - SM2_LEN_IN_BYTE; //C2 = C - C1 -C3
...
//    HI_PRINT_HEX("H", u8H, SM2_LEN_IN_BYTE);
    ...
    if(0 != memcmp(&pu8C[u32Index], u8H, SM2_LEN_IN_BYTE))
    {
