...
static HI_S32 RENDERResetTrackConfig(HI_HANDLE hTrack)
{
    ...
    s32Ret = Source_Client_SetTrackChannelMode(hTrack, HI_UNF_TRACK_MODE_STEREO);
    if (HI_SUCCESS != s32Ret)
    {
        HI_LOG_PrintFuncErr(Source_Client_SetTrackChannelMode, s32Ret);
        return s32Ret;
    }
...
HI_S32 RENDER_CheckNewEvent(HI_HANDLE hTrack, HI_MPI_AO_RENDER_EVENT_S* pstNewEvent)
{
    ...
    s32Ret = Source_Client_CheckNewEvent(hTrack, pstNewEvent);
    if (HI_SUCCESS != s32Ret)
    {
        HI_LOG_PrintFuncWarn(Source_Client_CheckNewEvent, s32Ret);
    }
...
HI_S32  RENDER_SetTrackChannelMode(HI_HANDLE hTrack, HI_UNF_TRACK_MODE_E enMode)
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_LOG_FuncEnter();

    s32Ret = Source_Client_SetTrackChannelMode(hTrack, enMode);
    if (HI_SUCCESS != s32Ret)
    {
        HI_LOG_PrintFuncErr(Source_Client_SetTrackChannelMode, s32Ret);
        return s32Ret;
...
HI_S32  RENDER_GetTrackChannelMode(HI_HANDLE hTrack, HI_UNF_TRACK_MODE_E* penMode)
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_LOG_FuncEnter();

    s32Ret = Source_Client_GetTrackChannelMode(hTrack, penMode);
    if (HI_SUCCESS != s32Ret)
    {
        HI_LOG_PrintFuncErr(Source_Client_GetTrackChannelMode, s32Ret);
        return s32Ret;
    }
...
HI_S32 RENDER_SetAtmosLockEnable(HI_BOOL bAtmosLockEnable)
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_LOG_FuncEnter();

    s32Ret = Source_Client_SetAtmosLockEnable(bAtmosLockEnable);
    if (HI_SUCCESS != s32Ret)
    {
        HI_LOG_PrintFuncErr(Source_Client_SetAtmosLockEnable, s32Ret);
        return s32Ret;
    }
...
HI_S32 RENDER_GetAtmosLockEnable(HI_BOOL* pbAtmosLockEnable)
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_LOG_FuncEnter();

    s32Ret = Source_Client_GetAtmosLockEnable(pbAtmosLockEnable);
    if (HI_SUCCESS != s32Ret)
    {
        HI_LOG_PrintFuncErr(Source_Client_GetAtmosLockEnable, s32Ret);
        return s32Ret;
    }
