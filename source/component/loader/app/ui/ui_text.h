...
#ifdef HI_BOOTLOADER_SUPPORT

HI_S32 UI_GFX_GetTextExtent(HI_CHAR* pcText, HI_S32* ps32Width, HI_S32* ps32Height);

HI_S32 UI_GFX_SetTextBGColor(HI_U32 Color);

HI_S32 UI_GFX_SetTextColor(HI_U32 Color);

HI_S32 UI_GFX_TextOut(HI_HANDLE hSurface, HI_CHAR* pcContent, HI_S32 s32PosX, HI_S32 s32PosY);

HI_S32 UI_GFX_TextOutEx(HI_HANDLE hSurface, HI_CHAR* pcContent,  HI_S32 s32PosX, HI_S32 s32PosY, HIGO_LAYOUT_E eLayout);
