...
ifeq ($(CFG_HI_ADVCA_TYPE),NAGRA)
    ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv410 hi3716mv420 hi3716mv450 hi3716mv430 hi3796mv200),)
		$(AT)mkdir -p $(HI_ROOTBOX_DIR)/mnt/app
		$(AT)mkdir -p $(HI_ROOTBOX_DIR)/mnt/data
    endif
else ifeq ($(CFG_HI_ADVCA_TYPE),CONAX)
    ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3716mv450 hi3716mv430 hi3796mv200),)
		$(AT)mkdir -p $(HI_ROOTBOX_DIR)/mnt/data
    endif
endif
