...
static HI_S32 GFX_ADP_ConvertMBFormat(HI_GFX_PF_E enPixelFormat, TDE2_MB_COLOR_FMT_E *pTdeFmt)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pTdeFmt, HI_FAILURE);
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, Cnt);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, Size);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, enPixelFormat);
...
static HI_S32 GFX_ADP_YCbCrToRgb(HI_LOGO_SURFACE_S* pSrcSurface, TDE2_RECT_S *pSrcRect, HI_LOGO_SURFACE_S* pDstSurface, TDE2_RECT_S *pDstRect, HI_BOOL bScale)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pSrcSurface, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pSrcRect, HI_FAILURE);
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pDstSurface, HI_FAILURE);
    ...
    if (HI_SUCCESS != Ret)
    {
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pSrcSurface->enPixelFormat);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, GFX_ADP_ConvertMBFormat, Ret);
        return HI_FAILURE;
    }

    if (HI_SUCCESS != GFX_ADP_ConvertFormat(pDstSurface->enPixelFormat, &(stDstSurface.enColorFmt)))
    {
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pDstSurface->enPixelFormat);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, GFX_ADP_ConvertFormat, Ret);
        return HI_FAILURE;
    }
    ...
    HI_GFX_CHECK_EQUAL_ZERO_RETURN_VALUE(stSrcSurface.u32YPhyAddr, HI_FAILURE);

    /**output src information
     **打印输入源信息
     **/
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, stSrcSurface.u32YPhyAddr);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, stSrcSurface.u32CbCrPhyAddr);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.u32YStride);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.u32YWidth);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.u32YHeight);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.enMbFmt);
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    ...
    HI_GFX_CHECK_EQUAL_ZERO_RETURN_VALUE(stDstSurface.u32PhyAddr, HI_FAILURE);
     ...
     **/
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, stDstSurface.u32PhyAddr);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stDstSurface.u32Height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stDstSurface.u32Width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stDstSurface.u32Stride);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stDstSurface.enColorFmt);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stMbOpt.enResize);
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");

    s32Handle = HI_TDE2_BeginJob();
    if (s32Handle == HI_ERR_TDE_INVALID_HANDLE)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_BeginJob, Ret);
        return HI_FAILURE;
    }
     ...
     **/
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, pSrcRect->s32Xpos);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, pSrcRect->s32Ypos);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pSrcRect->u32Width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pSrcRect->u32Height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, pDstRect->s32Xpos);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_INT, pDstRect->s32Ypos);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pDstRect->u32Width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pDstRect->u32Height);
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");

    Ret = HI_TDE2_MbBlit(s32Handle, &stSrcSurface,pSrcRect, &stDstSurface, pDstRect, &stMbOpt);
    if (HI_SUCCESS != Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_MbBlit, Ret);
    ...
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_EndJob, Ret);
        return HI_FAILURE;
    }
...
static HI_S32 GFX_ADP_RgbToRgb(HI_LOGO_SURFACE_S* pSrcSurface, TDE2_RECT_S *pSrcRect, HI_LOGO_SURFACE_S* pDstSurface, TDE2_RECT_S *pDstRect,HI_BOOL bScale)
{
    ...
    HI_GFX_CHECK_EQUAL_ZERO_RETURN_VALUE(stSrcSurface.u32PhyAddr, HI_FAILURE);

    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, stSrcSurface.u32PhyAddr);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.u32Stride);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.u32Width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.u32Height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSrcSurface.enColorFmt);
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stDstSurface.u32Height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stDstSurface.enColorFmt);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stOpt.enColorKeyMode);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stOpt.enOutAlphaFrom);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stOpt.enAluCmd);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stOpt.u8GlobalAlpha);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stOpt.bResize);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stOpt.enFilterMode);
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");

    s32Handle = HI_TDE2_BeginJob();
    if (s32Handle == HI_ERR_TDE_INVALID_HANDLE)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_BeginJob, s32Handle);
        return HI_FAILURE;
    }
    ...
    if (Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_Bitblit, Ret);
        (HI_VOID)HI_TDE2_EndJob(s32Handle,HI_FALSE,HI_TRUE,100);
        return HI_FAILURE;
    }
...
HI_S32 HI_GFX_Blit(HI_HANDLE hSrcSurface, HI_RECT* pSrcRect, HI_HANDLE hDstSurface, HI_RECT* pDstRect, const HI_GFX_BLTOPT_S* pBlitOpt)
{
    ...
    HI_GFX_CHECK_NULLPOINTER_RETURN_VALUE(pBlitOpt, HI_FAILURE);
    ...
    if (HI_SUCCESS != Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, GFX_ADP_YCbCrToRgb, Ret);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, GFX_ADP_RgbToRgb, Ret);
        goto ERROR_EXIT;
    }
...
HI_S32 HI_BOOT_GFX2D_Init(HI_VOID)
{
    ...
    if (HI_SUCCESS != Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_Open, Ret);
        return HI_FAILURE;
    }
    ...
    if (HI_SUCCESS != Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_SetAlphaThresholdState, Ret);
        return HI_FAILURE;
    }
    ...
    if (HI_SUCCESS != Ret)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_SetAlphaThresholdValue, Ret);
        return HI_FAILURE;
    }
...
HI_S32 HI_GFX_FillRect(HI_HANDLE hSurface, const HI_RECT* pstRect, HI_U32 u32Color, HI_GFX_COMPOPT_E eComPopt)
{
    ...
    {
        HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, pstSurface->enPixelFormat);
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, GFX_ADP_ColorExpand, Ret);
        return HI_FAILURE;
    }
    ...
    HI_GFX_CHECK_EQUAL_ZERO_RETURN_VALUE(stSurface.u32PhyAddr, HI_FAILURE);

    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, stSurface.u32PhyAddr);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSurface.u32Stride);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSurface.u32Width);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSurface.u32Height);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, stSurface.enColorFmt);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_XINT, u32FillData);
    HI_GFX_OutDebugInfoMsg(HI_GFX_MSG_DEBUG_INFO, "============================================================================");
    ...
    if (Ret != HI_SUCCESS)
    {
        HI_GFX_OutErrFuncMsg(HI_GFX_MSG_ERR_FUNC, HI_TDE2_QuickFill, Ret);
        (HI_VOID)HI_TDE2_EndJob(s32Handle,HI_FALSE,HI_TRUE,100);
        goto ERROR_EXIT;
    }
...
static HI_S32 GFX_ADP_ConvertFormat(HI_GFX_PF_E enPixelFormat, TDE2_COLOR_FMT_E *pTdeFmt)
{
    ...
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, Cnt);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, Size);
    HI_GFX_OutDebugValueMsg(HI_GFX_MSG_DEBUG_UINT, enPixelFormat);
