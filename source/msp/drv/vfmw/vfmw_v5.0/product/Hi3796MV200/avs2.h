...
typedef struct
{
    UINT8  dynamicMetadataAvailable;

    UINT8  cvr_mode_value_minus1;
    UINT8  cvr_major_version_id;
    UINT8  cvr_minor_version_id;

    VBOOL  cvr_coded_picture_info_flag;
    VBOOL  cvr_target_picture_info_flag;
    VBOOL  cvr_src_mdc_info_flag;
    VBOOL  cvr_extension_flag;

    UINT8  cvr_coded_picture_primaries;
    UINT16 cvr_coded_picture_max_luminance;
    UINT16 cvr_coded_picture_min_luminance;
    UINT8  cvr_target_picture_primaries;
    UINT16 cvr_target_picture_max_luminance;
    UINT16 cvr_target_picture_min_luminance;

    UINT16 src_mdc_primaries_x[3] ;
    UINT16 src_mdc_primaries_y[3] ;
    UINT16 src_mdc_ref_white_x ;
    UINT16 src_mdc_ref_white_y;
    UINT16 src_mdc_max_mastering_luminance;
    UINT16 src_mdc_min_mastering_luminance;
    UINT16 matrix_coefficient_value[4];
    //UINT16 chroma_to_luma_injection[2];
    //UINT8  k_coefficient_value[3];

    UINT8  cvr_payload_mode;
    ...
    UINT8  tone_mapping_output_fine_tuning_num_val;
    UINT8  tone_mapping_output_fine_tuning_x[10];
    UINT8  tone_mapping_output_fine_tuning_y[10];
    UINT8  saturation_gain_num_val;
    UINT8  saturation_gain_x[6];
    UINT8  saturation_gain_y[6];
    /* for now cvr_extension_flag must equel 0
    UINT8  cvr_extension_6bits;
    UINT16 cvr_extension_length;
    UINT8  cvr_extension_data_byte[cvr_extension_length];
    */
} AVS2_DYNAMIC_METADAT_S;
#endif
...
#ifdef AVS2_SL_HDR_EN
    AVS2_DYNAMIC_METADAT_S syn_dynamic_metaext;
#endif
} AVS2_SYNTAX_S;
