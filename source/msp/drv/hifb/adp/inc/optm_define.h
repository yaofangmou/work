...
typedef enum tagVDP_DATA_RMODE_E
{
    ...
    VDP_RMODE_TOP,                /** 隔行读顶场                             **/
    VDP_RMODE_BOTTOM,             /** 隔行读底场                             **/
    VDP_RMODE_BUTT
}OPTM_VDP_DATA_RMODE_E;

typedef enum tagDRV_VDP_WBC_WMODE_E
{
    DRV_VDP_WBC_WMODE_E_SELF_ADAPTION = 0,  /** 自适应，隔行输出隔行读，逐行输出逐行读 **/
    DRV_VDP_WBC_WMODE_E_PROGRESSIVE,        /** 逐行写                                 **/
    DRV_VDP_WBC_WMODE_E_TOP,                /** 隔行写顶场                             **/
    DRV_VDP_WBC_WMODE_EE_BOTTOM,            /** 隔行写底场                             **/
    DRV_VDP_WBC_WMODE_E_BUTT
}DRV_VDP_WBC_WMODE_E;
