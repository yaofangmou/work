 ...
 */
static struct hi_opp_def hi_opp_def_list[] = {
   ...
   && (!defined(CHIP_TYPE_hi3796mv100))
    ...
    OPP_INITIALIZER(true, 1400000, HI_VDD_MPU_OPP6_UV),
#endif
...
int  hi_opp_deinit(void)
{
    int r = -ENODEV;

    PM_FUNC_ENTER();

    r = hi_deinit_opp_table(hi_opp_def_list, ARRAY_SIZE(hi_opp_def_list));
