...
{
    VPSS_DBG_INFO("Src add Idx %d %#08x %#08x %d %d\n",
                  pstDataNode->stSrcData.u32FrameIndex,
                  pstDataNode->stSrcData.stBufAddr[0].u32PhyAddr_Y,
                  pstDataNode->stSrcData.stBufAddr[0].u32PhyAddr_C,
                  pstDataNode->stSrcData.stBufAddr[0].u32Stride_Y,
                  pstDataNode->stSrcData.stBufAddr[0].u32Stride_C);
