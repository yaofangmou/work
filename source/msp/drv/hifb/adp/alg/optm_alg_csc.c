...
static HI_VOID GetCscType(OPTM_COLOR_SPACE_E eCSDrv, OPTM_ALG_CS_S *pstCsAlg);
...
{
    HI_U32 u32Hue = 0;
    HI_S32 s32ContrstAdj = 0, s32SatAdj = 0, s32Rgain = 0, s32Ggain = 0, s32Bgain = 0;

    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstCscDrvPara);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pMatrixOri);
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pMatrixDst);
    ...
    HI_GFX_CHECK_ARRAY_OVER_RETURN_NOVALUE(u32Hue, OPTM_TABL_LEN);
...
HI_VOID OPTM_CalcCscCoef_YCbCrtoYCbCr(OPTM_ALG_CSC_DRV_PARA_S *pstCscDrvPara, const OPTM_CSC_TABLE_S *pMatrixOri, OPTM_CSC_TABLE_S *pMatrixDst)
{
    ...
    pMatrixDst->s32C10 = (HI_S32)( ((HI_S32)(pMatrixOri->s32C10 * OPTM_COS_TABLE[u32Hue]) / 1000 + (HI_S32)(pMatrixOri->s32C20 * OPTM_SIN_TABLE[u32Hue]) / 1000)
    ...
    pMatrixDst->s32C12 = (HI_S32)( ((HI_S32)(pMatrixOri->s32C12 * OPTM_COS_TABLE[u32Hue]) / 1000 + (HI_S32)(pMatrixOri->s32C22 * OPTM_SIN_TABLE[u32Hue]) / 1000)
                                 * (s32ContrstAdj * s32SatAdj)) / 10000;
...
HI_VOID OPTM_CalcCscMatrix(OPTM_ALG_CSC_DRV_PARA_S *pstCscDrvPara, OPTM_ALG_CSC_RTL_PARA_S *pstCscRtlPara)
{
    ...
    HI_GFX_CHECK_ARRAY_OVER_RETURN_NOVALUE(stAlgCSIn.eCsType, 4);
    HI_GFX_CHECK_ARRAY_OVER_RETURN_NOVALUE(stAlgCSOut.eCsType, 4);
...
static HI_VOID GetCscType(OPTM_COLOR_SPACE_E eCSDrv, OPTM_ALG_CS_S *pstCsAlg)
{
    HI_GFX_CHECK_NULLPOINTER_RETURN_NOVALUE(pstCsAlg);
...
static inline HI_VOID DRV_CSC_CalcYCbCrDc(OPTM_ALG_CSC_DRV_PARA_S *pstCscDrvPara, OPTM_ALG_CSC_RTL_PARA_S *pstCscRtlPara)
{
    HI_S32 tmpContrst = 0, tmpBright  = 0;
    OPTM_ALG_CS_S stAlgCSIn, stAlgCSOut;
