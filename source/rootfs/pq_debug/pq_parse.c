...
PQ_DBG_CMD_FUN_S stPQCmdFunction[] =
{
    ...
    {PQ_CMD_READ_LCACM_430_LUT,        HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_LCACM_430_LUT,       HI_PQ_Tool_WriteRegs},

    {PQ_CMD_READ_SNR_MOTION_430_LUT,        HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_SNR_MOTION_430_LUT,       HI_PQ_Tool_WriteRegs},
    {PQ_CMD_READ_ZME_VID_SEL,        HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_ZME_VID_SEL,       HI_PQ_Tool_WriteRegs},
    {PQ_CMD_READ_ZME_WBC_SEL,        HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_ZME_WBC_SEL,       HI_PQ_Tool_WriteRegs},
    //{PQ_CMD_BUTT, NULL},
};
